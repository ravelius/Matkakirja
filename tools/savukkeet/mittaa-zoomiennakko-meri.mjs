/*
 * ZOOMIENNAKKO MERELLÄ — karkean tason näkymisaika zoomissa (Karttaseppä
 * 22.9.2026; omistajan aamutesti: *"merialueella zoomatessa syvyysviivat
 * sotkeutuvat hetkeksi paksummiksi"*, Fablen päätös b: ennakko 50 %:iin
 * ja merellä laajemmalle).
 *
 ...
 * 700, headless-kohina huomioiden) ja ennakko käytti meren laajuutta
 * (zoomiennakkoMerella true, zoomiennakkoja > 0). Maalla vain kirjataan.
 *
...
vartio('meri: zoomiennakko käytti meren laajuutta', tulokset.meri.merella && tulokset.meri.ennakkojaMax > 0, `ennakkoja ${tulokset.meri.ennakkojaMax}`);
