 ...
 *      kanssa.
 *  10. POLTETTU JA ELÄVÄ NOSTO OVAT SAMAN KOKOISIA (lisätty 2.9.2026,
...
/* Vartio 10: poltettu ja elävä nosto saman kokoisia (kumpaan suuntaan tahansa). */
...
const tarkastaPerheet = (nimi, t) => {
  ...
  /*
   * VARTIO 10 (ks. johdanto). Poltettu nosto on laatan pikseleitä ja
