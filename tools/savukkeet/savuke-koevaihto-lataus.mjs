 ...
 *   L3 latauksen jälkeen overlayn ylin rivi "koe 2/4 Kosketus suoraan" ilman
 ...
 *      (ui.pallonSyote.touchLahde) — valinta todella päätyy peliin
 *   L5 ei sivuvirheitä
...
try {
  ...
  await sivu.evaluate(() => {
    document.querySelector('#piirtokoe-valikko button[data-piirtokoe="molemmat"]').click();
  ...
  await sivu.click('#piirtokoe-valikko button[data-piirtokoe="syotetouch"]');
  ...
  vaadi('L3 koe voimassa latauksen jälkeen', /^koe 2\/4 Kosketus suoraan · profiili p\d+/.test(r) && !r.includes('seuraavassa'), r);
