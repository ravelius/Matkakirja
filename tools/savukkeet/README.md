...
| savuke-takyportti | Täkynostojen portti kaupungissa, jolla EI ole fokusvirtaa (maapooli NOSTO_MAAT): Madridissa Espanjan kolme pistettä kartalla nimiöineen, tuike tasan yhden päällä, ≥44 px osuma, kortti aukeaa pisteestä lunastusteksteineen ja kysymysnappeineen, luettu jää kartalle vaimeana ja aukeaa uudelleen seuraavan syttyessä, Pariisin kaksi lähekkäistä täkyä eivät jää päällekkäin, ja fokusmoodi pois ⇒ ei pisteitä |
