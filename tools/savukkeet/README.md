...
| savuke-tarkkavarjo | Kehittäjän tarkka varjo (1′-korkeusvarjostus, js/korkeuskerros.js): kytkin pois ⇒ ei kerrosta eikä yhtäkään palapyyntöä, kytkin päälle lähizoomissa ⇒ palat haetaan, worker laskee ja varjokuva ilmestyy laattojen ja viivatason VÄLIIN kartan siirtokuoren sisään, kuvassa on oikeasti maata (peittävyys > 0) eikä pelkkä läpinäkyvä suorakaide, ruutu muuttuu ennen/jälkeen sekä varjo- että valopuolella, ja kytkin pois purkaa kerroksen heti. Pohjalaatat oikeasta ämpäristä, 1′-palat paikallisesta kansiosta (`--palat`, ks. tools/tee-korkeuspalat.mjs); kirjoittaa kaappaukset `tarkkavarjo-ennen.png` ja `tarkkavarjo-jalkeen.png` |
