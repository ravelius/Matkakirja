 ...
 *
 * HUOMAUTUS FABLELLE, JOTA EI OLE KORJATTU TÄSSÄ: kanoninen
 * matkakirjateksti alkaa sanoilla "Punainen linna kukkulalla", ja se on
 * peliruudulla lihavoitu ensimmäinen virke. Se pohjustaa kaaren
 * kysymystä vahvemmin kuin mikään tämän paketin oma rivi. Kaanon on
 * sanatarkka eikä sitä ole kosketettu; ero on kirjattu raporttiin.
 *
 * ── 1873-ANKKURIT ─────────────────────────────────────────────────
 *
...
export const FOKUSVIRTA_GRANADA = {
  ...
  matkakirja: {
    ...
    teksti: 'Punainen linna kukkulalla on kaunein raunio jonka olen '
     ...
     * loppu eri sävyssä.
     */
    luenta: '[curious] Punainen linna kukkulalla on kaunein raunio jonka '
