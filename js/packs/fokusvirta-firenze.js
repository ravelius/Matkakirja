...
export const FOKUSVIRTA_FIRENZE = {
  ...
  matkakirja: {
    ...
    teksti: 'Tämä kaupunki oli vielä äsken kuningaskunnan pääkaupunki, '
      ...
      + 'takovat kuten ovat takoneet neljäsataa vuotta. Galleriassa '
      + 'seisoin Davidin edessä niin kauan, että vartija alkoi vilkuilla '
      + '— mutta patsas seisoi kauemmin. Joki on ruskea ja kärsimätön; '
    ...
    luenta: '[softly] Tämä kaupunki oli vielä äsken kuningaskunnan '
      ...
      + 'vuotta. [warmly] Galleriassa seisoin Davidin edessä niin '
      + 'kauan, että vartija alkoi vilkuilla — mutta patsas seisoi '
      + 'kauemmin. [whispers] Joki on ruskea ja kärsimätön; sanotaan '
