  ...
  SAU: [
    {
      ...
      nostot: [
        {
          ...
          teksti: 'Hegran alueella on 131 kallioon veistettyä hautaa. Ne teki '
            + 'nabatealaisten kansa noin kaksituhatta vuotta sitten, ja Hegra '
            + 'oli heidän toiseksi tärkein kaupunkinsa Petran jälkeen. '
            + 'Kuuluisin haudoista on Qasr al-Farid, jonka nimi tarkoittaa '
            + 'yksinäistä linnaa. Se ei ole seinämässä kiinni kuten muut, '
            + 'vaan veistetty yhteen ainoaan yli kaksikymmentä metriä '
            + 'korkeaan lohkareeseen keskellä tasankoa. Työ jäi kesken, ja '
            + 'sen näkee yhdellä silmäyksellä: yläosa on hiottu valmiiksi '
            + 'porrastettuine koristeineen, alaosa on jäänyt karkeaksi '
            + 'kiveksi. Hegrasta tuli vuonna 2008 Saudi-Arabian ensimmäinen '
            + 'maailmanperintökohde.',
          selite: 'Valtava punertava lohkare, jonka etusivu on veistetty '
            + 'julkisivuksi. Ylhäällä on porrasmainen reunakoriste ja kaksi '
            + 'listaa, alhaalla pieni ovi, jonka edessä seisoo ihminen '
            + 'pienenä kuin hyönteinen.',
        ...
        },
        {
          ...
          teksti: 'Jubbahissa, noin yhdeksänkymmenen kilometrin päässä Hailista, '
            ...
            + 'kymmenen tuhannen vuoden ajalta. Kuvat tehtiin hakkaamalla: '
            + 'kallion pinta on ajan myötä tummunut, ja kun sitä koputtaa '
            + 'kivellä, alta paljastuu vaaleampi kivi. Kuva on siis vaalea '
            + 'piirros tummalla pohjalla. Mäkien juurella oli ennen järvi, '
            + 'jonka luo ihmiset ja eläimet tulivat juomaan — se on kuivunut '
            + 'kokonaan, mutta kuvat kertovat yhä, ketkä siellä kävivät. Alue '
            + 'otettiin maailmanperintöluetteloon vuonna 2015.',
        ...
        },
        {
          ...
          teksti: 'AlUlan vanhassa kaupungissa on yli tuhat savitiilitaloa. Ne on '
            + 'rakennettu kiinni toisiinsa niin tiiviisti, että uloimpien '
            + 'talojen seinät muodostavat yhdessä koko kaupungin muurin — '
            + 'erillistä muuria ei tarvittu. Kaupunki nousi vanhemman '
            + 'kaupungin raunioiden päälle, ja sen kiviä käytettiin '
            + 'uudelleen. Katot tehtiin palmunrungoista. Talot olivat '
            + 'asuttuja aivan äsken asti: viimeinen perhe muutti pois vuonna '
            + '1983 ja moskeijassa pidettiin viimeinen rukous 1985. Nyt katot '
            + 'ovat pudonneet ja huoneisiin näkee ylhäältä kuin avattuun '
            + 'laatikkoon.',
          selite: 'Ylhäältä kuvattu savitiilikaupunki. Sadat huoneet ovat '
            + 'katottomia ja seinät samanvärisiä kuin hiekka; katoista '
            + 'roikkuu vielä palmunrunkoja poikittain.',
      ...
      tehtava: {
        ...
        oikea: 0,
        fakta: 'Sama tummuma palaa hitaasti takaisin, joten vanhin kuva on aina '
          + 'himmein.',
      },
    },
    {
      id: 'vuoret',
      nimi: 'Vuoret',
      johdanto: 'Saudi-Arabiaa ajatellessa mieleen tulee hiekka. Maan '
        + 'lounaiskulmassa on kuitenkin vuoristo, jossa sataa kesäisin, '
        + 'pellot ovat portaina rinteessä ja aamut ovat sumuisia.',
      nostot: [
        {
          otsikko: 'Kolmen kilometrin korkeudessa on vihreää',
          tiedosto: 'Rijal Almaa, Aseer, Saudi Arabia (2020).jpg',
          teksti: 'Asirin vuoristo kohoaa maan lounaisosassa lähes kolmeen '
            + 'kilometriin. Korkeimmasta huipusta kiistellään: virallisesti '
            + 'se on Jabal Sawda, mutta vuoden 2018 mittaus antoi '
            + 'naapurihuipulle muutaman metrin enemmän. Kesällä merestä '
            + 'nouseva kostea ilma törmää rinteisiin ja sataa, ja siksi '
            + 'vuoret ovat vihreitä silloin kun muu maa on kuivimmillaan. '
            + 'Rinteet on muotoiltu portaiksi, jotta sadevesi ei valuisi '
            + 'suoraan alas vaan jäisi pelloille. Vuoristossa on niin '
            + 'viileää, että sumu peittää laaksot aamuisin.',
          selite: 'Ilmakuva vihreästä vuoristolaaksosta. Rinteillä on tiheää '
            + 'pensaikkoa ja pieniä porrasmaisia peltotilkkuja, pohjalla '
            + 'kulkee tie ja rinteillä on vaaleita taloja.',
          lahde: 'Saudi Press Agency (SPA), Wikimedia Commons (CC BY-SA 4.0)',
        },
        {
          otsikko: 'Savesta ladottu torni',
          tiedosto: 'Heritage village of Dhahran al-Janub 2021.jpg',
          teksti: 'Asirin vanhat talot ovat korkeita ja kapeita kuin tornit. Ne '
            + 'ladottiin savesta kerros kerrallaan, ja jokaisen kerroksen '
            + 'annettiin kuivua ennen seuraavaa. Seinistä työntyy ulos '
            + 'litteitä liuskekiviä riveinä: ne ovat räystäitä, jotka '
            + 'ohjaavat sadeveden pois seinän pinnalta, ettei savi liukenisi. '
            + 'Ikkunat ovat pieniä ja niiden ympärykset maalattiin '
            + 'valkoisiksi. Alimmassa kerroksessa pidettiin eläimiä ja '
            + 'varastoja, ylimmässä asuttiin. Talojen juurella on '
            + 'kastelupeltoja, joissa kasvaa viljaa ja vihanneksia.',
          selite: 'Savitiilisiä tornitaloja rinteessä. Ikkunoiden ympärillä on '
            + 'valkoiset kehykset, seinissä näkyy ulostyöntyviä kivirivejä, '
            + 'ja etualalla on vihreitä kasvimaita ruuduissa.',
        ...
        },
        {
          ...
          teksti: 'Asirissa talon vierashuoneen seinät maalataan kuvioilla. Tapa '
            + 'on nimeltään al-qatt al-asiri, ja sitä ovat perinteisesti '
            + 'tehneet talon naiset. Kuviot ovat geometrisia: kolmioita, '
            + 'vinoneliöitä, ruutuja ja siksakkeja riveissä päällekkäin, ja '
            + 'värit ovat punainen, keltainen, vihreä ja musta valkoisella '
            + 'pohjalla. Mallit ovat lähtöisin kudonnasta, ja naapurit '
            + 'vertailivat töitään keskenään — taitavimmin maalattu huone oli '
            + 'talon ylpeys. Unesco otti tavan aineettoman kulttuuriperinnön '
            + 'luetteloon vuonna 2017.',
          selite: 'Portaikko, jonka vieressä on kapea maalattu paneeli: '
            + 'valkoiselle pohjalle on ladottu vaakariveihin punaisia, '
            + 'keltaisia, vihreitä ja sinisiä kolmioita, ruutuja ja '
            + 'siksakkeja. Talo on nykyään museona.',
          lahde: 'Richard Mortel, Wikimedia Commons (CC BY 2.0)',
        },
      ],
      tehtava: {
        kysymys: 'Miksi Asirin talojen seinistä työntyy ulos kivirivejä?',
        vaihtoehdot: [
          'Ne ohjaavat sadeveden pois',
          'Niistä saa tikkaat katolle',
          'Ne kannattelevat välikattoja',
          'Ne osoittavat kerrosten määrän',
        ],
        oikea: 0,
        fakta: 'Ilman niitä sade huuhtoisi saviseinää vähän kerrallaan alaspäin.',
      },
    },
    {
      id: 'meri',
      nimi: 'Meri',
      johdanto: 'Saudi-Arabian länsiranta on Punaisenmeren rantaa. Vesi on lämmintä '
        + 'ja niin kirkasta, että riutan voi nähdä pinnan läpi, ja rannan '
        + 'edustalla on saaria, joita ei ole laskettu ihan tarkkaan.',
      nostot: [
        {
          otsikko: 'Kaksisataa saarta, kolme asuttua',
          ...
          teksti: 'Farasanin saaristo on Punaisellamerellä maan lounaisrannikon '
            ...
            + 'kolmella asutaan: Suurella Farasanilla, Sajidilla ja '
            + 'Qummahilla. Loput ovat lintujen ja kilpikonnien. Ylhäältä '
            + 'katsottuna saaret näyttävät siltä kuin ne kelluisi '
            + 'vaaleansinisellä matolla — se matto on matalaa vettä riutan '
            + 'päällä, ja tumma alue sen ympärillä on syvää merta. Saaristo '
            + 'otettiin Unescon biosfäärialueeksi vuonna 2021.',
          selite: 'Satelliittikuva saaristosta. Hiekanruskeat saaret ovat '
            + 'keskellä, niiden ympärillä hohtaa turkoosi matalikko, ja '
            + 'reunoilla vesi muuttuu tummansiniseksi.',
        ...
        },
        {
          ...
          teksti: 'Farasanin saaret eivät ole hiekkasärkkiä vaan kiveä, ja se '
            ...
            + 'että riutta jäi kuivalle. Siksi saarten rannat ovat teräviä ja '
            + 'rosoisia: kalkkikivessä näkyy yhä korallien reikäinen rakenne, '
            + 'ja siihen on ikävä astua paljain jaloin. Rantavesi on matalaa '
            + 'pitkälle ulos, ja siellä missä pohja on suojassa aalloilta, '
            + 'kasvaa matalaa metsää suolavedessä.',
          selite: 'Rosoista vaaleaa kalkkikiveä rannan reunalla, edessä turkoosi '
            + 'matala meri. Taivaanrannassa näkyy matala saari, jonka '
            + 'reunassa on tummanvihreä kasvivyöhyke.',
          lahde: 'Richard Mortel, Wikimedia Commons (CC BY 2.0)',
        },
        {
          ...
          teksti: 'Papukaijakala on saanut nimensä suustaan: sen etuhampaat ovat '
            ...
            + 'yhtä aikaa. Kalastajat tietävät sen tulevan maaliskuun lopulla '
            + 'tai huhtikuun alussa, ja parvia voi olla toistakymmentä, '
            + 'kussakin satoja kaloja. Silloin saarella pidetään vuosittainen '
            + 'juhla, jossa kilpaillaan saaliin määrästä ja tanssitaan.',
          selite: 'Kirkkaan turkoosi kala korallin edessä. Kyljessä on '
            + 'vaaleanpunaista ja violettia, pyrstö ja evät ovat siniset, ja '
            + 'suu on kova ja nokkamainen.',
          lahde: 'Diego Delso, Wikimedia Commons (CC BY-SA 4.0)',
        },
      ],
      tehtava: {
        ...
        oikea: 0,
        fakta: 'Sama kivi on rakennusainetta: saarten vanhat talot on tehty '
          + 'riutan palasista.',
      },
    },
  ],};
