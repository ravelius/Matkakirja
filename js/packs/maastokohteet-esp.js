...
export const MAASTOKOHTEET_ESP = [
  ...
  },
  {
    id: 'altamiran-luola',
    kuva: {
      osoite: 'https://media.matkakirja.app/karttanostot/20260920/esp-nosto-altamiran-luola-9eba0a3d.jpg',
      lyhyt: 'Altamiran luolan sisäänkäynti on rautaportin takana viheriöivän rinteen kalliossa.',
      selite: 'Luolan kävijöiden sisäänkäynti Santillana del Marin lähellä Kantabriassa on kallioon louhittu, ja sen edessä on ritilä ja metalliportti. Ympärillä kasvaa muratteja ja saniaisia.',
      lahde: 'Valokuva: Thilo Parg, Wikimedia Commons (CC BY-SA 4.0).',
      tekija: 'Thilo Parg',
      lahdeUrl: 'https://commons.wikimedia.org/wiki/File:Cueva_de_Altamira_1_visitor_entrance.jpg',
      lisenssi: 'CC BY-SA 4.0',
      lisenssiUrl: 'https://creativecommons.org/licenses/by-sa/4.0',
    },
    kuvat: [
      {
        osoite: 'https://media.matkakirja.app/karttanostot/20260920/esp-nosto-altamiran-luola-82565196.jpg',
        lyhyt: 'Altamiran luolan katossa näkyy punaisin ja mustin värein maalattuja biisoneita.',
        selite: 'Altamiran luolan katon esihistoriallisessa maalauksessa biisonit on kuvattu kallion pullistumia hyödyntäen punaisella okralla ja mustalla ääriviivoituksella.',
        lahde: 'Valokuva: Lissy Burges, Wikimedia Commons (CC BY-SA 4.0).',
        tekija: 'Lissy Burges',
        lahdeUrl: 'https://commons.wikimedia.org/wiki/File:Altamira_Nordspanien_Prähistorische_Höhlenmalerei_Deckengemälde_UniDiaVerlag_Nr._41501.tif',
        lisenssi: 'CC BY-SA 4.0',
        lisenssiUrl: 'https://creativecommons.org/licenses/by-sa/4.0',
      },
    ],
