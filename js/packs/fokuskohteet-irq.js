...
export const FOKUSKOHTEET_IRQ = [
  {
    ...
    ihme: {
      ...
      selite: 'Riippuvat puutarhat olivat antiikin kirjoittajien mukaan '
        ...
        + 'puutarhaa kasteltiin koneella, joka nosti vettä joesta '
        + 'terassien huipulle, ja se rakennettiin kuningattarelle, joka '
        + 'ikävöi vuoristokotinsa metsiä. Kaikki kertomukset ovat '
        + 'vuosisatoja myöhempiä, eikä yhtään babylonialaista mainintaa '
        + 'puutarhoista tunneta. Ne ovat seitsemästä ihmeestä '
   ...
   */
  {
    ...
    ihme: {
      ...
      selite: 'Ishtarin portti oli Babylonin loistoportti: '
        ...
        + 'alkoi leijonien reunustama Prosessiotie. Kerran vuodessa '
        + 'uudenvuoden juhlassa tietä myöten kannettiin Marduk-jumalan '
        + 'patsas kaupungin läpi kuninkaan kulkiessa mukana; juhlassa '
        + 'kuninkaan valta vahvistettiin seuraavaksi vuodeksi. '
        + 'Alkuperäinen portti '
  ...
  },
  {
    ...
    ihme: {
      ...
      selite: 'Sanheribin lounaispalatsi oli Assyrian mahdin '
        ...
        + 'härkäkolossit. Lähetystöt kulkivat valtaistuinsaliin '
        + 'käytävää, jonka reliefit kertoivat kuninkaan sotaretkistä — '
        + 'kokonainen huone esitti Lakisin kaupungin piirityksen alusta '
        + 'antautumiseen asti. Salit ovat poissa: rakennus oli jo '
