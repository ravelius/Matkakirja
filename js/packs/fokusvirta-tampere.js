...
export const FOKUSVIRTA_TAMPERE = {
  ...
  matkakirja: {
    ...
    teksti: 'Kahden järven välissä kohisee koski, ja kosken partaalla '
      ...
      + 'Tämä on pohjolan Manchester, sanoi isäntäni ylpeänä, ja piiput '
      + 'savuavat samaan tapaan. Tehtaansaleissa on enemmän naisia kuin '
    ...
    luenta: '[curious] Kahden järven välissä kohisee koski, ja kosken '
      ...
      + 'rautaa. [excited] Tämä on pohjolan Manchester, sanoi isäntäni '
      + 'ylpeänä, ja piiput savuavat samaan tapaan. Tehtaansaleissa on '
  ...
  pollo: {
     ...
     * yhden rivin työ.
     */
    teksti: 'Pohjolan Manchester on edelleen Tampereen lempinimi, tosin '
      + 'tehtaat ovat nykyään museoita, teattereita ja panimoita — '
      + 'piiput seisovat mut eivät savua.. Koski kohisee keskellä '
