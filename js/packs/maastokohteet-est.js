...
export const MAASTOKOHTEET_EST = [
  ...
  },
  {
    ...
    kuvat: [{
      osoite: 'https://media.matkakirja.app/karttanostot/20260912/est-kohde-narvan-linnus-7646b0a2dd5e.jpg',
      lyhyt: 'Narvan Hermannin linna ja Ivangorodin linnoitus seisovat vastakkain Narvajoen rannoilla, Viron ja Venäjän nykyisen rajan molemmin puolin.',
      selite: 'Narvan Hermannin linna ja Ivangorodin linnoitus seisovat vastakkain Narvajoen rannoilla, Viron ja Venäjän nykyisen rajan molemmin puolin.',
  ...
  },
  {
    ...
    kuva: {
      osoite: 'https://media.matkakirja.app/karttanostot/20260912/est-kohde-kuressaaren-linna-d8962b4b5073.jpg',
      lyhyt: 'Talvinen ilmakuva näyttää Kuressaaren linnan jykevän päälinnan, bastionit, vallihaudan ja sijainnin Saarenmaan matalalla rannikolla.',
      selite: 'Talvinen ilmakuva näyttää Kuressaaren linnan jykevän päälinnan, bastionit, vallihaudan ja sijainnin Saarenmaan matalalla rannikolla.',
      lahde: 'Valokuva: Stefan Hiienurm, Wikimedia Commons (CC BY-SA 4.0).',
      tekija: 'Stefan Hiienurm',
      lahdeUrl: 'https://commons.wikimedia.org/wiki/File:Kuressaare_Castle.jpg',
      lisenssi: 'CC BY-SA 4.0',
      lisenssiUrl: 'https://creativecommons.org/licenses/by-sa/4.0/',
    },
  ...
  },
  {
    id: 'kopu-tuletorn',
    kuva: {
      osoite: 'https://media.matkakirja.app/karttanostot/20260912/est-kohde-kopu-tuletorn-bb55a04ab1f1.jpg',
      lyhyt: 'Idästä kuvattu Kõpun majakka kohoaa Hiidenmaan mäntymetsästä massiivisen valkoisen tukirakenteensa varassa.',
      selite: 'Idästä kuvattu Kõpun majakka kohoaa Hiidenmaan mäntymetsästä massiivisen valkoisen tukirakenteensa varassa.',
      lahde: 'Valokuva: Ymblanter, Wikimedia Commons (CC BY-SA 4.0).',
      tekija: 'Ymblanter',
      lahdeUrl: 'https://commons.wikimedia.org/wiki/File:Kõpu_lighthouse_from_the_east.jpg',
      lisenssi: 'CC BY-SA 4.0',
      lisenssiUrl: 'https://creativecommons.org/licenses/by-sa/4.0/',
    },
    nimi: 'Kõpun majakka',
  ...
  },
  {
    id: 'kihnu',
    kuva: {
      osoite: 'https://media.matkakirja.app/karttanostot/20260912/est-kohde-kihnu-512c5cb9132a.jpg',
      lyhyt: 'Kihnun perinteisiä raidallisia hameita saaren maaseutumaisemassa.',
      selite: 'Kihnun perinteisiä raidallisia hameita saaren maaseutumaisemassa.',
      lahde: 'Valokuva: KalervoK, Wikimedia Commons (CC BY-SA 4.0).',
      tekija: 'KalervoK',
      lahdeUrl: 'https://commons.wikimedia.org/wiki/File:Kihnu_girls_Estonia.jpg',
      lisenssi: 'CC BY-SA 4.0',
      lisenssiUrl: 'https://creativecommons.org/licenses/by-sa/4.0/',
    },
    nimi: 'Kihnu',
  ...
  },
  {
    ...
    kuvat: [{
      osoite: 'https://media.matkakirja.app/karttanostot/20260912/est-kohde-parnu-e28cf1c466fd.jpg',
      lyhyt: 'Pärnun historiallinen mutakylpylärakennus kertoo kaupungin pitkästä kylpyläperinteestä ja asemasta Viron kesäpääkaupunkina.',
      selite: 'Pärnun historiallinen mutakylpylärakennus kertoo kaupungin pitkästä kylpyläperinteestä ja asemasta Viron kesäpääkaupunkina.',
      lahde: 'Valokuva: Scotch Mist, Wikimedia Commons (CC BY-SA 4.0).',
      tekija: 'Scotch Mist',
      lahdeUrl: 'https://commons.wikimedia.org/wiki/File:P%C3%A4rnu_01.jpg',
      lisenssi: 'CC BY-SA 4.0',
      lisenssiUrl: 'https://creativecommons.org/licenses/by-sa/4.0/',
    }],
    nimi: 'Pärnu',
