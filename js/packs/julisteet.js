...
export const JULISTEET = {
  ...
  /*
   * TYÖLISTAN 2 JULISTEET (48 kohdetta: Lähi-itä, Siperia, Aasia).
   * Otsikot aikakauden atlas-asuissa (Angora, Canton, Rangoon, Batavia,
   * Benares, Calcutta, Bombay, Madras, Urga, Akmolinsk, Kurrachee,
   * Ispahan, Katmandu, Taipeh, Novo-Nikolaevsk); vuosi on 1873 ellei
   * kohteella ole merkityksellisempää vuotta. Selitteet kertovat
   * kohteesta, ei kuvasta (Raamatun kuvatekstilinjaus); faktat
   * tarkistettu en-Wikipediasta 22.8.2026 (tools/juliste-tyolista-2,
  ...
  halab: {
    ...
    selite: 'Isoisän matkavuonna Aleppo oli vuonna 1866 perustetun Halepin '
      + 'vilajetin pääkaupunki, mutta sen vuosisatainen karavaanikauppa '
      + 'oli kääntynyt laskuun heti Suezin kanavan avauduttua 1869.',
  },
  damaskos: {
    ...
    selite: 'Isoisän matkavuonna Damaskos oli osmanien Syyrian vilajetin '
      ...
      + 'lähtöpaikka; sen Umaijadien moskeija oli valmistunut jo vuonna '
      + '715.',
  },
  luxor: {
    ...
    selite: 'Vuonna 1881 Deir el-Bahrin kalliokätkö tuli viranomaisten '
      ...
      + 'muinaiset papit olivat piilottaneet kymmenien faaraoiden '
      + 'muumiot, ja ne siirrettiin samana vuonna Kairoon.',
  },
  riad: {
    ...
    selite: 'Isoisän matkavuonna Riad oli savitiilimuurien ympäröimä Nejdin '
      + 'emiraatin pääkaupunki, jota Faisalin poikien valtataistelu '
      + 'repi — Masmakin linnoitusta oli muurattu vuodesta 1865, ja se '
      + 'valmistui vasta 1895.',
  },
  tabriz: {
    ...
    selite: 'Isoisän matkavuonna Tabriz oli Persian kruununprinssin '
      + 'asuinkaupunki ja maan tärkein kauppapaikka, jonka katetun '
      + 'basaarin kautta kulki idän ja Mustanmeren välinen tavaravirta.',
  },
  teheran: {
  ...
  isfahan: {
    ...
    selite: 'Isoisän matkavuonna Isfahanissa asui enää noin 60 000 ihmistä '
      + 'safavidien loiston jäänteissä: Persian pääkaupunki oli '
      + 'siirretty Teheraniin jo vuonna 1775.',
  },
  sana: {
  ...
  aden: {
    ...
    kaupunki: 'Aden',
    otsikko: 'Aden 1873',
    selite: 'Suezin kanavan avaaminen 1869 teki vuodesta 1839 '
      + 'brittihallussa olleesta Adenista Intian-reitin tärkeimmän '
      + 'hiilenottosataman.',
  },
  salalah: {
  ...
  shanghai: {
    ...
    selite: 'Kiinan ensimmäinen liikennöinyt rautatie rakennettiin 1876 '
      + 'Shanghaista Woosungiin ilman viranomaisten lupaa, ja se ehti '
      + 'kulkea alle vuoden ennen kuin varakuningas osti kiskot ja '
      + 'purki radan.',
  },
  tripoli: {
    ...
    selite: 'Isoisän matkavuonna Tripoli oli osmanien Tripolitanian '
      + 'vilajetin pääkaupunki — suora hallinto oli palautettu 1835 — '
      + 'ja Saharan halki kulkevien karavaanien viimeinen '
      + 'Välimeren-satama.',
  },
  jekaterinburg: {
    ...
    selite: 'Isoisän matkavuonna Jekaterinburgin rahapajassa lyötiin yhä '
      + 'valtaosa Venäjän keisarikunnan liikkeessä olleista kolikoista; '
      + 'paja suljettiin 1876.',
  },
  novosibirsk: {
    tiedosto: 'tuotanto/tuot-novosibirsk.png',
    kaupunki: 'Novosibirsk',
    otsikko: 'Novonikolajevsk 1897',
    selite: 'Novosibirskia ei ollut isoisän matkavuonna olemassa: kylä '
      + 'syntyi 1893 Siperian radan Ob-sillan työmaalle, sai nimen '
      + 'Novonikolajevsk 1895, ja silta valmistui keväällä 1897.',
  },
  irkutsk: {
    tiedosto: 'tuotanto/tuot-irkutsk.png',
    kaupunki: 'Irkutsk',
    otsikko: 'Irkutsk 1873',
    selite: 'Isoisän matkavuonna Irkutsk oli Itä-Siperian '
      + 'kenraalikuvernöörin puinen pääkaupunki, joka rikastui Kiahtan '
      + 'teekaravaaneista — suuri osa siitä paloi heinäkuun 1879 '
      + 'tulipalossa.',
  },
  jakutsk: {
  ...
  magadan: {
    ...
    selite: 'Magadania ei ollut isoisän matkavuonna olemassa — kaupunki '
      + 'perustettiin Nagajevin lahden rannalle vasta 1929 — joten '
      + 'juliste kuvaa sitä Ohotanmeren rannikkoa, jolla evenit '
      + 'paimensivat poroja ja valaanpyytäjät purjehtivat.',
  },
  kamtsatka: {
    ...
    selite: 'Petropavlovsk torjui liittoutuneiden piirityksen 1854, mutta '
      + 'varuskunta evakuoitiin Amurille jo seuraavana keväänä, ja '
      + 'isoisän matkavuonna Kamtšatkan pääpaikka oli enää pieni '
      + 'satamakylä tulivuorten juurella.',
  },
  sahalin: {
    ...
    selite: 'Pietarin sopimuksessa 1875 Japani luopui Sahalinista Venäjälle '
      + 'Kuriilien vastineeksi, ja koko saari jäi vuonna 1869 '
      + 'laillistetun rangaistussiirtolan käyttöön.',
  },
  vladivostok: {
  ...
  kioto: {
    ...
    selite: 'Heian-jingū rakennettiin 1895 kaupungin 1100-vuotisjuhlaan, ja '
      + 'samana vuonna Kiotossa avattiin Japanin ensimmäinen '
      + 'sähköraitiotie, jonka virta tuli Biwa-järven kanavan '
      + 'voimalasta.',
  },
  singapore: {
    ...
    selite: 'Suezin kanavan avaaminen 1869 käänsi höyrylaivaliikenteen '
      + 'Singaporen kautta, ja Straits Settlements oli siirretty '
      + 'Lontoon suoraan hallintaan 1867 — satama oli isoisän '
      + 'matkavuonna Kaakkois-Aasian vilkkain.',
  },
  varanasi: {
    ...
    selite: 'Benares oli hindulaisuuden pyhin kaupunki, jonka kivisiä '
      ...
      + 'kultakupolisen temppelin pystytti Ahilyabai Holkar vuonna '
      + '1780.',
  },
  hanoi: {
    ...
    selite: 'Ranskalaiset valtasivat Hanoin linnoituksen 20. marraskuuta '
      + '1873, mutta kaupunki palautettiin Nguyễn-hoville ja jäi '
      + 'Ranskalle vasta kymmenen vuotta myöhemmin.',
  },
  ulanbator: {
    ...
    selite: 'Urga oli Mongolian uskonnollinen ja kaupallinen keskus, jonka '
      + 'Gandanin luostari oli perustettu 1809 ja jonka ohi kulki '
      + 'Kiahtan ja Kalganin välinen teekaravaanitie.',
  },
  kathmandu: {
  ...
  astana: {
    ...
    selite: 'Astana oli isoisän matkavuonna Akmolinsk: Ishimin rannalle '
      + '1830 perustettu linnoituskylä, joka sai kaupunkioikeudet 1832 '
      + 'ja eli arojen karavaanireittien risteyksestä.',
  },
  kanton: {
    tiedosto: 'tuotanto/tuot-kanton.png',
    kaupunki: 'Kanton',
    otsikko: 'Kanton 1873',
    selite: 'Kanton oli ollut vuoteen 1842 asti Kiinan ainoa '
      + 'ulkomaankaupalle avoin satama, ja isoisän matkavuonna '
      + 'länsimaiset kauppahuoneet asuivat yhä Shamianin saarella, joka '
      + 'oli pengerretty jokeen 1850-luvun lopulla.',
  },
  yangon: {
    ...
    selite: 'Britit tekivät Rangoonista Britti-Burman pääkaupungin 31. '
      + 'tammikuuta 1862 ja rakensivat sen ruutukaavaan, kun Burman '
      + 'kuningas hallitsi yhä ylävirran Mandalaysta.',
  },
  mandalay: {
    ...
    selite: 'Mindon-kuningas perusti Mandalayn 1857 ja kutsui sinne 1871 '
      + 'viidennen buddhalaisen kirkolliskokouksen, joka hakkasi '
      + 'Pali-kaanonin 729 marmoritaululle.',
  },
  taipei: {
    tiedosto: 'tuotanto/tuot-taipei.png',
    kaupunki: 'Taipei',
    otsikko: 'Taipeh 1884',
    selite: 'Taipeh sai muurinsa ja porttinsa 1884, ja Dadaochengin '
      + 'teekauppa kasvatti sen niin nopeasti, että kaupungista tuli '
      + 'pian koko Taiwanin provinssin pääpaikka.',
  },
  hongkong: {
    tiedosto: 'tuotanto/tuot-hongkong.png',
    kaupunki: 'Hongkong',
    otsikko: 'Hongkong 1888',
    selite: 'Aasian ensimmäinen köysirata, Peak Tram, avattiin 30. '
      + 'toukokuuta 1888 ja nosti matkustajat Victoria Peakille, jonne '
      + 'oli siihen asti noustu kantotuolissa.',
  },
  jakarta: {
  ...
  manila: {
    ...
    selite: 'Vuoden 1863 maanjäristys kaatoi Manilan katedraalin, ja sen '
      + 'seitsemättä versiota alettiin rakentaa 1873 — se vihittiin '
      + 'vasta 1879.',
  },
  borneo: {
    ...
    kaupunki: 'Borneo',
    otsikko: 'Borneo 1873',
    selite: 'Borneon luoteisrannikkoa hallitsi valkoisten rajahien '
      + 'Sarawakin kuningaskunta, jonka Charles Brooke rakennutti '
      + 'Kuchingiin Astana-palatsin 1869; saaren sademetsissä Alfred '
      + 'Russel Wallace oli kerännyt näytteitään 1850-luvulla.',
  },
  sumatra: {
    ...
    selite: 'Alankomaat hyökkäsi Acehin sulttaanikuntaan keväällä 1873 ja '
      + 'aloitti Sumatran pohjoiskärjessä sodan, joka kesti '
  ...
  kashgar: {
    ...
    selite: 'Isoisän matkavuonna Kashgar oli Jakub Begin itsenäisen '
      + 'Jettišarin pääkaupunki: kapina oli irrottanut sen Kiinasta '
      + '1865, ja Qing-armeija otti alueen takaisin vasta 1877.',
  },
  lhasa: {
    ...
    selite: 'Kahdestoista dalai-lama Trinley Gyatso asetettiin '
      + 'täysivaltaiseksi 11. maaliskuuta 1873, mutta hän ehti hallita '
      + 'vain kaksi vuotta ennen kuolemaansa.',
  },
  kolkata: {
  ...
  chennai: {
    ...
    kaupunki: 'Chennai',
    otsikko: 'Madras 1873',
    selite: 'Isoisän matkavuonna Madrasissa ei ollut satamaa lainkaan: '
      + 'laivat ankkuroivat kauas rannasta ja lasti tuotiin maihin '
      + 'ommelluilla masula-veneillä — aallonmurtajien muuraus alkoi '
      + 'vasta 1876.',
  },
  mumbai: {
    ...
    selite: 'Victoria Terminus valmistui kuningatar Victorian kultaisen '
      + 'juhlavuoden 1887 kunniaksi ja avattiin matkustajille 20. '
  ...
  colombo: {
    ...
    selite: 'Kahviruoste oli tuhonnut Ceylonin kahviviljelmät, ja vuonna '
      + '1875 James Taylorin viljelmältä lähetettiin saaren ensimmäinen '
      + 'teelasti Lontoon huutokauppaan.',
  },
  karachi: {
    ...
    selite: 'Suezin kanavan avaaminen 1869 nosti Karachin Sindin vehnän ja '
      + 'puuvillan vientisatamaksi, ja brittien hallintorakennuksista '
      + 'Frere Hall oli valmistunut 1865.',
  },
};
