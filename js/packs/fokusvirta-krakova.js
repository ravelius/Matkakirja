 ...
 *
 * ── KAANONTÖRMÄYS, JOTA TÄMÄ PAKETTI EI RATKAISE ───────────────────
 *
 * FABLE KATSELMOI: ks. oppituntilohkon kommentti "AJOITUSKYSYMYS".
 * Lyhyesti: aarremerkintä kertoo isoisän nähneen Rafaelin muotokuvan
 * ruhtinaan kokoelmassa kesäkuussa 1873, mutta Czartoryskien kokoelma
 * saapui Krakovaan vasta 1876 (sama vuosiluku on jo pelin omassa
 * hyväksytyssä maalehdessä, js/packs/maa-kategoriat.js POL/taide).
 * Merkintä on kaanonia ja kopioitu sanatarkasti; oppitunti kertoo
 * tarkistetut vuosiluvut. Ratkaisu kuuluu Fablelle, ei tälle paketille.
 *
...
export const FOKUSVIRTA_KRAKOVA = {
   ...
   *
   * *** FABLE KATSELMOI: AJOITUSKYSYMYS. ***
   *
   * Aarremerkintä sanoo isoisän nähneen taulun "ruhtinaan kokoelmassa",
   * ja merkintä on sijoitettu Krakovaan kesäkuuhun 1873. Tarkistetut
   * vuosiluvut eivät sovi siihen: Czartoryskien kokoelma oli 1830-luvun
   ...
   * joka on sanaleikki": "Krakovaan se tuotiin 1876"), joten törmäys on
   * pelidatassa riippumatta tästä paketista.
   *
   * TÄMÄ PAKETTI EI RATKAISE SITÄ EIKÄ PIILOTA SITÄ. Kaanonteksti on
   * kopioitu sanatarkasti, ja oppitunti kertoo tarkistetut vuosiluvut,
   * koska Perustuslain totuudellisuuspilari ei salli vaientaa juuri sitä
   * vuotta, joka tässä on kysymys. Huomattakoon, ettei merkintä nimeä
   * Krakovaa: se sanoo vain "ruhtinaan kokoelmassa". Jos Fable haluaa
   * törmäyksen pois, ratkaisu on merkinnän puolella eikä täällä.
   *
   ...
   */
  aarremerkinta: {
    teksti: 'Ruhtinaan kokoelmassa näin muotokuvan, jonka edessä unohdin '
      + 'hengittää: nuori mies turkiskauluksessa, ja katse joka seuraa '
      + 'huoneen poikki. Mestarin käsialaa Roomasta, sanoi hoitaja, eikä '
      + 'maailmassa ole montaa sen vertaista. Kirjoitan tämän muistiin '
      + 'siksi, että sellaisilla tauluilla on tapana lähteä liikkeelle, '
      + 'kun ajat huononevat — ja pysyä kateissa kauan.',
  },
};
