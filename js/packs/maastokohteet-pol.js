...
export const MAASTOKOHTEET_POL = [
  {
    ...
    kuva: {
      ...
      tekija: 'OpenAI; referenssikuva Milan Bališin',
      lahdeUrl: 'https://commons.wikimedia.org/wiki/File:Rysy_006.JPG',
      lisenssi: 'CC BY-SA 4.0',
      lisenssiUrl: 'https://creativecommons.org/licenses/by-sa/4.0/',
    },
    kuvat: [{
      osoite: 'https://media.matkakirja.app/karttanostot/20260912/pol-maasto-rysy-024f6a6ea9a6.jpg',
      lyhyt: 'Rysyn huipulta avautuu näkymä Czarny Staw pod Rysami- ja Morskie Oko -järville.',
      selite: 'Rysyn huipulta avautuu näkymä Czarny Staw pod Rysami- ja Morskie Oko -järville.',
  ...
  },
  {
    ...
    kuva: {
      osoite: 'https://media.matkakirja.app/karttanostot/20260912/pol-maasto-sniezka-d0a256c0ac10.jpg',
      lyhyt: 'Śnieżkan tuulinen talvihuippu kohoaa Puolan ja Tšekin rajalla.',
      selite: 'Śnieżkan tuulinen talvihuippu kohoaa Puolan ja Tšekin rajalla.',
      lahde: 'Matkakirjan havainnekuva — lähdeperusteinen johdannainen',
      tekija: 'OpenAI; referenssikuva Pudelek (Marcin Szala)',
    ...
    kuvat: [{
      osoite: 'https://media.matkakirja.app/karttanostot/20260912/pol-maasto-sniezka-ae71dca3eea8.jpg',
      lyhyt: 'Śnieżkan tuulinen talvihuippu kohoaa Puolan ja Tšekin rajalla.',
      selite: 'Śnieżkan tuulinen talvihuippu kohoaa Puolan ja Tšekin rajalla.',
  ...
  },
  {
    ...
    kuva: {
      osoite: 'https://media.matkakirja.app/karttanostot/20260912/pol-maasto-itameri-478fe5caffe9.jpg',
      lyhyt: 'Helin kapea niemimaa erottaa avoimen Itämeren Gdańskinlahdesta Puolan rannikolla.',
      selite: 'Helin kapea niemimaa erottaa avoimen Itämeren Gdańskinlahdesta Puolan rannikolla.',
      lahde: 'Matkakirjan havainnekuva — lähdeperusteinen johdannainen',
      tekija: 'OpenAI; referenssikuva Guntars Mednis',
    ...
    kuvat: [{
      osoite: 'https://media.matkakirja.app/karttanostot/20260912/pol-maasto-itameri-89e455fc25a8.jpg',
      lyhyt: 'Helin kapea niemimaa erottaa avoimen Itämeren Gdańskinlahdesta Puolan rannikolla.',
      selite: 'Helin kapea niemimaa erottaa avoimen Itämeren Gdańskinlahdesta Puolan rannikolla.',
      lahde: 'Valokuva: Guntars Mednis, Wikimedia Commons (CC BY-SA 3.0).',
  ...
  },
  {
    ...
    kuva: {
      ...
      selite: 'Rohkean Veikselin leveä suu-uoma kohtaa Itämeren Gdańskin itäpuolella.',
      lahde: 'Matkakirjan havainnekuva — lähdeperusteinen johdannainen',
      tekija: 'OpenAI; referenssikuva Andrzej Otrębski',
      lahdeUrl: 'https://commons.wikimedia.org/wiki/File:Gdansk_Wisla_Smiala_1.jpg',
      lisenssi: 'CC BY-SA 3.0',
      lisenssiUrl: 'https://creativecommons.org/licenses/by-sa/3.0/',
    },
    kuvat: [
      {
        osoite: 'https://media.matkakirja.app/karttanostot/20260912/pol-maasto-veiksel-7d5c82de93e4.jpg',
        lyhyt: 'Rohkean Veikselin leveä suu-uoma kohtaa Itämeren Gdańskin itäpuolella.',
        selite: 'Rohkean Veikselin leveä suu-uoma kohtaa Itämeren Gdańskin itäpuolella.',
        lahde: 'Valokuva: Andrzej Otrębski, Wikimedia Commons (CC BY-SA 3.0).',
  ...
  },
  {
    id: 'westerplatte',
    kuva: {
      osoite: 'https://media.matkakirja.app/karttanostot/20260920/pol-nosto-westerplatte-c6fffb23.jpg',
      lyhyt: 'Punainen majakka seisoo aallonmurtajan päässä Westerplatten niemen kärjessä tyynen meren äärellä.',
      selite: 'Gdańskin sataman sisäänkäynnin punainen majakka on rakennettu kivi- ja betonilohkoista tehdyn aallonmurtajan päähän. Taustalla näkyy metsäistä rantaa ja satamaa Itämeren lahden rannalla.',
      lahde: 'Valokuva: Andrzej Otrębski, Wikimedia Commons (CC BY-SA 4.0).',
      tekija: 'Andrzej Otrębski',
      lahdeUrl: 'https://commons.wikimedia.org/wiki/File:Gdansk_Westerplatte_latarnia.jpg',
      lisenssi: 'CC BY-SA 4.0',
      lisenssiUrl: 'https://creativecommons.org/licenses/by-sa/4.0',
    },
    nimi: 'Westerplatte',
