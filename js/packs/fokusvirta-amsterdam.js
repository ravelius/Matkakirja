...
export const FOKUSVIRTA_AMSTERDAM = {
  ...
  matkakirja: {
    ...
    luentakuva: {
      ...
      selite: "Kanavatalon ullakolle mahtui kokonainen kirkko. Pappi seisoo alttarin vierellä puuparvien alla.",
      lahde: "Matkakirjan havainnekuva",
      lahteet: ["https://opsolder.nl/en/the-monument/"],
    },
    luentakuva2: {
      ...
      selite: "Ullakkokirkon urut ovat salin toisessa päädyssä. Vuonna 1794 rakennettu soitin kohoaa penkkien yläpuolella.",
      lahde: "Matkakirjan havainnekuva",
      lahteet: ["https://opsolder.nl/wp-content/uploads/2024/04/haantje36.pdf"],
    },
    ...
    kuvat: [
      {
        ...
        selite: "Aseman edustan pyörähalli sijaitsee veden alla. Pyörätelineet ja valkoiset pylväät kohoavat matalan kameran yllä.",
        lahde: "Matkakirjan havainnekuva",
        lahteet: ["https://www.prorail.nl/nieuws/twee-grote-fietsenstallingen-bij-station-amsterdam-centraal-geopend"],
      },
      {
        ...
        selite: "Ankka kelluu Open Havenfrontilla. Sen alapuolella on aseman edustan pyörähalli.",
        lahde: "Matkakirjan havainnekuva",
        lahteet: ["https://www.prorail.nl/nieuws/twee-grote-fietsenstallingen-bij-station-amsterdam-centraal-geopend"],
      },
    ],
