...
export const HAHMOTELMA_HUN = [
  ...
  },
  {
    ...
    kuvat: [
      ...
      {
        osoite: 'https://media.matkakirja.app/karttanostot/20260920/hun-nosto-herend-ef6e693f.jpg',
        lyhyt: 'Posliinimestari muotoilee esinettä käsin Herendin tehtaalla, edessään valkoisia korikulhoja.',
        selite: 'Työntekijä kokoaa käsin posliiniosaa valkoisen työtakin päällä, ja pöydällä on rivi läpikuvioituja posliinikulhoja. Kuvauksen mukaan kuva on otettu Herendin posliinitehtaalla.',
        lahde: 'Valokuva: Davidi Vardi, Wikimedia Commons (CC BY-SA 4.0).',
        tekija: 'Davidi Vardi',
        lahdeUrl: 'https://commons.wikimedia.org/wiki/File:Herend_Porcelain_Maker.jpg',
        lisenssi: 'CC BY-SA 4.0',
        lisenssiUrl: 'https://creativecommons.org/licenses/by-sa/4.0',
      },
    ],
