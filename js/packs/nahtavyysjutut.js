...
export const NAHTAVYYSJUTUT = {
  ...
  kobenhavn: {
    ...
    'Vapahtajan kirkko': {
      aika: '1682–1752',
      teksti: 'Vapahtajan kirkko (tanskaksi Vor Frelsers Kirke) seisoo '
          + 'Christianshavnissa, Amagerin puolella satamakanavaa. Kun '
          + 'Christian IV kaavaili Christianshavnia vuonna 1617, siitä '
          + 'piti tulla oma kauppiaskaupunkinsa, ja sellainen tarvitsi '
          + 'kirkon. Väliaikainen kirkko vihittiin 1639, mutta nykyisen '
          + 'kirkon rakentaminen alkoi vasta 1682 Lambert van Havenin '
          + 'piirustusten mukaan. Kirkko vihittiin 1695 keskeneräisenä: '
          + 'alttari oli tilapäinen ja tornista puuttui kokonaan huippu.'
        + '\n\n'
        + 'Torni jäi tynkänä yli puoleksi vuosisadaksi. Vasta 1747 '
          + 'Fredrik V:n aikana suunnitelma kaivettiin esiin, ja uusi '
          + 'arkkitehti Lauritz de Thurah hylkäsi van Havenin ehdotuksen '
          + 'ja piirsi oman. Kuningas hyväksyi sen 1749, ja kolme vuotta '
          + 'myöhemmin huippu oli valmis. Kuningas kiipesi ylös juhlallisesti '
          + '28. elokuuta 1752.'
        + '\n\n'
        + 'Huippu nousee 90 metriin, ja sen ympäri kiertää ulkoportaikko '
          + 'neljä kierrosta vastapäivään. Portaita on kaikkiaan 400, ja '
          + 'niistä viimeiset 150 kuljetaan ulkoilmassa kullatun kaiteen '
          + 'takana. Esikuva haettiin Roomasta: Sant Ivo alla Sapienzan '
          + 'kierrelyhty kääntyy samaan suuntaan.'
        + '\n\n'
        + 'Kierresuunta on synnyttänyt sitkeän tarinan, jonka mukaan '
          + 'arkkitehti hyppäsi huipulta huomattuaan portaiden kiertävän '
          + 'väärään suuntaan. Tarina on keksitty. Thurah kuoli vuoteeseensa '
          + 'seitsemän vuotta tornin valmistumisen jälkeen, eikä '
          + 'asiakirjoissa ole jälkeäkään siitä, että hän olisi ollut '
          + 'työhönsä tyytymätön.'
        + '\n\n'
        + 'Kirjallisuudessa torni sai kuuluisan roolin. Jules Vernen '
          + 'romaanissa Matka maan keskipisteeseen professori Lidenbrock '
          + 'panee veljenpoikansa Axelin kiipeämään portaita viitenä '
          + 'peräkkäisenä päivänä, jotta korkeanpaikankammo katoaisi ennen '
          + 'laskeutumista tulivuoreen. Kirjan alkuperäisessä kuvituksessa '
          + 'Édouard Riou piirsi kierteen vahingossa väärinpäin, myötäpäivään.'
        + '\n\n'
        + 'Tornissa soi myös Pohjois-Euroopan suurin kellopeli: 48 '
          + 'pronssikelloa, joista suurimmat painavat yli 2 000 kiloa ja '
          + 'pienin 10 kiloa. Yhteispaino on lähes 12 tonnia, ja peli '
          + 'soittaa virsisävelmiä joka tunti aamukahdeksasta '
          + 'keskiyöhön. Kirkon urut ovat vielä vanhemmat: Botzenin '
          + 'veljekset rakensivat ne vuosina 1698–1700, niissä on yli '
          + '4 000 pilliä, ja koko soitin lepää kahden puisen norsun '
          + 'selässä.',
      kuvat: [
        {
    ...
    'Rosenborgin linna': {
      aika: '1606–1633',
      teksti: 'Rosenborgin linna alkoi huvilana kaupungin ulkopuolella. '
          + 'Christian IV osti vuonna 1606 joukon tontteja silloisen '
          + 'Nørrevoldin takaa: sinne mahtui hänen lystilinnansa lisäksi '
          + 'puutarha ja kyökkimaa, joka ruokki hovia. Rakennus lähti '
          + 'liikkeelle vaatimattomana erakkomajana, mutta se laajeni '
          + '28 vuoden aikana neljässä vaiheessa ja seisoi 1633 valmiina '
          + 'sellaisena kuin se on yhä: hollantilaista renessanssia, '
          + 'punatiiltä ja hiekkakiveä, tornit patinoituneen vihreinä.'
        + '\n\n'
        + 'Linna oli kuninkaan lempipaikka, ja se näkyi loppuun asti. '
          + 'Kuolemansairaana Frederiksborgissa Christian IV käski kuljettaa '
          + 'itsensä reellä Rosenborgiin päättääkseen päivänsä siellä. '
          + 'Hän kuoli linnassa helmikuussa 1648.'
        + '\n\n'
        + 'Kuninkaanlinnana Rosenborg oli käytössä noin vuoteen 1710, '
          + 'kunnes Fredrik IV vaihtoi sen ajanmukaisempiin kesäasuntoihin '
          + 'ja teki vanhasta linnasta kuninkaallisten kokoelmien kodin. '
          + 'Juuri siksi sisustukset ovat säilyneet niin täydellisinä. '
          + 'Sen jälkeen linnassa asuttiin enää kahdesti, molemmilla '
          + 'kerroilla hätätilassa: Christiansborgin palon jälkeen 1794 ja '
          + 'brittien hyökätessä kaupunkiin 1801.'
        + '\n\n'
        + 'Yleisölle ovet aukesivat 1838. Kolmannen kerroksen Pitkä sali '
          + 'valmistui jo 1624 tanssisaliksi, ja siellä ovat yhä '
          + 'yksinvaltiaiden kruunajaistuoli ja kuningattaren valtaistuin, '
          + 'jonka edessä seisoo kolme hopeista leijonaa. Kellarin '
          + 'holvissa säilytetään Tanskan kruununjalokiviä ja '
          + 'kruununregaaleja.'
        + '\n\n'
        + 'Linnan ympärillä on Kuninkaan puutarha, maan vanhin '
          + 'kuninkaallinen puisto. Christian IV perusti sen juuri ennen '
          + 'itse linnaa, ja nykyään siellä käy arviolta 2,5 miljoonaa '
          + 'ihmistä vuodessa. Naapurissa on kasarmi: kuninkaallinen '
          + 'henkikaarti majoittuu siinä ja vartioi linnaa.',
      kuvat: [
        {
    ...
    Kastellet: {
      aika: '1660-luku',
      teksti: 'Kastellet on tähtilinnoitus kaupungin pohjoisreunalla ja '
          + 'yksi Pohjois-Euroopan parhaiten säilyneistä linnoituksista. '
          + 'Se on viisikulmio, jonka jokaisessa kärjessä on bastioni: '
          + 'Kuninkaan, Kuningattaren, Kreivin, Prinsessan ja Prinssin '
          + 'bastioni. Vallit ja vallihaudat olivat aikanaan osa koko '
          + 'kaupungin kiertänyttä bastionirengasta, josta on muuten '
          + 'jäljellä vain Christianshavnin vallit.'
        + '\n\n'
        + 'Alku oli vaatimattomampi. Christian IV perusti paikalle '
          + 'Sankt Annæn skanssin 1624 vahtimaan sataman suuta. Työ jäi '
          + 'hänen aikanaan kesken, ja vasta ruotsalaisten piiritettyä '
          + 'Kööpenhaminaa vuosina 1658–1660 Fredrik III kutsui paikalle '
          + 'hollantilaisen insinöörin Henrik Rusen. Hän rakensi skanssista '
          + 'kunnollisen linnoituksen, joka sai nimen Citadellet '
          + 'Frederikshavn ja valmistui 1664. Sen kaksi porttia ovat '
          + 'vuodelta 1663: Kuninkaanportti kaupunkiin päin ja '
          + 'Norjanportti aukealle.'
        + '\n\n'
        + 'Kastellet erosi muusta vallirenkaasta yhdellä epämiellyttävällä '
          + 'tavalla: sen tykit voitiin kääntää myös kaupunkiin päin, '
          + 'kuninkaan omia alamaisia kohti. Linnoitus toimi myös '
          + 'sotilas- ja valtionvankilana. Vankila rakennettiin kiinni '
          + 'kirkkoon, ja seinään porattiin reikiä, jotta vangit kuulivat '
          + 'jumalanpalvelukset sellistään. Struensee odotti täällä '
          + 'teloitustaan, ja englantilainen seikkailija John Norcross '
          + 'istui muureissa 32 vuotta, joista 16 puuhäkissä.'
        + '\n\n'
        + 'Piiritykseen varauduttiin tosissaan. Kaksi makasiinia riitti '
          + 'täysinäisinä ruokkimaan 1 800 miehen varuskunnan, muun '
          + 'väen ja heidän perheensä neljäksi vuodeksi. Kuninkaan '
          + 'bastionilla jauhoi tuulimylly, sillä piiritetty kaupunki '
          + 'tarvitsi jauhoja. Nykyinen mylly on vuodelta 1847 ja korvasi '
          + 'edellisen, jonka myrsky kaatoi. Vuonna 1800 Kööpenhaminan '
          + 'valleilla pyöri 16 myllyä; Kastelletin mylly on niistä ainoa '
          + 'yhä toimiva. Venäjän keisarinna Maria Fjodorovna, Kristian '
          + 'IX:n tytär, tilasi ruisjauhonsa juuri tästä myllystä — armeijan '
          + 'leipätehdas lähetti ne Pietariin, missä hänelle tarjoiltiin '
          + 'joka aamu leipävelliä.'
        + '\n\n'
        + 'Taidemaalari Christen Købke kasvoi Kastelletissa, jonka myllyn '
          + 'hänen isänsä omisti, ja maalasi portteja ja valleja yhä '
          + 'uudestaan. Vakavampia päiviä tuli 9. huhtikuuta 1940, kun '
          + 'saksalaiset joukot nousivat maihin Langelinien rannassa, '
          + 'räjäyttivät Norjanportin ja ottivat linnoituksen haltuunsa '
          + 'vankilakseen. Kastellet kunnostettiin 1989–1999, ja se on '
          + 'edelleen sekä sotilasaluetta että kaupunkilaisten puisto.',
      kuvat: [
        {
  ...
  izmir: {
    ...
    'Salepçioğlun moskeija': {
      ...
      teksti: 'Rukoussali on pohjaltaan neliö, ja sen päällä lepää yksi '
          ...
          + 'Ikkunoiden edessä on valkoiset rautaparvekkeet.'
        + '\n\n'
  ...
  ankara: {
    ...
    'Linnanportin kellotorni': {
      ...
      teksti: 'Linnaan mennään yhä samasta paikasta kuin ennen: ulomman '
          ...
          + 'varustuksen jatkoksi. Itse porttiaukon kaari on ladottu '
          + 'vuorotellen vaaleista ja tummista kivistä.'
        + '\n\n'
        + 'Kellotorni on vuodelta 1884. Turkin vanhin pystyssä oleva '
          ...
          + 'kantaisi kauas.'
        + '\n\n'
        + 'Kellotorni tuli ottomaanien kaupunkeihin myöhään. Ajatus syntyi '
          + 'Euroopassa 1200-luvulla ja levisi ottomaanien alueelle '
    ...
    'Luxorin museo': {
      ...
      teksti: 'Museo avattiin 1975 Niilin itärannalle rantakadun varteen. '
        ...
        + 'Vuonna 1989 Luxorin temppelin aurinkopihan alta kaivettiin 26 '
          ...
          + 'Patsaan viereen seinään on kaiverrettu selite: Amenhotep III, '
          + '18. dynastia, 1405–1367 eaa. Kartušeista on hakattu pois yksi '
          + 'ainoa sana, Amunin nimi — Ekhnatonin jälki isänsä jumalaa '
          + 'vastaan. Samasta kätköstä tuli Thutmosis III '
          + 'alabasterisfinksinä.'
        + '\n\n'
  ...
  riad: {
    'Masmakin linnoitus': {
      aika: '1902',
      teksti: 'Linnoitus on savitiiltä ja savilaastia, ja perustus on '
          + 'ladottu kivilohkareista. Rakennus jakautuu kuuteen osaan: '
          + 'portti, moskeija, majlis, kaivo, tornit ja sisäpiha. Nurkissa '
          + 'on neljä tornia, kukin noin 18 metriä korkea, ja niiden seinät '
          + 'ovat 1,25 metriä paksut; ylös noustaan tornin sisäisiä '
          + 'portaita. Muodosta lähteet ovat eri mieltä: tornit kuvataan '
          + 'joko kartiomaisiksi tai sylinterimäisiksi. Kaivo ei ole pihan '
          ...
          + 'vierasmaja.'
        + '\n\n'
        + 'Pääportti on länsimuurissa. Ovi on 3,6 metriä korkea, 2,65 leveä '
          + 'ja kymmenen senttiä paksu, ja se on tehty palmupuusta. '
          + 'Keskellä on aukko nimeltä al-Khokha, juuri yhden ihmisen '
          + 'kokoinen. Se on puolustusrakenne: väki kulkee sisään ja ulos '
          + 'ilman että porttia avataan. Portin yläpuolella työntyy '
          + 'muurista kolme pyöreäpäistä ulkonemaa, joiden alapinnassa on '
          + 'reikä.'
        + '\n\n'
        + 'Työ alkoi 1865 ja valmistui 1895. 13. tammikuuta 1902 Abdulaziz '
          + 'ibn Saud palasi Kuwaitin maanpaosta ja otti Masmakin '
    ...
    'Saudi-Arabian kansallismuseo': {
      ...
      teksti: 'Museo avattiin 23. tammikuuta 1999 osaksi Kuningas Abdulazizin '
        ...
        + 'Wabarin kraattereista — Kamelinkyttyrä, jonka Aramcon '
        + 'nostoryhmä punnitsi 1966: 2 045 kiloa. Museon kyltti lupaa '
        + 'silti 2,75 tonnia. Samassa salissa ovat kalaliskon ja '
    ...
    'Perustuslakitalo': {
      ...
      teksti: 'Talon rakennutti vuonna 1868 Haj Mehdi Koozekonani, Tabrizin '
        ...
        + 'Perustuslakivallankumous alkoi 1905 ja päättyi 1911, ja Tabriz '
          ...
          + 'maanalaisia lehtiä.'
        + '\n\n'
        + 'Talo merkittiin Iranin kulttuuriperintöluetteloon 1975. Museossa '
          + 'on esillä vallankumouksellisten veistoksia ja heidän '
  ...
  teheran: {
    ...
    'Golestanin palatsi': {
      ...
      teksti: 'Naser al-Din Shah halusi pääkaupunkiinsa talon, joka '
          ...
          + 'Kashi. Kuistin alla kulkee kaakelipaneeli, jossa seisoo rivi '
          + 'tummiin takkeihin ja päähineisiin puettuja hahmoja.'
        + '\n\n'
        + 'Se oli myös ensimmäinen talo kaupungissa, jonka rakenteissa '
          ...
          + 'on tallella.'
        + '\n\n'
        + 'Katolle asennettiin kello, jonka Britannian kuningatar Viktoria '
          + 'lahjoitti Naser al-Din Shahille. Sen tehtävä oli kertoa '
          + 'tuolloin pienen Teheranin asukkaille paikallinen aika. Lyönti '
          + 'oli kova ja palatsin asukkaat valittivat siitä, joten shaahi '
          + 'määräsi äänen vaimennettavaksi. Kelloon tehty työ ei auttanut, '
          + 'ja kello vaikeni. Se oli hiljaa yli sata vuotta, ja lyönti '
          + 'kuului taas 12. marraskuuta 2012.',
      kuvat: [
        {
    ...
    'Masoudiehin talo': {
      ...
      teksti: 'Talon rakennutti Mas\'ud Mirza Zell-e Soltan, Naser al-Din '
          ...
          + 'Julkisivujen koristeluun kuuluu myös turkoosinvihreää '
          + 'reikälaattaa, ja keskeltä nousevassa kaarevassa päätykentässä '
          + 'on persiankielinen kirjoituslaatta.'
        + '\n\n'
        ...
        + '\n\n'
        + 'Maaliskuun 1. päivänä 1998 rakennus annettiin Iranin kansallisen '
          + 'kulttuuriperinnön seuralle, ja 17. tammikuuta 1999 se '
          + 'merkittiin Iranin kansalliseen kulttuuriperintöluetteloon '
  ...
  isfahan: {
    ...
    'Hasht Behesht': {
      ...
      teksti: 'Hasht behesht tarkoittaa persiaksi kahdeksaa paratiisia, ja '
        ...
        + '\n\n'
        + 'Talo on kahdeksankulmainen ja kaksikerroksinen, ja siihen johtaa '
          + 'kaksi pääovea. Umpinainen se ei ole: neljällä leveimmällä '
          + 'sivulla on suuri holvattu parveke eli iwan, ja parvekkeiden '
          + 'alla nousee ohuita puupylväitä. Keskellä on sali kupolin alla, '
          + 'ja sitä ympäröivien pienten huoneiden matalat holvit on '
          + 'päällystetty peililasilla: pinta näyttää liikkuvan katsojan '
          + 'mukana. Muuta koristelua ovat seinämaalaukset, läpileikattu '
          + 'puutyö, kaakeli ja stukko; ulkokaakelissa on poikkeuksellisen '
          + 'paljon keltaista.'
        + '\n\n'
        + 'Talo seisoo Chahar Baghin puistokadun varrella, ja sen edessä on '
          + 'allas. Puutarha on taloa vanhempi: Abbas Suuren '
          + 'kaupunkikaavassa uuden aukion ja puistokadun väliin jäi laaja '
          + 'puutarha, ja siitä on tänään jäljellä Hasht Beheshtin puisto. '
          + 'Pascal Costen vuonna 1840 piirtämä pohjapiirros nimeää '
          + 'puutarhan osat ranskaksi: lepohuoneet, suihkualtaat, kanavan, '
          + 'nurmikentät, hedelmätarhat ja plataanikujat. Talossa toimi '
          + 'myöhemmin Isfahanin ensimmäinen moderni koulu, Madrese-ye '
          + 'Homayouni eli Hänen majesteettinsa koulu. Iranin '
