  ...
  pariisi: [
    {
      ...
      /*
       * Pikkurivin kuvat (omistajan tarkennus 16.8.2026: "pienempiin
       * nostoihin notredame ja kolmas sitten joku mielenkiintoinen
       * vähän erilainen nosto"). Rivi rajaa kuvat suhteeseen 4:3
       * (css .lehti-kuvarivi), joten pystykuvat eivät kestä rajausta —
       * vanha Wallace-kaivo ja kimeera poistuivat siksi. Molemmat uudet
       * ovat Commonsin juryttämiä (Featured picture + Quality image),
       * lisenssit tarkistettu API:sta ja kuvat katsottu silmin.
       */
      kansikuvat: [
        {
