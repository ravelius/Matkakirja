  ...
  sana: [
    {
      id: 'kaupunki',
      nimi: 'Sana',
      johdanto: 'Vuorten välisessä laaksossa runsaan 2 200 metrin korkeudessa '
        + 'on savimuurien ympäröimä vanhakaupunki, jossa on yli sata '
        + 'moskeijaa, kaksitoista hammamia ja 6 500 taloa, ja jonka talot '
        + 'on rakennettu ylöspäin jopa kahdeksaan kerrokseen.',
      kansikuvat: [
        {
          tiedosto: 'Rooftops of Old Sana\'a (2286011017).jpg',
          selite: 'Vanhankaupungin kattoja ylhäältä katsottuna. Keskellä '
            + 'kohoaa valkoinen minareetti, jonka huipulla on pieni '
            + 'kupoli, ja kauempana erottuu kaksi muuta tornia. Talot '
            + 'ovat ruskeaa tiiltä, ja niiden yläosat on kuvioitu '
            + 'valkoisella kalkilla. Katot ovat tasaisia, ja niillä on '
            + 'vesisäiliöitä, lautasantenneja ja kuivumassa olevaa '
            + 'pyykkiä. Horisontissa on matala vuorijono.',
          lahde: 'Dan from Brussels, Europe, Wikimedia Commons (CC BY-SA 2.0)',
        },
        {
          tiedosto: 'Façades in the Old City of Sana\'a (2286046989).jpg',
          selite: 'Kaksi tornitalon julkisivua alaviistosta pilvetöntä '
            ...
            + 'medaljonkeja. Ikkunaluukut ovat puuta ja osa niistä on '
            + 'auki. Ylimmän katon reunalla on punavalkoinen kangaskatos.',
          lahde: 'Dan from Brussels, Europe, Wikimedia Commons (CC BY-SA 2.0)',
        },
        {
          tiedosto: 'Beside Bab Al-Yemen (10874332564).jpg',
          selite: 'Aukio Jemenin portin vieressä illalla. Vasemmalla kohoaa '
            + 'korkea tornitalo, jonka ikkunoissa näkyy sinistä lasia, '
            + 'keskellä on kapea tornitalo ja oikealla leveä julkisivu. '
            + 'Keskellä palaa katulyhty, jossa on kolme lamppua, ja '
            + 'katutasossa on valaistuja kauppoja markiiseineen. '
            + 'Etualalla liikkuu tiheä ihmisjoukko, ja vasemmalla on '
            + 'sininen pressukatos.',
      ...
      nostot: [
        {
          ...
          tiedosto: 'Buildings in the Old City of Sana\'a (2286047981).jpg',
          teksti: 'Sanaan tornitalo on yhden suvun talo. Korkeimmat yltävät '
            + 'kahdeksaan kerrokseen, ja rakennusaine vaihtuu matkalla '
            + 'ylös: pohja on kivilohkareita, yläkerrat poltettua tiiltä. '
            + 'Talossa asui yksi laaja isälinjainen suku, ja uusi kerros '
            + 'rakennettiin sitä mukaa kun poika meni naimisiin ja sai '
            + 'omia lapsia. Pohjakerros oli viljavarasto ja eläinsuoja, '
            + 'ylin kerros mafraj eli vastaanottohuone, josta on talon '
            + 'parhaat näkymät. Esikuvana pidetään Ghumdanin palatsia, '
            + 'jonka al-Hamdani kuvasi 900-luvulla '
            + 'kaksikymmenkerroksiseksi; useimmat arviot jäävät kuuden ja '
            + 'kymmenen kerroksen välille.',
          selite: 'Tornitaloja kadulta alaviistoon kuvattuna syvänsinistä '
            + 'taivasta vasten. Keskimmäisen talon ylimmällä katolla on '
            + 'erillinen pieni huone, jonka seinät on kuvioitu samoin '
            + 'kuin alempien kerrosten. Tiilipintaa jaksottavat valkoiset '
            + 'vaakavyöt ja siksakkinauhat, ikkunoiden yläpuolella on '
            + 'kaarevia valoaukkoja ja seinissä pyöreitä valkoisia '
            + 'kiekkoja. Osa ikkunoista on avoinna, ja oikeassa reunassa '
            + 'yksi seinä on rapattu kokonaan valkoiseksi.',
          lahde: 'Dan from Brussels, Europe, Wikimedia Commons (CC BY-SA 2.0)',
        },
        {
          otsikko: 'Puoliympyrä täynnä väriä',
          tiedosto: 'Sanaa Window, Yemen (10716059805).jpg',
          teksti: 'Talojen koristelu tehdään kipsistä, kalkista tai muusta '
            + 'rappauksesta. Sanaassa julkisivun kuviot syntyvät ulos '
            + 'työntyvistä tiilistä, jotka kalkitaan valkoisiksi, ja '
            + 'ikkunoiden ympärille vedetään kipsityö. Ikkunan '
            + 'yläpuolelle jätetään kaareva valoaukko, johon asetetaan '
            + 'värillistä lasia geometriseksi tai kasviaiheiseksi '
            + 'kuvioksi. Vanhankaupungin ikkunatyyppejä on kaksi: '
            + 'alabasterista leikattu qamariyya ja värilasinen kaariaukko '
            + 'aqd mulawwan, jonka lasit pysyvät paikoillaan '
            + 'kipsiritilässä. Tiiliseinä suojataan kalkkirappauksella ja '
            + 'qadad-laastilla.',
          selite: 'Ikkuna sisältä katsottuna pimeässä huoneessa. Kaariaukkoon '
            + 'on leikattu kipsistä ristikko, ja sen jokaisessa aukossa '
            + 'on lasi: keskellä kaksi suurta sinistä ristiä, niiden '
            + 'välissä keltaisia pisteitä ja punaisia kukkia, reunoilla '
            + 'kirkkaita valkoisia kolmioita ja ympärillä kaksi riviä '
            + 'pieniä keltaisia, oransseja ja valkoisia soikioita. Muu '
            + 'huone on täysin musta.',
          lahde: 'Rod Waddington from Kergunyah, Australia, Wikimedia Commons (CC BY-SA 2.0)',
        },
        {
          otsikko: 'Portti, josta lähdettiin etelään',
          tiedosto: 'Bab al Yemen.jpg',
          teksti: 'Vanhaakaupunkia kiertää savimuuri, jonka korkeus on 9–14 '
            + 'metriä. Muurin eteläpäässä on Bab al-Yaman eli Jemenin '
            + 'portti, vanhankaupungin pääportti ja porteista '
            + 'koristeellisin. Saksalainen maantieteilijä Carl Rathjens '
            + 'ajoitti portin nykyisen asun 1600-luvulle. Etelään '
            + 'Ma\'bariin ja Dhamariin matkaavat lähtivät juuri tästä '
            + 'portista, ja vastapäätä muurin pohjoisreunalla on Bab '
          ...
          selite: 'Portti vuonna 1986. Keskellä on korkea harmaakivinen '
            + 'kaariaukko, jonka kummallakin puolella on pilarein '
            + 'jäsennetty seinä ja sen takana pyöreä tiilitorni; tornien '
            + 'ja muurin yläreunaa kiertää sahalaitainen harja. '
            + 'Kaariaukosta näkyy kadun päässä valkoinen tornitalo ja '
            + 'matala kupolikatto. Portin edessä on aitaus, sen takana '
            + 'kymmeniä ihmisiä ja kolme vaaleaa henkilöautoa sekä '
            + 'valkoisia kangasbannereita arabiankielisin tekstein.',
          lahde: 'Bernard Gagnon, Wikimedia Commons (CC BY-SA 3.0)',
        },
      ],
    },
    {
      ...
      johdanto: 'Vanhakaupunki jakautui kortteleihin, joissa jokaisessa oli '
        ...
        + 'tori myi kaiken suolasta hopeaan, ja iltapäivä istuttiin '
        + 'ylimmässä kerroksessa.',
      nostot: [
        {
          otsikko: 'Sama vesi kastelee kahdesti',
          tiedosto: 'Vegetable Garden in Old Sana\'a (2286045031).jpg',
          teksti: 'Vanhakaupunki oli jaettu kortteleihin, joita sanotaan '
            + 'nimellä hara. Korttelin ytimenä oli lahjoitusvaroin '
            + 'ylläpidetty kokonaisuus: moskeija, hammam eli kylpylä ja '
            + 'maqshama eli viljelypuutarha. Moskeijan pesualtaasta '
            + 'jäänyt vesi johdettiin puutarhan kasteluun. Talousjäte '
            + 'pudotettiin kuiluja pitkin alas, ja vuoristoilmassa se '
            + 'kuivui nopeasti; kuivunut jäte poltettiin kylpylän '
            + 'uunissa. Luvut vaihtelevat lähteittäin: yhtäällä '
          ...
          selite: 'Muurin rajaama viljelypalsta keskellä vanhaakaupunkia. '
            ...
            + 'kolme palmua ja neljä pientä lehtipuuta. Palstan '
            + 'takaseinänä on matala kivimuuri, jonka päällä seisoo yksi '
            + 'ihminen. Muurin takaa nousee rivi tornitaloja, joiden '
            + 'ruskeaa tiilipintaa jaksottavat valkoiset kaaret ja vyöt. '
            + 'Taivas on pilvetön ja syvänsininen.',
          lahde: 'Dan from Brussels, Europe, Wikimedia Commons (CC BY-SA 2.0)',
        },
        {
          otsikko: 'Suolatorilla myydään kaikkea muuta',
          tiedosto: 'Old City Market, Sanaa (10035332343).jpg',
          teksti: 'Vanhankaupungin tunnetuin kauppapaikka on Suq al-Milh eli '
            + 'suolatori. Nimi kertoo vain yhdestä tavarasta: samoilta '
            + 'kujilta ostetaan leipää, mausteita, rusinoita, puuvillaa, '
            + 'kuparia, saviastioita, hopeaesineitä ja vanhaa tavaraa. '
            + 'Tori on paikkana vanhempi kuin vanhankaupungin suuri '
            + 'moskeija, sillä moskeija rakennettiin 600-luvulla jo '
          ...
          selite: 'Torikuja hämärissä. Katukiveys on märkä ja heijastaa '
            + 'lyhtyjen valoa. Oikealla riippuu vaatekaupan edessä rivi '
            + 'kirkkaanvärisiä pitkiä pukuja ja kaksi mallinukkea, ja '
            + 'niiden takana on valaistuja myymälöitä ja arabiankielisiä '
            + 'kylttejä. Vasemmalla on kangaskojuja ja matalilla pöydillä '
            + 'kasoittain tekstiilejä. Etualalla poika seisoo maahan '
            + 'levitetyn maton äärellä, jolla on rivittäin pieniä '
            + 'värikkäitä esineitä, ja toinen poika kyykkii vieressä. '
            + 'Taempana kadulla kävelee toistakymmentä ihmistä.',
          lahde: 'Rod Waddington from Kergunyah, Australia, Wikimedia Commons (CC BY-SA 2.0)',
        },
        {
          otsikko: 'Ylin kerros, laulaja ja kuparivati',
          tiedosto: 'Sana\'a Old City, Yemen (12652620853).jpg',
          teksti: 'Ylimmän kerroksen mafraj on talon toinen vastaanottohuone, '
            + 'ja siellä kokoonnutaan iltapäivisin; kokoontumista '
            + 'sanotaan nimellä magyal. Sanaan oma laulutyyli al-ghina '
            + 'al-sanani juontuu 1300-luvulle ja otettiin Unescon '
            + 'aineettoman kulttuuriperinnön luetteloon vuonna 2003. '
            + 'Kokoonpanossa on laulaja ja kaksi soittajaa: qanbus eli '
            + 'jemeniläinen luuttu ja sahn nuhasi eli kuparivati, jota '
          ...
          selite: 'Tornitalon ylempi kerros lähikuvassa. Kolmen ikkunan '
            ...
            + 'valoaukkoa, joissa on kipsiin leikattu tähtiristikko. '
            + 'Ikkunoissa on ruskeat puukarmit ja valkoiset verhot, ja '
            + 'ikkunoiden ympärillä on paksut valkoiset kipsikehykset. '
            + 'Seinän yläreunassa kulkee läpimurrettu kaide ja sen alla '
            + 'rivi ulos työntyviä puuparruja. Oikealla näkyy toinen '
            + 'talo, jonka kahdessa ikkunassa on samanlaiset valoaukot, '
            + 'ja vasemmalla taustalla kohoaa tumma vuori.',
          lahde: 'Rod Waddington from Kergunyah, Australia, Wikimedia Commons (CC BY-SA 2.0)',
        },
      ],
      tehtava: {
        kysymys: 'Mikä kielisoitin kuuluu Sanaan laulun kokoonpanoon?',
        vaihtoehdot: [
          'qanbus',
          'santur',
          'kanun',
        ...
        oikea: 0,
        fakta: 'Kokoonpanossa on laulaja ja kaksi soittajaa: qanbus eli '
          + 'jemeniläinen luuttu sekä sahn nuhasi eli kuparivati, jota '
          + 'lyödään kahdeksalla sormella.',
      },
    },
  ],
  /*
  ...
  aden: [
    {
      id: 'kaupunki',
      nimi: 'Aden',
      johdanto: 'Adenin vanhin kaupunginosa on sammuneen tulivuoren kraatterin '
        + 'pohjalla, sadetta kertyy vuodessa 36 millimetriä, ja kallioon '
        + 'hakattuja vesialtaita oli aikoinaan 53.',
      kansikuvat: [
        {
          ...
          selite: 'Adenin Crater-kaupunginosa ylhäältä kuvattuna. Matalat '
            ...
            + 'kohoaa koko kuvan levyinen ruskeanharmaa harjanne, jonka '
            + 'rinteillä ei kasva mitään. Edessä on merenlahti, jossa '
            + 'kelluu toistakymmentä kapeaa venettä, ja lahden ympäri '
            + 'kulkee kivetty rantamuuri ja tie. Rannassa on kaksi '
            + 'pyöreää paviljonkia ja puistokaistale, ja kuvan '
            + 'alareunassa punakattoinen rakennusrivi.',
        ...
        },
        {
          ...
          selite: 'Adenin rantaviivaa 1800-luvun lopulla. Etualalla on '
            + 'kivinen vuorovesiranta, jonka takana kaartuu hiekkainen '
            + 'lahdenpohjukka; rannalla makaa yksi puutynnyri. Matalien '
            + 'valkoisten rakennusten rivissä on kaksikerroksinen talo, '
            + 'jonka molemmissa kerroksissa kiertää avoin veranta. Niiden '
            + 'takana nousee porrasmainen kalliopenger, sen päällä lisää '
            + 'rakennuksia ja kaksi korkeaa lipputankoa. Kuvan alle on '
            + 'kirjoitettu käsin: Aden. French & English Consulates.',
          lahde: 'Rijksmuseum, Wikimedia Commons (CC0)',
        },
        {
          tiedosto: '24 Aden (6) cisterne.jpg',
          selite: 'Tawilan altaille johtava kuru. Kummallakin puolella kohoaa '
            + 'jyrkkä harmaa kallioseinämä, ja niiden välissä on kivestä '
            + 'muurattu terassi valkoisine kaiteineen. Yläterassilla '
            + 'seisoo kuusi ihmistä, joista vasemmanpuoleisin pitää '
            + 'kameraa silmillään, ja alempana portaita nousee kaksi '
            + 'ihmistä. Kurun perällä erottuu poikittainen muuri. '
            + 'Taivaalla lentää useita lintuja, ja oikeassa reunassa '
            + 'kasvaa yksi vihreä pensas.',
          lahde: 'Ljuba brank, Wikimedia Commons (CC BY-SA 3.0)',
        },
      ],
      nostot: [
        {
          otsikko: 'Kaupunki tulivuoren pohjalla',
          tiedosto: 'Veduta di Aden in un giorno di mercato.jpg',
          teksti: 'Adenin vanhin kaupunginosa on nimeltään Crater, ja nimi on '
            + 'kirjaimellinen: korttelit ovat sammuneen tulivuoren '
            + 'kraatterin pohjalla. Nimen antoivat britit, ja virallinen '
            + 'nimi on Seera. Kraatteria ympäröi Jabal Shamsanin '
            + 'vuoristo, jonka korkeimmat huiput ylittävät 500 metriä, ja '
            + 'koko Adenin kallioperä on tulivuoriperäistä. Vuoden 2003 '
            + 'laskennassa kaupunginosassa asui 76 723 ihmistä. Kaupunki '
          ...
          selite: 'Puupiirros Adenista markkinapäivänä vuodelta 1885. '
            + 'Kivisellä kentällä on kymmeniä kameleita, osa seisoo ja '
            + 'osa makaa maassa; niiden keskellä seisoo yksi vaaleaan '
            + 'kaapuun pukeutunut ihminen, ja vasemmalla erottuu muutama '
            + 'pieni hahmo. Taustalla kulkee pitkä matala rakennusrivi, '
            + 'jonka alaosassa on holvikaarikäytävä, ja sen takana on '
            + 'litteäkattoisia valkoisia taloja. Ylimpänä kohoaa jyrkkä '
            + 'paljas vuorenseinämä, joka täyttää koko kuvan yläosan.',
          lahde: 'Tuntematon tekijä, Wikimedia Commons (PD)',
        },
        {
          otsikko: 'Vesi otettiin talteen kalliosta',
          tiedosto: 'Mountain side view of the Terrace-cisterns at Aden. Wood eng Wellcome V0012139.jpg',
          teksti: 'Kraatterissa sataa vähän, joten vesi kerättiin kalliosta. '
            + 'Wadi Tawilan uomaan on hakattu porrastettu sarja altaita, '
            + 'jotka ottavat talteen Shamsanin rinteiltä valuvan sateen '
            + 'ja hillitsevät tulvia. Altaita oli alun perin noin 53, ja '
            + 'niistä on jäljellä 13. Seinät vuorattiin stukilla, johon '
            + 'sekoitettiin tulivuorentuhkaa; siitä tuli vettä '
            + 'läpäisemätön luonnonsementti. Iästä lähteet ovat eri '
            + 'mieltä: yhden oletuksen mukaan työn aloitti himjarilaisten '
            + 'valtakunta, joka hallitsi osaa Jemenistä 115 eaa.-525 '
            + 'jaa., toiset lukevat altaat rasulideille, jotka '
            + 'kunnostivat niitä vuosina 1229-1454. Paikalla oleva kyltti '
            + 'myöntää, ettei rakentamisesta tiedetä varmaa.',
          selite: 'Puupiirros Adenin porrasaltaista. Kuvan alaosassa on suuri '
            + 'tyhjä allas, jonka kaareva reunamuuri on rapattu sileäksi; '
            + 'sen takana altaat jatkuvat porrastuen ylös kurua kohti. '
            + 'Puolivälissä kasvaa tiivis puuryhmä, ja kurun perällä '
            + 'erottuu poikittainen pato. Molemmin puolin nousevat '
            + 'viivoituksella varjostetut jyrkät vuorenrinteet. '
            + 'Alareunassa lukee: TERRACE-CISTERNS, ADEN.',
          lahde: 'Wellcome Collection, Wikimedia Commons (CC BY 4.0)',
        },
        {
          otsikko: 'Moskeija, jonka perustaja toi kahvin',
          tiedosto: 'Aidarous Mosque.jpg',
          teksti: 'Craterissa Aidrus-kadun varrella on Adenin tunnetuin '
            + 'moskeija. Se on nimetty Abu Bakr al-Aydarusin (1447-1508) '
            + 'mukaan. Hän syntyi Tarimissa Hadramautissa, tuli nuorena '
            + 'Adeniin, valvoi kaupungin moskeijan ja sen sufikoulun '
            + 'rakentamista ja jäi asumaan kaupunkiin; kuolemansa jälkeen '
            + 'häntä on pidetty Adenin walina eli suojeluspyhänä. Kolme '
            + 'arabiankielistä lähdettä liittää hänen nimensä kahviin: '
            + 'kertomuksen mukaan hän innostui kahvipensaan marjojen '
            + 'vaikutuksesta vaellusmatkoillaan ja toi tavan '
            + 'Hadramautiin. Moskeija rakennettiin 1400-luvun lopulla tai '
            + '1500-luvun alussa, ja nykyinen rakennus on vuoden 1859 '
            + 'jälkeiseltä ajalta.',
          selite: 'Aidrus-moskeija Craterissa. Vasemmalla on suuri valkoinen '
            + 'kupoli, jonka huipulla on kolme päällekkäistä vihreää '
            + 'palloa ja niiden yllä ohut tanko, ja sen vieressä pienempi '
            + 'kupoli. Keskellä on neliömäinen valkoinen rakennus, jossa '
            + 'on tummanruskeat puiset ikkunaluukut ja räystäät. Oikealla '
            + 'nousee minareetti, jossa on kaksi tummapuista parveketta, '
            + 'uritettu kupoli huipulla ja neljä kaiutintorvea ylemmällä '
            + 'parvekkeella; minareetin alaosa on rappaamatonta kiveä. '
            + 'Etualalla on valkoinen pylväskaide ja vihreä portti, ja '
            + 'oikeassa taustassa paljas kallioinen kukkula.',
    ...
    },
    {
      ...
      johdanto: 'Adenin satama on yksi maailman suurimmista luonnonsatamista, '
        ...
        + 'Höyrylaivakaudella kaupunki eli siitä, mitä laivat tarvitsivat '
        + 'matkallaan.',
      nostot: [
        {
          otsikko: 'Vapaasatama vuodesta 1850',
          tiedosto: 'Aden postcard.jpg',
          teksti: 'Vuonna 1830 höyrylaiva Hugh Lindsay kulki Bombaysta Suezin '
            + 'kannakselle ja täydensi Adenissa hiilivarastonsa '
            + 'sulttaanin luvalla. Britit perustivat hiiliaseman ensin '
            + 'Sokotran saarelle 1834, mutta siirsivät katseensa pian '
            + 'Adeniin. Lahejin sulttaani luovutti heille 194 '
            + 'neliökilometriä maata vuonna 1838, ja kaupunki otettiin '
            + 'haltuun 19. tammikuuta 1839. Vuonna 1850 Aden julistettiin '
            + 'vapaakauppasatamaksi, ja se vei Mokhalta koko kahvikaupan. '
            + 'Satamasta tuli myös postin vaihtopaikka: Suezista '
          ...
          selite: 'Käsin väritetty postikortti Adenin Steamer Pointista. '
            ...
            + 'matkustajahöyrylaiva, jonka runko on punainen; sen takana '
            + 'näkyy kaksi tummaa laivaa ja oikeassa reunassa pieni '
            + 'höyryalus. Rannassa on avoin aukio ja kaksi katosta: '
            + 'toisessa on harjakatto ja toisessa kaareva peltikatto '
            + 'pylväiden päällä. Aukiolla kävelee kaksi ihmistä, ja '
            + 'oikeassa alanurkassa on valkoinen pylväskaide. Yläreunassa '
            + 'lukee: Aden - St. Point, The landing stage & S. S. Persia.',
          lahde: 'Tuntematon tekijä, Wikimedia Commons (PD)',
        },
        {
          otsikko: 'Satama siirtyi niemen toiselle puolelle',
          tiedosto: 'Aden in 1949, view from the boat.JPG',
          teksti: 'Vanha satama oli kraatterin puolella, mutta se mataloitui '
            + 'liettymällä, ja kaupan painopiste siirtyi niemen toiselle '
            + 'puolelle Steamer Pointiin. Sinne tuli hiiliasema, ja '
            + 'siellä matkustajat nousivat maihin. Matka Suezin '
            + 'kanavalle, Bombayhin ja Sansibariin on Adenista '
            + 'suunnilleen yhtä pitkä, ja kaupunki itse on vain kuuden '
            + 'metrin korkeudella merenpinnasta. 1950-luvulla satama oli '
            + 'maailman toiseksi vilkkain polttoainetäydennyspaikka, ja '
          ...
          selite: 'Adenin satama veneestä kuvattuna vuonna 1949. Rannassa on '
            + 'rivi matalia vaaleita rakennuksia, ja niiden takana nousee '
            + 'paljas kukkula, jonka laella seisoo kapea torni. Lahdella '
            + 'kelluu toistakymmentä pientä venettä, etualalla on tumma '
            + 'poiju ja oikeassa reunassa vene, jossa seisoo yksi '
            + 'ihminen. Kuva on haalistunut ja vaalea, ja taivas on '
            + 'tasaisen valkoinen ilman yhtään pilveä.',
          lahde: 'Taks, Wikimedia Commons (CC BY-SA 3.0)',
        },
        {
          otsikko: 'Kellotorni sataman rannassa',
          tiedosto: 'Big Ben Aden View from the inner roadstead.jpg',
          teksti: 'Sataman rannalle rakennettiin kellotorni, joka muistuttaa '
            + 'etäisesti Lontoon Elizabeth-tornia; siitä nimi Big Ben '
            + 'Aden. Tornin tekivät brittiläiset insinöörit yhdessä '
            + 'paikallisten työmiesten kanssa, ja se valmistui vuonna '
            + '1890. Korkeutta on 22 metriä ja leveyttä 1,5 metriä, '
            + 'pohjakaava on suorakaide, ja rakennusaineena on musta kivi '
            + 'ja sementti. Katto on tasasivuisen kolmion muotoinen ja '
            + 'päällystetty punaisella tiilellä. Sisällä nousee '
            + 'rautaportaikko, ja torni katsoo merelle Tawahin yli. '
          ...
          selite: 'Adenin sisäsatama pilvisenä päivänä. Keskellä on matala '
            ...
            + 'rakennelma. Takana rinteeseen nousee tiivis vaaleiden '
            + 'talojen kaupunginosa, ja talojen yllä erottuu kapea torni, '
            + 'jonka huippu on terävä ja tumma. Vedellä on hajallaan '
            + 'pieniä veneitä ja oikealla muutama isompi alus. Oikeassa '
            + 'reunassa näkyy harmaa teräksinen laiturinreuna, ja taivas '
            + 'on kauttaaltaan pilvien peitossa.',
          lahde: 'Грищук ЮН, Wikimedia Commons (CC BY-SA 3.0)',
        },
      ],
      tehtava: {
        kysymys: 'Minkä kaupungin satama oli 1950-luvulla Adenia vilkkaampi '
          + 'polttoainetäydennyspaikka?',
        vaihtoehdot: [
          'New York',
          'Hampuri',
          'Marseille',
        ...
        oikea: 0,
        fakta: 'Aden on suunnilleen yhtä kaukana Suezin kanavasta, '
          + 'Bombaysta ja Sansibarista, joten se sopi täydennyspaikaksi '
          + 'joka suuntaan.',
      },
    },
  ],
  ...
  salalah: [
    {
      id: 'kaupunki',
      nimi: 'Salalah',
      johdanto: 'Kaupunki, jossa aurinko paistaa toukokuussa 335 tuntia ja '
        + 'heinäkuussa 44, ja jonka rannan raunioissa kävivät aikanaan '
        + 'sekä Marco Polo että Zheng He.',
      kansikuvat: [
        {
          tiedosto: 'Al Baleed Archaeological Park.jpg',
          selite: 'Al-Baleedin kaivausalue iltavalossa. Etualalla on paljasta '
            + 'hiekkaa ja siitä nousevia matalia kivimuureja ja '
            + 'perustusrivejä, keskellä ladottu suorakaiteen muotoinen '
            + 'muuri ja sen takana neljän puupilarin varaan tehty '
            + 'palmunlehtikatos, jonka alla on punainen penkki. Taustalla '
            + 'kulkee tiheä palmurivistö, sen takana matala vaalea '
            + 'rakennus ja kaukana hämärtyvät vuoret. Taivas on pilvetön.',
          lahde: 'Juozas Šalna, Wikimedia Commons (CC BY 2.0)',
        },
        {
          tiedosto: 'Darbat Waterfalls, Dhofar.jpg',
          selite: 'Wadi Darbatin putoukset heinäkuussa khareef-kauden aikaan. '
            + 'Vesi valuu useana leveänä verhona kalkkikiviportaiden yli '
            + 'turkoosiin altaaseen, ja portaiden päällä ja välissä '
            + 'kasvaa tiheää vihreää ruohoa ja pensasta. Vasemmassa '
            + 'reunassa on puun runko ja yläreunassa sen oksisto '
            + 'vastavalossa, etualalla vedestä nousee kuivunut oksa ja '
            + 'oikeassa reunassa on harmaita lohkareita. Kaukana '
            + 'rinteellä seisoo ihmisiä ja pysäköityjä autoja.',
        ...
        },
        {
          ...
          selite: 'Wadi Dawkahin suitsukepuisto. Vaalealla sorakentällä '
            + 'kasvaa kymmeniä matalia, leveälatvuksisia suitsukepuita '
            + 'harvassa, ja tasanko jatkuu samanlaisena horisonttiin '
            + 'asti. Puiden seassa kävelee kaksi ihmistä, toinen '
            + 'valkoisessa ja toinen tummassa asussa. Oikeassa reunassa '
            + 'on katos, jonka kaksi vaaleaa kangaskatetta nousevat '
            + 'teräviksi kärjiksi puupilarien varaan, ja sen ympärillä '
            + 'kiertää puinen kaide.',
          lahde: 'Dr. Thomas Liptak, Wikimedia Commons (CC BY-SA 4.0)',
        },
      ],
      nostot: [
        {
          otsikko: 'Kaupunki, joka antoi maakunnalle nimen',
          tiedosto: 'Al Balid Archeological Park 5.jpg',
          teksti: 'Salalahin rannassa on matalia kivimuureja ja perustuksia. '
            + 'Ne ovat keskiaikaista Zafaria, josta koko Dhofarin '
            + 'maakunta sai nimensä. Kaupunki rakennettiin 500-luvulla ja '
            + 'jäi autioksi 1600-luvulla. Se peri suitsukesataman '
            + 'tehtävän, kun idempänä ollut Khor Rori hiipui, ja sen '
            + 'kaduilla kulkivat Marco Polo, Ibn Battuta, Ibn al-Mujawir '
            + 'ja Zheng He. Loppuun oli kaksi syytä: viereinen lahti '
            + 'kuroutui umpeen järveksi, ja 1500- ja 1600-luvuilla '
          ...
          selite: 'Al-Baleedin raunioalue vedestä katsottuna. Etualalla on '
            + 'tyyni vesi, jonka pinnassa näkyy heijastus, ja rannassa '
            + 'nousee luonnonkivestä muurattu viisto tukimuuri, jonka '
            + 'päällä on tasaisesti ladottu vaalea kivimuuri. Muurin '
            + 'takana kulkee hiekkatie ja sen takana kohoaa kaksi matalaa '
            + 'kumpua, joissa on paksuja katkonaisia muurinjäänteitä ja '
            + 'porrasmaisia kivikerroksia. Vasemmalla erottuu pieni katos '
            + 'ja oikealla valkoinen opastaulu.',
          lahde: 'https://www.flickr.com/photos/pukomuko/, Wikimedia Commons (CC BY 2.0)',
        },
        {
          otsikko: 'Aurinko katoaa kolmeksi kuukaudeksi',
          tiedosto: 'Salalah landscape meadows.jpg',
          teksti: 'Khareef on arabian puhekielinen sana syksylle, mutta '
            + 'Dhofarissa se tarkoittaa kesämonsuunia kesäkuun ja '
            + 'syyskuun alun välillä. Rannan edustalla nousee kylmää '
            + 'vettä syvyydestä, ja pinnan lämpötila pysyy siellä '
            + 'runsaassa kahdessakymmenessä asteessa, kun ulompana ollaan '
            + 'lähempänä kolmeakymmentä. Mereltä puhaltava lämmin ja '
            + 'kostea ilma jäähtyy tämän yllä, ja siitä tiivistyy sumu. '
            + 'Sadetta mitataan silti vähän: lentoasemalla heinäkuussa '
          ...
          selite: 'Salalahin yläpuolinen rinne khareefin aikaan. Betonitien '
            + 'reunasta alkaa yhtenäinen vihreä ruohorinne, jossa on '
            + 'esillä muutamia tummia kiviä ja ylhäällä yksittäisiä '
            + 'pensaita. Vasemmalla laakso laskee ja nousee toiselle '
            + 'puolelle matalaksi vihreäksi ylängöksi, jonka reunassa '
            + 'erottuu muutama vaalea rakennus. Taivas on sininen ja '
            + 'siinä on isoja valkoisia kumpupilviä.',
          lahde: 'Poojaryroshan, Wikimedia Commons (CC BY-SA 4.0)',
        },
        {
          otsikko: 'Kieli, jota ei kirjoiteta',
          tiedosto: 'Priced possession of a shepherd, Salalah, Dhofar, Sultanate of Oman.jpg',
          teksti: 'Salalahin ympärillä puhutaan arabian rinnalla shehriä eli '
            + 'jibbalia. Se ei ole arabian murre vaan oma seemiläinen '
            + 'kieli, yksi nykyeteläarabialaisista kielistä. Sen oma nimi '
            + 'Śḥɛrɛ̄t tarkoittaa vuorten kieltä, ja puhujat asuvat juuri '
            + 'vuorilla, niiden takaisilla ylängöillä ja rannikon '
            + 'kaupungeissa. Kirjoitusperinnettä ei ole: kielellä ei '
            + 'julkaista. Puhujamäärästä lähteet ovat eri mieltä — '
            + 'Salalahin artikkeli mainitsee 25 000 puhujaa vuodelta '
          ...
          selite: 'Yksi ihminen seisoo selin katsojaan pitkässä heinikossa: '
            + 'tummanvihreä pitkähihainen paita, ruudullinen huivi pään '
            + 'ja hartioiden yli ja oikeassa kädessä musta taipuisa '
            + 'letku. Edessä avautuu kellanvihreä laidun, jolla laiduntaa '
            + 'hajallaan toistakymmentä vuohta, osa ruskeita ja osa '
            + 'mustanvalkoisia. Ylempänä maasto jatkuu tasaisena ja '
            + 'kivisenä.',
    ...
    },
    {
      ...
      johdanto: 'Dhofar on suitsukepuun kotiseutua, ja koko rannikon vauraus '
        ...
        + 'lajitellaan käsin, ja reitti vei mereltä Gazaan asti.',
      nostot: [
        {
          otsikko: 'Puu, joka tarttuu kallioon kiinni',
          tiedosto: 'Boswellia sacra in Dhofar.JPG',
          teksti: 'Boswellia sacra jää kahden ja kahdeksan metrin väliin ja '
            + 'kasvaa usein monirunkoisena. Kuori on ohut kuin paperi ja '
            + 'irtoaa käsin. Jyrkässä rinteessä puu kasvattaa juurista '
            + 'pullistuman rungon tyveen: se painuu kalliota vasten kuin '
            + 'tyyny ja pitää puun paikallaan. Kasvupaikka on kivinen '
            + 'rinne tai rotko, maa kalkkipitoista, korkeus enintään 1 '
            + '200 metriä. Hedelmä on noin sentin mittainen kota. Lajia '
            + 'kasvaa Omanissa, Jemenissä, Somaliassa ja Etiopiassa, ja '
          ...
          selite: 'Suitsukepuu jyrkässä kalkkikivirinteessä. Rungot '
            + 'haarautuvat useaksi jo maan tasalta, kuori on vaalea ja '
            + 'kuoriutuu ohuina liuskoina, ja oksat ovat lähes '
            + 'lehdettömiä: latvassa on vain muutamia keltavihreitä '
            + 'lehtitupsuja. Taustalla kohoaa vaakasuorina kerroksina '
            + 'murtuva kallioseinämä, ja kivien välissä kasvaa kuivia '
            + 'heinätuppaita.',
          lahde: 'Mileli, Wikimedia Commons (CC BY-SA 3.0)',
        },
        {
          otsikko: 'Maitomainen neste jähmettyy ilmassa',
          tiedosto: 'Omani Frankenscense.JPG',
          teksti: 'Puu alkaa antaa pihkaa vasta 8–10 vuoden ikäisenä. Runkoon '
            + 'tai oksaan tehdään matala viilto tai kuoresta poistetaan '
            + 'pala, ja haavasta valuu maitomaista nestettä, joka '
            + 'jähmettyy ilmassa ja kerätään käsin. Jyvät lajitellaan '
            + 'käsin laadun mukaan, ja laatuun vaikuttaa myös keruun '
            + 'ajankohta. Parhaana pidetään Najdin kapean sumuvyöhykkeen '
            + 'puita siellä, missä aavikko kohtaa Dhofarin vuoret: ne '
            + 'kasvavat erittäin hitaasti ja antavat suuria valkoisia '
            + 'paakkuja. Paremmuudesta ei olla yksimielisiä — laajimmin '
            + 'hyväksytty näkemys on, että Somalian metsien hartsi on '
            + 'laadukkainta.',
          selite: 'Suitsukejyviä avatussa rasiassa. Uurrettu metallirasia on '
            + 'auki, ja sen sisällä on vähintään yhdeksän erillistä '
            + 'hartsipalaa, väriltään kellanruskeasta lähes valkoiseen ja '
            + 'pinnaltaan jauhemaisen huurteisia. Oikeassa yläkulmassa on '
            + 'valkoinen posliinihuhmar, jossa on lisää paloja, ja sen '
            + 'edessä lepää huhmaren nuija. Alusta on vaaleaa puuta.',
          lahde: 'Andygriffith at English Wikipedia, Wikimedia Commons (PD)',
        },
        {
          otsikko: 'Reitti mereltä Gazaan',
          tiedosto: 'Salalah, museo della terra degli incensi, interno, sezione navale 01.jpg',
          teksti: 'Suitsukkeella on käyty kauppaa Arabian ja Somalian '
            + 'rannikoilla yli viisituhatta vuotta. Herodotos kirjoitti, '
            + 'että sitä kerätään Etelä-Arabiasta ja että puita '
            + 'vartioivat siivekkäät käärmeet, jotka sai karkotettua '
            + 'storaxin savulla. Reitti tunnetaan tarkasti: Dhofarin '
            + 'hartsi koottiin Moscha Limeniin eli Khor Roriin, vietiin '
            + 'laivalla Qanaan, sieltä maitse Shabwaan ja edelleen '
            + 'pohjoiseen Najraniin, Mekkaan, Medinaan, Petraan ja '
            + 'Gazaan. Osa kulki Persianlahden kautta Babyloniin ja '
            + 'Palmyraan. Al-Baleedin puistossa avattiin vuonna 2007 '
            + 'suitsukemuseo, jonka kaksi salia kertovat merenkulusta ja '
            + 'historiasta.',
          selite: 'Suitsukemuseon meriosasto Al-Baleedin puistossa. '
            + 'Vasemmalla seisoo suuren puulaivan takaosa täydessä '
            + 'koossa: kaiverrettu peräpeili, kaiteet, köysikiepit ja '
            + 'poikkipuille kääritty purje. Oikealla kiertää seinustaa '
            + 'tummapuinen näyttelyrivi lasivitriineineen, ja yhdessä '
            + 'vitriinissä on purjelaivan pienoismalli; edessä on '
            + 'telineillä messinkinen taivaanpallo ja tekstitauluja. '
            + 'Lattia on kiiltävää lautaa ja katto tumma, ja siihen on '
            + 'tehty pieniä valopisteitä tähtitaivaaksi.',
          lahde: 'Francesco Bini, Wikimedia Commons (CC BY-SA 4.0)',
        },
      ],
      tehtava: {
        kysymys: 'Kuinka vanhana suitsukepuu alkaa antaa pihkaa?',
        vaihtoehdot: [
          '8–10 vuoden iässä',
          '2–3 vuoden iässä',
          '30 vuoden iässä',
        ...
        oikea: 0,
        fakta: 'Pihkaa alkaa tulla noin 8–10 vuoden iässä. Sen jälkeen '
          + 'runkoon tehdään matala viilto, ja ilmassa jähmettyneet '
          + 'jyvät kerätään ja lajitellaan käsin.',
      },
    },
  ],
  /*
  ...
  mosul: [
    {
      id: 'kaupunki',
      nimi: 'Mosul',
      johdanto: 'Kaupungin arabiankielinen nimi tarkoittaa liitoskohtaa: Mosul '
        + 'kasvoi Tigrisin ylityspaikkaan 223 metrin korkeuteen '
      ...
      kansikuvat: [
        {
          ...
          selite: 'Tigrisin ranta Mosulissa vuonna 1932. Etualalla maassa on '
            + 'pitkiä puuriukuja ja niistä sidottuja ristikoita, joiden '
            + 'alle on ladottu kymmeniä täyteen puhallettuja nahkasäkkejä '
            + 'lautan kelluketta varten. Rannalla työskentelee neljä '
            + 'ihmistä: yksi seisoo polviaan myöten vedessä, yksi '
            + 'kumartuu säkin yli, ja kaksi on lastin vieressä vaaleissa '
            + 'vaatteissa ja päähuivissa. Taustalla joen yli kulkee '
            + 'silta, joka lepää veneiden ja matoilla verhottujen tukien '
            + 'varassa; kaiteellisella sillalla erottuu yksittäisiä '
            + 'kulkijoita. Vastaranta on matalaa puurivistöä, ja taivas '
            + 'on vaalea ja tyhjä.',
          lahde: 'Matson Collection, Wikimedia Commons (PD)',
        },
        {
          tiedosto: 'Iraq. Mosul. A native courtyard LOC matpc.16205.jpg',
          selite: 'Mosulilaisen talon sisäpiha ylhäältä kuvattuna vuonna '
            + '1932. Vasemmassa seinässä on kaksi suurta teräväkärkistä '
            + 'holvikaarta, ja niiden viereen nousee kaiteeton '
            + 'tiiliportaikko. Yläkerrassa kiertää parvi, jonka aukot on '
            + 'peitetty tiheillä puuristikoilla, ja oikealla on korkea '
            + 'rivi samanlaisia ristikkoikkunoita. Oikeanpuoleisen seinän '
            + 'edessä seisoo kolme kartiomaista rakennelmaa, joiden '
            + 'pinnassa näkyvät vaakasuorat muurauskerrokset. Niiden '
            + 'vieressä seisoo yksi mies vaaleassa kaavussa ja tummassa '
            + 'takissa. Pihan lattia on laattaa, ja alanurkassa on '
            + 'saviruukku kivien päällä.',
          lahde: 'Matson Collection, Wikimedia Commons (PD)',
        },
        {
          ...
          selite: 'Vihannestori Mosulissa vuonna 1932. Maassa on kasa pitkiä, '
            + 'uurteisia kurkkuja, ja vasemmalla niitä on toinen, '
            + 'pienempi kasa. Etualalla mies ruudullisessa päähuivissa '
            + 'kumartuu kasan yli ja leikkaa yhtä kurkkua veitsellä. '
            + 'Hänen takanaan seisoo nuorempi mies päähuivissa pitkä '
            + 'puuseiväs kädessä, ja hänen vierellään kaksi tummiin '
            + 'viittoihin ja huiveihin pukeutunutta ihmistä. Oikeassa '
            + 'reunassa kyykkii yksi ihminen. Taustalla häämöttää '
            + 'vaaleisiin vaatteisiin pukeutuneita ihmisiä valkoisten '
            + 'kangaskatosten alla.',
          lahde: 'Matson Collection, Wikimedia Commons (PD)',
        },
      ],
      nostot: [
        {
          otsikko: 'Nimen alkuperästä ei olla yksimielisiä',
          tiedosto: 'Woman\'s muslin dress c. 1855.jpg',
          teksti: 'Musliini on palttinasidoksinen puuvillakangas, jota '
            + 'tehdään ohuesta harsosta karkeaan lakanakankaaseen asti. '
            + 'Nimen alkuperä on kiistanalainen. Tavallisin selitys on '
            + 'Mosul, ja Hobson-Jobson-sanakirja johtaa sanan '
            + 'kaupungista, joka oli tunnettu kauppapaikka ja jonka hyvin '
            + 'hienoa kangasta vietiin Eurooppaan. Marco Polo kirjoitti '
            + 'vuonna 1298 matkakirjassaan, että musliinia tehdään '
            + 'Mosulissa. Selitys ei ole ainoa: osa tutkijoista johtaa '
            + 'nimen Masulipatnamin satamasta Koromandelin rannikolta, '
            + 'samaan tapaan kuin calico on saanut nimensä Calicutista ja '
            + 'denim Nîmesistä. Kangasta itseään kudottiin eniten '
            + 'Bengalissa.',
          selite: 'Valkoinen musliinipuku mallinuken päällä mustaa taustaa '
            + 'vasten. Hame levenee kellona, ja siinä on kolme '
            + 'päällekkäistä volangikerrosta. Vyötäröllä on leveä sileä '
            + 'vyö, hihat pullistuvat leveiksi ja kapenevat ranteessa, '
            + 'olkapäillä on pienet poimutetut kaitaleet ja kaulassa '
            + 'kapea röyhelö. Päässä on laskostettu valkoinen myssy. '
            + 'Kangas on niin ohutta, että alempi volangi näkyy ylemmän '
            + 'läpi.',
          lahde: 'Unknown author, Wikimedia Commons (PD)',
        },
        {
          otsikko: 'Orjasta emiiriksi, ja palatsi joen rantaan',
          tiedosto: 'Badr al din lu\'lu\' (frontispiece).jpg',
          teksti: 'Badr al-Din Lu\'lu\' (n. 1178–1259) oli vapautettu orja, ja '
            + 'hänen nimensä tarkoittaa helmeä. Vuodesta 1211 hän toimi '
            + 'atabegina Mosulin lapsihallitsijoille, vuonna 1234 hän löi '
            + 'ensimmäiset omat kolikkonsa, ja kalifi al-Mustansir '
            + 'vahvisti aseman antamalla hänelle arvonimen al-Malik '
            + 'al-Rahim, armollinen kuningas. Laajimmillaan vuonna 1251 '
            + 'hänen alueensa ulottui Sinjarista ja Nusaybinista Khaburin '
            + 'varrelle. Hän rakennutti Sinjarin portin, Imam Yahyan ja '
            + 'Awn al-Dinin hautapyhäköt sekä Tigrisin länsirannalle Qara '
            + 'Sarayn eli Mustan palatsin.',
          selite: 'Käsikirjoituksen kokosivun kuva kultapohjalle maalattuna. '
            + 'Keskellä istuu parrakas mies kaavussa, jonka kultapohjan '
            + 'peittää lähes kokonaan tiheä sininen kiehkurakirjoitus; '
            + 'olkavarsissa on nauhat, joihin on kirjoitettu arabiaksi, '
            + 'ja pään takana on suuri kultainen sädekehä '
            + 'koristereunuksineen. Hänen ympärillään on ainakin kymmenen '
            + 'seuralaista punaisissa ja tummissa lakeissa sekä '
            + 'kypärämäisissä päähineissä. Maalipinta on kulunut ja siinä '
            + 'on vaaleita lohkeamia.',
          lahde: '13th century painter, Wikimedia Commons (PD)',
        },
        {
          otsikko: 'Kivi, jota sahattiin laatoiksi',
          tiedosto: 'Assyrian Relief of the Banquet of Ashurbanipal From Nineveh Gypsum N Palace British Museum 03.jpg',
          teksti: 'Mosulin marmori ei ole marmoria vaan kipsikiveä eli '
            + 'alabasteria, jonka paljastumia on eri puolilla '
            + 'Pohjois-Irakia. Siitä tehtiin assyrialaisten palatsien '
            + 'seinälaatat 800–600-luvuilla eaa. Kivi on pehmeää ja '
            + 'hieman veteen liukenevaa, joten paljas pinta oli '
            + 'rapautunut ja louhijan oli kaivettava syvemmälle ennen '
            + 'kuin käyttökelpoinen kerros alkoi. Lohkareet sahattiin '
            + 'laatoiksi pitkillä rautasahoilla. Laatat kiinnitettiin '
          ...
          selite: 'Kipsikivinen seinälaatta Niniven pohjoisesta palatsista. '
            + 'Vasemmalla istuu korkeaselkäisellä tuolilla hahmo, jolla '
            + 'on korkea päähine ja jalkojen alla jakkara; hän kohottaa '
            + 'matalaa maljaa. Keskellä lepää parrakas mies sohvalla, '
            + 'toinen käsi koholla, ja hänen edessään on matala pöytä. '
            + 'Oikealla seisoo palvelija pitkä viuhka kädessä. '
            + 'Yläreunassa kaartuu köynnös, jossa roikkuu rypäleterttuja, '
            + 'ja oikeassa laidassa on lehtevä puu. Reliefi on hyvin '
            + 'matalaa, mutta hiukset, parta ja kankaiden laskokset on '
            + 'veistetty tarkasti.',
    ...
    },
    {
      ...
      johdanto: '1200-luvun Mosulissa messinkiastioiden kuviot upotettiin '
        ...
        + 'esineistä juuri mosulilaisissa on eniten kaiverrettua tekstiä.',
      nostot: [
        {
          otsikko: 'Vain kahdesta esineestä on varmuus',
          tiedosto: 'Angular harp and reedpipe, from the Blacas Ewer, 13th century, Mosul, Iraq.jpg',
          teksti: 'Ainoa aikalaislähde alasta on andalusialaisen '
            + 'maantieteilijän Ibn Sa\'idin kertomus noin vuodelta 1250: '
            + 'kaupungissa on monta käsityöalaa, erityisesti '
            + 'upotekoristeisia messinkiastioita, joita viedään '
            + 'ulkomaille ja annetaan lahjoiksi hallitsijoille. '
            + 'Liitenimen al-Mawsili kantavia messinkiesineitä tunnetaan '
            + '35 kappaletta ja niillä 27 eri tekijää, ja neljä '
            + 'viidesosaa niistä on vuosilta 1220–1275. Varmuudella juuri '
            + 'Mosulissa tehtyjä on kaksi: Shuja\' ibn Man\'an kannu '
            + 'vuodelta 1232 ja Ali ibn Yahyan kynälaatikko vuodelta '
            + '1255–56.',
          selite: 'Yksityiskohta Shuja\' ibn Man\'an kannun kyljestä. '
            + 'Liuskareunaisen medaljongin sisällä istuu kaksi soittajaa: '
            + 'vasemmalla on kulmaharppu, jonka runko kulkee vinosti '
            + 'soittajan sylin yli, ja oikealla lyhyt ruokopilli, jota '
            + 'soittaja pitää molemmin käsin huulillaan. Kummankin pään '
            + 'takana on sädekehä, ja kummallakin on tummat nauhat '
            + 'hihoissa. Kasvot ja vaatteet erottuvat vaaleina, koska ne '
            + 'on upotettu hopealla. Tausta on tiheää köynnöstä, ja '
            + 'medaljongin ympärillä kiertää sokkelomainen '
            + 'murtoviivakuvio.',
          lahde: 'Unknown artist, April 1232, Mosul, Iraq, Wikimedia Commons (PD)',
        },
        {
          otsikko: 'Tekniikka kulki Heratin kautta länteen',
          tiedosto: 'Clevelandart 1956.11.jpg',
          teksti: 'Upotustyö kehittyi Khurasanissa 1100-luvulla, kun '
            + 'hopeasepiltä loppui raaka-aine ja he alkoivat käyttää sitä '
            + 'ohuina kuvioina toisen metallin pinnassa. Herat sai '
            + 'maineen työn laadusta, ja tapa levisi länteen, koska se '
            + 'vaati vain vähän työkaluja. 1200-luvun alkuun mennessä se '
            + 'oli Mosulissa. Ahmad al-Dhaki al-Mawsilin messinkikannussa '
            + 'vuodelta 1223 on kolmessa kerroksessa 30 medaljonkia, '
            + 'joissa on metsästystä, peltotyötä, kamelinratsastajia ja '
            + 'soittajia. Kuvioihin oli upotettu hopeaa ja se erottui '
            + 'messingistä vaaleana, mutta suurin osa upotuksesta on ajan '
            + 'mittaan irronnut.',
          selite: 'Messinkikannu harmaata taustaa vasten. Suora, ylöspäin '
            + 'kalteva nokka päättyy nuppiin, kannessa on matala kupoli '
            + 'ja terävä huippu, ja kaareva kahva nousee rungosta kaulan '
            + 'viereen palloon asti. Runko on päärynän muotoinen ja lepää '
            + 'leveällä jalalla. Kaulassa, olkapäällä ja jalassa kiertää '
            + 'arabiankielisiä kirjoitusnauhoja, ja rungon levein vyöhyke '
            + 'on täynnä pieniä ihmishahmoja. Pinta on kulunut '
            + 'laikukkaaksi: vaaleaa upotusta on jäljellä vain siellä '
            + 'täällä.',
          lahde: 'Ahmad al-Dhaki al-Mawsili, Wikimedia Commons (CC0)',
        },
        {
          otsikko: 'Kahdeksankulmio oli pajan merkki',
          tiedosto: 'Yunus ibn Yusuf, "al-naqqash al-Mawsili" - Ewer - Walters 54456 - Detail K.jpg',
          teksti: 'Mosulin metallityö on ainoa tunnettu tapaus islamilaisessa '
            + 'maailmassa, jossa tekijät merkitsivät esineisiin myös '
            + 'keskinäiset suhteensa: mestari, oppipoika eli tilmidh ja '
            + 'palkkalainen eli ajir. Julian Raby on esittänyt, että '
            + 'toistuvat merkit olivat pajan tai ammattikunnan tunnuksia. '
            + 'Kahdeksankulmio, jonka sisus on täytetty monimutkaisella '
            + 'geometrisella kuviolla, esiintyy ainakin 13 esineessä '
            + '1220-luvulta 1240-luvulle, ja sitä käyttivät muun muassa '
            + 'Ahmad al-Dhaki, Ibn Jaldak, Shuja\' ibn Man\'a, Dawud ibn '
            + 'Salama ja Yunus ibn Yusuf. Toinen merkki on 10- tai '
            + '12-lehtinen ruusuke esineen pohjassa, kohdassa jota ei '
            + 'tavallisesti näe.',
          selite: 'Lähikuva Yunus ibn Yusufin kannun kyljestä. Keskellä on '
            + 'kahdeksankulmio, jonka sisus on täytetty sokkelomaisella '
            + 'murtoviivakuviolla; kuvio lähtee keskeltä '
            + 'kahdeksansakaraisena tähtenä ja kiertyy kulmiin asti. '
            + 'Kahdeksankulmion ääriviivat ja kuvion urat on upotettu '
            + 'vaalealla metallilla, joka erottuu tummasta pohjasta. '
            + 'Ympärillä on tiheää köynnöskuviota, jonka lehtien lomassa '
            + 'erottuu pieniä eläinten päitä.',
          lahde: 'Yunus ibn Yusuf, "al-naqqash al-Mawsili" (Iraqi or Syrian), Wikimedia Commons (PD)',
        },
      ],
      tehtava: {
        kysymys: 'Mitä metallia mosulilaiset upottivat messinkiesineiden '
          + 'pintaan?',
        vaihtoehdot: [
          'hopeaa',
          'tinaa',
        ...
        oikea: 0,
        fakta: 'Tekniikka syntyi Khurasanissa, kun hopeasepiltä loppui '
          + 'raaka-aine ja he alkoivat käyttää sitä ohuina kuvioina '
          + 'toisen metallin pinnassa.',
      },
    },
  ],
  /*
  ...
  jakutsk: [
    {
      id: 'kaupunki',
      nimi: 'Jakutsk',
      johdanto: 'Jakutsk perustettiin 1632 hirsilinnoitukseksi Lenan '
        + 'rannalle, ja siitä kasvoi maailman suurin yhtenäisen ikiroudan '
        + 'päälle rakennettu kaupunki. Helmikuun 5. päivänä 1891 täällä '
        + 'mitattiin −64,4 astetta, ja tammikuun keskilämpötila on yhä noin '
        + '−37 astetta.',
      kansikuvat: [
        {
          tiedosto: 'Якутск.jpg',
          selite: 'Jakutsk talvipäivänä korkealta kuvattuna. Etualassa kulkee '
            + 'luminen katu, jolla ajaa puolenkymmentä autoa ja jonka '
            + 'reunalla seisoo neljän hengen ryhmä pysäköidyn valkoisen '
            + 'auton vieressä; kadun ja katsojan välissä on tasainen '
            + 'lumikenttä. Kadun takana leviää matalien puutalojen '
            + 'kortteli, jonka katot ovat lumen peitossa ja pihat erotettu '
            + 'pelti- ja lauta-aidoin. Keskellä erottuu kaksikerroksinen '
            + 'puutalo, jota verhoillaan parhaillaan uudelleen: toinen '
            + 'seinä on vanhaa tummanruskeaa lautaa, toinen vastanaulattua '
            + 'vaaleaa vinolautaa, ja ikkunoissa on valkoiset karmit. '
            + 'Taustalla nousee rivi kerrostaloja, keltaisia, harmaita ja '
            + 'sinertäviä, ja niiden lomassa seisoo rakennusnostureita. '
            + 'Oikealla kohoaa ohut valkoinen savujuova. Taivas on vaalean '
            + 'siniharmaa ja horisontti utuinen.',
          lahde: 'Якупова Инна, Wikimedia Commons (CC BY-SA 4.0)',
        },
        {
          tiedosto: 'Якутский острог (восстановленный).jpg',
          selite: 'Jakutskin ostrogin puutornin jäljennös syyspäivänä. Torni '
            + 'on salvottu pyöreistä hirsistä, ja nurkissa hirrenpäät '
            + 'työntyvät ristiin. Harmaan aumakaton alta pistää esiin rivi '
            + 'teräväkärkisiä orsia. Katon päällä on pieni vartiokoju, '
            + 'jossa on aukot joka sivulla, veistetty kaide ja terävä '
            + 'huippu ohuine tankoineen. Julkisivun keskeltä työntyy ulos '
            + 'katettu parveke: sen kaiteessa toistuu vinoruutuinen '
            + 'puuleikkaus ja aukkojen yläreunat ovat aaltoilevat. '
            + 'Parvekkeen alla on kaariaukossa kaksilehtinen lauta-ovi, '
            + 'jossa roikkuu valkoinen ilmoituslappu, ja ovelle nousee '
            + 'lankuista tehty luiska. Tornia ympäröivät keltalehtiset '
            + 'koivut, ja oikealla häämöttää sinilasinen rakennus.',
          lahde: 'Prok of eva, Wikimedia Commons (CC BY-SA 4.0)',
        },
        {
          tiedosto: 'Вид на городской пляж, 203-мкр Якутск 18.06.2026.jpg',
          selite: 'Kaupungin uimaranta kesäkuussa. Vasemmalla lepää tyyni '
            + 'joenhaara, ja hiekkaranta kaartuu loivana kaarena kuvan '
            + 'poikki. Vedessä ja rantaviivalla on uimapukuisia ihmisiä, '
            + 'hiekalla makaa punainen kumivene, ja rannan yli kulkevan '
            + 'puisen kulkusillan varrella on rivi valkoisia '
            + 'aurinkotuoleja. Keskellä ja oikeassa reunassa seisoo kaksi '
            + 'samanlaista uimavalvojan tornia: vaaleat ristikkojalat ja '
            + 'niiden päällä tummansiniset säleikkökaiteet ja katos. Törmän '
            + 'päällä kulkee kaide, ja sen takana nousee toistakymmentä '
            + 'vaaleaa kerrostaloa. Vasemmalla horisontissa on matalaa '
            + 'metsää ja yksi sähkölinjan masto. Taivas on sininen ja siinä '
            + 'on ohuita valkoisia pilviä.',
          lahde: 'SmallSonMarex, Wikimedia Commons (CC BY-SA 4.0)',
        },
      ],
      nostot: [
        {
          otsikko: 'Linnoitus siirrettiin joen toiselle rannalle',
          tiedosto: 'Yakutsk 1900.jpg',
          teksti: 'Kasakkapäällikkö Pjotr Beketov pystytti 25. syyskuuta 1632 '
            + 'Lenan oikealle rannalle hirsivarustuksen, jota sanottiin '
            + 'Lenan ostrogiksi. Vuosina 1642–1643 linnoitus siirrettiin '
            + 'vastarannalle Tuimaadan laaksoon Saisary-järven tuntumaan, '
            + 'ja siitä paikasta kasvoi nykyinen Jakutsk. Kaupungin aseman '
            + 'Jakutsk sai siirron myötä 1643, ja vuoden 1897 väenlaskussa '
            + 'asukkaita oli 6 535. Ostrogin porttitorni vuosilta 1685–1687 '
            + 'säilyi yli kolme vuosisataa ja tuhoutui tulipalossa 22. '
            + 'elokuuta 2002, muutamaa päivää ennen kaupungin '
            + '370-vuotisjuhlaa. Torni rakennettiin uudelleen vanhojen '
            + 'mittapiirustusten mukaan.',
          selite: 'Jakutskin asemakaava vuodelta 1900. Kellastuneelle '
            + 'paperiarkille on painettu mustin viivoin ruutukaava, joka '
            + 'kulkee vinosti jokeen nähden; korttelien sisällä talot '
            + 'näkyvät pieninä täytettyinä suorakaiteina. Oikeassa '
            + 'alanurkassa virtaa leveä joki, jonka rannat on varjostettu '
            + 'tiheillä viivoilla. Vasemmalla on suuri soikea järvi '
            + 'korkeuskäyrineen, ja ylhäällä sekä alhaalla on kapeampia '
            + 'lampia. Oikeaan reunaan on ladottu kirjaimin merkitty '
            + 'selitysluettelo, jossa mainitaan muun muassa basaari, '
            + 'suolamakasiini, luostari, vanhan varustuksen jäännökset ja '
            + 'Šerginin kuilu. Vasemmassa yläkulmassa lukee kyrillisin '
            + 'kirjaimin kaupungin kaavan nimi ja oikeassa yläkulmassa '
            + 'taulun numero. Arkin kulmiin on kirjoitettu käsin sinisellä '
            + 'musteella arkistotunnus, ja oikea reuna on repeytynyt.',
          lahde: 'Unknown author, Wikimedia Commons (PD)',
          wiki: 'Jakutsk',
        },
        {
          otsikko: 'Kolmetuhatta virstaa satulassa',
          tiedosto: 'Kate Marsden leaving Yakutsk.jpg',
          teksti: 'Englantilainen sairaanhoitaja Kate Marsden lähti '
            + 'Moskovasta 1. helmikuuta 1891 etsimään yrttiä, jonka '
            + 'kerrottiin auttavan spitaalia sairastavia. Kesäkuun 22. '
            + 'päivänä 1891 hän lähti Jakutskista kohti Viljuiskia: edessä '
            + 'oli kolmetuhatta virstaa ratsain. Saattajina olivat '
            + 'virkamies Sergei Petrov, joka toimi tulkkina, ja kasakka '
            + 'Prokofjev. Piispa Meletios antoi hänelle näytteen etsitystä '
            + 'kasvista, mutta parannuskeinoa siitä ei tullut. Vuonna 1892 '
            + 'Marsden valittiin Kuninkaallisen maantieteellisen seuran '
            + 'jäseneksi, ja seuraavana vuonna ilmestyi hänen '
            + 'matkakirjansa. Viljuiskiin avattiin 1897 spitaalisairaala.',
          selite: 'Ratsastajat lähdössä matkaan suuren hirsitalon edestä; '
            + 'kuva on karkearakeinen mustavalkoinen painate. Talon seinä '
            + 'on salvottu paksuista hirsistä, ikkunoissa on veistetyt '
            + 'pielilaudat ja avatut luukut, ja yläkerroksen seinää kiertää '
            + 'rivi pyöreitä koristeita. Keskellä on pylväiden kannattama '
            + 'katettu porttikäytävä. Talon edessä seisoo rivi vaaleita '
            + 'hevosia. Vasemmalla satulassa istuu hahmo leveälierisessä '
            + 'hatussa ja pitkässä viitassa, oikeassa reunassa toinen '
            + 'ratsastaja lakissaan. Hevosten välissä seisoo kolme miestä, '
            + 'joista kaksi on univormussa ja lakissa. Hevosten selkään on '
            + 'sidottu suuria kuormia ja peitteitä. Maa on paljasta '
            + 'hiekkaa.',
          lahde: 'Unknown author, Wikimedia Commons (PD)',
        },
        {
          otsikko: 'Rauta hampaita vasten, suu resonaattorina',
          tiedosto: 'Якутск, ул.Кирова,31, Музей и Центр хомуса народов мира, 22.06.2013 - panoramio (5).jpg',
          teksti: 'Khomus on jakuuttien munniharppu: hevosenkengän muotoinen '
            + 'rautakehys, jonka keskellä värähtelee ohut kieleke. Soittaja '
            + 'painaa kehyksen hampaitaan vasten ja näpäyttää kielekettä; '
            + 'ääni syntyy kielekkeen värähtelystä, ja suuontelo toimii '
            + 'kaikukoppana — sävy muuttuu suun muotoa vaihtamalla. '
            + 'Jakutskin Kirovinkadulla avattiin 30. marraskuuta 1990 '
            + 'maailman kansojen khomusin museo, jonka pohjana oli '
            + 'professori Ivan Aleksejevin kokoelma; soittimia on 1 613 ja '
            + 'maita 52. Spiridon Šišigin oli 1991 niiden ensimmäisten '
            + 'joukossa, joille myönnettiin maailman khomusvirtuoosin '
            + 'arvonimi, ja vuonna 2011 kaupungin sirkustalossa soitti yhtä '
            + 'aikaa 1 344 khomusistia.',
          selite: 'Lasivitriini khomusmuseossa. Vaalean puukiekon päälle on '
            + 'pystytetty rivi metallisia munniharppuja. Jokaisen kehys on '
            + 'taottu omanlaisekseen: yksi muistuttaa pöllöä pyöreine '
            + 'silmineen, toinen on viuhkamainen ja sahalaitainen, '
            + 'kolmannen päällä istuu lintu, neljäs on siivet levällään '
            + 'lentävä lintu. Kehysten keskeltä työntyy ulos ohut suora '
            + 'kieleke. Kiekolla on myös pieni kirjava kivipallo, ja '
            + 'etureunassa lepää yksi soitin vaakatasossa. Kiekon molemmin '
            + 'puolin on selostekortit, vaaleanpunainen ja valkoinen, '
            + 'joissa on kyrillistä tekstiä. Taustalla erottuu sumeana '
            + 'museon puinen sisustus.',
          lahde: 'Vadim Zhivotovsky, Wikimedia Commons (CC BY 3.0)',
          wiki: 'Munniharppu',
          musiikki: 'https://music.apple.com/fi/album/sing-my-khomus-live/1794380412?i=1794383325',
          musiikkiNimi: 'Spiridon Šišigin: Sing My Khomus Apple Musicissa',
    ...
    },
    {
      ...
      johdanto: 'Kaupungin alla maa on jäässä yli kahdensadan metrin '
        ...
        + 'jokea reunustaa kymmenien kilometrien mittainen '
        + 'kalkkikivipylväiden rivistö.',
      nostot: [
        {
          otsikko: 'Kauppias kaivatti yhdeksän vuotta',
          tiedosto: 'Музей истории изучения вечной мерзлоты, Институт мерзлотоведения СО РАН, Республика Саха (Якутия).jpg',
          teksti: 'Suuresta Ustjugista kotoisin ollut kauppias Fjodor Šergin, '
            + 'Venäjän-Amerikan komppanian konttorin johtaja Jakutskissa, '
            + 'alkoi kesällä 1828 kaivattaa pihaansa kuilua vettä varten. '
            + 'Vuoteen 1837 mennessä kuilu oli runsaat 116 metriä syvä, '
            + 'eikä vettä tullut: maa oli jäässä koko matkan. Aleksandr '
            + 'Middendorff mittasi kuilun lämpötiloja marraskuusta 1844 '
            + 'toukokuuhun 1846 ja päätteli ikiroudan paksuudeksi 187–204 '
            + 'metriä; 1900-luvun kairaukset antoivat 210–214 metriä. '
            + 'Jakutskiin perustettiin 1960 ikiroutainstituutti, jonka '
            + 'maanalainen tutkimuskäytävä kulkee 12–15 metrin syvyydessä.',
          selite: 'Opastettu ryhmä ikiroutainstituutin maanalaisessa '
            + 'käytävässä. Katto ja seinien yläosa ovat paksun huurteen '
            + 'peitossa: jääkiteet ovat kasvaneet lehtimäisiksi ja '
            + 'neulamaisiksi tupsuiksi, jotka riippuvat katosta alaspäin '
            + 'yhtenäisenä röyhelönä. Alempana seinä on paljasta harmaata '
            + 'maata, jonka pinta on juovainen. Vasemmalla seisoo mies '
            + 'mustassa pipossa ja harmaankirjavassa takissa; hän puhuu ja '
            + 'pitää kättään koholla. Hänen edessään on joukko kuulijoita '
            + 'selin kameraan, kaikilla paksut talvitakit. Takaseinällä '
            + 'hohtavat punaiset numerot.',
          lahde: 'Тереховская Полина Юрьевна, Wikimedia Commons (CC BY 4.0)',
          wiki: 'Ikirouta',
        },
        {
          otsikko: 'Pää, joka odotti jäässä 18 000 vuotta',
          tiedosto: 'Skeleton of the mammoth in the Yakutsk Museum.jpg',
          teksti: 'Jakutiasta on löytynyt mammutinjäänteitä enemmän kuin '
            + 'mistään muualta, ja Jakutskiin perustettiin 1991 Pjotr '
            + 'Lazarevin aloitteesta mammuttimuseo; kokoelmassa on yli 2 '
            + '000 luulöytöä. Vuonna 2002 Jukagirin kylän lähistöltä '
            + 'kaivettiin esiin urosmammutin pää, jossa oli tallella '
            + 'nahkaa, vasen korva ja silmäkuoppa; nahka oli paikoin kahden '
            + 'senttimetrin paksuista. Syöksyhampaiden perusteella eläin '
            + 'oli kuollessaan 40–45-vuotias, ja se eli noin 18 000 vuotta '
            + 'sitten. Löytöä tutkivat 2003–2004 asiantuntijat muun muassa '
            + 'Yhdysvalloista, Ranskasta, Alankomaista ja Japanista.',
          selite: 'Mammutin luuranko museosalissa alaviistosta kuvattuna. '
            + 'Luut ovat ruskeanharmaat, ja kallo kääntyy oikealle katsojaa '
            + 'kohti: silmäkuoppa, leukaluu ja poskihampaat erottuvat. '
            + 'Kallosta lähtee kaksi pitkää syöksyhammasta, jotka kaartuvat '
            + 'alas ja sisäänpäin ja ovat väriltään tummanruskeat. '
            + 'Kylkiluut muodostavat tiheän kaaren, ja paksut jalkaluut '
            + 'seisovat hiekanvärisellä alustalla. Luurankoa tukevat '
            + 'siniharmaat metallitangot. Lattia on ruudutettu harmaalla, '
            + 'valkoisella ja vaaleanpunaisella laatalla, katossa on '
            + 'alaslaskettu levykatto ja pyöreitä kohdevaloja, ja '
            + 'vasemmalla näkyy näyttelyvitriini.',
          lahde: 'JukoFF, Wikimedia Commons (CC BY 4.0)',
          wiki: 'Villamammutti',
        },
        {
          otsikko: 'Kivinen aita joen rannalla',
          tiedosto: 'Белые ночи на территории ЛС.jpg',
          teksti: 'Lenan pilarit reunustavat jokea Jakutskista ylävirtaan. '
            + 'Kallio on kambrikautista kalkkikiveä, joka kerrostui matalan '
            + 'meren pohjalle. Pylväät itsessään ovat paljon nuorempia: '
            + 'Siperian alusta kohosi, kallioon repesi rakoja, ja '
            + 'rapautuminen sekä karstiliukeneminen syvensivät niitä '
            + 'pystysuoriksi kuiluiksi. Seinämä nousee paikoin yli '
            + 'kahdensadan metrin korkeuteen joen pinnasta ja jatkuu rantaa '
            + 'pitkin kymmenien kilometrien matkan. Lenan pilarien '
            + 'luonnonpuisto otettiin Unescon maailmanperintöluetteloon '
            + 'vuonna 2012; sen pinta-ala on yli miljoona hehtaaria.',
          selite: 'Lenan pilarit ilta-auringossa. Vasemmalta kuvan poikki '
            + 'jatkuu kalkkikiviseinämä, joka on halkeillut kapeiksi '
            + 'pystysuoriksi pylväiksi; kivi on vaaleanruskeaa ja '
            + 'kellertävää, ja huiput ovat teräviä. Seinämä madaltuu '
            + 'vähitellen oikealle ja häviää kaukaisuuteen matalana '
            + 'kalliolinjana. Pylväiden juurella kasvaa tiheää havumetsää, '
            + 'ja sen alla on kapea vaalea hiekkarantakaistale. Etualalla '
            + 'on tyyni joki, jonka pintaan kallio ja metsä heijastuvat '
            + 'pitkinä juovina. Taivas on vaalea ja pilvinen.',
          lahde: 'VasilyevaED, Wikimedia Commons (CC BY-SA 4.0)',
          wiki: 'Lena',
        },
      ],
      tehtava: {
        kysymys: 'Mitä Fjodor Šergin etsi, kun hän kaivatti Jakutskiin yli '
          + 'sadan metrin syvyisen kuilun?',
        vaihtoehdot: [
          'Vettä',
          'Kultaa',
          'Mammutinluuta',
        ...
        oikea: 0,
        fakta: 'Šerginin kuilu antoi ensimmäiset syvältä mitatut lämpötilat '
          + 'jäätyneestä maasta ja todisti ikiroudan tieteelle; kaivun '
          + 'kulut jäivät kuitenkin kauppiaan omaan piikkiinsä. Kaivanto on '
          + 'yhä olemassa: se kuuluu nykyään Jakutskin ikiroutainstituutin '
          + 'museokohteisiin yhdessä maanalaisen tutkimuskäytävän kanssa.',
      },
    },
  ],
  magadan: [
    {
      id: 'kaupunki',
      nimi: 'Magadan',
      johdanto: 'Nagajevanlahden rannalle alettiin rakentaa koulua ja '
        + 'sairaalaa 22. kesäkuuta 1929, ja kymmenen vuotta myöhemmin '
        + 'työläisasutuksesta tuli kaupunki. Rautatietä tänne ei ole: ainoa '
        + 'maayhteys muualle on 2 032 kilometrin mittainen Kolyman valtatie '
        + 'Jakutiaan.',
      kansikuvat: [
        {
          tiedosto: 'The Bay of Nagaev, Magadan.jpg',
          selite: 'Nagajevanlahden ranta syyspäivänä. Oikealla kohoaa '
            + 'nurmikummulla valkoinen majakkatorni, jonka jalustan '
            + 'alareunaa kiertää punainen nauha ja jonka kylkeen on jätetty '
            + 'pystyriviin neljä pientä tummanvihreää ikkunaa. Tornin '
            + 'huipulla on musta kaide ja sen sisällä tumma lyhtykoppi, '
            + 'jalustan seinässä tummanpunainen ovi. Kummun poikki kulkee '
            + 'kivetty polku, betoniportaita ja teräskaiteita, ja etualalla '
            + 'nurmella makaa paksuja ajopuunrunkoja. Vasemmalla '
            + 'levittäytyy tyyni lahti, jonka takana kohoavat siniharmaat, '
            + 'loivakaartoiset vaarat. Rannassa kulkee kapea asfalttitie ja '
            + 'yksi ohut lyhtypylväs. Taivas on sininen ja täynnä valkoisia '
            + 'poutapilviä.',
          lahde: 'Евгений Пиманов, Wikimedia Commons (CC BY-SA 4.0)',
        },
        {
          tiedosto: 'Trinity Cathedral in Magadan.jpg',
          selite: 'Pyhän Kolminaisuuden katedraali matalassa talviauringossa. '
            + 'Valkoisesta rakennuksesta nousee kolme suurta kullattua '
            + 'sipulikupolia; keskimmäinen on korkein, ja jokaisen huipulla '
            + 'on kultapallo ja koristeellinen risti, jonka alin poikkipuu '
            + 'on vinossa. Kupolit lepäävät valkoisilla lieriötorneilla, '
            + 'joissa on korkeita kaariaukkoja; oikeanpuoleisen aukosta '
            + 'erottuu kello. Kattolinjan muodostaa rivi puoliympyrän '
            + 'muotoisia kaaria. Seinät on jaettu leveisiin '
            + 'pystypilareihin, joiden välissä on kapeita kaari-ikkunoita. '
            + 'Keskellä on kaareva sisäänkäyntikatos, jonka päällä on '
            + 'pienempi kullattu kupoli ja jonka otsassa on pyöreä '
            + 'mosaiikkikuva. Katokselle nousee leveä kiviportaikko, ja sen '
            + 'molemmin puolin kaartuu valkoinen pylväskaide.',
          lahde: 'Евгений Пиманов, Wikimedia Commons (CC BY-SA 4.0)',
        },
        {
          tiedosto: 'Lenin Avenue in Magadan.jpg',
          selite: 'Leninin valtakatu aurinkoisena päivänä. Kadun varrella '
            + 'seisoo pitkä rivi vaaleankeltaisia nelikerroksisia taloja, '
            + 'joilla on tummanpunaiset katot; katonreunaa kiertää musta '
            + 'metallikaide, ja sen lomassa seisoo rivi valkoisia jalustoja '
            + 'pienine kivimaljakoineen. Lähimmän talon keskiosassa on '
            + 'korkeat pilasterit ja niiden yllä kaareva koristepääty. '
            + 'Talojen edessä on rivi havupuita, jotka yltävät toisen '
            + 'kerroksen ikkunoihin, ja niiden lomassa lyhtypylväitä. Kadun '
            + 'poikki on maalattu suojatie, ja liikennemerkkien joukossa '
            + 'erottuu nopeusrajoitus 40. Oikealla ajaa punavalkoinen '
            + 'pikkubussi ja muutama henkilöauto. Etualalla kävelee kolme '
            + 'ihmistä, joista yhdellä on keltainen kassi. Taivaalla on '
            + 'valkoisia ja harmaita pilviä, ja katua halkovat sähköjohdot.',
          lahde: 'Евгений Пиманов, Wikimedia Commons (CC BY-SA 4.0)',
        },
      ],
      nostot: [
        {
          otsikko: 'Sitsikaupunki kahden lahden välissä',
          tiedosto: 'Marchekan and Magadan.jpg',
          teksti: 'Ivan Molodyhin vesitutkimusretkikunta suositteli '
            + 'Nagajevanlahtea sataman paikaksi ja tienrakennuksen '
            + 'lähtökohdaksi, ja Olan piirin toimeenpaneva komitea päätti '
            + '13. lokakuuta 1928 rakentaa lahden rannalle kulttuuriaseman. '
            + 'Asuintalot, koulu, sairaala ja asuntola alkoivat nousta 22. '
            + 'kesäkuuta 1929. Marraskuussa 1931 höyrylaiva Slavstroi toi '
            + 'Kaukoidän armeijasta kotiutettuja miehiä, ja asukasluku '
            + 'nousi kertaheitolla viidestäsadasta kahteentuhanteen. '
            + 'Telttojen kaupunginosaa sanottiin sitsikaupungiksi, ja sen '
            + 'telttakatu nimettiin armeijan komentajan Vasili Bljuherin '
            + 'mukaan; nykyään se on Nagajevan katu. Kaupunkioikeudet '
            + 'tulivat 14. heinäkuuta 1939.',
          selite: 'Magadan kuvattuna kukkulalta kesäpäivänä. Matalien talojen '
            + 'ja kerrostalojen meri täyttää kuvan keskiosan ja jatkuu '
            + 'oikealle meren rantaan asti, jossa vesi näkyy kapeana '
            + 'sinisenä kaistaleena. Kaupungin takana kohoaa pitkä, '
            + 'loivarinteinen vaara, jonka kupeissa on vielä valkoisia '
            + 'lumilaikkuja; oikealla vaaran yllä lepää ohut pilviharso. '
            + 'Etualalla kasvaa tiheää matalaa pensaikkoa, jonka keskeltä '
            + 'nousee kaksi korkeaa ristikkomastoa ja kaareva katuvalaisin. '
            + 'Alimpana näkyy betonilaatta, jolla on rivi pieniä harmaita '
            + 'rakenteita, ja oikealla vaaleita lohkareita. Taivas on '
            + 'kirkkaan sininen ja pilvetön.',
          lahde: 'frage23, Wikimedia Commons (CC BY 2.0)',
          wiki: 'Magadan',
        },
        {
          otsikko: 'Kukkulalle nousivat viidentoista metrin kasvot',
          tiedosto: 'Маска Скорби.jpg',
          teksti: 'Sverdlovskissa 1925 syntynyt kuvanveistäjä Ernst '
            + 'Neizvestny oli asunut Yhdysvalloissa neljätoista vuotta, kun '
            + 'hän toi kesällä 1990 Magadaniin diakuvat '
            + 'muistomerkkiluonnoksestaan. Paikan ehdotti arkkitehti Kamil '
            + 'Kozajev: Krutaja-kukkulalla oli aikanaan toiminut Transitka, '
            + 'kauttakulkupaikka josta vankisaattueet lähetettiin Kolyman '
            + 'leireille. Viisitoistametrinen Surun maski paljastettiin 12. '
            + 'kesäkuuta 1996. Vasemmasta silmästä valuvat kyyneleet ovat '
            + 'pieniä naamioita, oikea silmä on ristikoitu ikkuna, ja '
            + 'monumentin sisään on tehty vankisellin jäljennös. '
            + 'Kozajevilta on peräisin myös ajatus muuttaa muistomerkki '
            + 'museoksi.',
          selite: 'Surun maski alhaalta kuvattuna. Harmaa kulmikas ihmiskasvo '
            + 'kohoaa kuvan keskeltä taivasta vasten niin, että ylälaita '
            + 'jää kauas katsojan yläpuolelle. Oikealla poskella valuu '
            + 'ylhäältä alas jono pieniä naamioita, joissa erottuu silmiä '
            + 'ja suita; samanlaisia naamioita on rivissä myös pään '
            + 'ylälaidalla. Vasemmalla työntyy ulos suuri kulmikas lohkare, '
            + 'jonka alle jää syvä varjo, ja sen alapuolella kulkee kapea '
            + 'metalliportaikko. Poskea halkoo viisto harjanne. Alareunaa '
            + 'kehystävät suuret rosoiset graniittilohkareet. Taivas on '
            + 'syvänsininen, ja siinä ajelehtii valkoisia kumpupilviä.',
          lahde: 'Сергей Ковалев, Wikimedia Commons (CC BY-SA 4.0)',
          wiki: 'Ernst Neizvestny',
        },
        {
          otsikko: 'Levyjonoja hillitsi ratsupoliisi',
          tiedosto: 'Магадан, Карла Маркса, 30 20240904 01.jpg',
          teksti: 'Vadim Kozin syntyi 1903 Pietarissa kauppiaan ja '
            + 'romanikuorosuvun tyttären poikana ja aloitti uransa '
            + 'mykkäelokuvien säestäjänä. 1930-luvun Leningradissa hänen '
            + 'gramofonilevyjään jonotettiin niin, että järjestystä '
            + 'pitämään kutsuttiin ratsupoliisi, ja hän kertoi laulaneensa '
            + 'yhdessä konsertissa jopa neljäkymmentä laulua ilman '
            + 'mikrofonia. Toukokuussa 1944 hänet pidätettiin ja tuomittiin '
            + 'seuraavana vuonna kahdeksaksi vuodeksi leirille; Magadanissa '
            + 'hän työskenteli musiikki- ja draamateatterissa. '
            + 'Vapauduttuaan hän jäi kaupunkiin ja kuoli siellä 1994. '
            + 'Lauluja hän sävelsi noin kolmesataa, tunnetuimpina Osen ja '
            + 'Ljubuška.',
          selite: 'Magadanin musiikki- ja draamateatteri iltavalossa. '
            + 'Kolmikerroksisen talon seinät on maalattu hiekankeltaisiksi, '
            + 'ja niitä jäsentävät valkoiset pilasterit. Pääsisäänkäynnin '
            + 'edessä on neljän valkoisen nelikulmaisen pilarin rivi, '
            + 'joiden yläpäissä on tummat koristekapiteelit. Katonreunalla '
            + 'seisoo rivissä neljä tummaa ihmishahmoa: ensimmäinen '
            + 'kohottaa pitkän esineen kasvoilleen, toinen pitelee soitinta '
            + 'olkapäätään vasten. Osa katutason ikkunoista on peitetty '
            + 'harmailla luukuilla, ja pilarien välissä roikkuu kirjava '
            + 'pystybanneri. Talon edessä on tiilipintainen koroke, mustia '
            + 'lyhtypylväitä ja pysäköintimerkkejä. Illan pilvet hohtavat '
            + 'vaaleanpunaisina.',
          lahde: 'Bok, Wikimedia Commons (CC BY-SA 4.0)',
          musiikki: 'https://music.apple.com/fi/album/%D0%BE%D1%81%D0%B5%D0%BD%D1%8C/1707574060?i=1707574190',
          musiikkiNimi: 'Vadim Kozin: Osen Apple Musicissa',
    ...
    },
    {
      ...
      johdanto: 'Magadanin luonnonsuojelualue perustettiin 1982, ja sen 883 '
        ...
        + 'kilometrejä. Yhdellä niistä, Jamskin saarilla, pesii yli '
        + 'kymmenen miljoonaa merilintua.',
      nostot: [
        {
          otsikko: 'Kalliot, joilla lintuja lasketaan miljoonissa',
          tiedosto: 'Ямские острова. Остров Матыкиль.jpg',
          teksti: 'Jamskin saaret ovat pieni saariryhmä Šelihovinlahden '
            + 'eteläosassa Pjaginan niemimaan itäpuolella: Matykil, Atykan, '
            + 'Baran, Katemaljuu ja Kokontse. Niillä pesii yli kymmenen '
            + 'miljoonaa merilintua, ja pelkästään myrskylintuja on noin '
            + 'miljoona — lajilla ei ole Kaukoidässä suurempaa yhdyskuntaa. '
            + 'Vuorovesi nousee ja laskee saarten välissä kuudesta '
            + 'kahdeksaan metriin ja virta yltää kymmeneen kilometriin '
            + 'tunnissa, joten pienellä veneellä liikkuminen on '
            + 'vaarallista; myrskyssä aallot kohoavat viiteen tai kuuteen '
            + 'metriin. Matykil nousee noin 700 metriin, ja sen rannalla on '
            + 'Ohotanmeren pohjoisin paikka, jossa stellerinmerileijonat '
            + 'saavat poikasensa.',
          selite: 'Kallioinen saari nousee merestä usvan keskeltä. Terävät '
            + 'huiput ja jyrkät seinämät hohtavat matalassa auringossa '
            + 'kullanruskeina, ja kallionkielekkeitä peittää paikoin vihreä '
            + 'sammal- ja ruohokasvusto. Vasemmalla, kauempana, siintää '
            + 'usvan takaa toinen sahalaitainen kallioryhmä. Yksi lintu '
            + 'lentää kuvan vasemmalla puolella siivet levällään, ja '
            + 'seinämien edessä näkyy pieniä vaaleita lintuja. '
            + 'Rantaviivassa erottuu kivikkoa. Merenpinta on lähes tyyni, '
            + 'ja kalliot piirtyvät siihen pitkinä väreilevinä '
            + 'heijastuksina. Taivaalla on tummia ja vaaleita pilviä.',
          lahde: 'Екатерина Васягина, Wikimedia Commons (CC BY-SA 4.0)',
          wiki: 'Ohotanmeri',
        },
        {
          otsikko: 'Selkään kasvaa kyttyrä matkan varrella',
          tiedosto: 'Лососевая путина.jpg',
          teksti: 'Kyttyrälohi on tyynenmerenlohista pienin ja levinnein: '
            + 'keskipaino on 2,2 kiloa, ja suurin tunnettu yksilö oli 76 '
            + 'senttiä pitkä ja painoi seitsemän kiloa. Meressä selkä on '
            + 'sinivihreä ja kyljet hopeiset, mutta jokeen palatessa väri '
            + 'haalistuu ja koiraalle kasvaa selkään selvä kyttyrä, josta '
            + 'laji on saanut nimensä. Kutuaika alkaa heinäkuussa ja jatkuu '
            + 'lokakuun alkuun. Naaras kaivaa pyrstöevällään pohjaan '
            + 'kuoppia, ja hedelmöittyneet mätimunat haudataan kutukummun '
            + 'alle. Poikaset kuoriutuvat marras–tammikuussa ja laskeutuvat '
            + 'mereen touko–kesäkuussa kolmisenttisinä. Kudun jälkeen '
            + 'emokala kuolee.',
          selite: 'Lohia tiiviissä parvessa kirkkaan veden alla. Kaloja on '
            + 'kymmenittäin päällekkäin ja vierekkäin, lähes kaikki samaan '
            + 'suuntaan kääntyneinä. Selät ovat vihertävän harmaat ja '
            + 'täynnä suuria mustia soikeita täpliä, kyljet hopeanvalkoiset '
            + 'ja evät läpikuultavat. Yhdellä kalalla suu on raollaan, ja '
            + 'useilla silmä erottuu selvästi. Vasemmassa alalaidassa yhden '
            + 'kalan kyljessä on avoin vaaleanpunainen haava. Pohjalla on '
            + 'pyöreitä vaaleita kiviä, joita peittää vihreä levä.',
          lahde: 'Кирилл Уютнов, Wikimedia Commons (CC BY-SA 4.0)',
          wiki: 'Kyttyrälohi',
        },
        {
          otsikko: 'Keltainen nokka lohijoen yllä',
          tiedosto: 'Белоплечий орлан - краснокнижный вид.jpg',
          teksti: 'Kuningasmerikotka pesii Ohotanmeren rannoilla, '
            + 'Kamtšatkassa, Amurin alajuoksulla, Pohjois-Sahalinilla ja '
            + 'Šantarinsaarilla. Naaras painaa parhaimmillaan yli yhdeksän '
            + 'kiloa ja on selvästi koirasta suurempi, ja siipiväli yltää '
            + 'yli kahteen metriin. Nokka on luultavasti järein kaikista '
            + 'nykyisistä kotkista, ja se on keltainen jo nuorilla '
            + 'linnuilla. Varpaat ovat lyhyet ja vahvat, niiden alapinnalla '
            + 'on piikkejä ja kynnet ovat lyhyet ja voimakkaasti '
            + 'koukistuneet; kaikki tämä auttaa pitämään kiinni liukkaasta '
            + 'saaliista, sillä ravinto on enimmäkseen kalaa, etenkin '
            + 'lohikaloja. Pesä kasvaa vuosien korjailussa kolme metriä '
            + 'leveäksi ja kaksi metriä korkeaksi.',
          selite: 'Kuningasmerikotka lennossa sivulta kuvattuna. Siivet ovat '
            + 'nousemassa ylöspäin, ja niiden kärkisulat erottuvat '
            + 'toisistaan sormien tavoin. Höyhenpuku on tummanruskea, mutta '
            + 'siiven etureunassa on leveä valkoinen kaistale, ja pyrstö '
            + 'sekä sääret ovat valkoiset. Nokka on suuri, '
            + 'oranssinkeltainen ja raollaan. Keltaisissa varpaissa roikkuu '
            + 'saalis: vaalea kuollut lintu, jonka ohuet jalat ja yksi '
            + 'sulka riippuvat alaspäin. Taustalla on epätarkka vihreä '
            + 'lehtipuurinne.',
          lahde: 'Кирилл Уютнов, Wikimedia Commons (CC BY-SA 4.0)',
          wiki: 'Kuningasmerikotka',
        },
      ],
      tehtava: {
        kysymys: 'Mitä kyttyrälohelle tapahtuu kudun jälkeen?',
        vaihtoehdot: [
          'se kuolee',
          'se palaa mereen talvehtimaan',
          'se jää jokeen vartioimaan mätiä',
          'se vaeltaa seuraavaan jokeen',
        ],
        oikea: 0,
        fakta: 'Kyttyrälohen kierto kestää kudusta kutuun kaksi vuotta: mäti '
          + 'kuoriutuu talvella pohjasoraan, poikanen lähtee mereen '
          + 'alkukesästä ja palaa jokeen seuraavana kesänä. Kutu on kalan '
          + 'viimeinen työ, ja kaksivuotinen kierto näkyy siinä, että '
          + 'kannan runsaus vaihtelee joka toinen vuosi.',
      },
    },
  ],
  kamtsatka: [
    {
      id: 'kaupunki',
      nimi: 'Kamtšatka',
      johdanto: 'Niemimaa Ohotanmeren, Beringinmeren ja Tyynenmeren välissä '
        + 'on noin 1 200 kilometriä pitkä ja pinta-alaltaan neljänneksen '
        + 'Suomea pienempi. Sen satamakaupunki Petropavlovsk sai nimensä '
        + 'kahdesta laivasta, jotka tulivat lahdelle talvehtimaan 1740.',
      kansikuvat: [
        {
        ...
        },
        {
          ...
          selite: 'Vitus Beringin muistomerkki Petropavlovskissa. '
            + 'Metallipylväs on muotoiltu tykinputkeksi, ja sen huipulla '
            + 'lepää lootuskukassa tykinkuula. Jalustan kilvessä on omistus '
            + 'Petropavlovskin perustajalle, merenkulkija Beringille, ja '
            + 'vuosi 1740.',
        ...
        },
        {
          ...
          selite: 'Kolmen veljen kalliot Avatšanlahden suulla. Kolme '
            + 'kivipaadetta kohoaa merestä lahdensuun reunassa, ja ne ovat '
            + 'Petropavlovskin tunnus. Tarina kertoo veljeksistä, jotka '
            + 'asettuivat hyökyaallon tielle kaupungin edestä ja jäivät '
            + 'kiveksi.',
      ...
      nostot: [
        {
          ...
          teksti: 'Merenkulkija Ivan Jelagin lähti Vitus Beringin käskystä '
            + 'Ohotskista syksyllä 1739, talvehti Kamtšatkalla ja purjehti '
            + 'seuraavana keväänä Bolšeretskista niemimaan eteläkärjen '
            + 'ympäri Avatšanlahdelle 10. kesäkuuta 1740. Syyskuun 20. '
            + 'päivänä hän ilmoitti, että rantaan oli valmistunut yhteen '
            + 'liitetty asuinrakennus viisine huoneineen, kolme kasarmia ja '
            + 'kolme kaksikerroksista aittaa. Syyskuun lopulla lahdelle '
            + 'saapui Aleksei Tširikovin pakettivene Pyhä apostoli Paavali '
            + 'ja 6. lokakuuta Beringin Pyhä apostoli Pietari. Satama sai '
            + 'nimensä aluksilta, ja jälkimmäistä päivää — uutta lukua 17. '
            + 'lokakuuta — pidetään kaupungin perustamispäivänä.',
        ...
        },
        {
          ...
          teksti: 'Stepan Krašeninnikov syntyi Moskovassa 1711 ja lähti '
            ...
            + 'Retkikunnan professorit Gmelin ja Müller lähettivät hänet '
            + 'edeltä Ohotskiin ja Kamtšatkaan, ja niemimaalla hän vietti '
            + 'neljä vuotta 1737–1741 kirjaten kasveja, eläimiä, kivilajeja, '
            + 'tulivuoria, kieliä ja tapoja. Kamtšatkan maan kuvaus ilmestyi '
            + 'vuonna 1755. Tekijä kuoli Pietarissa saman vuoden '
            + 'helmikuussa, ja Nikolai Karamzin kertoi vuonna 1802 hänen '
            + 'kuolleen juuri sinä päivänä, jona kirjan viimeinen arkki tuli '
            + 'painosta.',
        ...
        },
        {
          ...
          teksti: 'Itelmeenien oma nimitys tarkoittaa suunnilleen olevaa tai '
            ...
            + 'pani merkille, että itelmeenit moittivat tätä liiasta '
            + 'ahkeruudesta: vuoria, jyrkänteitä, kareja ja koskisia jokia '
            + 'oli tehty enemmän kuin kukaan tarvitsi. Jasakkikirjoista on '
            + 'arvioitu, että itelmeenejä oli 1697 noin 12 680 ja 1738 enää '
            + '8 448.',
          selite: 'Kamtšadaaleja Natšikin kylässä vuonna 1904. Aikuiset ja '
            + 'lapset seisovat puisen kuivaustelineen ääressä, jonka '
    ...
    },
    {
      ...
      nostot: [
        {
          ...
          teksti: 'Kljutševskaja sopka kohoaa 4 750 metriin: se on niemimaan '
            + 'korkein vuori ja Euraasian korkein toimiva tulivuori. Vuori '
            + 'purkautui kirjatusti ensi kerran 1697, eikä se ole sen '
            + 'jälkeen juuri levännyt. Ensimmäisen tunnetun nousun huipulle '
            + 'tekivät 1788 Daniel Gauss ja kaksi Billingsin retkikunnan '
            + 'miestä. Sen jälkeen huipulle ei kiivetty ennen vuotta 1931, '
            + 'ja tuolta retkikunnalta menehtyi useita miehiä '
            + 'laskeutumismatkalla lentäviin laavapalloihin.',
          selite: 'Kljutševskaja sopka purkauksessa kesällä 1993. '
            + 'Lumijuovaisen kartion huipulta kohoaa tumma tuhkapatsas. '
            + 'Vuori on Euraasian korkein toimiva tulivuori.',
        ...
        },
        {
          ...
          teksti: 'Petropavlovskilaiset kutsuvat kaupungin takana kohoavia '
            + 'tulivuoria kotitulivuoriksi. Korjakskaja sopka on 3 456 '
            + 'metriä korkea ja noin 35 kilometriä kaupungista pohjoiseen, '
            + 'Avatšinskaja sopka 2 741 metriä ja sammunut Kozelskaja 2 189 '
            + 'metriä; viimeksi mainitun rinteiltä on venäläisten lähteiden '
            + 'mukaan löytynyt harvinaista mustaa timanttia eli karbonadoa. '
            + 'Cookin viimeisellä matkalla mukana ollut John Ledyard kutsui '
            + 'kahta vuorta Pietariksi ja Paavaliksi ja kirjasi '
            + 'päiväkirjaansa Avatšinskajan purkauksen 15. kesäkuuta 1779.',
        ...
        },
        {
          ...
          teksti: 'Kronotskin luonnonpuiston geologi Tatjana Ustinova ja '
            ...
            + 'huhtikuussa 1941. Kevättalvi sopi matkaan, sillä koirat '
            + 'pääsivät kulkemaan hangella kesällä läpitunkemattomien '
            + 'pensaikkojen yli. Ensimmäinen heidän näkemänsä gejsiri sai '
            + 'nimen Pervenets eli esikoinen. Suuria gejsirikenttiä '
            + 'tunnetaan maailmassa vain kourallinen, ja tämä oli niistä '
            + 'viimeisiä löydettyjä — vaikka niemimaan pienempiä gejsirejä '
            + 'oli kuvannut jo Krašeninnikov 1738.',
      ...
      tehtava: {
        ...
        oikea: 0,
        fakta: 'Laakso avautui kahdelle ihmiselle ja koiravaljakolle '
          + 'keskellä kevättalvea 1941. Gejsernaja-joen varresta on '
          + 'sittemmin laskettu parikymmentä suurta gejsiriä ja satoja '
          + 'kuumia lähteitä.',
      },
    },
  ],
  ...
  vladivostok: [
    {
      ...
      johdanto: 'Kenraalikuvernööri Nikolai Muravjov-Amurski nimesi vuonna '
        + '1859 poukaman Kultaiseksi sarveksi, ja lahden nimeksi vakiintui '
        + 'Vladivostok, idän hallitsija. Seuraavana kesänä rantaan jätettiin '
        + 'sotilasosasto.',
      kansikuvat: [
        {
      ...
      nostot: [
        {
          ...
          teksti: 'Poukamalla oli jo kiinalainen nimi, ja ranskalaisia ja '
            + 'brittialuksia oli käynyt siellä 1850-luvulla, kun '
            + 'kenraalikuvernööri Nikolai Muravjov-Amurski purjehti vuonna '
            + '1859 höyrykorvetti Amerikalla Pietari Suuren lahdella. Hyvin '
            + 'suojattu poukama sai häneltä nimen Kultainen sarvi: muoto oli '
            + 'sama kuin Konstantinopolin samannimisellä lahdella. Nimi '
        ...
        },
        {
          ...
          teksti: 'Aseman perustuskivi laskettiin 19. toukokuuta 1891 vanhaa '
            + 'lukua kruununprinssi Nikolai Aleksandrovitšin läsnä ollessa, '
            + 'ja asema vihittiin käyttöön 2. marraskuuta 1893. Platon '
            + 'Basilevskin piirtämä kivitalo sai jatkoa, kun Moskovaan '
            + 'rakennettiin Jaroslavlin asemaa: insinööri Vladimir Planson '
            + 'laajensi ja korotti Vladivostokin aseman vuosina 1910–1912 '
            + 'saman vanhavenäläisen muotokielen mukaiseksi, ja ensimmäinen '
        ...
        },
        {
          ...
          teksti: 'Juli Borisovitš Briner syntyi Vladivostokissa 11. '
            + 'heinäkuuta 1920. Suku oli sveitsiläisperäinen ja varakas — '
            + 'maanomistusta, hopeakaivoshankkeita ja isoisä Jules Brinerin '
            + '1870-luvulla perustama tuonti- ja vientiliike — ja asui '
            + 'Aleutskaja-kadun nelikerroksisessa talossa. Poika päätyi '
            + 'Harbinin ja Pariisin kautta Yhdysvaltoihin, otti nimen Yul '
            + 'Brynner ja näytteli Siamin kuningasta näyttämöllä ja '
            + 'valkokankaalla. Hän kertoi olevansa äitinsä puolelta romanien '
            + 'jälkeläinen, vaikka sukututkimus ei ole sitä vahvistanut, ja '
    ...
    },
    {
      ...
      nostot: [
        {
          otsikko: 'Suurimpana pidetty tiikeri',
          tiedosto: 'Siberian Tiger enjoying snow 10.jpg',
          teksti: 'Amurintiikeriä pidetään tiikerin alalajeista suurimpana, '
            + 'joskin nykyiset yksilöt jäävät keskimäärin bengalintiikeriä '
            + 'kevyemmiksi. Vanhoissa mittauksissa uros painoi keskimäärin '
            + '215 kiloa; luonnosta punnittujen urosten keskipaino on '
            + 'nykyään 176 ja naaraiden 118 kiloa. Koko levinneisyys mahtuu '
            + 'Venäjän Kaukoitään: se venyy Primorjen mitalta lähes tuhat '
            + 'kilometriä pohjoiseen ja ulottuu eteläiseen Habarovskiin '
        ...
        },
        {
          ...
          teksti: 'Ussurin sekametsä peittää noin 187 000 neliökilometriä '
            ...
            + 'sekä Sihote-Alinin molemmin puolin. Valtapuita ovat '
        ...
        },
        {
          ...
          teksti: 'Vladimir Arsenjev (1872–1930) tutki Kaukoidän maastoja '
            + 'vuodesta 1902 ja teki Sihote-Alinille retkiä muun muassa 1906 '
            + 'ja 1907–1908. Oppaakseen hän sai nanaimetsästäjän Dersu '
            + 'Uzalan (noin 1849–1908), josta tuli hänen kirjojensa '
            + 'keskushahmo. Vanhetessaan metsästäjän näkö heikkeni eikä '
            + 'kaupunkielämä sopinut hänelle; keväällä 1908 hän palasi '
            + 'taigaan Arsenjevilta saamansa uuden kiväärin kanssa, ja pian '
            + 'sen jälkeen hänet löydettiin surmattuna. Retkistä syntyivät '
      ...
      tehtava: {
        kysymys: 'Missä vuoristossa ovat amurintiikerin tärkeimmät '
