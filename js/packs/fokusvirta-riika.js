 ...
 *
 * LIVIALLE EI OLE KIRJOITETTU MAADOITUSTA. Kaanoni antaa Livialle yhden
 * kentän (pollo.teksti), ja Livian ääni on päätoimittajan. Moottori
 * kelpuuttaa kaupungin ilman maadoitusta (js/fokusvirta.js: *"Kaupunki,
 * jolla on maadoitusteksti → maadoitus, kuten ennenkin"*), joten kenttä
 * jätetään Fablen kirjoitettavaksi eikä sitä arvata tässä.
 *
...
export const FOKUSVIRTA_RIIKA = {
  ...
  pollo: {
    /* KAANON (Fable) — Livian teksti sellaisenaan. Ks. tiedoston alku:
     * maadoitusta ei ole kirjoitettu, koska sitä ei ole kaanonissa. */
    teksti: 'Sitä mustaa juomaa myydään Riiassa edelleen, savipulloissa, ja '
      + 'paikalliset vannovat sen nimeen edelleen — ja turistit katuvat '
      + 'edelleen.. Vanha kaupunki on säilynyt niin ehjänä, että keskiaika '
