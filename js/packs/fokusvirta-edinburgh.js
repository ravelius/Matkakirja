 ...
 *
 * ── AJALLINEN KORJAUS TEHTY (Fable, integrointi 29.8.2026) ─────────
 *
 * Pakin alkuperäisessä merkinnässä isoisä kirjoitti elokuussa 1873,
 * että kaupunki PYSTYTTI koiralle patsaan. Greyfriars Bobbyn
 * juomakaivo paljastettiin kuitenkin vasta 15. marraskuuta 1873, eli
 * kolme kuukautta myöhemmin; pronssi oli tosin jo valettu, sillä lady
 * Burdett-Coutts tilasi sen ennen koiran kuolemaa.
 *
 * PÄÄTOIMITTAJA KORJASI KAANONIN: viimeinen virke kuuluu nyt
 * "Kaupunki aikoo pystyttää sille muistomerkin — ennen kuin pystyttää
 * sellaisen monelle ihmiselle." Sama virke on vaihdettu sekä
