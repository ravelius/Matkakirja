...
export const MAAKARTAT = {
  ...
  SYR: {
     ...
     *
     * TÄMÄ ON PELIN AINOA SVG-MAAKARTTA. Se ei ole ongelma: pelin
     * kuvaosoite on Special:FilePath?width=1000, ja testasin sen —
     * Commons rasteroi SVG:n PNG:ksi (content-type image/png). Pieni
     * kanvaasi ei siis rajoita tarkkuutta.
     *
