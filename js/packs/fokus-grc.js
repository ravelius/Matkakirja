 ...
 *
 * LEHTIKUVAT POISTUIVAT v1365:ssä (vanha lehtijärjestelmä purettiin,
 * kartta on laattapyramidi). Riveillä oli sen jälkeen yhä kenttä
 * `tiedosto: '<ISO>.webp'`, jota peli ei lukenut ja jota ämpärissä ei
 * ollut; peilaus haki niitä joka ajolla ja sai 135 × 404. Kenttä
 * poistettiin 23.9.2026. Taulu kertoo nyt vain, missä maa on laudalla.
 */
