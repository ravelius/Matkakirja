...
/*
 * ÄÄNITE ON ENNALLAAN (omistaja 17.9.2026 klo 03.40 UTC: *"Se simpukka
 * tarkoitti pulun simpukka kommenttia. Ei kertojan."*). Kertojan
 * simpukkavirke palautettiin arabia-jaksoon sanatarkasti sellaisena
 * kuin se on ämpärin luennassa, joten aikaleimat täsmäävät eikä
 * ihmisen-matka-kertomus.mp3:a uusita eikä leikata.
 */
...
export const IHMISEN_MATKA_KERTOMUS = [
  ...
  },
  {
    ...
    maisema: 'savanni',
    tunne: { tunne: 'utelias', voimakkuus: 0.35 },
  ...
  },
  {
    ...
    maisema: 'jokilaakso',
    tunne: { tunne: 'miettiva', voimakkuus: 0.4 },
  ...
  },
  {
    ...
    /*
     * PULUN SIMPUKKAKOMMENTTI ON POISTETTU (omistaja 17.9.2026 klo 03.40
     * UTC, sanatarkasti: *"Se simpukka tarkoitti pulun simpukka
     * kommenttia. Ei kertojan."*). Repliikki *"Simpukoita. Hyvä alku."*
     * on pois datasta kokonaan — sitä ei piiloteta esityksen ajaksi
     * vaan sitä ei ole. Numero 1 jää varatuksi (js/liviapuhe.js
     * LIVIAN_LINSSILAHTEET), jotta muut välihuomiot pitävät omat
     * äänitteensä.
     */
    pulu: null,
  },
  {
    ...
    tunne: { tunne: 'vakava', voimakkuus: 0.4 },
  ...
  },
  {
     ...
     *
     * VIRKE PALAUTETTU omistajan korjauksella 17.9.2026; äänite
     * ennallaan.
     */
    hiljaiset: ['blombos'],
    alue: null,
  ...
  },
  {
    ...
    tunne: { tunne: 'hammastys', voimakkuus: 0.68 },
  ...
  },
  {
    ...
    tunne: { tunne: 'vakava', voimakkuus: 0.45 },
  ...
  },
  {
    ...
    maisema: 'tundratuuli',
    tunne: { tunne: 'lammin', voimakkuus: 0.42 },
