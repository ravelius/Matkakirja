    ...
    },
    {
      ...
      kohdat: [
        ...
        'ALKUKOHTAUS V5 (omistajan teksti 25.8.2026, sanasta '
          ...
          + 'sivun?"; "Mistä aloitan?" on KEHYSTETTY 1873-NAPPI '
          + 'ilman sykettä (ei lueta; omistaja 26.8.2026 iltap. — '
          + 'kumoaa saman päivän ALOITA MATKA -välivaiheen). '
    ...
    },
    {
      ...
      kohdat: [
        ...
        'SAAPUMISSEKVENSSI (omistaja 26.8.2026, sanamuodot kaanon): '
          ...
          + '→ selvän hengähdyksen jälkeen (~1,8 s) pöllö '
          + '"Tervetuloa <maahan>. Sinun on ratkaistava tehtävä '
          + '<kaupungissa> ennen kuin voit etsiä aarretta." → tauon '
          + '(~1,6 s) jälkeen TOINEN kupla alle (ensimmäinen jää): '
          + '"Klikkaa kaupungin kultaista merkkiä kartalla." '
          + '(oikaisu 26.8: merkki EI ole vihreä — teksti kuvaa '
          + 'todellisen kultaisen kiekon). Saapumiskamera zoomaa '
          + 'LÄHEMMÄS: ~60 % maan ikkunasta, kaupunki keskellä. '
          + 'Napautusohitus '
          + 'hyppää sekvenssiin, ei yli. SAAPUMISLEIMAN päiväys on '
          + 'PELAAJAN nykyhetki laitteen kellosta (ei 1873 — '
          + 'isoisän vuosi elää vain piirroksissa ja merkinnöissä). '
          + 'Toistaiseksi vain avauslennossa; laajennus muihin '
          + 'lentoihin on oma päätös.',
