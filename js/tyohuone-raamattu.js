    ...
    },
    {
      ...
      kohdat: [
        ...
        'REITIT LAUTAPELITYYLIIN (omistaja 1.9.2026, kaappaukset: '
          ...
          + 'piirustuksia"): katkorytmi 24 -> 40 R, viiva 2,8 -> 4,0 R, '
          + 'pyoreat paat, deterministinen kasivarahuojunta (siemen '
          + 'reitista - poltto pysyy puhtaana funktiona). RINNAKKAISET '
          + 'MERIREITIT karsitaan osuuskarsinnalla (sama ura <= 16 yks '
          + 'ja <= 30 astetta -> vain yksi piirtyy; paat piirtyvat '
          + 'aina; pelimoottorin reittidataa ei kosketa). Askelhelmi '
          + 'karsitulta osuudelta jaa pois - helmi ilman viivaa olisi '
          + 'merkki tyhjassa meressa; peli kavelee silti kaikki '
          + 'askelmat. LENTOREITIT EIVAT OLE VIIVATASOSSA (omistaja: '
