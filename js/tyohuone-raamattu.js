    ...
    },
    {
      ...
      kohdat: [
        ...
        'KEVYT KULKU -KOKEILU (omistaja 24.8.2026, ilta): '
          ...
          + 'Kartan pallurat (laatta, kohde- ja matkapisteet) ovat '
          ...
          + 'KREIKAN TÄKYNOSTO VALITTU (omistaja 25.8.2026): '
          + '"Hän löysi Troijan kullan — ja puki sen vaimonsa '
          + 'ylle", miniatyyrinä Sophia Schliemannin korukuva '
          + '(sama joka on matkakirjamerkinnässä); nosto vie '
          + 'Schliemann-syvennykseen. '
