    ...
    },
    {
      ...
      kohdat: [
        ...
        'SAAPUMISSEKVENSSI (omistaja 26.8.2026, sanamuodot kaanon): '
          ...
          + '→ ~1 s: pöllö "Tervetuloa <maahan>. Sinun on '
          + 'ratkaistava tehtävä <kaupungissa> ennen kuin voit etsiä '
          + 'aarretta." → heti alle TOINEN kupla (ensimmäinen jää): '
          + '"Klikkaa vihreää pistettä kartalla." Napautusohitus '
