...
import { livianLuentatyo } from './livia-pilotti-cuet.js';
...
export async function tarkistaLivianPilottiData(data,
  ...
  const tyo = livianLuentatyo(kaupunki, kentta, kupla);
  ...
  if (data.revision !== tyo.revision || data.kaupunki !== tyo.kaupunki || data.avain !== tyo.avain) {
