...
export const LIVIAN_MIETINNAT = {
  yleiset: [
    ...
    'Hetki, tarkistan asian kahdesta paikasta..',
    'Odotas, pudotin muistiinpanot katolle..',
    'Pieni hetki, tästä on jossain sähke..',
    'Nokka kiinni, minä ajattelen..',
    'Hetkinen, siivet ovat vielä märät sateesta..',
    'Odota, tämä vaatii kaksi kierrosta tornin ympäri..',
    'Annas kun kaivan tämän muistista. Siellä on ruuhkaa..',
    'Pieni hetki, pulla ensin ja tieto sitten..',
    'Hetki vain, kartta on väärinpäin..',
    'Odotas, luen sen pienellä painetun kohdan..',
    'Katsotaas, mistä tämä lankakerä alkaa..',
    'Hetkinen, kysyn asiaa oikealta linnulta..',
    'Pieni hetki, arkiston hyllyt ovat minua korkeammalla..',
    'Odota, tässä on kaksi vastausta ja minä valitsen paremman..',
    'Hetki, murut pois kirjan päältä..',
    'Annas kun istun alas. Tämä on istumakysymys..',
    'Pieni hetki, sähkekone rätisee taas..',
    'Odotas, muistin juuri jotain ja unohdin sen..',
    'Hetkinen, tämä osui johonkin minkä olen itse nähnyt..',
    'Katson tästä ikkunasta, näkyisikö vastaus..',
    'Pieni hetki, järjestän faktat riviin..',
    'Hetki, tuuli vei yhden sivun..',
  ],
  vastaus: [
    ...
    'Tämän minä tiedän. Tai tiedän kenen luota se löytyy..',
    'Hyvä että kysyit. Käyn hakemassa tarkan luvun..',
    'Tästä on kirjoitettu. Etsin mistä..',
    'Sopiva kysymys minulle. Hetki, tarkistan etten muista väärin..',
  ...
  pitkat: [
    ...
    'Kestää vielä. Löysin matkalta kaksi mielenkiintoista sivupolkua..',
    'Pian. Sain vastauksen, mutta se oli väärään kysymykseen..',
    'Vielä hetki. Tämä on isompi asia kuin miltä se näytti..',
