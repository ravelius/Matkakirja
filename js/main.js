...
const APP_VERSION = '2026-09-21.2098';
...
if (karttaValikko) {
  ...
  otsikko.className = 'valikko-aliotsikko';
  otsikko.textContent = 'Tarkkuus liikkeessä';
  karttaValikko.appendChild(otsikko);
  ...
  naytaTarkkuus();
  karttaValikko.appendChild(ryhma);
  karttaValikko.appendChild(vihje);
}
