...
export const TESTATTAVAA = [
  'v858 — vuosisäägraafin vaihteluvyöhyke: avaa lehden sääriviltä vuosiennuste — keskilämpökäyrän ympärillä on nyt haalea kaista kuukauden tyypillisestä ylimmästä ja alimmasta päivälämmöstä, ja asteikko venyy sen mukana pakkasen puolelle. Katso Rovaniemi (kaista pakkasella), Firenze ja Bagdad (leveä kaista) sekä Dublin (kapea); sama graafi on myös Matkailijan oppaassa',
