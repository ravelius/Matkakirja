...
export const TESTATTAVAA = [
  'v901 — kolme omistajan kaappauksista: 1) NÄHTÄVYYSJUTUN PYSTYKUVA täyttää nyt puhelimessa koko palstan (oli 46 % eli ~155 px, postimerkki) — kokeile esim. Firenze → Galleria dell\'Accademia ja muita pystykuvallisia juttuja; iPadilla mitta on ennallaan, ja tekstin lomassa olevat pikkukuvat pysyvät tarkoituksella pieninä; 2) TIETÄJÄN TIE (laukun i-nappi): nykyisen tason avatar 6,4 → 9 rem, pysyy selityksen rinnalla 360 px:n leveyteen asti ja putoaa sitä kapeammilla tekstin alle keskitettynä; 3) PÖLLÖN PALJASTUSKORTTI (uuden pelin ensimmäinen laatta): harso 62 → 90 %, vaaleat hohteet pois teksteistä ja pitkä esittely tummalla musteella — sen väri tuli aiemmin yleissäännöstä .dialog p eikä omasta lohkostaan, joten teksti oli vaaleampi kuin oli tarkoitus. Sama koskee kaikkia aarrekortteja',\n  'v900 — Istanbulin lehti nykystandardiin: 1) etusivun iso kuvapaikka selaa nyt kolmea yleisnäkymää (Kultainen sarvi hämärissä, lautat vanhankaupungin edustalla, Eminönün rantatori ylhäältä); 2) kohdekartta 6 → 10 kohteeseen — uudet ovat Süleymaniyen moskeija, Galatan silta, Sirkecin asema ja Neitsyttorni, kaikilla oma kuratoitu juttu kahdella kuvalla (kartalla numeroympyröinä, kunnes miniatyyrit generoidaan; kymmenen promptia on jonossa); 3) UUSI Matkailijalle-osio ja Matkaopas "Matkailijan Istanbul" viidellä jaksolla (liikenne ja Tünel 1875, vanhankaupungin kilometri, lautta Aasian puolelle, balık ekmek, sää ja tulppaanikuukausi). iPhone/iPad-askeleet: avaa Istanbul → etusivun karuselli 1/3–3/3, vieritä kartalle ja napauta kohteita 7–10, sitten Matkailijalle-osion "Lue lisää matkailijan oppaasta" → oppaan ensimmäisessä jaksossa kolmen kuvan karuselli',
