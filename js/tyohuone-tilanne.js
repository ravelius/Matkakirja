...
export const TESTATTAVAA = [
  'v856 — pöllö on nyt LÖYDETTÄVÄ AARRE: aloita uusi peli ja katso että alanappirivin keskipaikka on tyhjä (ei pöllöä, ei kuplia, ei ohjeita), avaa sitten ensimmäinen laatta — laatan oma aarre paljastuu normaalisti ja heti sen perään pöllö esittäytyy omalla paljastuskortillaan; sen jälkeen nappi ilmestyy riviin ja pöllö toimii kuten ennen. Ensimmäisen tietäjätason onnittelu (Utelias kulkija) odottaa löytöä ja tulee vasta sen jälkeen. Kesken oleva vanha tallennus: pöllö on heti käytössä eikä sitä tarvitse löytää uudelleen',
