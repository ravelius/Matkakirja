...
export const KAARI_TAGIT = {
  ...
  madrid: {
    puhuja: ['Horatio 1873', 'Pilar'],
    tunnetilat: ['jännitys', 'arvoitus'],
    teemat: ['mittaus', 'viesti', 'suvun jälki'],
    beat: ['tuore jälki'],
  },
  lissabon: {
    puhuja: ['Horatio 1873', 'Inês'],
    tunnetilat: ['ihmetys', 'lämpö'],
    teemat: ['kommellus', 'kesken jäänyt työ', 'tosihuomio'],
    beat: ['toinen esine muualla'],
    aisti: ['maku'],
  },
  dubrovnik: {
    puhuja: ['Horatio 1873', 'Ivo'],
    tunnetilat: ['hengähdys', 'huumori'],
    teemat: ['mittaus', 'toinen mittaaja', 'taikausko'],
    beat: ['tuore jälki'],
  },
  oslo: {
    puhuja: ['Horatio 1873', 'Sigrid'],
    tunnetilat: ['huumori', 'ihmetys'],
    teemat: ['legenda', 'suvun oma tapa', 'lupaus'],
    beat: ['tuore jälki'],
    aisti: ['maku'],
  },
  edinburgh: {
    puhuja: ['Horatio 1873', 'Ewan'],
    tunnetilat: ['huumori', 'jännitys'],
    teemat: ['kommellus', 'mittaus', 'Horation pieni pyyntö'],
    beat: ['ajaton arvoitus'],
  },
  helsinki: {
    puhuja: ['Horatio 1873', 'Aino', 'Reginald'],
    tunnetilat: ['hengähdys', 'lämpö'],
    teemat: ['mittaus', 'pieni teko', 'opetettu taito'],
    beat: ['tuore jälki'],
  },
  krakova: {
    puhuja: ['Horatio 1873', 'Stanisław'],
    tunnetilat: ['haikeus', 'arvoitus'],
    teemat: ['mittaus', 'legenda', 'keskiyön poikkeus'],
    beat: ['ajaton arvoitus'],
  },
  berliini: {
    puhuja: ['Horatio 1873', 'Lotte'],
    tunnetilat: ['arvoitus', 'ihmetys'],
    teemat: ['mittaus', 'suvun kirjaus', 'mahdoton havainto'],
    beat: ['tuore jälki'],
    motiivit: ['barometri'],
  },
  odessa: {
    puhuja: ['Horatio 1873', 'Fjodor'],
    tunnetilat: ['lämpö', 'arvoitus'],
    teemat: ['suvun oma tapa', 'merimiessolmu', 'näköharha'],
    beat: ['tuore jälki'],
    motiivit: ['isoisän merkki'],
  },
  lappi: {
    puhuja: ['Horatio 1873', 'Aslak', 'Reginald'],
    tunnetilat: ['ihmetys', 'haikeus'],
    teemat: ['legenda', 'jälkien lukeminen', 'sama käsiala'],
    beat: ['tuore jälki'],
  },
  barcelona: {
    puhuja: ['Horatio 1873', 'Mercè'],
    tunnetilat: ['arvoitus', 'huumori'],
    teemat: ['legenda', 'kesken jäänyt työ', 'kaupunki kasvaa yhä'],
    beat: ['tuore jälki'],
    motiivit: ['nykymaailma'],
  },
  kreeta: {
    puhuja: ['Horatio 1873', 'Eleni', 'Reginald'],
    tunnetilat: ['arvoitus', 'huumori'],
    teemat: ['legenda', 'lanka', 'laina ja palautus'],
    beat: ['vanha jälki', 'tuore jälki'],
    motiivit: ['nykymaailma'],
  },
  moskova: {
    puhuja: ['Horatio 1873', 'Vera', 'Reginald'],
    tunnetilat: ['jännitys', 'arvoitus'],
    teemat: ['suvun suru', 'mahdoton aika', 'mittaus'],
    beat: ['tuore jälki'],
    motiivit: ['barometri', 'nykymaailma'],
  },
  alpit: {
    puhuja: ['Horatio 1873', 'Anselm', 'Reginald'],
    tunnetilat: ['ihmetys', 'lämpö'],
    teemat: ['pelastava koira', 'löytynyt esine', 'mittaus'],
    beat: ['tuore jälki'],
    motiivit: ['barometri'],
  },
  sofia: {
