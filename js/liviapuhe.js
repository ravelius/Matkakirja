...
export const LIVIAN_KAUPUNKILAHTEET = {
  ...
  istanbul: [LIVIAN_VARATTU, 'huudahdus', ['kommentti', 3]],
  bukarest: [LIVIAN_VARATTU, 'huudahdus', ['kommentti', 2]],
  sarajevo: [LIVIAN_VARATTU, 'huudahdus', ['kommentti', 2]],
  budapest: [LIVIAN_VARATTU, 'huudahdus', ['kommentti', 2]],
  wien: [LIVIAN_VARATTU, 'huudahdus', ['kommentti', 2]],
  praha: [LIVIAN_VARATTU, 'huudahdus', ['kommentti', 2]],
  krakova: [LIVIAN_VARATTU, 'huudahdus', ['kommentti', 2]],
  varsova: [LIVIAN_VARATTU, 'huudahdus', ['kommentti', 2]],
  pietari: [LIVIAN_VARATTU, 'huudahdus', ['kommentti', 2]],
  moskova: [LIVIAN_VARATTU, 'huudahdus', ['kommentti', 2]],
  kiova: [LIVIAN_VARATTU, 'huudahdus', ['kommentti', 2]],
  odessa: [LIVIAN_VARATTU, 'huudahdus', ['kommentti', 2]],
  helsinki: [LIVIAN_VARATTU, 'huudahdus', ['kommentti', 2]],
  tampere: [LIVIAN_VARATTU, 'huudahdus', ['kommentti', 2]],
  tallinna: [LIVIAN_VARATTU, 'huudahdus', ['kommentti', 2]],
  riika: [LIVIAN_VARATTU, 'huudahdus', ['kommentti', 3]],
  vilna: [LIVIAN_VARATTU, 'huudahdus', ['kommentti', 3]],
};
