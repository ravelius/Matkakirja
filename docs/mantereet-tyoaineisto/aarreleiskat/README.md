...
## Toteutus peliin (avoin)

- js/ui.js playTokenReveal: vinjetointimalli + fakta-teksti +
  purppurakarttatausta; pääaarteille diplomikehys.
- Leiman lyöntianimaatio paljastukseen; tumma siirtymä
  (pimennys → plansi kirkastuu) ennen vaaleaa lopputilaa.
