# Työlista Opukselle — valmiit paketit ja historia (arkisto)

**ARKISTOITU 17.8.2026** (dokumenttiremontin D6,
docs/dokumenttiremontti-suunnitelma.md; päätoimittajan ohje PR
#1217:n kommentissa): docs/tyolista-opukselle.md:n valmiit paketit,
vanha viiden session Vakiokäynnistys, heinäkuun TILANNE-kuittaukset
ja kaikki päätöshistoria — sanatarkasti siirrettyinä. Elävään
työlistaan jäivät bannerilinjaukset ja avoimet paketit (O4/O6/O7).
Tämä on historiaa, ei voimassa olevaa ohjetta: linjaukset ovat
Raamatussa, reseptit docs/moduulit/-kansiossa.
