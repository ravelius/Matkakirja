...
## OMISTAJA klo 19.2x (KORTTI, SITOVA): RADIOLINSSIN UUDISTUS NATIIVISSA — RAAMATTUUN; BUILD 10 UUSINTA b9755e9:STA (TESTFLIGHT-TIIMI F72JLS57C5); TIIMISELVITYS (24.9.2026 klo 19.03)

Radiouudistus: paneeli kuvaputken tekstuureilla, VU + LCD samaan riviin, hämärä kartta, 3D-radiomastot kolmessa koossa punaisella vilkulla (valittu VU:n tahdissa, valaisee ympäristöä), radioaaltorenkaat, rahina etäisyyden mukaan, kamera-ajo asemaa vaihtaessa; Linssiseppä (uusi sessio) tekee kuvitetun suunnitelman, kuvaputkelta tekstuurit, toteutus build 12. Build 10: uusinta 36023934052 (MATKAKIRJA_TEAM=$TEAM_ID) kaatui samaan CodeSign-virheeseen → TEAM_ID on RCD77XPB7M ja CI:n varmenne kuuluu F72JLS57C5:lle; Natiivisepän hotfix b9755e9 palauttaa TestFlight-oletuksen F72JLS57C5:ksi (buildit 4–9), kehitys RCD77XPB7M; Julkaisija ajaa b9755e9:stä. Tulkinta: Individual-jäsenyydessä Personal Team -ID = maksullisen tiimin ID → F72JLS57C5 = gmail-tilin maksullinen tiimi, RCD77XPB7M = me.com-tilin; omistajalta kysytään kumman alla ASC:n Matkakirja on. Linssiseppä 71 % → luovutus -ilta ja nollaus käsketty (löydös 43 ja radiouudistus luovutukseen).
...
## OMISTAJA klo 20.1x (KORTTI): RADIOHAVAINNEKUVA 2 HYVAKSYTTY BUILD 12:N POHJAKSI; FABLE: LENNON KIERTO <= 180° (LYHYEMPI SUUNTA, MAISEMA RATKAISEE TASATILANTEEN); WEBIN LIIKU-VIAT KORJATAAN; LOYDOS 45 KORJATTU (pelikoodari/liiku-luenta 96a5a19) (24.9.2026 klo 20.14)

Omistaja hyväksyi kortilla Linssisepän toisen havainnekuvan (hämärä 0,18/0,17/0,24, Black Marble perustaso 0,5 ja valitun maston ympärillä 1,0, bloom 4 + 14 pt, mastot asukasluvun mukaan, Iso-raja 2 milj.) build 12:n toteutuksen pohjaksi: Linssiseppä paneeli ja äänet, Natiiviseppä mastot, hämärä ja yövalot (Karttasepän Z0–Z6-sarja 25.9.). Linssiseppä korjasi omistajan paneelipalautteen (punainen nappi keskelle LCD:n oikealle jäävään tilaan; iPadilla 15+30+15 pt, iPhonen LCD 260 → 240 pt) #3115:een (cd4bc7eb3). Natiiviseppä: lennon kamerareitti natiiviseppa/kamerareitti 8fe2136 (testit 37/37, video proto-3d/lokit/kamerareitti-b11k/lento.mp4, Lontoo–Ateena 20 s); kirjaimellinen maisemasääntö tuotti 360–410° kierron (Ateenassa 79°/s) → Fablen päätös: kierto rajataan enintään 180 asteeseen lyhyempään suuntaan, maisema ratkaisee vain tasatilanteen (noin 35°/s); laskun sumeat laatat ennen Z8:aa esilatauksen kautta. Pelikoodari: löydös 45 (Liiku piiloon kerronnan ajaksi) korjattu natiiviin haarassa pelikoodari/liiku-luenta 96a5a19 webin mittojen mukaan (piilossa kun isoisä, saapumispuhe tai Livia puhuu, palaa 1,3 s jälkeen; testit 271/271), merge-pyyntö Natiivisepällä, natiivikuvapari Laitetestaajalta; webin kaksi pientä vikaa (Liiku näkyy ~1 s ennen ääntä ja välähtää 0,2 s 30 s:n kohdalla) korjataan webiin, ei kopioida natiiviin.

## BUILD 11 = PROTO-MASTER 1c8cdab (KAMERAREITTI, KAINALO, YLAPALKKI 44, LIIKU 45; HYTINA 27 EI MUKANA) → JULKAISIJA AJAA 1.0.11; NATIIVISEPPA 71 % → LUOVUTUS JA NOLLAUS KASKETTY (24.9.2026 klo 20.23)

Natiiviseppä ilmoitti klo 20.2x: build 11 = proto-master 1c8cdab (kamerareitti 8fe2136, kainalo c6db5b5, ylapalkki-matala f29def5, liiku-luenta 96a5a19; tarkistus 0, luo OK). Hytinä 27 ei valmis. Kierto <= 180° ja Z8-esilataus siirtyvät build 12:een (agentti haarassa natiiviseppa/kamerareitti). Fable käski Julkaisijaa ajamaan build 11:n (versio 1.0.11, laskuri 10, -nographics, PR #3107/#3110 -kaava, ei avainnipun hakulistan vaihtoa, Unity-editori kiinni viennin ajan). Natiiviseppä 71 % (Postivahti) → luovutus -20260924-ilta.md, worktree-siivous ja clear_session self samassa vuorossa mergen jälkeen; Pelikoodari ja Natiivi-UI 4 worktreetä → Postivahti pyysi siivoukset.

## WEBIN LIIKU-VIAT: 30 s VALAHDYS KORJATTU (#3116), KOHTA (a) → B VARAVENTTIILILLA: ISO KUVA AVAUTUU KUN AANI ALKAA ('playing'), MUTTA HETI JOS AANET POIS, play() EPAONNISTUU TAI 'playing' EI TULE 1,5 s:SSA (24.9.2026 klo 20.28)

Pelikoodari: PR #3116 korjaa 30 s:n välähdyksen (varaventtiili mittaa puheen edistymistä; Liiku piilossa 3,9–55 s), natiivi e9b39de seuraa. Kohta (a) (Liiku näkyy ~1 s ison kuvan kanssa ennen ääntä) ei ratkea kuvaan sidotulla piilolla, koska 15.9. sääntö kieltää epäonnistuneen play():n piilottamasta mitään. Fablen päätös: vaihtoehto B varaventtiilillä — web avaa ison kuvan vasta 'playing'-tapahtumasta, mutta kuva avautuu heti nykyiseen tapaan (Liiku näkyvissä), jos äänet ovat pois päältä, play() epäonnistuu tai 'playing' ei tule 1,5 sekunnissa; kuva ei saa koskaan jäädä avaamatta äänen takia. Sama kaava natiiviin ei tarvita (kuvat avautuvat vasta luennon soidessa).

## HAVAINNEKUVA-MERKKI NATIIVISSA: TARKOITETTU MERKKI KAIKISSA KORTEISSA (VERSAALI, AMERICAN TYPEWRITER 0,68 em, REUNAN TILALLA KEVYT POHJAVARI); WEBIN KOHDEKORTIN PUUTTUVA MERKKI ON BUGI (fokusnosto.css LADATAAN MYOHASSA) → PELIKOODARI (24.9.2026 klo 20.31)

Natiivi-UI kysyi klo 20.3x: webissä Havainnekuva-merkintä näkyy kohdekortissa (Carcassonne) paljaana 11,2 px:n tekstinä, koska fokusnosto.css ladataan vasta ensimmäisen fokusnoston yhteydessä; muissa korteissa omistajan 20.9. hyväksymä merkki (versaali, American Typewriter 0,68 em, 1 px reuna, pyöristys 3). Fablen päätös: natiivissa tarkoitettu merkki kaikissa korteissa; UITK ei piirrä rich textiin reunaa, joten reunan tilalla kevyt pohjaväri samasta sävystä. Webin kohdekortin paljas teksti on bugi, ei malli: Pelikoodari korjaa (fokusnosto.css tai merkin tyyli ladataan ennen kohdekorttia), Natiivi-UI ilmoittaa Pelikoodarille suoraan. Kuvat proto-3d/lokit/pariteetti-b12/web-havainne-*.png.
...
## BUILD 11 (6ff16f3) KAATUI ALLEKIRJOITUKSEEN (AJO 36035600272, errSecInternalComponent, LOGIN-NIPUN FD3S699799); FABLE: CI ALLEKIRJOITTAA NIMETYLLA IDENTITEETILLA TESTFLIGHT-NIPUSTA (CODE_SIGN_IDENTITY=SHA1 + --keychain), EI HAKULISTAN VAIHTOA, EI OMISTAJAA (24.9.2026 klo 20.54)

Julkaisija klo 20.5x: Unity-vienti läpi, 'Arkistoi ja allekirjoita' ARCHIVE FAILED (65): codesign UnityFramework.framework errSecInternalComponent; Xcode valitsi login-nipun 'Apple Development: Sami Reivinen (FD3S699799)' + 'iOS Team Provisioning Profile: fi.matkakirja.peli' kuten build 10:ssä; omistajan set-key-partition-list ei pitänyt tai ei koske tätä avainta; laskuri 10, mitään ei ladattu. Fablen päätös: korjaus CI:hin ilman hakulistan vaihtoa — arkistointi ja vienti nimetyllä identiteetillä TestFlight-avainnipusta (CODE_SIGN_IDENTITY=<API-varmenteen SHA-1>, tarvittaessa manuaalinen tyyli + profiili tai -allowProvisioningUpdates API-avaimella, OTHER_CODE_SIGN_FLAGS=--keychain), PR proto3d-testflight-työnkulkuun, uusinta 6ff16f3:sta. Jos kaatuu yhä, Julkaisija raportoi identiteetit ja virheen → omistajalta täsmäkorjaus kortilla.

## KAMERAREITIN JATKO 6c2378e (KIERTO <= 180°, LAATAT 100 % ORBITIN ALKAESSA) → MERGE BUILD 12:EEN NYT; KYLMAN ALUN SUMEUS OMANA ERANA (PRIORITEETTI); SENTINELIN MERISUORAKULMIOT EGEANMERELLA → KARTTASEPPA (24.9.2026 klo 21.01)

Natiiviseppä klo 20.5x: kamerareitin jatko (natiiviseppa/kamerareitti 6c2378e, testi b12k) toimii simulaattorissa, videot omistajalle; kierto <= 180° lyhyempään suuntaan, kohdealueen laatat 100 % ladattuina orbitin alkaessa (15,5 s), lämpimällä välimuistilla lasku terävä. Ensimmäinen lento asennuksen jälkeen yhä sumea vaikka esilataus valmis (sumu ja usva eivät syy) → Natiiviseppä selvittää omana eränään, build 12:n prioriteetti mastojen rinnalla. Sivuhavainto: Sentinelin tumman meren rajat suorakulmioina Egeanmerellä → Karttasepälle suoraan. Fable: merge nyt.

## NATIIVI-UI ERA BUILD 12:EEN: nosto-levea MASTERISSA (iPAD VAAKATAITTO >= 1100 pt, HAVAINNEKUVA-MERKKI), kartuscha-reuna MERGEJONOSSA (LIIKU EI MAAKORTIN PAALLE, PELKKA SANA), radio-mastonimi 85ee341 → b12d; WEBIN HAVAINNE-CSS #3119 (24.9.2026 klo 21.26)

Natiivi-UI klo 21.3x: nosto-levea masterissa (kuvaparit b11n/b11m); kartuscha-reuna mergejonossa (iPhonen Liiku ei nouse maakortin päälle, täyte 0 kuten webissä, Liiku pelkkä sana, iPhonella kevyt reuna); radio-mastonimi 85ee341 mastojen testikäännökseen b12d (▶-napit piilossa mastojen aikana, valitun maston nimi havainnekuvan mukaan); build 11:n Pulu.Oikea-kaatuminen korjattu masterissa 6ff16f3; Pelikoodari korjasi webin havainne-CSS:n PR #3119. Seuraavaksi Natiivi-UI kuvaa b12d:n. Fable: Julkaisija luokitinestossa (odottaa omistajan tekstiä), Unity vapautettu Natiivisepälle, Laitetestaajalle mitattu pariteettikierros b11o:sta.

## OMISTAJA klo 21.2x (SITOVA, JULKAISIJAN SESSIOSSA): JUMI → AINA ASKUSERQUESTION-KORTTI OMISTAJALLE; JULKAISIJALLE 'JATKA' (VAIHTOEHTO 1: TYONKULUN ALLEKIRJOITUSKORJAUS PR:NA, BUILD 11 UUDESTAAN Build/yo:STA) (24.9.2026 klo 21.28)

Omistaja kirjoitti Julkaisijan sessioon klo 21.2x: 'Jatka' (vaihtoehto 1) ja 'Tee aina kysymys kortti jos jäät jumiin'. Raamattuun (Ydinajatus kohta 2, FABLEN KÄSKYT): JUMI → KORTTI — jos sessio jää jumiin (luokitin estää toimen, päätös puuttuu tai työ ei etene), se tekee aina AskUserQuestion-kortin omistajalle omassa sessiossaan eikä jää odottamaan tekstiä; yksi rivi Fablelle lokia varten. Julkaisija jatkaa: työnkulun allekirjoituskorjaus PR:nä, build 11 uudestaan Build/yo:sta, sitten #3114, #3118, #3119.

## OMISTAJA klo 21.3x: PARITEETTI NOPEAMMIN TESTATTUA JA KORJATTUA → AUTOMAATTINEN PARITEETTIAJO (tools/pariteetti-ajo.mjs, PELIKOODARI), ERI-RIVIT SUORAAN OMISTAJASESSIOLLE HAAROINA; ALLEKIRJOITUKSEN KOESILMUKKA JULKAISIJALLE (24.9.2026 klo 21.30)

Omistaja kysyi klo 21.3x, miten pariteetin saisi nopeammin testattua ja korjattua. Fablen linjaus: pariteettikierros automatisoidaan — Pelikoodari rakentaa tools/pariteetti-ajo.mjs:n, joka ajaa koko taulun (rivit 1–41 + lisät) samalla pelitilalla webissä (Playwright-koukut) ja natiivissa (simulaattorin ui-komennot, komentolista Laitetestaajalta), 4 koossa, vertaa webin DOM-laatikot natiivin accessibility-puun mittoihin ja kuvien rakenteeseen, tulostaa SAMA/ERI(px)/PUUTTUU-taulun ja kontaktiarkin; tavoite alle 15 min ilman ihmistä, ajo jokaiselle testikäännökselle (ensin b11o). ERI-rivit reititetään suoraan Natiivi-UI:lle (natiivi) tai Pelikoodarille (web) haaroina kuvapareineen; Laitetestaaja tekee mitatun käsikierroksen b11o:sta siihen asti. Allekirjoitukseen Julkaisijalle koesilmukka: 1 min codesign-koe ajurissa molemmilla identiteeteillä, sitten arkistointi erikseen valmiista Build/yo:sta, vasta sitten koko build; API-nipun avaimeen set-key-partition-list nipun omalla salasanalla jos tarpeen.

## ALLEKIRJOITUSKORJAUS PR #3120 (OMISTAJA HYVAKSYI KORTILLA): ARKISTO JA VIENTI MANUAL-TILASSA TESTFLIGHT-NIPUN DISTRIBUTION-SHA-1:LLA, --keychain RAJAA NIPPUUN; BUILD 11 AJETAAN Build/yo:STA MERGEN JALKEEN (~8–10 min) (24.9.2026 klo 21.33)

Julkaisija klo 21.3x: PR #3120 — arkisto Manual-tila, CODE_SIGN_IDENTITY = TestFlight-nipun Distribution-varmenteen SHA-1, profiili PROVISIONING_PROFILE_SPECIFIER_APP vain sovellus-targetille, --keychain rajaa nippuun; vienti manual samalla SHA-1:llä ja profiililla. TestFlight-nipussa 4 Distribution-identiteettiä ja 1 'Apple Development: Created via API', partition-list asetetaan jo työnkulussa → erillistä koetyötä ei tarvita. Suora ajo haarasta luokittimen estämä (CI Bypass) → merge vihreänä ensin, sitten ajo valmiista Build/yo:sta (vienti_kansio=yo) ilman Unity-vientiä. Web-jono pidossa ajon ajan. Tulos arviolta klo 21.4x.

## OMISTAJA klo 21.4x: LINSSIKATALOGIIN KUVAT (HAVAINNEKUVA + CC-KUVA PER LINSSI, KUVAPUTKI) JA SIVU VISUAALISEKSI ESITTELYSIVUKSI KUMPPANEILLE → TILAUS POSTILAATIKKOON, SUUNNITELMA linssikatalogi-uudistus-suunnitelma-20260924.md, TOTEUTUS SISALTOKIRJURI (24.9.2026 klo 21.52)

Omistaja klo 21.4x: linssikatalogiin muutama kuva jokaiseen linssiin (noin yksi havainnekuva ja yksi CC-kuva) kuvaputken tehtävänä, ja linssisuunnitelmasivu selkeämmäksi ja visuaalisemmaksi, koska sitä näytetään yhteistyökumppaneille. Fable: tilaus kuvaputkelle posti/fable-kuvaputki-linssikatalogi-kuvitus-20260924.md (148 linssiä × 2 kuvaa; erä 1 = 29 ei-idea-linssiä heti työn alla olevan erän jälkeen ennen galleria 59:ää, erä 2 = 119 ideaa jonon perään; havainnekuva generoitu 16:9 pelin pergamenttiestetiikassa ilman UI-tekstiä, CC-kuva aito PD/CC 4:3 lähteineen; toimitus media.matkakirja.app/linssikatalogi/, ei repoon), aineisto posti/linssikatalogi-tilaus-20260924.json. Sivun uudistus: docs/raportit/linssikatalogi-uudistus-suunnitelma-20260924.md (avaus + moottorikortit, Pelissä nyt, Seuraavat-kaista, korttiruudukko aikajanapalkilla ja 1873-merkkipaalulla, suodattimet, tiekartta-kanban, maailmankartta, esitystila ja tulostus); tekijä Sisältökirjuri, Pelikoodari tarkistaa, Fable hyväksyy kuvista.

## BUILD 11 TESTFLIGHTISSA: 1.0.11 (202609241848), PROTO 6ff16f3, AJO 36042445620, ALLEKIRJOITUS #3120:N NIMETYLLA IDENTITEETILLA, LASKURI 11 (24.9.2026 klo 21.56)

Julkaisija klo 21.5x: build 11 sisäisessä TestFlight-ryhmässä, versio 1.0.11, CFBundleVersion 202609241848, proto-master 6ff16f3 (kamerareitti 8fe2136, kainalo c6db5b5, ylapalkki-matala f29def5, liiku-luenta 96a5a19 + e9b39de, Pulu.Oikea-korjaus 323a0b5). Allekirjoitus meni läpi #3120:n nimetyllä identiteetillä (TestFlight-nipun Distribution-SHA-1, --keychain) ilman hakulistan vaihtoa. Muutoslokirivi Julkaisijalle: 'Build 11: lennon uusi kamerareitti (kone läheltä, loittonus, kierto kohteen ympäri), iPhonen matalampi yläpalkki, Liiku piilossa kerronnan ajan, iPadin lehti leveämpi, radiolinssin korjaukset (kaikki maat näkyvissä, nappi keskellä), lehden otsikot ja leveä nostokortti, kartan nimet uudella fontilla.'. Omistajalle ilmoitettu yhdellä rivillä; löydökset 46 alkaen.

## OMISTAJA klo 22.0x: LINSSIKATALOGIN UUDISTUSSUUNNITELMA HYVAKSYTTY, TOTEUTUS KAYNNISSA (SISALTOKIRJURI); KYSYMYS: RADION KARTTA VARILLISENA TOPOGRAFIAKARTTANA → LINSSISEPPA TEKEE VARIANTIT A (HAMARA + VALOT) JA B (PAIVA) (24.9.2026 klo 21.59)

Omistaja hyväksyi linssikatalogin uudistussuunnitelman ('hyvä uudistussuunnitelma, toteuta se') — Sisältökirjuri toteuttaa vaiheen 1, kuvaputken erä 1 tilattu. Omistajan kysymys: miltä radiolinssi näyttäisi, jos kartta olisi värillinen topografiakartta pergamentin sijaan → Linssiseppä tekee havainnekuvasta kaksi varianttia (A topografia hämärässä Black Marble -valoineen ja mastoineen, B topografia päivänvalossa) docs/raportit/kaappaukset/radiouudistus-20260924/3-topografia-a/b.jpg; ei koodimuutoksia ennen omistajan valintaa.

## OMISTAJA klo 22.1x (KORTTI, SITOVA): LINSSIKATALOGI JARJESTETAAN MOOTTOREITTAIN (6 OSAA, MOOTTORIKORTIT, PAALLEKKAISET YHDISTETAAN, KENTAT MITA OPITAAN / PELIKYTKOS / 1873-SIDOS / AINEISTO+LISENSSI, PELISSA NYT -OSA, 5 LISAYSTA); PILOTIT ENNALLAAN M1 KIINA JA S1 SIIRTOMAAT (24.9.2026 klo 22.06)

Fablen arvio omistajalle klo 22.0x: katalogi (148) sekoittaa kolme akselia (teema, manner, moottori), ~15 päällekkäistä (F2=U3=R28, A6=T2, G1⊂B3+P2, D6=S1/O2, D2+H6=S3, E1→E7, C4=U2, B4+G6+U1, F1=R13, F4=R12), 26 'seuraavaa', pelin 12 nykyistä linssiä puuttuvat; alue- ja virtamoottoreilla ei pilottia eikä aineistoputkea (alueen rajat GPL → omat CC0-monikulmiot); linssiltä puuttuu mitä opitaan, pelikytkös ja 1873-sidos. Omistaja valitsi kortilla: pääjako toteutustavan mukaan kuuteen osaan (aikajana pisteet+reitit; alue; virta; data; esitysmoottori sali/pallon kasvu/paikka; pohjakartat = ei linssejä), teema ja manner suodattimiksi, moottorikortit (rakennettu, pilotti, aineistoputki, web/natiivi, puuttuu), päällekkäiset yhdistetään id:t säilyttäen, 'seuraava' enintään 8, Pelissä nyt -osa (topografia, vesistöt, radio, astronautin kamera, vertailu, yökartta, aarteet, aikaselain, maatiedot, omistus, pallo, reliefi + B1, C7), lisäykset: Suomi isoisän aikaan, Valokuvan synty 1826–1900, Elämän matka (logaritmikello), Mantereet liikkuvat, Aika ja nollameridiaani; Q2 pohjakartaksi, C5 pelin rungoksi, R35 Suomi-linssiin. Pilotit ennallaan omistajan päätöksellä: M1 Kiinan dynastiat ja S1 Siirtomaat ensin (Fable ehdotti N1/S2, hylätty). Toteutus: Fablen agentti (Opus) kirjoittaa docs/linssikatalogi.md uusiksi + linssikatalogi-data.js; Sisältökirjuri rakentaa sivun uuteen rakenteeseen; kuvaputken erä 1 -id:t pysyvät.

## OMISTAJA klo 22.2x (KORTTI, SITOVA): TYOTAVAN NELJA PARANNUSTA — KAANNOSPALVELU (TOINEN UNITY-KOPIO, HAARA → SIMULAATTORI ILMAN NATIIVISEPPAA), BUILD-JUNA (TESTIKAANNOS 2 h VALEIN, BUILD-SUUNNITELMA), TILATAULU + PYSYVAT REITITYKSET (POSTIVAHTI, docs/raportit/tilataulu.md), JULKAISIJA SONNETIIN + SISALTOJUNAT 2×/PV (24.9.2026 klo 22.21)

Omistaja kysyi klo 22.1x, onko sessioiden työtapa järkevä. Fablen analyysi: kolme pullonkaulaa — yksi Unity ja yksi Natiiviseppä (mergeääjä, kääntäjä ja kehittäjä; muut odottivat b11o/b12d-käännöksiä tunteja, Julkaisijan vienti lukitsi Unityn), Fable viestinvälittäjänä (~25 lokimerkintää 2 h:ssa, viestiraja täyttyi, omistajalla ei tilanäkymää), sarjalliset jonot (30 avointa PR:ää, pariteetti käsin). Omistaja valitsi kortilla kaikki neljä parannusta; kirjattu Raamattuun Ydinajatus kohta 2 'TYÖTAVAN NELJÄ PARANNUSTA'. Toteutus: käännöspalvelu Natiiviseppä + Julkaisija (build 12 -jonon rinnalla), build-juna Julkaisija (aikataulu) + Natiiviseppä (integraatiohaara), tilataulu Postivahti, Julkaisijan malli Sonnetiin seuraavassa nollauksessa tai heti kun jono sallii, sisältöjunat Julkaisija + Sisältökirjuri.

## OMISTAJA klo 22.3x: TOKENEITA RIITTAA (NELJA TILIA VUOROTELLEN, VIIKKORESET) → MALLIVALINTA KYVYN MUKAAN; JULKAISIJA PYSYY OPUKSELLA KUNNES KAANNOSPALVELU JA BUILD-JUNA OVAT VALMIIT; TOPOGRAFIAVARIANTIT A/B OMISTAJALLE (PR #3122) (24.9.2026 klo 22.23)

Omistaja: 'Tokeneita on vielä paljon koska minulla on yhteensä neljä tiliä joiden välillä vuorottelen ja reset tulee kerran viikossa.' Fable: parannuksen 4 Sonnet-osa lykätään — Julkaisija pysyy Opuksella käännöspalvelun ja build-junan rakentamisen ajan, sisältöjunat voimaan heti; Raamatun kohta täsmennetty. Linssisepän topografiavariantit valmiit (PR #3122): A hämärä + Black Marble + mastot topografiapohjalla, B päivä pelkin mastoin; omistajalle kortilla.

## OMISTAJA klo 22.3x (SITOVA): RADIOLINSSIN POHJA ON VARILLINEN TOPOGRAFIAKARTTA HAMARASSA YOVALOINEEN (HAVAINNEKUVA A, PR #3122) — EI PERGAMENTTI (24.9.2026 klo 22.24)

Omistaja: 'Nyt on hyvä radiolinssi, tuo yö versio topografialla.' Radiolinssin kartta on natiivin topografialinssin värillinen pohja hämärän kertoimella 0,18/0,17/0,24, NASA Black Marble -valot (perustaso 0,5, valitun maston ympärillä 1,0), mastot, hehku ja radioaaltorenkaat kuten havainnekuvassa 2, mutta pergamentin sijaan topografiapohjalla (docs/raportit/kaappaukset/radiouudistus-20260924/3-topografia-a.jpg). Raamatun RADIOLINSSIN UUDISTUS -kohtaan lisätty POHJA-lause. Natiiviseppä: hämärä ja yövalot topografiapohjan päälle (radiolinssi vaihtaa pohjan topografiaan avautuessaan ja palauttaa sulkeutuessaan); Linssiseppä: suunnitelman luku päivitetään, paneeli ennallaan; web ennallaan.

## TILATAULU KAYTOSSA (docs/raportit/tilataulu.md, HAARA postivahti, 10 min); ENSIMMAINEN VERSIO KORJATTAVANA (BUILD 11 JO TF:SSA, LINSSISEPAN VALINTA TEHTY); WORKTREET 25 > 20, LEVY 36 Gt LAHELLA RAJAA 35 → POISTOT (24.9.2026 klo 22.26)

Postivahti julkaisi tilataulun klo 22.23 (sessiot, jumit, PR:t ~40: sisältö 21, toiminto 10, luonnokset 9, TestFlight, resurssit). Fable korjautti: build-tila luetaan Julkaisijan viimeisestä viestistä ja lokista (build 11 on TestFlightissa, ei ajossa), Linssisepän valinta tehty, uusi rivi 'Fablen viimeisin päätös'. Worktreet 25 (katto 20) ja levy 36 Gt (raja 35) → Postivahti ajaa poistolistat rooleille.

## OMISTAJAN LOYDOS 46 (BUILD 11, klo 22.3x, SITOVA): KARTTA ROSOINEN, KORKEUSEROT EIVAT NAY, KALLISTUS ANEEMINEN — PERUSKARTTA (PERGAMENTTI) KUNTOON; KALLISTUS SAA JAADA POIS JOS EI PARANE, VALON PITAISI MUOTOILLA KORKEUSEROJA → VEDOKSET KARTTASEPPA (LAATAT) JA NATIIVISEPPA (VALO, SUODATUS, HORISONTTI) (24.9.2026 klo 22.29)

Omistajan kuvat build 11:stä (Kreikka ylhäältä ja kallistettuna): rantaviivat paksuina rosoisina portaikkoina, reliefi haaleina laikkuina, meri täynnä syvyyskäyriä, kallistuksessa maasto litteä, tausta musta. Omistaja: 'Kartta näyttää rosoiselta ja huonolta. Korkeuserot eivät näy ja kallistus näyttää aneemiselta… Värillinen topografia auttaisi mutta haluaisin saada tämän vanhan version toimimaan. Kolmiulotteisuus ei ole niin tärkeä ja kallistuksen voi ottaa pois jos ei saada paremman näköiseksi… varsinkin jos valo muotoilisi korkeuseroja. Peruskartta pitää saada paremmaksi.' Fablen jako: (1) LAATAT, Karttaseppä: Kreikan koesarja Z5–Z8 — rantaviiva vektorista joka tasolla antialiasoituna ja ohuempana (mustetta ei paksunneta karkeilla tasoilla), aito monisuuntainen hillshade + rinnevarjostus sekoitettuna lämpimään hypsometriaan (kerma → ruskea), meri rauhaksi (syvyyskäyrät vaimeiksi tai pois, rannan hachure-vinjetti 3–5 viivaa häipyen), kuvavedos omistajalle ennen koko polttoa; (2) PIIRTO, Natiiviseppä: karttatilaan matala aurinko (Aurinko.cs) ja korkeuskerroin 2 maatasolla niin että valo muotoilee maaston, rasterikerroksen anisotrooppinen suodatus + trilinear, kallistuksessa pergamentinsävyinen horisonttiusva mustan sijaan, kallistuskulman katto; kuvapari (ylhäältä + kallistus) omistajalle. Päätösportti: omistaja valitsee vedoksista; jos kallistus ei parane, se otetaan pois oletuksesta (omistaja sallii). Löydös 46.

## OMISTAJA klo 22.4x (SITOVA, LOYDOS 47): KIERRON ESTIN NIPISTYKSESSA (POHJOINEN PYSYY KUNNES KIERTO SELVASTI YLI KYNNYKSEN), KALLISTUS HITAAMPI JA SUUNTA ALHAALTA YLOS, MAASTOON LISAA TARKKUUTTA MAATASOLLA (GOOGLE EARTH -VERTAILU) → PELIKOODARI (ELEET) JA NATIIVISEPPA (MAASTO) (24.9.2026 klo 22.46)

Omistaja testasi Google Earthia: maaston muodot tulevat vasta lähempää zoomatessa → maatasolle tarkempi maastotaso (Natiiviseppä, löydöksen 46 valon rinnalle); tahattoman kierron estin: pieni kierto nipistyksen sivutuotteena jätetään huomiotta, pohjoinen pysyy paikallaan kunnes kahden sormen kierto ylittää selvän kynnyksen (Pelikoodari mittaa Google Earthista, n. 15–20°, ei hyppyä kynnyksellä); kahden sormen kallistus aavistuksen hitaampi ja suunta käännetään vedoksi alhaalta ylös. Raamattuun NATIIVI PELI ETUSIJALLE -kohtaan 'ELEET: KIERRON ESTIN, KALLISTUS JA MAASTON TARKKUUS'. Eleet Pelikoodarille (natiivin eleet, Matkavalinta/eleet), maasto Natiivisepälle.

## LEVYHALYTYS klo 22.4x: 28 Gt VAPAANA (RAJA 35) — SYYT: proto-3d/lokit 31 Gt (230 KANSIOTA, KAIKKI ALLE 3 vrk), SIMULAATTORIT 29 Gt (6 KAYTOSSA, iPAD 11 = 12 Gt), Build/ 14 Gt; OMISTAJALLE SKRIPTI vapauta-levy-20260924-ilta.sh (30 KANSIOTA, ~15 Gt, EI RAPORTTIVIITTAUKSIA) (24.9.2026 klo 22.48)

Postivahti hälytti 29 Gt:stä. Mittaus: lokit 31 Gt kaikki 22.–24.9. (isoimmat linssit-piikit 2,4 Gt, pariteetti-ajo 1,2 Gt, maat-/kontakti-/kosketusala-/tummuus-/sininen-ajot 0,5–0,6 Gt kpl), simulaattorit 29 Gt mutta kaikki kuusi bootattua ovat rooleilla käytössä, Build/ 14 Gt aktiivisia (dd-sim 5,1, dd-laite 4,1, yo 1,9), Matkakirja-proto-kaannos 6 Gt on jo olemassa käännöspalvelua varten, wt/ 9,4 Gt. Muistion säännön mukaan pysyvät poistot omistajalle skriptillä: docs/raportit/vapauta-levy-20260924-ilta.sh poistaa 30 lokikansiota (~15 Gt), joihin mikään committoitu raportti tai loki ei viittaa; viitatut (~7 Gt) säilyvät. Yön siivous (yli 2 vrk) ei tänään auta, koska kaikki on tuoretta → ehdotus: lokikansioiden ikäraja 1 vrk, kun levy on alle 40 Gt.
...
## KAANNOSPALVELU TOIMII (klo 22.50): proto-3d/tyokalut/proto-kaanna.sh <haara>[+<haara>…] [UDID…], KOPIO Matkakirja-proto-kaannos, JONO YKSI KERRALLAAN, LOKI proto-3d/lokit/kaannospalvelu/; ENSIMMAINEN b12j (528c59d) ASENTUI NATIIVI-UI:N SIMEIHIN RINNAKKAIN PAAKOPION KANSSA; build-12-suunnitelma.md, JUNA juna/b12; 2 h AJASTIN launchd → OMISTAJAN KORTTI (24.9.2026 klo 22.50)

Natiiviseppä toteutti käännöspalvelun tunnissa: mikä tahansa pushattu proto-haara (tai haarojen summa) kääntyy kopiossa Matkakirja-proto-kaannos ja asentuu annettuihin simulaattoreihin ilman Natiiviseppää; Unity-editori ei enää lukitse muita. Suunnitelma docs/raportit/build-12-suunnitelma.md (haara selvittaja-3d-luovutus 31fcd23f1), integraatiohaara juna/b12 luotu. Kahden tunnin ajastin tarvitsee launchd-agentin → Natiiviseppä kysyy omistajalta kortilla. Löydös 46 agentilla (valo, suodatus, usva, katto, maaston tarkkuus), ennen-kuvat isolta iPadilta. Fable: Postivahti välittää kutsun kaikille rooleille.

## LOYDOS 47 TOTEUTETTU: pelikoodari/eleet-kierto c5a4833 (KIERRON ESTIN 15° ILMAN HYPPYA, KALLISTUS VETO YLOS 0,20 °/pt; ARVOT OMISTAJAN KORTILLA, GE EI MITATTAVISSA); PARITEETTIAJO 1. KIERROS b12g: 176 PARIA 28,7 min, NATIIVI 176/176, WEB 173/176, TULOS KALIBROIMATON (SAMA 0 / ERI 126 / PUUTTUU 50 TILAEROISTA) (24.9.2026 klo 22.51)

Pelikoodari klo 22.5x: eleet merge-pyynnössä Natiivisepällä (video iPad 13:lta testikäännöksen jälkeen). Pariteettiajo tools/pariteetti-ajo.mjs + ui puu masterissa; ensimmäinen kierros b12g:llä 44 riviä × 4 kokoa; automaattitulos vielä kalibroimaton: rivien pelitilat eroavat (webin sähke Sofiassa vs natiivin Marseillessa, väärät nostotunnisteet, natiivin tutki ilman kohtaamista) ja ±8 px raja tiukka; korjattu turva-alue, anfangi, otsakkeet, peitto. Seuraavaksi rivien tilat kuntoon, iPhonen vaaka omaan simulaattoriin (−11 min), toinen ajo; ERI-reititys vasta sen jälkeen. Kontaktiarkki proto-3d/lokit/pariteetti-ajo/b12g-1/kontaktiarkki.html. Fable: OK, kalibrointi ennen reititystä; kesto tavoite 15 min saavutetaan jakamalla koot rinnakkain kahteen simulaattoriin.
...
## LOYDOS 46 VEDOKSET (KARTTASEPPA, karttaseppa-kartta46 27e86235f): JUURISYYT LAATOISSA — PALLOSARJASSA EI RANTAVIIVAA, 1-BITTINEN VARIRAJA, MILLER→MERCATOR LAHIN PIKSELI, JPEG 80 4:2:0, ETOPO 3' + YKSI VALO; TUMMA KEHA ON NATIIVIN MAARAJA → NATIIVISEPPA; B (VEKTORIRANTA, AA, RAUHALLINEN MERI) ~2 h, C (B + GLO-30 MONISUUNTAINEN VARJOSTUS) ~½ pv + 3,5 h, LISAKSI SILEA SARJA JA SYVAT TASOT ~5 h (24.9.2026 klo 23.10)

Vedokset docs/raportit/kaappaukset/kartta-46-20260924/ (A-nykyinen, B-rannat-meri, C-rannat-meri-reliefi z6 1344 px + Peloponnesoksen Z8-lähikuvat 2×, LUEMINUT.md resepteineen). Fablen arvio kuvista: C on selvästi paras — vuoret erottuvat, rannat teräviä, meri rauhallinen; omistajalle kortti A/B/C. Karttasepän kysymys ranta pohjaan vai oma rantataso: Fablen päätös — pallosarjaan ranta pohjaan (natiivi lataa yhden pinnan), webin tasokartan pohja ennallaan ilman rantaa omalla rantatasollaan; Karttaseppä vahvistaa toteutettavuuden.

## LINSSIKATALOGI JARJESTETTY MOOTTOREITTAIN (f0aae0fac): 165 LINSSIA, 6 MOOTTORIKORTTIA, 13 YHDISTETTYA, LISATTY D7 B8 B9 F5 P6 E10 R36 Q3 Q4 JA RENKAAN 1 LEIKKI- JA KATSELULINSSIT Y1–Y10, E1 SAILYY WEBIN RENGAS 1 -AARRELINSSINA; linssikatalogi-data.js (24.9.2026 klo 23.14)

Fablen agentti (Opus) kirjoitti docs/linssikatalogi.md:n uusiksi (655 riviä) ja tuotti linssikatalogi-data.js:n; md ja data vastaavat (165/165 id), omistajan lainaukset tallella, dokumenttitesti 3/3. Pelissä nyt: X1–X7 (pallo, topografia, vesistöt, satelliitti, radio, vertailu, maatiedot) + B1 + C7 + Y1–Y6 leikkilinssit (Kellot, Lippuarvaus, Tähtitaivas, Muuttolinnut valmiina haaroissa, Yökartta ja Vuodenajat jonossa); Y7–Y10 katselulinssit jonossa. Seuraava-tila: A1 A4 B2 B3 H1 M1 S1 + E7→E10 (esitys) + 17 datalinssiä (data); 24 muuta 'jonossa'. HYDE 3.3 on NC → R16/R17/R21 HYDE 3.2. Pelikytkös 'avoin' 17 linssillä. Kuvaputken tilaukseen tulee 18 uutta id:tä ja 12 poistuu — päivitetään kun kuvaputki palaa tauolta. Sisältökirjuri vaihtaa sivun datalähteen.
...
## RESEPTI 2026-09-25 KOODATTU (KARTTASEPPA, PR #3130, 262 TESTIA): KUVAPARI 3-kreikka-z6.jpg + 3-peloponnesos-z9.jpg (wt/karttaseppa-kartta46/docs/raportit/kaappaukset/kartta-46-20260924/) — FABLE: Z9 SELVASTI NYKYISTA PAREMPI; OMISTAJAN HYVAKSYNTA AAMUN KORTISSA; KOKO POLTTO ~4–4,5 h YOLLA (POHJA PAIVALLA 4 YTIMELLA, PALLO ENSI YONA klo 22); E28 PYRAMIDI 101/101, PALLO Z9–Z11 KAYNNISSA (25.9.2026 klo 00.49)

Karttasepän ilmoitus klo 00.5x: DEM-lohkot, GLO-90 + GLO-30 kuten maastossa, kaistajako 122 pohjashardia, --resepti 2026-09-25, #3123 mukana. Kesto koko maailmalle yöllä ~4–4,5 h (16 ydintä), päivällä ~16–18 h (4); levy huipussa 10–12 Gt; NAS-luku ~50 Gt. Fablen ehdotus: pohja + viivat päivällä 4 ytimellä (~6–7 h), pallo Z0–Z9 ensi yönä klo 22 alkaen (~2,4 h), TF klo 04 ja levysiivous klo 03 kierretään. Ei polttoa tänä yönä. #3130 Julkaisijalle mergeen kun vihreä.

## LINSSIKATALOGIN NELJA VALILEHTEA PR #3131 (SISALTOKIRJURI, PINO #3129:N PAALLE, TESTIT 4282/0): HYVAKSYTTY KUVISTA, YKSI KORJAUS (PUHELIMEN VALILEHTIRIVI LEIKKAUTUU); JULKAISIJA: #3129:N SAVUKE UUSIKSI klo 02.52 E28:N JALKEEN (20 min AIKAKATKAISU KUORMASSA), #3123 JA #3130 MENOSSA, SITTEN #3131 REBASE + VERSIONOSTO (25.9.2026 klo 00.57)

Välilehdet moottorit/pelissa/seuraavat/katalogi hash-reitityksellä, seuraavat täytenä ruudukkona ilman vaakavieritystä; jumi (vanhat id:t törmäsivät hasheihin) korjattu. Kaappaukset wt/sisaltokirjuri-linssikatalogi-valilehdet/docs/raportit/kaappaukset/linssikatalogi-valilehdet-20260925/. Puhelimella 393 px neljäs välilehti näkyy vain 'KOKO' → mahdutetaan kaikki neljä näkyviin.

## FABLE: iPHONEN VAAKA PISTESKAALAAN (1 pt = 1 CSS-px KUTEN iPADISSA, WEB 874 × 402 vs VIITESKAALA 648 × 298 → UI 35 % LIIAN SUURI, LEHTI ILMAN PALSTOJA) BUILD 12:EEN; PYSTY SAMOIN JOS YKSI VAKIO JA KUVAPARIT PYSYVAT ALLE 8 px, MUUTEN b13. NATIIVI-UI: tyyppikuvake, juliste-url, liuska-48 TODENNETTU b12k → JUNASSA; PARITEETTI b12-2 #25–28, #35 KORJATTU (natiivi-ui/pariteetti-b12-2), #11/#40/#31 LINSSISEPALLE (25.9.2026 klo 01.03)

Natiivi-UI:n kysymys klo 01.0x. Perustelu: WEB ON MALLI, MITATTUNA — pisteskaala poistaa muunnosvirheen ja antaa lehden intron kaksi palstaa (raja 768). Pystyssä ero vain 2,5 % (392 vs 402). Panoroi-kytkentä odottaa Pelikoodaria; intro-palstojen tasaus kokeiluna (ui tasaus), ei estä junaa. Luenta lokit/pariteetti-ajo/b12-2/natiivi-ui-vastaus.md.
...
## NATIIVISEPAN VALITILA klo 01.3x: LOYDOS 46 ISOLLA iPADILLA (b12p) — MATALA VALO MUOTOILEE RELIEFIN, VEKTORIRANNAT JA -RAJAT TERAVAT (proto-3d/lokit/loydos46-b12p/vali-ennen-jalkeen.jpg); VIKA: KALLISTUKSESSA HORISONTIN YLLA MUSTAA (USVAN TAUSTA) → KORJAUS, SITTEN KUVAPARI RANTA TAYSILLA / 0,25 / POIS; RAJAKORKEUDET OLETUKSENA (1 530 SOLUA, ALPIT 4 739 m); KUUNTELIJA LuoPalloon (natiiviseppa/kuuntelija); JUNASSA RADIO, PANOROI, 4 NATIIVI-UI-HAARAA, ELEET, METAT — JUNA KAANTYY klo 08; LENTOPINNAN KYLMAN ALUN SUMEUS KESKEN (D KAATUI KYLMASSA KOKEESSA, OLETUS ENNALLAAN) (25.9.2026 klo 01.22)

Fablen katsaus välikuvaan: oikea puoli selvästi parempi (reliefi, terävät rannat), meressä yhä vanhan sarjan syvyyskäyrät — poistuvat reseptin 2026-09-25 pallosarjan myötä. Musta kaista horisontin yllä Natiivisepän tiedossa.

## LINSSISEPPA: RADIOPINTOJEN .METAT d3acfd1 JA SIMULAATTORIKIERROS OK (PINNAT, HAMARA, TOPOGRAFIA, VIRITYS, KAMERA-AJO, RENKAAT, MASTOT); LOYTO: SULUSSA PERGAMENTTI PALASI 2,4 s SUMEANA → linssiseppa/radio-sulku-pohja 86ac64e; SHA:T NATIIVISEPALLE JUNAAN. FABLE: PANEELIN SULKU LIUKUEN (KAANTEINEN 0,8 s) → NATIIVI-UI; VIIVAIMEN VETO → LAITETESTAAJAN AAMUKIERROS; LINSSISEPPA SEURAAVAKSI MAAPALLON TILA -LINSSIN AINEISTOSUUNNITELMA (EI TOTEUTUSTA) (25.9.2026 klo 01.29)

Kuvat proto-3d/lokit/radio-b12-sim-20260925/. Kolmen haaran yhdistelmä ei kääntynyt kaanna.sh-konfliktin takia, juna kääntyi (d802169).

## MAAPALLON TILA -LINSSIN AINEISTOSUUNNITELMA (LINSSISEPPA a3468dde9, docs/raportit/linssi-maapallon-tila-aineistosuunnitelma-20260925.md): NSIDC G02135 + GISTEMP v4 + NASA JPL GMSL (ZENODO, CC BY 4.0, NOAA LSA PYSAHTYNYT 17.2.2025) — FABLE: ANIMAATIO PAATTYY 2025:EEN, 2026 VAIN TEKSTINA; ARKTINEN 2026 LUKUNA, POLYGONI LOKAKUUSSA; ATTRIBUUTIO 'NASA JPL (CC BY 4.0)' RIITTAA, EKSTRAPOLAATIO POIS; TOTEUTUS VASTA PARITEETIN JA OMISTAJAN BUILD-KOKEILUN JALKEEN (25.9.2026 klo 01.37)

Lähteet ladattu ilman tunnusta, putki pelkällä Nodella, siirto ~1,7 Mt + lämpö 2,4 Mt. 2026 N-minimi 4,60 milj. km² täsmää NSIDC:n lukuun. Viivaimen vedon ohje Laitetestaajalle lähetetty.
...
## VIIVAIMEN VETO OLI AITO BUGI JA ON KORJATTU (LINSSISEPPA linssiseppa/radio-veto a26b248, 235/235; NIMIEN Clickable VEI OSOITTIMEN KAAPPAUKSEN) — LAITETESTAAJA VAHVISTI SIMULAATTORISSA (VETO, LUKITUS, NAPAUTUS); LUKITUS ~1 s (ENNEN 2,6 s); JUNAAN. JULKAISIJA: #3132 MAINISSA 01.23, #3135 SAVUKKEET PUNAISIA E28-KUORMASSA (5 RIVIA) → UUSINTA 02.52 #3129:N KANSSA, PARIISI-LAHIZOOM PYSYVASTI PUNAINEN ESTAA MERGEN (25.9.2026 klo 02.09)

Natiivi-UI antoi luvan RadioNakyma.cs-muutokseen; laitteella tarkistetaan aamun kierroksella.
...
## JULKAISIJA: #3135 MAINISSA v2212 (UUSINNASSA PUNAISINA VAIN ASTRO-PALLO-RIVIT, EIVAT KOSKE PR:AA); #3131 REBASETTU JA VIHREA → MERGE KUN TF 04 ON KAYNNISSA; CODEXIN POSTI 251a426e0: TILAUS 3576ee735 AJETTAVISSA, NAS-MERKINTA POISTETTU, ERA 1b JATKUU, TUNTIHAKU PAALLA (:17) (25.9.2026 klo 03.52)

#3106 galleria 59 lähetetään vasta mergen jälkeen.

## BUILD 12 -JUNA KOOSSA (NATIIVISEPPA juna/b12 03b7ed4, 120 COMMITTIA): LOYDOKSET 46, 48, 49, 50, 52, SAAPUMISKAMERA WEBIN MUKAAN, RADIO KOKONAAN, PANOROI, ELEET, NATIIVI-UI:N ERAT; EI MUKANA LENTOPINNAN KYLMA ALKU JA YOVALOT (b13) — FABLE: klo 08 KAANNOS → LAITETESTAAJAN SAVUKIERROS → NATIIVISEPPA MERGEAA MASTERIIN SANALLA BUILD → JULKAISIJA 1.0.12; RADION HAMARA KAAVAN MUKAINEN, TUMMEMPI OMISTAJAN PAATOS (25.9.2026 klo 03.59)

Juna kääntyi simulaattoriin (9cd472d), savutesti ilman poikkeuksia. Merge vaatii LuoPallon, kohtauksen, materiaalien ja metojen commitin (~15 min).
...
## BUILD 12 MERGETTY MASTERIIN (NATIIVISEPPA, PROTO-MASTER b79f036 = juna/b12 a8eb8b8): LAITETESTAAJAN SAVUKIERROS iPHONE 18 PRO LAPI (SAAPUMINEN, KARTTA 46, KAUPUNKIKORTTI 48, AANET 49, RADIO); EPAVARMA: KAHDEN SORMEN KALLISTUS EI REAGOINUT SYNTEETTISEEN ELEESEEN → OMISTAJA VAHVISTAA LAITTEELLA; iPAD TESTAAMATTA (ATTACH ODOTTI LUPAA); JULKAISIJA AJAA 1.0.12; RAPORTTI docs/raportit/savukierros-b12-20260925.md; KAANNOSVAHTI SEURAAVAKSI (25.9.2026 klo 04.20)

Kortti-kysymys iPad-attachista on Laitetestaajan sessiossa.

## KAANNOSVAHTI PAALLA (NATIIVISEPPA, launchd fi.matkakirja.juna-vahti, 10 min KIERROS): UUSIMMAN juna/b<N>-HAARAN UUSI COMMIT, KARKI 10 min ENNALLAAN → proto-kaanna.sh HETI LAITETESTAAJAN JA PARITEETIN SIMULAATTOREIHIN; VARATTU JONO → SEURAAVA KIERROS; 2 h AJASTIN VARMISTUKSENA; juna/b13 AVATTU MASTERISTA b79f036, juna-merge.sh MERGEAA OLETUKSENA UUSIMPAAN JUNAAN; LOKI proto-3d/lokit/kaannospalvelu/juna.log (25.9.2026 klo 04.20)

Toteuttaa omistajan 04.1x-päätöksen (TYÖTAVAN NELJÄ PARANNUSTA 2).
...
## OMISTAJA klo 04.3x (SITOVA, RAAMATTUUN): TYONJOHTAJAN HARKINTA — FABLE KYSYY ENSIN ITSELTAAN, MITEN ASIA KANNATTAA TEHDA JUURI TASSA TILANTEESSA (KUORMA, VUOROKAUDENAIKA, OMISTAJA, MUU KESKENERAINEN), JA VASTA TARVITTAESSA OMISTAJALTA KORTILLA VAIHTOEHTOINEEN; SAANTOA EI SOVELLETA SOKEASTI (ESIMERKKI: 4 YDINTA klo 04.30 VAPAALLA KONEELLA) (25.9.2026 klo 04.38)

Kirjattu Ydinajatus kohtaan 2 FABLEN KÄSKYT -kohdan perään.

## NATIIVISEPPA NOLLATTU (LUOVUTUS -20260925.md, selvittaja-3d-luovutus 95443d63a; ALOITUSVIESTI LAHETETTY: BUILD 13 -JONO — LENTOPINNAN KYLMA ALKU, YOVALOT, E28 SYVAT TASOT, KAUPUNKINIMIEN 8 ASENTOA, NATIIVI-UI:N ERA 2) (25.9.2026 klo 04.39)

Nollaus kaavan mukaan (clear samassa vuorossa, list_events 0).

## OMISTAJA klo 04.4x (SITOVA, RAAMATTUUN, KORVAA JUMI → KORTTI): JUMI → FABLE — SESSIOT EIVAT KYSY OMISTAJALTA EIVATKA JAA ODOTTAMAAN HANTA (YOLLA EIKA PAIVALLA) VAAN LAHETTAVAT FABLELLE YHDEN VIESTIN (TILANNE, VAIHTOEHDOT, SUOSITUS) JA JATKAVAT MUUTA TYOTA; FABLE PAATTAA RAAMATUN SISALLA, VAIN OMISTAJAN VALINNAT KORTTINA FABLEN OMASSA SESSIOSSA + PUSH; SYY: MUIDEN SESSIOIDEN KORTIT EIVAT NOUSE OMISTAJALLE PONNAHDUSIKKUNANA; TYOPOYTASOVELLUKSEN LUPAIKKUNASTA ILMOITUS FABLELLE (25.9.2026 klo 04.42)

Postivahti pushaa uudelleen Fablen yli 10 min auki olleesta kortista. Kaikille sessioille ilmoitettu; aloitusviestipohjat päivitetään seuraavassa nollauksessa.

## JUMI → FABLE VALITETTY KAIKILLE 10 SESSIOLLE (2 SendMessage-ESTOA → VARAKANAVA); LAITETESTAAJA (3de5248e2): iPAD-ATTACH ONNISTUI OMISTAJAN OLLESSA KONEELLA, BUILD 12:N SAVUKIERROS iPHONELLA JA iPADILLA KAIKKI PASS, KUITATTU NATIIVISEPALLE (25.9.2026 klo 04.45)

Lupaikkuna oli työpöytäsovelluksen laitelupa Laitetestaajan sessiossa.

## OMISTAJAN LOYDOKSET 53–59 BUILD 12:STA (klo 04.5x): 53 OHITA-NAPPI EI LOPETA PULUN PUHETTA; 54 PULULLA PUHEKUPLA UUTEEN KAUPUNKIIN SAAVUTTAESSA VAIKKA EI PITAISI; 55 NOPAN HEITTO EI JATKU AUTOMAATTISESTI LIFTATESSA; 56 KARTTA EI ZOOMAA NOPAN HEITON JALKEEN → VALITTAVAT KOHTEET JAAVAT PIILOON; 57 REITTI EI AINA PIIRRY; 58 MAAILMA-TILASSA PELAAJA EI PAASE VAIHTAMAAN KAUPUNKIIN; 59 KAUPUNKILEHTI AVAUTUU SAAVUTTAESSA VAIKKA EI PITAISI → PELIKOODARI (53–55, 57–59 PELILOGIIKKA WEBIN MUKAAN), NATIIVISEPPA (56 KAMERA), NATIIVI-UI (59 LEHDEN AVAUS); KAIKKI BUILD 13:EEN (25.9.2026 klo 04.53)

Jokaiseen: webin käytös mitattuna (video tai kuvapari) ennen korjausta, WEB ON MALLI.

## OMISTAJA klo 04.5x: LOYDOS 60 SIIRTYMAREITIT JAAVAT NAKYVIIN SAAPUMISEN JALKEEN; LISAKSI PALJON MUITA VIRHEITA LIIKKUMISESSA JA REITEISSA → BUILD 13:N PAATEEMA: LIIKKUMISEN JA REITTIEN PARITEETTIKIERROS — KOKO KETJU (NOPPA → KOHTEET → VALINTA → MATKA/LENTO → SAAPUMINEN → VALIKORTTI → KARTTA; REITTIVIIVAT, KULJETTU REITTI, SIIRTYMAREITIT, PULU, OHITA, LEHTI) VERRATAAN WEBIIN VAIHE VAIHEELTA JA KORJATAAN YKSITYISKOHTAISESTI (PELIKOODARI OMISTAA, LAITETESTAAJA MITTAA WEBIN VIDEOT, NATIIVISEPPA KAMERA, NATIIVI-UI LEHDET) (25.9.2026 klo 04.56)

Löydökset 53–60 ovat saman ketjun oireita; korjataan kerralla tarkistuslistan kautta, ei yksittäin.
...
## OMISTAJA klo 05.1x (SITOVA, LOYDOS 68, iPHONE, KUVAT loydos68-iphone-palkki-piilossa.png / -nakyvissa.png): PALKKI PIILOTETTUNA HAMPURILAINEN MUUTTUU KOLMEKSI VAKASEKSI JA PYSYY HAMPURILAISEN PAIKALLA (NYT ALEMPANA PILLERIN RIVILLA); HAMPURILAINEN JA RAHA/PAIVA-PILLERI HIEMAN SISEMMAS REUNOISTA; ISOISAN PAIKKAKUPLA HAVIAA SAMAAN AIKAAN YLAPALKIN KANSSA → NATIIVI-UI, BUILD 13; RAAMATTU TARKENNETTU (YLAPALKKI-KOHTA) (25.9.2026 klo 05.12)

Aiempi muotoilu 'kolmen väkäsen nappi (☰)' oli tulkittu hampurilaiseksi.
...
## RAAMATTU MAINISSA PR #3137 (JULKAISIJA, 4288/0): JULKAISIJA NOUDATTAA UUSIA KOHTIA TIEDOSTOSTA; FABLEN HAARAN .claude/settings.json JA CLAUDE.md JATETTIIN MAINISTA POIS (LUPAMUUTOKSET OMISTAJALLE). LOYDOS 71 DIAGNOSOITU (LINSSISEPPA): NAPIN TrickleDown-StopPropagation NIELEE NAPAUTUKSEN 'radio'-TEKSTIIN → LAPSILLE PickingMode.Ignore (Mediarivi.cs, NATIIVI-UI); WEB-MALLISSA KARTUSCHAN RADIO SOITTAA MAAN ASEMAN KORTISSA, EI AVAA LINSSIA — PYSYY WEBIN MUKAISENA (25.9.2026 klo 05.17)

Fablen haaran synkkaus mainiin jätetään Julkaisijalle (merge-yritys tuotti 7 ristiriitaa, peruttu).

## B25/D14 (NATIIVISEPPA): LENNON ESITYS KAIKILLE LENNOILLE = A, HYVAKSYTTY POIKKEAMA; KESTOA EI KIINNITETA WEBIN 2,8 s:IIN (TEMPO/KAMERA-AJOT, OHITUS NAPAUTUKSELLA); ENNEN LAHTOA JA LASKUN JALKEEN WEBIN TILA. LOYDOS 56 TEHTY (natiiviseppa/kohdesovitus 8961981); KAKSI OPUS-AGENTTIA REITEILLE JA SAATTOKAMERALLE, NATIIVISEPPA D7/D8/D11 (25.9.2026 klo 05.19)

Webissä rajausajo 1,1 s + kone 44 px 2,8 s + punainen jälki.

## OMISTAJA klo 05.4x (SITOVA, PERUUTUS, LOYDOS 73): iPHONEN PYSTYASENNOSSA YLAPALKKIA EI PIILOTETA — AINA NAKYVISSA; PIILOTUS JA VAKASNAPPI VAIN VAAKAMUODOSSA; MUUT YLAPALKIN MUUTOKSET VOIMASSA; PILLERI MATALAMMAKSI (DYNAMIC ISLANDIN KORKEUS) JA HAMPURILAINEN SAMAAN KORKEUTEEN; ISOISAN PAIKKAKUPLA PIENENNETTYNA VAIN TEKSTIN LEVYINEN JA NAYTTAA VAIN KAUPUNGIN NIMEN → NATIIVI-UI, BUILD 13; RAAMATTU PAIVITETTY (25.9.2026 klo 05.27)

Korvaa 24.9. klo 16.1x:n automaattisen piilotuksen pystyasennossa; löydös 68:n väkäsnappi ja sisennys jäävät voimaan vaakamuodossa ja marginaalit pystyssä.

## CODEXIN KATALOGIKUVAT POSTILAATIKOSSA (9633da03c JA AIEMMAT: ERA 1b-TAYDENNYS, 2a, 2b, 2-05…2-10; VIIMEISET R19–R34 JA X1–X5, 38 OBJEKTIA/ERA media.matkakirja.app/linssikatalogi/, R28 JA R32 ILMAN CC-LAHDEKUVAA) → SISALTOKIRJURI TARKISTAA JA PAIVITTAA linssikatalogi-data.js:N YHDELLA PR:LLA; SISALTOJUNA VASTA POLTON JALKEEN (25.9.2026 klo 05.28)

Julkaisijan ilmoitus klo 05.3x.

## LINSSIKATALOGIN KUVITUS (SISALTOKIRJURI): 142/155 TILATUSTA KUVITETTU, 13 ILMAN (X6, X7, B8, B9, D7, F5, P6, E10, R36, Q1–Q4 — JONON HANTA), 5 ILMAN CC-AIKALAISKUVAA DOKUMENTOIDUSTI (C7, R4, R20, R28, R32); KUVATEKSTIT + LAHTEET KUVATEKSTIT-TAULUKOSSA linssikatalogi.html:SSA, data.js KOSKEMATON (FABLE: KELPAA); PR + KAAPPAUKSET TULOSSA (25.9.2026 klo 05.33)

Kuvapolut noudattavat data.js:n geneeristä kaavaa <id>-havainne.jpg jo #3128:sta asti.

## OMISTAJAN LOYDOS 74 BUILD 12:STA (iPHONE, IHMISEN MATKA -LINSSI, KUVAT loydos74-iphone-ihmisen-matka-ylapalkki.png / -pallo.png, SITOVA, RAAMATTUUN): a) KAIKKIEN LINSSIEN LOGO JA ☰/SULJE DYNAMIC ISLANDIN KORKEUDELLE, KAAREVAT KULMAT HUOMIOON; b) JATKA/TAUKO JA ☰ PAREMMALLA TAUSTAVARILLA; c) VUOSILUKU VASEMPAAN REUNAAN; d) PALLON VIRHEET (PIENESSA PALLOSSA MAAKUNTARAJAT MUSTANA LAISKANA EUROOPASSA, TEKSTI PALLON PAALLA); e) LINSSIN ALKAESSA PALLO EI SAA VILAHTAA ISONA JA KUTISTUA NAKYVISSA — PIILOSSA; f) UUDELLEENALOITUS: KERTOJA JATKAA VANHASTA KOHDASTA VIRHEELLISESTI → ALUSTA. → NATIIVI-UI (a–c), NATIIVISEPPA (d–e), LINSSISEPPA (f + linssin ohjaus); BUILD 13 (25.9.2026 klo 05.35)

Owner: 'Muista aina tarkistaa että koska ylhäällä ruutu kaareutuu niin ota se sijoittelussa huomioon.'

## OMISTAJA klo 05.4x (LOYDOS 75): UNITYN 'MADE WITH UNITY' -ALOITUSRUUTU POIS (UNITY 6: SALLITTU KAIKILLA LISENSSEILLA) JA TILALLE OMA YHTENAINEN AVAUS — iOS LaunchScreen MATKAKIRJA-LOGOLLA PERGAMENTILLA + PELIN ALOITUSRUUTU SAMALLA KUVALLA ILMAN VALAHDYSTA → NATIIVISEPPA, BUILD 13 (25.9.2026 klo 05.37)

Vaihtoehto: omat logot Unityn splash-jonoon — ei käytetä, koska oma avaus on yhtenäisempi.

## LAITETESTAAJA 71 % → LUOVUTUS JA NOLLAUS KASKETTY; LEVY LASKI 155 → 111 Gt TUNNISSA POLTON AIKANA (ARVIO OLI 10–12 Gt HUIPPU) → KARTTASEPPA TARKISTAA, RAJA: JOS HUIPPU UHKAA YLITTAA 70 Gt, PALLO-OSUUS JAETAAN KAHTEEN AJOON (25.9.2026 klo 05.39)

Postivahdin ilmoitus klo 05.4x.

## OMISTAJA klo 05.5x (SITOVA, LOYDOS 76, iPHONE, KUVA loydos76-iphone-matkalaukku-logo-ja-musta-kartta.png): MATKAKIRJA-LOGO AVATUN MATKALAUKUN OIKEAAN YLAKULMAAN, SAMA LINKKI TEKIJATIETOIHIN JA LAHTEISIIN KUIN WEBIN LOGOSSA → NATIIVI-UI; RAAMATTUUN. FABLEN HAVAINTO SAMASTA KUVASTA (LOYDOS 77): KARTTA MUSTANA ASTEVERKKOINEEN SAHARAN ETELAPUOLELLA (AL KUFRA / DARFUR / BAHR EL GHAZAL), LAATAT PUUTTUVAT TAI EIVAT LATAUDU MATKALAUKUN OLLESSA AUKI → NATIIVISEPPA, KIIREELLINEN (25.9.2026 klo 05.41)

Kuvassa pergamentti loppuu terävään viistoon rajaan ja alapuoli on mustaa asteverkkoa; sumennus (kartan sumennus kuvien aikana) näkyy alareunassa.
...
## PARITEETTISIMULAATTORIT (PELIKOODARI): 4 SIMUA 11,5 Gt, SOVELLUSDATA VAIN 0,44 Gt, LOPUT iOS-POHJAA; siivoa-pariteettisimut.sh (--aja) TEHTY — FABLE: SIMUJA EI POISTETA, --aja JOKAISEN PARITEETTIAJON LOPUSSA; PARITEETTISIMUT OVAT CLAUDEN TYOKALUA, EIVAT OMISTAJAN TIEDOSTOJA (25.9.2026 klo 05.52)

Lokikansiosääntö (pysyvät poistot omistajalle) koskee lokikansioita, ei Clauden luomia simulaattoreita.

## LOYDOS 77 JUURISYY (NATIIVISEPPA): EI KATTAVUUSVIKA — MUSTA ALUE OLI RADION HAMARA JA 'ASTEVERKKO' MASTON RENKAAT + MAAVALO BAHR EL GHAZALIN KOHDALLA; RADION MASTOVISUAALIT JAIVAT PALLOLLE VAIKKA RADIO EI OLLUT AUKI → VARMISTUS RadioMastoihin (NOLLAUS JOKA KEHYS KUN LINSSI EI AUKI) + SULKUPOLUN SELVITYS LINSSISEPAN KANSSA; OMISTAJALTA KYSYTTY, SOIKO ASEMA SUDANISSA ENNEN KUVAA (25.9.2026 klo 06.00)

Löydös 77 uudelleenluokiteltu radion sulkuviaksi (liittyy 71:een ja Linssisepän radio-sulku-pohjaan).

## PELIKOODARI 70 % → LUOVUTUS JA NOLLAUS KASKETTY (LUOVUTUS -20260925.md, clear_session SAMASSA VUOROSSA, LEPOILMOITUS TILATTU) (25.9.2026 klo 06.04)

Postivahdin ilmoitus klo 06.0x.

## LINSSIKATALOGIN KUVITUS PR #3138 (SISALTOKIRJURI, v2214, TESTIT 4304/0): 142/155 KUVITETTU, 13 ILMAN (JONON HANTA), 5 ILMAN CC-KUVAA DOKUMENTOIDUSTI, KAAPPAUKSET 4 VALILEHDESTA → JULKAISIJAN SISALTOJUNAAN POLTON JALKEEN (25.9.2026 klo 06.05)

Julkaisija näkee PR:n jonossaan; ei erillistä käskyä.

## PELIKOODARI NOLLATTU (LUOVUTUS -20260925.md, pelikoodari-tyo-20260923 5c95b2c3f; ALOITUSVIESTI LAHETETTY: pelikoodari/liikkuminen fb0a30e TODENNUS → MERGE-PYYNTO JA VIDEOPARI, SITTEN 61/63/66/67) (25.9.2026 klo 06.08)

Nollaus kaavan mukaan (clear samassa vuorossa, list_events 0).

## LEVYSIIVOUS (NATIIVISEPPA): vapauta-levy-natiiviseppa-20260925.sh VAPAUTTAA 24,5 Gt (VANHAT SCRATCHPADIT 17,7, Build/laite + dd-laite 6,2, LAATTAVALIMUISTIT 0,7) — FABLE: SALLITTU AJAA ITSE (CLAUDEN OMAT TYOTIEDOSTOT, EI OMISTAJAN; 24.9. SAANTO KOSKEE LOKIKANSIOITA); KAANNOSPALVELU ON JO INKREMENTAALINEN (49 Gt OLI KIRJOITUSMAARAA, EI KULUMISTA); iPAD PRO 11:N 3,6 Gt VANHAT KONTIT SIMULAATTORIN OMISTAJALLE (25.9.2026 klo 06.15)

44 Gt/h lasku jäi ilman yksiselitteistä syytä; levy vakaa 110 Gt, Postivahti seuraa.

## LOYDOS 67 JUURISYY (PELIKOODARI): PULUN WORKER — SONNET 5 AJATTELI OLETUKSENA JA AJATTELU SOI 900/350 TOKENIN RAJAN → PR #3139 (AJATTELU POIS MALLIN MUKAAN + KATKAISU VIIMEISEEN KOKONAISEEN VIRKKEESEEN, 197/197), JULKAISIJALLE; LOYDOS 66: PELIKOODARIN OSA pelikoodari/pulu-puhe b3e0b67 (CHATIN LUKU PULUN PUHEEKSI), NATIIVI-UI:N OSA (welcome/wink/dash-KETJU, MIETINTAELEET, KOKO) VALITETTY; LIIKKUMISEN YHDISTELMA (juna/b13 + 5 HAARAA, 274/274) KAANNOSJONOSSA; LEVY: NATIIVISEPAN SIIVOUS −24,5 Gt → 126 Gt VAPAANA (25.9.2026 klo 06.27)

Natiivi-UI:n järjestys annettu: 69/70 → 65 → 73/68 → 62/64/71/72/74/76 → 66.

## KUORMA 500–900 (POLTTO 16 YDINTA + UNITY + PLAYWRIGHT + CI RUNNER): NATIIVI-UI:N SIMULAATTORITODENNUS JA KAAPPAUS EPAONNISTUVAT, KAANNOS 50 min → FABLE: POLTTO 8 YTIMEEN (PALLO VALMIS ~11), NATIIVI-UI JATKAA KOODITYOTA JA TODENTAA KUORMAN LASKETTUA; JUNASSA 65 VALIKKO JA 62 OPAS (juna/b13 3e8fe0c), TODENTAMATTA 59, 71, 64, 74 a–c (25.9.2026 klo 06.32)

Työnjohtajan harkinta: build 13:n todennukset omistajan löydöksistä ovat tänään tärkeämpiä kuin kartan valmistuminen klo 08.45.

## POLTTO 8 YTIMEEN klo 06.33 (KARTTASEPPA): JATKUU JATKOKOHDASTA, 91/378 POHJASHARDIA VALMIINA (HITAAMPI KUIN ARVIO 1,5 h), PALLO SAMASSA AJOSSA PERAAN — VALMISTUMINEN TODENNAKOISESTI ILTAPAIVALLA (25.9.2026 klo 06.33)

Loput pohjashardit ja pallo Z0–Z9 8 ytimellä; Karttaseppä ilmoittaa kun sarja on koossa.

## LINSSIKATALOGI 155/155 KUVITETTU (SISALTOKIRJURI, PR #3138 PAIVITETTY, 4304/0): ERAT 2-11 JA 2-12 TOIVAT HANNAN 13 LINSSIA, O6 KUVAPAIVITYS (BACON 1923), 5 ILMAN CC-AIKALAISKUVAA DOKUMENTOIDUSTI; VALMIS SISALTOJUNAAN (25.9.2026 klo 06.40)

Kuvaputken linssikatalogitilaus on siten kokonaan toimitettu.

## LOYDOS 69 JUURISYY (NATIIVI-UI natiivi-ui/selite-69 61e9d9b): NOSTOT-RIVIEN Clickable KAAPPASI PAINALLUKSEN → RIVIT EIVAT OTA OSUMAA, VEDON AIKANA EI VIERITYSTA; LOYDOS 70: WEBISSAKIN MAAKUNNAT VAIN 8 MAALLE JA MUISSA OLETUKSENA RANSKA (karttatyokalu-maakunnat.js:297) — FABLE: BUGIKORJAUS MOLEMPIIN (EI POIKKEAMA): NYKYISEN MAAN RYHMA AVATTUNA, MUISSA MAISSA TEKSTI 'TALLE MAALLE EI OLE VIELA MAAKUNTIA' + MUUT RYHMAT SULJETTUINA, LISTA PAIVITTYY SAAPUMISESSA → NATIIVI-UI (NATIIVI) + PELIKOODARI (WEB-PR) (25.9.2026 klo 07.05)

Web on malli tarkoitetulta käytökseltään; ilmeinen webin virhe korjataan molempiin.

## NATIIVI-UI 73 % → LUOVUTUS JA NOLLAUS KASKETTY (LUOVUTUS -20260925-l.md, KOKO LOYDOSLISTA TILOINEEN, clear_session SAMASSA VUOROSSA, LEPOILMOITUS TILATTU) (25.9.2026 klo 07.06)

Toinen nollaus tänään (edellinen 02.46); syynä löydösten 61–76 tiheä virta.

## LIIKKUMISEN ERA TODENNETTU (PELIKOODARI pelikoodari/liikkuminen b089ece, KAANNOS c535aea, iPHONE): 55 AUTOMAATTIHEITTO, 56 KOHDESOVITUS, 57/60 REITIT, A20/A21 KOREOGRAFIA (ASKEL 860 ms, TAUKO 190 ms), 53 VAIENNUS, 58 MAAILMA-HYPPY OK; 59 KORJAUS NATIIVI-UI:N a91cbfd:SSA (KAANNOKSESSA VANHA); LISAKSI D17 (KORTTI VASTA 420 ms KAMERA-AJON JALKEEN) JA 'SAAVUIT'-ILMOITUS POIS (WEB EI NAYTA); VIDEOPARI proto-3d/lokit/liikkuminen-pariteetti/videopari-j3-j4-*.mp4; MERGE-PYYNTO NATIIVISEPALLE (BUILD 13). SIVULOYDOT: 'SOFIA' PIIRTYY TUPLANA (NATIIVISEPPA), MAAILMA-HYPYSSA ATEENAN LUENTOKORTTI JAA LONTOON TRAILERIN VIIMEISEKSI KUVAKSI (NATIIVI-UI) (25.9.2026 klo 07.08)

Sivulöydöt kirjataan Natiivisepälle ja Natiivi-UI:lle aloitus-/luovutusviesteihin; Pelikoodari on ilmoittanut ne suoraan.

## NATIIVISEPAN ERA juna/b13 2abbbcf: KAUPUNKINIMET WEBIN EHDOKASKEHALLA (LUKKO, LIIKEVARA, NAPPULAN VAISTO), LOYDOS 56, D7/D8/D11 (LOITONNUKSEN KATTO, PANOROINTIRAJA), REITIT B4/B5/B10/B23/A14/D15, SAATTOKAMERA A20/B12–B16, LOYDOS 75 (UNITYN LOGORUUTU POIS, PERGAMENTTI + LOGO, ALOITUSVERHO), LOYDOS 77 (RADION VAHTI), NATIIVI-UI:N 65 JA 62; TESTIT 141/141, UNITY 0; KUVAT lokit/b13-yhdistelma; AVOINNA 74 VIDEO, 75 LAITEVIDEO, PELIKOODARIN LIIKKUMINEN-MERGE, YOVALOT, LENTOPINNAN KYLMAKOE; BUILD VASTA SAVUKIERROKSEN JALKEEN (25.9.2026 klo 07.09)

Käännösvahti kääntää 2abbbcf:n automaattisesti Laitetestaajan simuihin.

## LOYDOS 74 VALMIS (LINSSISEPPA, YHDISTELMAKAANNOS 74f7cc5, SHA:T JUNAAN b13): f) 'ALOITA ALUSTA' NOLLAA KERTOJAN (AANI JAI TAUOLLE, EI KELAUTUNUT → ihminen-74 5dc65e0, 236/236); e) AVAUS ALKAA PIENESTA PALLOSTA ILMAN VALAHDYSTA (NATIIVISEPPA 902ec5f); a–c) LINSSIPALKKI SAAREN RIVILLA, VUOSILUKU VASEMMALLA (NATIIVI-UI 17783d8); d) LAISKAA EI NAY; LOYDOS 77: RADION SULUN JALKIAJO KATKESI → radio-sulku-varmistus 2cf6ed9 + VAHTI; VIDEO proto-3d/lokit/loydos74-video-20260925/ihmisen-matka-pieni.mp4; AVOINNA KERTOJAN TEKSTIN VARJO (NATIIVI-UI) (25.9.2026 klo 07.11)

Löydös 77:n juurisyy oli radion sulun jälkiajon katkeaminen (renkaat ja hämärä jäivät).

## LOYDOS 70 KORJATTU WEBIIN (PELIKOODARI PR #3140, 4289/4289 + SAVUKE maakunnat-oletusmaa 4/4): NYKYISEN MAAN RYHMA AUKI, MUISSA 'TALLE MAALLE EI OLE VIELA MAAKUNTIA', TALLENNETTU VALINTA EI PIDA RANSKAA AUKI, LISTA PAIVITTYY SAAPUESSA; #3139 (67) VIHREA → JULKAISIJALLE MOLEMMAT HETI; LIIKKUMINEN JUNASSA juna/b13 cfdc127 (25.9.2026 klo 07.19)

Pelikoodari todentaa 59:n käännöksessä cf195a1.

## LAITETESTAAJA (8264d507f): LIIKKUMISEN VIDEOT J3/J4 NATIIVI + WEB JA J5 WEB (docs/raportit/liikkuminen-pariteetti-videot-20260925.md) PELIKOODARILLE; J5 NATIIVI VAATII KEHITTAJA-KEYCHAIN-KOODIN (EI KIIRE); SIVUHAVAINTO: MCP:N iOS SIMULATOR -KOSKETUSTYOKALU EI TOIMINUT SESSIOSSA (KUORMA?), KIERRETTY TEKSTIKOMENNOIN (25.9.2026 klo 07.27)

Kehittäjäkoodi on Keychainissa (AVAIMET NATIIVISSA); Pelikoodari tietää polun.

## #3139 MAINISSA (4292/0); #3140 ODOTTAA: SAVUKE nostojen-liikevara KAATUI POIKKEUKSEEN 0/0 VAIN TASSA PR:SSA (MUUALLA 10/10) → PELIKOODARI TUTKII HETI (paivitaMaa ILMAN PANEELIA?), JULKAISIJA UUSII SAVUKKEET POLTON JALKEEN (25.9.2026 klo 07.39)

Muut punaiset (astro-pallo, nimiot-elavat, webkit) heiluvat kuormassa kaikissa haaroissa.

## #3140 LIIKEVARA-PUNAINEN OLI INFRAA (PELIKOODARI): PLAYWRIGHTIN SELAINYHTEYS KATKESI KAYNNISTYKSESSA 4 s KOHDALLA (JSON.parse coreBundle) 6 RINNAKKAISESSA SARJASSA POLTON AIKANA, EI SIVUVIRHEITA; PAIKALLISESTI 10/10 → EI MUUTOSTA, JULKAISIJA UUSII POLTON JALKEEN (25.9.2026 klo 07.46)

Vahvistaa säännön: ei PR-savukkeita polton aikana.

## NATIIVI-UI BUILD 13 -TILA klo 07.5x: JUNASSA 65, 62, 59 JA LIIKKUMISRIVIT; MERGE-PYYNNOISSA TODENNETTUINA 69, 71, 64 (KAUPUNKILEHTI 1:1, HEITTO 553 pt — OMISTAJAN NYKIMINEN TODENNAKOISESTI LAITTEEN SUORITUSKYKYA, MITATTAVA LAITTEELLA); KAANNOSJONOSSA 73/68, 63 (KOHDEKARTALTA PUUTTUIVAT KAIKKI TYYLIT), 72, 76, 66, 74 d2 JA LUENNAN KUVAT MAAILMAHYPYN JALKEEN; 70:N VASTAUS (b) JA NOLLAUSKASKY OVAT SESSION JONOSSA (25.9.2026 klo 07.48)

Sessio 85 %; ei lisäviestejä ennen vuoron päättymistä.
...
## SISALTOJUNA (JULKAISIJA, KUORMAN LASKETTUA): #3138, #3134, #3122, #3106, #3043, #3005, #2988; KONFLIKTISSA #3126 (LAITETESTAAJA) JA #3069/#3068/#3066/#3045 (SISALTOKIRJURI) → TEKIJAT REBASEAVAT; VANHAT SISALTO-PR:T (10 kpl) → SISALTOKIRJURI TARKISTAA VANHENTUMISEN JA LISTAA SEURAAVAAN JUNAAN. PELIT SAMMUTETTU 5/6 SIMULAATTORISTA, coreaudiod YHA 320 % — VAATII sudo killall coreaudiod (OMISTAJA) (25.9.2026 klo 08.09)

Laitetestaaja sammutti omansa ja välitti säännön; iPad Pro 11:ssä peli yhä käynnissä (Natiivi-UI:n todennus).
...
## SISALTOKIRJURI NOLLATTU (LUOVUTUS -20260925.md, sisalto-tyo-20260924-1805 584c9f8d3; ALOITUSVIESTI LAHETETTY): VANHOJEN SISALTO-PR:IEN AUDIT — 9 REBASETTU JA VIHREA, #2897/#2895 (NC-LISENSSIKORVAUKSET) REBASETTU, CI VAHVISTAMATTA, #2991 (JULISTEET BERGEN/SEVILLA) AIDOSTI PUNAINEN: JULISTEKUVAT PUUTTUVAT → TILAUS KUVAPUTKELLE, #2981 JA #2935 SULJETTU VANHENTUNEINA; SISALTOJUNAN MEKANIIKKA KERROTTU (4 PR / 4 h, JULKAISIJA AJAA) (25.9.2026 klo 09.01)

Nollaus kaavan mukaan (clear samassa vuorossa, list_events 0).

## OMISTAJA MERGESI PR #3142 (SUDO-SALLINNAT settings.json:IIN) klo 09.04 gh pr merge -KOMENNOLLA — HUOLTOKOMENNOT VOIMASSA KAIKISSA CHECKOUTEISSA MAININ KAUTTA; POSTIVAHTI VOI AJAA coreaudiod-KORJAUKSEN (25.9.2026 klo 09.05)

Roolit saavat sallinnat seuraavassa git pull -kierroksessa; Postivahdille ilmoitettu.

## SISALTOKIRJURI: 14 PR:N AUDIT VALMIS (#2897/#2895 VIHREITA, TAULUKKO JULKAISIJALLE); #2991:N JULISTEKUVAT BERGEN + SEVILLA TILATTU KUVAPUTKELTA (3ee87f1d3); SEURAAVAKSI RENESSANSSISALIN TEOSLUETTELO CODEXIN MANIFESTEISTA (LINSSISEPALLE), #3045 REBASE, GALLERIA 59:N TILAUS #3106:N MERGEN JALKEEN (25.9.2026 klo 09.06)

Teosluetteloon kipsivalos-huomautus (SMK PD Mark, ei marmorin skannaus) ja Pietà Moseksen tilalle.

## SISALTOJUNA #3143 MAINISSA v2215 (4293/0): #3138 KATALOGIN KUVITUS 155/155, #3134, #3122, #3106 GALLERIA 59 -KUVATILAUS, #3043, #3005, #2988, #3126 NAPPI-INVENTAARIO; TOINEN JUNA (11 AUDITOITUA PR:AA) KUORMAN ALLE 150; #2991 PIDOSSA KUVIEN TAKIA (25.9.2026 klo 09.07)

Linssikatalogi täysin kuvitettuna tuotannossa v2215.

## RENESSANSSISALIN TEOSLUETTELO PR #3144 (SISALTOKIRJURI: 42 MAALAUSTA, 16/18 MUOTOKUVAA, 5 VEISTOSTA — PIETA MOSEKSEN TILALLA —, 3 KARTTAA) → LINSSISEPALLE; #3045 PUHDAS JA VIHREA; GALLERIA 59: TILAUS OLI JO LAHETETTY 24.9. JA KAIKKI 4 ERAA TOIMITETTU → SISALTOKIRJURI INTEGROI KUVAT PELIIN (YKSI PR) JA KUITTAA CODEXILLE (25.9.2026 klo 09.11)

Fablen virhe: luovutuksen jonokohta 4 (galleria 59) oli jo tehty; tarkistan postilaatikon ennen tilauskäskyjä.

## PERUSKARTTASARJA 2026-09-25 VALMIS LEVYLLA klo 09.11 (KARTTASEPPA): PYRAMIDI 378/378 (POHJA, VIIVAT, NOSTOT, RANTA), PALLO Z0–Z9 349 525 LAATTAA, EHEYS OK, 8,7 Gt — FABLE: PALLO UUSIKSI ILMAN VIIVATASOA (~35 min, NATIIVI PIIRTAA RAJAT VEKTORINA), SITTEN AMPARIIN (pyramidi/2026-09-25-*, pallo/laatat/2026-09-25-pohja-20260925), POLUT NATIIVISEPALLE BUILD 13:EEN; WEBIN OSOITIN VASTA OMISTAJAN KUVAKOKEILUN JALKEEN (25.9.2026 klo 09.12)

Poltto valmistui ennen arviota, koska pohja oli jo tehty tauolle mennessä.

## TAIDEMUSEO-SUUNNITELMA PAIVITETTY TEOSLUETTELOLLA (LINSSISEPPA PR #3145, LUKU 4.5 AINEISTO RAITOIHIN: MAALAUKSET TEOSPAIKKOIHIN, MUOTOKUVAT MEDALJONKEIHIN, VEISTOKSET JALUSTOILLE KIPSIVALOSMERKINNALLA, 3 KARTTAA); LOYTO: TAYSI SUUNNITELMA OLI VAIN TYOHAARASSA, PR TUO SEN MAINIIN; FABLE: LEONARDON MUOTOKUVA VAIHDETAAN RIJKSMUSEUMIN/NGA:N PD-KAIVERRUKSEEN (ITALIAN JULKISYHTEISON AINEISTO VALTETAAN), PIETAN R2-POLKUUN matkakirja/-ETULIITE → SISALTOKIRJURI (25.9.2026 klo 09.14)

Sama linja kuin päätöksessä 1 (Codice-riski).

## FABLE JULKAISIJALLE: #3144 JA #3145 SEURAAVAAN JUNAAN; YLEISSAANTO — VIHREAT DOCS- JA SISALTO-PR:T ROOLEILTA JUNAAN ILMAN FABLEN HYVAKSYNTAA, KYSYTAAN VAIN SAANNOISTA, LUVISTA, AMPARIN OSOITTIMESTA JA APP STORE -JULKAISUSTA (25.9.2026 klo 09.14)

Tokenisäästö: Fablelle vain päätökset (Ydinajatus C).

## OMISTAJA klo 09.3x: JARJESTELMAN VALVOJA — 64 Gt RAM, SIVUTUS 22,3/23,5 Gt TAYNNA (AAMUN JUMIEN SYY): 16 POLTTO-NODEA × 0,4 Gt + 6 SIMULAATTORIA × 2,6 Gt + PLAYWRIGHT-CHROMIUMIT ~1 Gt × 6 + 11 CLAUDE-SESSIOTA × 1,3 Gt → SAANNOT: JOUTILAAT SIMULAATTORIT SAMMUTETAAN KOKONAAN (shutdown, 30 min), SAVUKKEET ENINTAAN 3 RINNAKKAIN SIMULAATTORIEN KANSSA, POSTIVAHTI HALYTTAA SIVUTUKSESTA > 16 Gt, POLTTO EI PAIVAKAYTON KANSSA TAYSILLA (25.9.2026 klo 09.23)

Vapaata muistia 63 % polton päätyttyä.

## OMISTAJA klo 09.3x (SITOVA, RAAMATTUUN): UUSIA LINSSEJA EI ALOITETA ENNEN KUIN PARITEETTI ON VARMASTI VALMIS — EI TOTEUTUSTA EIKA UUTTA SUUNNITTELUA (MAAPALLON TILA, TAIDEMUSEO, DATALINSSIT); VALMIS = LIIKKUMISLISTA 0 ERI, PARITEETTIAJO 0 YLI 16 px, OMISTAJAN BUILD-KOKEILU ILMAN UUSIA LOYDOKSIA; LINSSISEPPA OLEMASSA OLEVIEN LINSSIEN PARITEETTIIN JA RADIOUUDISTUKSEN LOPPUUN (25.9.2026 klo 09.24)

Valmiit suunnitelmat (#3145, Maapallon tila -aineistosuunnitelma) jäävät odottamaan.

## OMISTAJA klo 09.4x (SITOVA, LOYDOS 78, BUILD 12): RUSKEA YLAPALKKI HIEMAN KORKEAMPI SEKA iPADILLA ETTA iPHONELLA — iPAD WEBIN 57 pt, iPHONE NYKYISTA KORKEAMPI MUTTA WEBIA MATALAMPI, NATIIVI-UI EHDOTTAA MITAT KUVAPARILLA → NATIIVI-UI, BUILD 13; RAAMATTU TARKENNETTU (25.9.2026 klo 09.38)

Liittyy löydöksiin 68/73 (pilleri Dynamic Islandin korkeus, väkäsnappi vaaka).

## OMISTAJA klo 09.4x (SITOVA, LOYDOS 79, BUILD 12): KARTTANOSTOJEN IKKUNOITA (KORTTEJA) SAA LIIKUTTAA VAIN YLAREUNASTA (OTSIKKOKAHVASTA), EI KOKO ALALTA — SISALTOALUE VARATAAN VIERITYKSELLE JA NAPAUTUKSILLE → NATIIVI-UI, BUILD 13, WEBIN KAHVA MALLINA (25.9.2026 klo 09.38)

Sama koskee kaikkia raahattavia kortteja natiivissa.

## SISALTOKIRJURI: #3144 KORJATTU (LEONARDO → RIJKSMUSEUM, PIETAN R2-POLKU), GALLERIA 59 -INTEGRAATIO PR #3147 (36/38 KUVAA 30 KAUPUNKIIN, 2 OLI JO PELISSA, KUITTAUS CODEXILLE, TESTIT 70/70) → SEURAAVAKSI PUUTELISTA CODEXILLE (59 TILATTU, 30 SAATU) JA TYOLISTAN SEURAAVA SISALTOKOHTA (25.9.2026 klo 09.44)

Ei linssityötä ennen pariteettia.

## GALLERIA 59: TAYDENNYSTILAUS CODEXILLE (ROBINSON CRUSOE + PUERTO MONTT PUUTTUIVAT); tyolista-opukselle.md VANHENTUNUT (O6/O7/O8 JO TOTEUTETTU) → SISALTOKIRJURI PAIVITTAA SEN JA ALOITTAA TURISTIOPPAAT 71 KAUPUNGILLE 3 KAUPUNGIN ERINA (LONTOON/PARIISIN KAAVA), JATKUVA TEHTAVA ILMAN ERILLISTA LUPAA (25.9.2026 klo 09.49)

Lähde docs/raportit/sisalto-inventaario-20260924.md.

## NATIIVI-UI ERA JUNAAN b13 (TODENNETTU iPHONE 2c1cc6f5): 70, C16 (LIVIAN PALJASTUS, OHJEKUPLAT, LUENNAN LYKKAYS), D6, 66, 72, 76, HYPPYKUVAT; KORJATTU TODENNUKSESSA 73 (SAARI 49,7 pt JA PILLERI 5,6 pt LIIAN ALHAALLA), 63 (UNITY EI PURA webp → ImageIO, 6/8 KOHDEKARTAN PIIRROSTA PUUTTUI), 74-LAAJENNUS; 74-LINJAUS: OMA YLAPALKKI VAIN AIKAJANALLA, MUUT LINSSIT PELIN YLAPALKILLA (SAARIRIVI 73:STA); AVOIMET 63 LEHTINIMIO JA MITTAKAAVA, 72 VAAKUNAOSIO; UUSI VIKA: IHMISEN MATKA MUSTA RUUTU TRAILERIN AIKANA → LINSSISEPPA; LAITETESTAAJAN JUMITTUNUT b13-VIENTI TAPETTU 08.21 (25.9.2026 klo 09.51)

Merge-pyyntö proto-3d/lokit/pariteetti-b12/merge-pyynto-natiivi-ui-b13-70-c16-d6-66-72-76-hyppy.md.
...
## LINSSIPARITEETTI juna/b13 1957cf02 (LINSSISEPPA, iPHONE, 11 RIVIA): SAMA 1, ERI 6, PUUTTUU 4; PAASYY 31/39/41: NATIIVI PIILOTTAA MAAKYLTIN, PAIKKAKUPLAN, LIIKUN JA NOSTOT KAIKISSA LINSSEISSA, WEB VAIN PORTTILINSSEISSA → NATIIVI-UI (LinssiUi.Vaihtui WEBIN LISTALLA); 11 JA 40 NATIIVI-UI; TYOKALUKORJAUKSET PELIKOODARILLE (12/12b, 13, iPHONEN £300/PAIVA 1 SALLITUIKSI); 37 RADIO = HYVAKSYTTY POIKKEAMA; FABLE: LINNUT ODOTTAVAT PARITEETTIA (EIVAT KUULU RADIOUUDISTUKSEN LOPPUUNVIENTIIN) (25.9.2026 klo 10.09)

Raportti proto-3d/lokit/pariteetti-ajo/b13-linssit/.

## MUISTI AIDOSTI TAYNNA klo 10.3x (VAPAA 36 %, KOMPRESSORI 1,7 M SIVUA, SIVUTUS 22,8/23,5 Gt, 6–8 SIMULAATTORIA BOOTTINA): POSTIVAHDILLE VALTUUS SAMMUTTAA JOUTILAAT SIMULAATTORIT ITSE (20 min, ENINTAAN 4 BOOTTINA PAIVALLA); PARITEETTIAJO ENINTAAN 2 SIMULLA EIKA SAVUKKEIDEN KANSSA SAMAAN AIKAAN; 11 CLAUDE-SESSIOTA × 1,3 Gt ON PYSYVA POHJAKUORMA (25.9.2026 klo 10.14)

Omistajalle ehdotus: joutilaat sessiot (Siirtoseppä, Karttaseppä polton jälkeen) voi sulkea päiväksi, jos muisti ei riitä.
...
## PARITEETTISIMUT KIINNI (PELIKOODARI 10.16; PARITEETTIAJO RAJAA 2 SIMUUN JA SAMMUTTAA LOPUKSI f42c397c3); JUURISYY BOOTTAUKSEEN: KAANNOSVAHDIN juna-ajo.sh ASENTAA SIMS-LISTAN SIMUIHIN JA JATTAA NE PAALLE → NATIIVISEPPA MUUTTAA: ASENNUKSEN JALKEEN shutdown NIILLE, JOTKA EIVAT OLLEET BOOTTINA (25.9.2026 klo 10.17)

Selittää, miksi sammutuspyynnöt purivat vain väliaikaisesti.
...
## SISALTOJUNA #3149 MAINISSA v2216 (4293/0): #3144 TEOSLUETTELO, #3145 TAIDEMUSEO-SUUNNITELMA, #3069, #3068, #3066, #3045, #3042, #3000, #2987, #2930, #2927, #2897; #2895 JAI POIS RISTIRIIDAN TAKIA (SISALTOKIRJURI PAIVITTAA), #2991 PIDOSSA; MUISTISAANTO SAVUKKEISIIN PR #3146 (3 RINNAKKAIN SIMULAATTORIN KANSSA) (25.9.2026 klo 10.35)

Vanhojen sisältö-PR:ien jono on nyt lähes tyhjä.

## NATIIVISEPPA 71 % → LUOVUTUS JA NOLLAUS KASKETTY (LUOVUTUS -20260925-b.md, clear_session SAMASSA VUOROSSA, LEPOILMOITUS TILATTU) (25.9.2026 klo 10.37)

Toinen nollaus tänään (edellinen 04.5x).
...
## TURISTIOPAS ERA 2 (SAO LUIS, OURO PRETO, CAYENNE) PR #3150; #2895 REBASETTU (NC-VIITTEET KAIKKI 9 KORVATTU #2897:N KANSSA, TUNNETUT-LISTA TYHJA); ERA 3 (BERMUDA, SITKA, COOBER PEDY) TYON ALLA (25.9.2026 klo 10.47)

Lisenssityö: NC-viitteet nyt nolla.

## CODEXIN POSTI 7755d9c5a: GALLERIA 59:N TAYDENNYS (2 KAUPUNKIA) JA BERGENIN + SEVILLAN JULISTEIDEN R2-TODENNUS → SISALTOKIRJURI INTEGROI TAYDENNYKSEN JA TUO JULISTEET #2991:EEN (PITO PURETAAN) (25.9.2026 klo 10.57)

Kuvaputki toimittaa nyt samana päivänä.

## OMISTAJA KAYNNISTI KONEEN UUDELLEEN klo 11.3x (NAYTTO EI HERANNYT, NETTIKATKO); KONE YLHAALLA 12.03, SIVUTUS 0, SIMULAATTORIT 0, RUNNERIT KAYNNISSA; FABLE HERATTI 10 SESSIOTA; KARTTASEPAN PALLON VIENTI JATKUU PUUTTUVISTA LAATOISTA; OMISTAJA VAIHTAA TILIA — SIIRTOPROMPTI ANNETTU, LUOVUTUS -b.md (25.9.2026 klo 12.05)

Luokitin (Sonnet) oli hetken rate-limitissä, ei tokenikiintiö.
...
## SIIRTOSEPPA EHJA (TUOTANTO 1.x v96 SKEEMA 1.38, 2.0 v43); #3133 SKEEMA 1.39 (karttavalot.ankkuri JA .puoli, LOYDOS 50 C) → FABLE: MERGE JA OSOITIN 1.39:AAN; YOAJON AIKARAJA + Build/yo-SIIVOUS PR #3152; SAANTO: SISALTOPAKETIN YHTEENSOPIVAT LISAYSVERSIOT ILMAN KYSYMYSTA, KYSYTAAN VAIN RIKKOVISTA MUUTOKSISTA JA KARTTALAATTOJEN OSOITTIMISTA (25.9.2026 klo 12.09)

Palautus vie-sisalto.yml -f palauta=N.

## LINSSIPARITEETTI 2 (LINSSISEPPA juna/b13 93ab72f1): SAMA 1, ERI 9, PUUTTUU 1 — 39 = 8 px JA 12 = 13 px ALLE RAJAN, 31/41 KARTUSCHA WEBIN TAPAAN; JALJELLA NATIIVI-UI 41 (JAPANI-KORTTI PILLERIN PAIKALLE), 31/41 PAIKKAKUPLAN TEKSTI JA LIIKUN PAIKKA, 11 JA 40; PELIKOODARIN TYOKALULLE 13/30/12b; 37 RADIO HYVAKSYTTY POIKKEAMA; 74 d2 NATIIVI-UI VIE JUNAAN; KOLMAS KIERROS KUN KORJAUKSET JUNASSA (25.9.2026 klo 12.11)

Yövalot linssin puolelta odottavat Karttasepän Black Marble -sarjaa (Natiiviseppä käyttää jo).

## LENTOPINNAN KYLMAKOE VALMIS (NATIIVISEPPA): D EI OLETUKSEKSI (LASKUN JALKEEN ~2 s HARMAITA LAATTALAIKKUJA), OLETUS 0 PYSYY, VALKOINEN SUORAKULMIO KONEEN VIERESSA KORJATAAN b13; POHJA-25 (natiiviseppa/pohja-25 fb200e37 = 2026-09-25-pohja-20260925 Z0–Z9) ODOTTAA KARTTASEPAN Z9-SYNKKAUSTA; FABLE: OFFLINE-PAKETTEIHIN Z9 VAIN KAUPUNKIEN YMPARILLE (SIIRTOSEPPA), MUUALLA Z8; JUNASSA MYOS NATIIVI-UI 73/63/79/LINSSIKERROKSET (juna/b13 d76c9669) (25.9.2026 klo 12.11)

Tulokset proto-3d/lokit/lentopinta-b13-TULOS.md.

## NATIIVISEPPA: VALKOINEN SUORAKULMIO EI NAY JUNASSA (VAIN lento-pinta-HAARASSA, EI b13:EEN), KAANNOS 53b155e2 (JUNA + 74e + 11); juna/b13 75cd4c89; Z9-OFFLINE-PYYNTO SIIRTOSEPALLE. OMISTAJA PYSAYTTAA KAIKKI SESSIOT klo 12.4x TILINVAIHTOA VARTEN — KESKEN: KARTTASEPAN PALLON AMPARIVIENTI (SYNC JATKAA), SISALTOKIRJURIN ERA 3; UUDET SESSIOT ALOITUSVIESTEISTA docs/raportit/viesti-<rooli>-aloitus.md (25.9.2026 klo 12.16)

Fable-sessio jää lepäämään; siirtoprompti annettu omistajalle.

## PYSAYTYS- JA TALLENNUSKASKY KAIKILLE 10 SESSIOLLE klo 12.16 (LUOVUTUS + ALOITUSVIESTI + PUSH, EI clear_session; OMISTAJA PYSAYTTAA, UUSI FABLE LAHETTAA ALOITUSVIESTIT). LAITETESTAAJA: SAVUKIERROS juna/b13 93ab72f1 iPHONE PASS (SAAPUMINEN, AANET, KAUPUNKIKORTTI, KIERTO, RADIO), PR #3153; LOYDOT: 'ui linssi radio' JA 'linssi radio' ERI REKISTERITILASSA (UI/PELITILA-DESYNC? → PELIKOODARI + NATIIVI-UI), POI-NIMIEN GENETIIVIVIKA RANSKASSA (Rouenin./Nimesin areena — ALUENIMET-natiivi.json → KARTTASEPPA); iPAD-KIERROS TEKEMATTA (25.9.2026 klo 12.18)

BUILD-sana odottaa: savukierros iPhonella on läpi 93ab72f1:llä, mutta juna on edennyt (75cd4c89+); uusi Fable päättää BUILDista uusimmasta junasta.
...
## FABLE LOI 10 ROOLISESSIOTA ITSE OHJAAMALLA CLAUDE-APPIA (osascript + screencapture, OMISTAJAN LUPA settings.local.json): File > Open Folder → polku → Trust workspace → malli (Opus/Sonnet) → aloitusviesti; ALOITUSVIESTIT LAHETETTY, NIMET ROOLINIMILLA (25.9.2026 klo 12.53)

Uudet id:t: Julkaisija local_22b29f10-7af8-43fc-a974-1d666f716c97; Natiiviseppä local_bf20055b-d582-4812-ba2b-b59c37a5e7b8; Pelikoodari local_97810d35-a79c-484b-8573-660a4c40eaa6; Natiivi-UI local_33ba1387-d688-4e44-8e05-10951e61efc0; Linssiseppä local_45a869de-4d6b-4ed6-a6c9-30fd8442587e; Siirtoseppä local_b50bb32e-18e2-47c5-a597-8a18d56874e1; Karttaseppä local_37708e68-5a58-45ca-8dee-c13620993531; Sisältökirjuri local_256f6a15-b806-4259-97bd-b2ba8d342f86; Laitetestaaja local_c22294e5-4f0f-46ce-b1d3-9d8f3da223b1; Postivahti local_e6d70b5a-fc8a-430c-a2a2-8c8da7f3fcc7; Fable local_593b89a1-2514-4d74-b956-2a73db862382. Opit: luokitin esti osascriptin ilman sallintaa; menu-item-klikit (Radix) eivät rekisteröidy System Eventsin click at -komennolla, näppäinoikotiet (1/3 mallivalikossa, Tab+Return trust-ikkunassa) toimivat; ⌘⇧G-näppäily hyppäsi Chromeen — kansiopolku kirjoitetaan valitsimeen aloittamalla '/', loput erillisenä keystrokena.
...
## SISALTOJUNA #3168 v2220 MAINISSA: #3166 (28 GALLERIAA), #3165 (PAKETTI 1.40, #3162 SULJETTU), #3159 JA #3164 (TURISTIOPAS 3–4), TESTIT 4297/0; HUOM: #3163 (CODEX) MERGETTIIN klo 13.25 SUORAAN TILILLA ravelius TAVALLISENA MERGE-COMMITTINA JUNAN OHI JA TF-VIENNIN AIKANA (ILMAN VERSIONOSTOA) — FABLE KYSYY OMISTAJALTA, OLIKO HAN; LINSSISEPAN KIERROS 3 KAYNNISSA, EI SAVUKKEITA SEN AIKANA (25.9.2026 klo 13.45)

Siirtoseppä vie 1.40:n tuotantoon mergen jälkeen.
...
## KAANNOSVAHTI NALKIINTYI (POSTIVAHTI): UUSI juna/b13-COMMIT ~10 min VALEIN NOLLAA 600 s NIPUTUKSEN, VIIMEISIN KAANNOS 12.37, VANHIN KAANTAMATON 56b7eace 13.17 → FABLE (SITOVA): NIPUTUKSELLE YLARAJA — KAANNOS VIIMEISTAAN 20 min ENSIMMAISESTA KAANTAMATTOMASTA COMMITISTA; NATIIVISEPPA TOTEUTTAA JA PAKOTTAA KAANNOKSEN 686c1634:STA; POSTIVAHTI HALYTTAA YLI 25 min (25.9.2026 klo 13.50)

Tarkentaa Raamatun BUILD-JUNA-kohtaa (10 min niputus); Raamattuun päivitetään seuraavassa synkassa.

## LINSSISEPAN KIERROS 3 → NATIIVI-UI: KOHDAT 2 (VIRTANAPIT PIILOON ESITYKSEN AJAKSI ≤ 600 px) JA 3 (LINSSIN NIMILAPPU ✕:N VASEMMALLE) TESTIKAANNOKSESSA natiivi-ui/linssipuhelin-k3; FABLE: RIVIT 13 JA 40 (dy +33/+48, IHMISEN MATKAN AIKAJANAPALKKI) = HYVAKSYTTY POIKKEAMA iPHONELLA, LOYDOS 74 PYSYY (KELLO EI MAHDU SAAREN VASEMMALLE) (25.9.2026 klo 13.57)

Omistajan build 13 -palaute alkoi klo 13.5x: löydökset 80–85 avauskuva, aloitusnäyttö ja aloituslento (kirjataan ja jaetaan, kun kaikki erät ovat tulleet).

## LINSSIPARITEETTI KIERROS 3 (LINSSISEPPA, juna/b13 + linssipuhelin-k3 24ad5004): iPHONE 0 AVOINTA (11/12/39 ALLE 16 px; 13/40, 31/41, 37, 30/31 NIMILAPPU JA VAAKA = HYVAKSYTYT POIKKEAMAT); iPAD JALJELLA 31 PAIKKALAPPU, 39 VERTAILUPANEELI, 13 TAUKO → NATIIVI-UI; KOTIMAAN KOROSTUS (WEB: KULTAREUNA + RELIEFI VAIN KOTIMAASSA) → NATIIVISEPPA; TYOKALU PR #3171; OPPI: SIMULAATTORIA EI SAMMUTETA HETI ASENNUKSEN PERAAN (25.9.2026 klo 14.16)

Loppuraportti docs/raportit/linssipariteetti-3-20260925.md tilattu.

## OMISTAJAN LOYDOKSET BUILD 13:STA 80–109 KIRJATTU (docs/raportit/omistajan-loydokset-b13-20260925.md) JA JAETTU: AVAUS JA ALOITUSLENTO 80–85 (NATIIVISEPPA + NATIIVI-UI: MUSTA NELIO POIS, YLAPALKKI/LOGO/☰/PULU POIS ALOITUKSESSA JA LENNOLLA, OHITA-NAPPI, FEIDI MUSTAAN → TOPOGRAFIAKARTTA → KAMERA LOYTAA KONEEN KORKEUDESSA, LOPPU PAPERILLE 'ATEENA, PAIVA 1' → VANHA KARTTA), MATKAKIRJA 86–91, KARTTA JA NOSTOT 92–95 JA 102–109, LINSSIT JA LAATIKOT 96–101; SAANTO 97: AUTOMAATTISESTI PIENENEVAT LAATIKOT ANIMOIDAAN RIVI KERRALLAAN; SEURAAVA NUMERO 110 (25.9.2026 klo 14.18)

Roolit taulukossa. Kotimaan korostus (Linssisepän havainto) Natiivisepälle.

## LOYDOS 95 (SISALTOKIRJURI): 423 MINIATYYRISTA 5 LEIKKAAMATONTA, VARTIJATESTI PR #3177, LEIKATUT TILATTU CODEXILTA → FABLE: TARKISTA MYOS KARTAN NOSTOKUVAT JA WEBP-MUUNNOS (OMISTAJA NAKI USEITA); 108 VALIMERI + MESSINANSALMI AGENTILLA; TURISTIOPAS 30/30 PR:ISSA (#3167 MERGE-KORJATTU, #3169 #3172 #3173 #3176 #3178, TYOLISTA #3179), SISALTOJUNA #3174 v2221 MAINISSA (ERAT 6–8); FABLE: LOPUT 41 INVENTAARION KAUPUNKIA JATKUVAT 3:N ERINA (JATKUVA TEHTAVA); 109 KUVA: REITTIVERKKO + VALIPISTEET NAKYVAT LEVOSSA HETI ALOITUSLENNON JALKEEN → PELIKOODARI TOISTAA KYLMASTA KAYNNISTYKSESTA (25.9.2026 klo 14.30)

Ilman versionostoa mainiin: #3171, #3175, #3154, #3153, #3160, #3151, #3170. Linssisepän kierros 3 ohi.

## LOYDOS 95 SYY: ATEENASSA 6 UUDEMPAA 512 px KARTTANOSTO-KOHTAUSKUVAA (CODEX #2678) MAALATTUINE TAUSTOINEEN, TAYTTO 0,69–0,88; SAMA KAHTIAJAKO KOKO PELISSA (122 KOHTAUSKUVAA, 69 TAYTTO ≥ 0,6); DATA KUNNOSSA → FABLE: (b) ATEENAN 6 TILATAAN TAYSIN LEIKATTUINA PILOTIKSI BUILD 14:AAN, (c) KAIKKI 69 HETI KUN OMISTAJA HYVAKSYY PILOTIN; TYYLISAANTO KUVAPUTKEEN: KARTTANOSTOJEN KUVAT OVAT LEIKATTUJA KOHTEITA, EIVAT KOHTAUKSIA (25.9.2026 klo 14.31)

Vanhat 1024 px nähtävyydet (akropolis, agora, kallimarmaro) ovat oikein: rakennus yksin läpinäkyvällä pohjalla, täyttö 0,3.

## ALOITUSLENTO 84–85 VALMIS VIDEOLLA (NATIIVISEPPA natiiviseppa/aloituslento-84 0e7b6377): VALINTA → MUSTA (LAATAT LADATAAN) → SATELLIITTIPINTA → KAMERA LONTOOSEEN, KONE JO NOUSUSSA → KOKO LENTO PINNALLA → KORTTI → VANHA KARTTA; FABLE: SENTINELIN OMAT PILVET LOPPUORBITISSA → A) SENTINEL POIS ALOITUSLENNON ORBITISTA (BLUE MARBLE Z7), C) PILVETON S2-SARJA KARTTASEPAN JONOON Z9:N JA MAAKUNTIEN JALKEEN; MUSTA EI KIINTEA 4,3 s VAAN LAATTOJEN VALMISTUMISEEN; KOTIMAAN KOROSTUS 2efe2b44, 98-RAJAPINTA 8ea72ef1, 99 KORJAUSKIERROKSELLA, 106 PATCH NATIIVI-UI:LLE (25.9.2026 klo 14.36)

Video proto-3d/lokit/aloituslento-84/b/aloituslento-84-85.mp4.

## ALOITUSLENTO: SENTINEL POIS LIU'USTA ALKAEN (6a58ab3a, KAMERA ~3000 km → VAIHTO EI NAY); VERHO LAHTEE KUN REITTI ≥ 90 % JA NAKYVA PALLO ≥ 97 % (KATTO 5 s); YHDISTELMAKAANNOS 84–85 + KOTIMAA + 98 KAYNNISSA; KARTTASEPALLE C-RIVI: PILVETON SENTINEL-2-SARJA Z8–Z10 (300 km) JA Z11 (60 km) 19 LENTOKAUPUNGIN YMPARILTA, s2-alkup-RAKENNE, Z9:N JA 105/107:N JALKEEN (25.9.2026 klo 14.38)

Kaupungit: Lontoo + LennonAikajana.Kaupungit (18).

## LOYDOS 95: ATEENAN 6 KOHTAUSKUVAA TILATTU LEIKATTUINA (PILOTTI), PR #3180 VARTIJATESTI + LUETTELO 70 KOHTAUSKUVASTA; 27 MINIATYYRIA PUUTTUU AMPARISTA → FABLE: VIEDAAN/TILATAAN HETI (PUUTTUVA SISALTO); 108 PR #3181; TURISTIOPAS ERA 11 AGENTEILLA (25.9.2026 klo 14.39)

Luettelo docs/raportit/miniatyyrit-kohtauskuvat-20260925.md (69+1). Omistajan hyväksyntä koskee vain 69 kohtauskuvan leikkaamista pilotin jälkeen.

## LOYDOKSET 105/107 (KARTTASEPPA PR #3182): FABLE: MAAKUNTARAJAT KAIKISTA 138 MAAKUNTAMAASTA SISALTOPAKETTIIN SKEEMANA 1.42 (SIIRTOSEPPA, VAIHTOEHTO A; KOKOELMA 0,7 → 8,3 Mt, gz 2,4 Mt, PAKETTI 96 Mt), EI NATIIVIN OMAA .bin-PURKUA; LAHDETIEDOSTO REPOON GZIPATTUNA; MAA ILMAN MAAKUNTIA = VAIN MAAN NIMI TAI TYHJA LISTA (25.9.2026 klo 14.48)

Natiivi-UI toteuttaa listan säännön, Natiiviseppä piirron.

## OMISTAJA klo 14.5x (SITOVA): 110 ALOITUSLENNOLLE KIINTEA KESTO SEKUNTEINA ETAISYYDESTA RIIPPUMATTA — AIKA KUROTAAN NOPEUTTAMALLA KONETTA VAIN KESKIVAIHEILLA, KONE SAA LENTAA ERI VAUHDEILLA (NATIIVISEPPA EHDOTTAA ARVON); 111 SIIRTYMAREITIT WEBISSA PAKSUMMAT KUIN NATIIVISSA → MITATAAN WEBISTA JA TEHDAAN SAMA (PELIKOODARI + NATIIVISEPPA); SEURAAVA NUMERO 112 (25.9.2026 klo 14.54)

Lisätty docs/raportit/omistajan-loydokset-b13-20260925.md.

## OMISTAJA klo 14.5x (SITOVA): 112 ALOITUSNAYTON TAUSTAPALLOLLE WEBIN TAPAAN LENTOKONE, JOKA LENTAA KAUPUNGISTA TOISEEN JA PIIRTAA PUNAISTA VIIVAA PERASSAAN; WEBIN ISOISAN VALOKUVAT JATETAAN POIS (EIVAT TOIMI) → NATIIVISEPPA (PELIKOODARI MITTAA WEBIN); SEURAAVA NUMERO 113 (25.9.2026 klo 14.56)

Lisätty docs/raportit/omistajan-loydokset-b13-20260925.md.

## POHJA-25 JUNASSA (juna/b13 713c1cdc): VIIVATON PERUSKARTTASARJA Z0–Z9 + RasterinLaatikko, KUVAPARI proto-3d/lokit/pohja-25/kuvapari.jpg; KARTTASEPPA POLTTAA KERMASARJAN p080; 98 JUNASSA; 110: EHDOTUS 20 s (NOUSU ~4,2 s, LASKU ~8 s VAKIO, MATKAVAIHE NOPEUDELLA; PARAMETRI LennonAikajana.AloituslennonKestoS) → OMISTAJALTA KORTTI (25.9.2026 klo 14.57)

Lyhin reitti (Istanbul) hidastuu, pisin (Sydney, ennen 26 s) nopeutuu.

## OMISTAJA klo 14.5x (SITOVA, 110): ALOITUSLENNON KESTO 10 s, VAUHDIKAS — HITAAT JA NOPEAT LIIKKEET VUOROTELLEN: KAMERA HIDASTUU LAHELLA KONETTA JA MENEE PALJON LAHEMMAKSI (KONEESTA NAKYY VAIN PUOLET KERRALLAAN), SITTEN KIIREHTII NOPEASTI KAUEMMAS; NATIIVISEPPA SUUNNITTELEE MAHDOLLISIMMAN DYNAAMISEN NOPEUDENVAIHTELUN ITSE; TESTATAAN BUILD 14:SSA (25.9.2026 klo 14.59)

AloituslennonKestoS = 10; nousu ja lasku saavat lyhentyä suhteessa.

## NATIIVI-UI BUILD 13 -LOYDOKSET MERGE-PYYNNOSSA: 86/87/97 (MATKAKIRJA 'Ateena 🔊', KUTISTUS RIVI KERRALLAAN, natiivi-ui/matkakirja-86), 88 YLAPALKKI, 91 CHAT, 96+96b AVARUUS, 106 NIMIOLUKKO (+PELIKOODARIN 93); KESKEN 81/83 (API NATIIVISEPALTA), 82, 89, 90, 92, 94, 102, 103; KONTEKSTI 63 % → FABLE: LUOVUTUS (o) JA NOLLAUS HETI, EI UUTTA ERAA (25.9.2026 klo 15.06)

Selostus proto-3d/lokit/pariteetti-b12/merge-pyynto-natiivi-ui-b13-11-41.md, kuvat b13o/. Lepoilmoitus tilattu; aloitusviesti sen jälkeen.

## LIIKKUMISLISTA ERI/PUUTTUU 0 (PELIKOODARI, LISTA 99be024ff): A13 KORJATTU JA TODENNETTU (HAIVYTYS 250 ms), A3/A9/A11/B22/B23 TODENNETTU VIDEOLTA, C10/C12/C16/D6 KORJATTU KOODISSA → TODENNETAAN VIDEOLTA JUNAN KAANNOKSESTA; 93/100/101/104 JUNASSA 9f78c612 (101: LEHTI 30 → 120 fps iPADILLA); 109 JUURISYY: ALOITUSKARTAN NAPAUTUKSEN NAAPURIREITIT JAIVAT (SAANTO LAHETTI VAIN MUUTOKSET), MERGE-PYYNTO reitit-alku e4c75de4, TODENNUS BUILD 14 NAPAUTUKSELLA; 112 MITAT NATIIVISEPALLE; 111 KOODI SAMA (2,5 + VARJO 4) → ERO PIIRROSSA, MITATAAN KUVASTA (25.9.2026 klo 15.08)

Pariteetin valmius: liikkumislista 0 täyttyy, linssipariteetti iPhone 0 (iPad 3 Natiivi-UI:lla); kolmas ehto (omistajan build-kokeilu ilman uusia löydöksiä) ei täyty — build 13 toi 33 löydöstä (80–112). Uusia linssejä ei vielä.

## 110 TOTEUTETTU (NATIIVISEPPA natiiviseppa/aloituslento-84 f5c708b0): KESTO 10 s, DYNAAMINEN AIKAJANA — SYOKSY → LAHI 1 (12 km, KONEESTA PUOLET, HIDAS LIUKU KYLKEA PITKIN) → NOPEA PAKO 1200 km → KAUKO → SYOKSY 2 TOISELLE KYLJELLE → LAHI 2 → NOPEA PAKO → LIUKU/KIERTO/ORBIT SAAPUMISEEN; LENTO EI ENAA PITENE REPLIIKIN MUKAAN → FABLE: PUHE EI KATKEA, SAA JATKUA KORTIN PAALLE, YLI ~12 s REPLIIKIT LYHENNETAAN (PELIKOODARI); JUNASSA JO 84–85, 98, 99, POHJA-25, 100/101/104/109/A13, 86–91/96/106 (25.9.2026 klo 15.13)

Käännös jonossa → video → merge.

## KARTTASEPPA: Z9 VALMIS — 2026-09-25-pohja-20260925 AMPARISSA 349 525/349 525 + laatat.json (15.19), NATIIVISEPPA JA SIIRTOSEPPA TIETAVAT; #3182: 105 MAAKUNNAT 142 MAALLE (TYHJA OLIO = EI MAAKUNTIA), VEKTORIT 2026-09-25a AMPARISSA, 107 MERINIMET VEDEN PAALLE; FABLE: KERMAHUNTU 2026-09-25-p080 (27 MAATA + _maailma Z0–Z8, 33 948 LAATTAA, 160 Mt) SAA VIEDA julisteet/pallo/kerma/2026-09-25-p080/ (UUSI SARJA, EI OSOITINMUUTOS); WEBIN NOSTOTASO POLTETAAN UUDELLEEN 1.40-DATASTA, WEBIN OSOITIN VASTA OMISTAJAN KUVAKOKEILUN JALKEEN; S2-LOPPUORBIT KAYNNISSA (25.9.2026 klo 15.20)

Huomio: Wikidata-haussa lähti vahingossa omistajan sähköposti User-Agentissa, korjattu (repon työkalu ei lähetä sitä).
...
## SISALTOPAKETTI 1.41 (OFFLINE Z9 KAUPUNGEILLE) TUOTANNOSSA v106 JA 1.42 (MAAKUNTARAJAT 138 MAASTA) v107, 2.0 v54, AMPARITARKISTUKSET OK (SIIRTOSEPPA); NATIIVISEPPA JA NATIIVI-UI ILMOITETTU; SIIRTOSEPALLE SELVITYS: PAKETIN TAUSTAPAIVITYS NATIIVISSA (docs/raportit/paketin-taustapaivitys-20260925.md), EI TOTEUTUSTA ENNEN ESILATAUSPOLITIIKAN HYVAKSYNTAA (25.9.2026 klo 15.40)

Pelikoodari nollattu 15.33 ja käynnissä (RC päällä), aloittaa C16 B-ajolla.

## SKEEMA 1.42 (v107) RIKKOO BUILD 13:N MAAKUNNAT (NATIIVISEPPA): MaaKartta RAJAA MAAKUNNAT EUROOPPAAN JA 255 ALUEESEEN AAKKOSJARJESTYKSESSA → OSA EUROOPAN MAAKUNNISTA PUTOAA JA LATAUS RASKASTUU (8,3 Mt, 42 k KAARTA) → FABLE: SIIRTOSEPPA PALAUTTAA 1.x-OSOITTIMEN v106:EEN (1.41) HETI, v107 TAKAISIN KUN BUILD 14 (natiiviseppa/maakunnat-kaikki, MAAKOHTAINEN KERROS asetaMaa-MALLILLA) ON TESTFLIGHTISSA; SAANTOTARKENNUS: LISAYSVERSIO, JOKA MUUTTAA VANHAN BUILDIN KAYTOSTA, EI OLE YHTEENSOPIVA — NATIIVISEPALTA TARKISTUS ENNEN TUOTANTOA, KUN AINEISTON KOKO/KATTAVUUS KASVAA OLEELLISESTI (25.9.2026 klo 15.42)

Junassa nyt myös 111 reittiviiva, kuvasumennus pois linssin ajaksi (rivi 39 -sumeuden juurisyy), 107 merinimet todennettu v106:lla.

## 112 JUNASSA (NATIIVISEPPA etusivulento-112 4cfc63fd): ALOITUSNAYTON PALLOLLA WEBIN REITTI LONTOO→PARIISI→…→NEW YORK→LONTOO 49,6 s, KONE #2e2114, VIIVA #c2452f, KAMERA SEURAA SILOTETTUNA, KONEEN RUUTUPAIKKA ±0,2 pt WEBISTA; FABLE: ALOITUSNAYTON SAVYTYS WEBIN PORTIN MUKAAN (TUMMA, MITATTUNA), EI VAALEAA VERHOA; OTSIKKO PYSYY, KONE JA VIIVA KULKEVAT SEN TAKANA KUTEN WEBIN VIDEO ALOITUSTEKSTIEN TAKANA → NATIIVI-UI 81/83:N PERAAN (25.9.2026 klo 15.43)

Video proto-3d/lokit/etusivulento-112/c/, web-klipit lokit/loydos112-etusivupallo/.

## NATIIVI-UI: 81/82/83 JA 86/89 VALMIIT, MERGE-PYYNTO NATIIVISEPALLA (TESTIKAANNOS d266addf, VIDEOT b13o/): ALOITUSNAYTOLLA JA VALINNASSA EI YLAPALKKIA, LENNOLLA PALKKI JA PULU POIS, OHITA-NAPPI (OhitaAloituslento); 89 JUURISYY: PeliOhjain NAYTTI LUENNAN ALUSSA PAIKKARIVIN TUMMANA ILMOITUKSENA ('Ateena, elokuussa 1873. Pölyä ja puhetta kullasta.') — WEB EI NAYTA → POISTETTU, LAPPU VAALEA ALUSTA ASTI; AUKI: OHITA-NAPPI MUSTAN VERHON (84) ALLA (NATIIVISEPALTA); SEURAAVAKSI 94, 102, 90. SIIRTOSEPPA: TAUSTAPAIVITYKSEN SELVITYS PR #3192 (DELTA NYKYISELLA MANIFESTILLA, < 3 Mt/JUNA; NATIIVISTA PUUTTUU MANIFESTI, sha256, minSovellus, VERKKOTYYPPI, SIIVOUS; OMISTAJALLE: MOBIILIDATALLA AUTOMAATTISESTI VAIN < 5 Mt); 1.x-OSOITIN v106 PALAUTETTU, 2.0 EI PALAUTETA (KEHITTAJALIPPU) (25.9.2026 klo 15.47)

Ohita-nappi: sen pitää olla verhon päällä myös mustan aikana — Natiiviseppä ratkaisee kerrosjärjestyksen.

## PELIKOODARI: C16/C10/C12 TODENNETTU VIDEOLLA, c16b MERGE-PYYNNOSSA; LIIKKUMISLISTA TAYSIN VALMIS (79331c9f1); SEURAAVA ERA: b14-TARKISTUSLISTA LAITETESTAAJALLE + ESILATAUKSEN NYKYTILAN KARTOITUS JA ODOTUSMITTARI (EI POLITIIKAN TOTEUTUSTA); TUOTANTO v109 (1.41 + #3190), v108 (1.42) KORJATTU KASIAJOLLA (25.9.2026 klo 15.56)

Oikea nollauskomento ui livia paljastus nollaa.

## LINSSISEPPA: 98 AVARUUSLINSSI TUMMAKSI JUNASSA (pallon-savy + astro-tumma, SAVY 0,5, PISTEET HEHKUVAT); 96 AVARUUSCHAT JUNASSA (NATIIVI-UI avaruus-96, iPHONE TODENNETTU: ISO PULU EI AVAA PAAKESKUSTELUA, KORTTI PULUN YLAPUOLELLA, VASTAUKSET TOIMIVAT) — AVOINNA NATIIVI-UI:LLA: ISON PULUN NAPAUTUS NAYTTAA MARSEILLE-KUPLAN AVARUUDESSA, iPADIN RIVI 31 LAPPU VENYY ILMAN 🔊; KOTIMAAN KOROSTUS (RIVI 39) JUNAN KARJELLA, RIVI 39 KUNNOSSA MOLEMMILLA; RIVIEN 3b–3f PIKSELOINTI = KERRONNAN KUVASUMENNUS (NATIIVISEPPA KORJASI); TYOKALU PR #3195 (25.9.2026 klo 15.58)

Linssisepän jono: seuraava kierros 4 kun build 14 -juna on käännetty.
...
## NATIIVISEPPA NOLLATTU klo 16.00 → ALOITUSVIESTI LAHETETTY (b029ecbe0), RC TAKAISIN; juna/b13 KAANNETTY b8eb4fdb 16.02 JA 7f68d1f7 16.04 → BUILD 14 = LAITETESTAAJAN PASS-COMMIT (7f68d1f7), JULKAISIJA VIE proto_ref-SYOTTEELLA (#3198); 5 h -KIINTIO 70 % klo 16.10 (NOLLAUTUU 17.30) (25.9.2026 klo 16.11)

Paketti 1.42 peruttu (#3191), tuotanto v109 (1.41); #3194–#3197 mainissa.

## OMISTAJA klo 16.1x (SITOVA, RAAMATTUUN): ESILATAUSPOLITIIKKA HYVAKSYTTY FABLEN EHDOTUKSEN MUKAAN — PELAAJA EI ODOTA VERKKOA TIEDETYSSA KOHDASSA; KUUSI TASOA (BUILDISSA, KAYNNISTYS, VALINTA+LENTO, KAUPUNGISSA JOUTILAANA, LIIKKUMISEN ENNAKOINTI, LINSSIT), ESILATAAJA-PALVELU PRIORITEETTIJONOLLA, LEVY- JA MUISTIVALIMUISTI, MOBIILIDATALLA DELTAT < 5 Mt AUTOMAATTISESTI, MITTARIT; TYONJAKO: PELIKOODARI PALVELU + MITTARIT, NATIIVISEPPA LAATAT/PINNAT, SIIRTOSEPPA PAKETIN TAUSTAPAIVITYS (#3192), LAITETESTAAJA SAVUKE (25.9.2026 klo 16.18)

Kirjattu Raamatun NATIIVI PELI ETUSIJALLE -osioon ennen TESTFLIGHT-BUILDIT-kohtaa. Toteutus alkaa build 15:n jälkeen (build 14 ja 15 ensin).
...
## OMISTAJA klo 16.2x (SITOVA): FABLE SAA NOLLATA JOUTILAAT SESSIOT JA JATTAA NE LEPAAMAAN KUN JONO ON TYHJA; KAIKKI 69 KOHTAUSKUVAA TILATAAN HETI LEIKATTUINA (EI ODOTETA PILOTTIA) → SISALTOKIRJURI TILAA CODEXILTA; GLO-30 SELITETTY OMISTAJALLE (25.9.2026 klo 16.23)

Joutilaan session nollaus: luovutus + aloitusviesti + clear_session self, aloitusviesti vasta kun työtä on.

## NATIIVI-UI: 94 (KOKORUUDUN TYYLIT PUUTTUIVAT KOKONAAN → WEBIN MUKAAN), 112 (VAALEA VERHO POIS, TUMMA SAVY MITATTUNA, VIIVA OTSIKON TAKANA), 102 (KUVASUURENNOS RUUDUN TAYTEEN), 90 (LUENTAKUVAT iPADILLA 528 pt) VALMIIT, MERGE-PYYNTO 7b54d362 (iPHONE + iPAD, KUVAPARIT b13o/); OHITA VERHON PAALLA (dbcc0eb1) NATIIVISEPPA TODENTAA; 105-DATA TOIMII ILMAN KOODIMUUTOSTA; RIVI 31 KORJATTU; SEURAAVAKSI 96b JA 95 (ImageIO-ALFA) (25.9.2026 klo 16.29)

Build 15 -sisältö kasassa Natiivi-UI:n osalta.

## BUILD 14 PROTO-MASTERISSA b6cdf4c3 (PUU = TF-KAANNOS 7f68d1f7); BUILD 15 -JUNA/b13 KARKI 67630aa5: VERHO-OHITA (OHITA NAKYY KOKO MUSTAN AJAN), KERMA-25 (REUNA OSUU RANTAAN), NATIIVI-UI 94/112/102/90; ODOTTAVAT: MAAKUNNAT-KAIKKI (NATIIVIKUVAT OK, TSUKOTKA ±180°, WEB-KUVAPARI TEKEILLA), s2-orbit 266bb732 (PILVETON LOPPUORBIT 19 KAUPUNKIIN + ESILATAUS 191 LAATTAA ATEENALLE) (25.9.2026 klo 16.30)

Build 15 arvio ~klo 19: maakunnat-kaikki + s2-orbit junaan → käännös → Laitetestaajan kierros (iPhone + iPad) → BUILD.

## KOEPYRAMIDI WEBIIN PR #3203 (KARTTASEPPA, 5d1eb813b): ?pyramidi=2026-09-25 LUKEE LUETTELON koe/2026-09-25/ JA PALLON LAATAT 2026-09-25-pohja-20260925, TUOTANNON OSOITIN 23a ENNALLAAN, TESTIT 69/0, SAVUKE 6/6; OHJERIVI OMISTAJALLE KUN MAINISSA JA PAGESISSA; KARTTASEPPA LEPAA (KONTEKSTI 52 %, EI NOLLAUSTA). NATIIVI-UI: 95 EI NATIIVIN VIKA — 7 ATEENAN KUVASSA TAUSTA ON KUVASSA ITSESSAAN (LAPINAKYVAA 12–40 %), WEB NAYTTAA SAMOIN, ImageIO SAILYTTAA ALFAN → CODEXIN LEIKATUT KORJAAVAT; 96b TOTEUTETTU (minipulu-96c b565fdf6), TESTIKAANNOS ODOTTAA BUILD 14 -VIENNIN LUKKOA (25.9.2026 klo 16.32)

5 h -kiintiö 79 %, nollautuu 17.30.
...
## BUILD 14 TESTFLIGHTISSA klo 16.4x: 1.0.14, CFBundleVersion 202609251332, PROTO 7f68d1f7 (= MASTER b6cdf4c3), AJO 36140368496, SISAINEN RYHMA, LASKURI 14, LuoPallo AJETTU; TF-VIENTI JA SAVUKKEET JAKAVAT SAMAN AJURIN → JULKAISIJA PERUI KAKSI SAVUKEAJOA. MAASTOSARJA 2026-09-24-maailma: z0–z10 GLO-90 KOKO MAAILMA, z11 EUROOPPA GLO-90, z12 EUROOPPA GLO-30 (2,26 M LAATTAA / 11,8 Gt); KOKO MAAILMAN GLO-30 MUUTTAISI VAIN z11–z12 (~19 M LAATTAA, 95 Gt, VIENTI ~5 vrk / ~75 $) → FABLE: MYOHEMMIN z11 KOKO MAAILMA + z12 VAIN PELIN MAIHIN JA KAUPUNKIEN YMPARILLE (3–5 M LAATTAA), EI KIIRE (25.9.2026 klo 16.41)

Omistajalle rivi build 14:stä.

## MAAKUNNAT-KAIKKI JUNASSA (d65c81ba, KUVAPARI): RAJAUS KUTEN WEBISSA; FABLE: NATIIVIIN WEBIN 5 SAVYN TAYTTO 34 % (b15 TAI HETI SEN JALKEEN); ±180°-SAUMA AINEISTON REUNA → KARTTASEPALLE MYOHEMMIN; WEBIN GRC/JPN-TAYTTO WEB-VELAKSI; 1.42 TUOTANTOON KUN b15 TF:SSA (25.9.2026 klo 16.43)

Kuvapari proto-3d/lokit/maakunnat-kaikki/kuvapari-maakunnat-kaikki-20260925.jpg.

## ESILATAAJA-SUUNNITELMA HYVAKSYTTY (PELIKOODARI PR #3205: Esilataaja.cs, TASOT Nakyva > SeuraavaRuutu > TamaKaupunki > Kohdekaupungit > Muu, 6 RINNAKKAISTA + NAKYVA OHITTAA, UUSINTA 1/2/4/8 s, VIRRANSAASTO PYSAYTTAA 4–5, Range-JATKAMINEN, LEVY 2 Gt + LRU 200/300 Mt, OSUMA-% JA VerkkoOdotus; ERAT 1–4, ALOITUS BUILD 15:N JALKEEN; MITTARI pelikoodari/verkko-odotus BUILD 15:EEN); MITTAUS: SAAPUMISESSA AINOA VERKKO-ODOTUS PUHE 1,0 + 0,75 s KYLMANA, NOSTODATA 0; VERHOT OSUVAT AINA KATTOON (ALOITUS 8 s, LENTO 5 s; PALLON VALMIUS 10 % / 72 %) = LATAUSASTE, EI VERKKO → NATIIVISEPPA SELVITTAA (TAVOITE ALOITUS ≤ 3 s, LENTO ≤ 2 s LAMPIMANA) (25.9.2026 klo 16.48)

Raportit docs/raportit/esilataus-nykytila-20260925.md ja esilataaja-suunnitelma-20260925.md.

## OMISTAJA klo 17.0x: WEBIN KOEPYRAMIDI HYVAKSYTTY ('vaihda'), MUTTA KOELIPULLA KARTTANOSTOJA EI VOI KLIKATA → FABLE: OSOITINVAIHTO VASTA KUN NOSTOT TOIMIVAT (KARTTASEPPA KORJAA); KERMAHUNTU TULEE BUILD 15:EEN; CODEX: AMSTERDAMIN LEIKATUT KUVAT PR #3207 JUNAAN (25.9.2026 klo 17.04)

Koepyramidi #3203 mainissa v2227, Pages 16.53.

## OMISTAJA klo 17.0x (SITOVA, BUILD 14): 113 MAAKUNTIEN AARIVIIVAT LIIAN VOIMAKKAAT, VAIN KOHDEMAASSA (NATIIVISEPPA, WEBIN MITTA); 114 MAAKUNNAT-LISTAAN VALINTA 'POIS' (NATIIVI-UI); 115 MAAKUNNAN MINI-INFORUUTUUN PIENI KUVA MAAKUNNASTA (SISALTOKIRJURI DATA + NATIIVI-UI); 116 PLUSMERKKI POIS, TILALLE 'LUE LISAA' TEKSTIN LOPPUUN (NATIIVI-UI); SEURAAVA NUMERO 117 (25.9.2026 klo 17.07)

Lisätty docs/raportit/omistajan-loydokset-b13-20260925.md.

## VERHOJEN VALMIUS MITATTU (NATIIVISEPPA, natiiviseppa/verho-valmius): ALOITUSVERHO 1,9–2,8 s (100 %, TAVOITE ≤ 3 s TAYTTYY; PELIKOODARIN 8 s OLI MITTAUSSKRIPTIN VIRHE), MUSTA VERHO 3,0–4,2 s (LAHIKUVA LONTOO 30 km 2,4–3,0 s OSUU KATTOON ASTEELLA 87 % — CESIUM LASKEE MUKAAN KAMERAN ULKOPUOLISET LAATAT) → FABLE HYVAKSYI BUILD 16:EEN: LONTOON LAHIKUVAN JA VALINTANAKYMAN LAATAT ESILADATAAN ALOITUSNAYTOSSA, VALMIUSEHTO ASTE ≥ 90 % + TASAANTUNUT 300 ms, LAHIKUVAN KATTO 1,2 s, SAMA EHTO MUIHIN VERHOIHIN (25.9.2026 klo 17.08)

Build 15 leikataan ilman viivytystä.
...
## LOYDOS 115 (SISALTOKIRJURI): KENTTA pikkukuva MAAKUNTIEN_LUONNEHDINNAT-OLIOON, 512 px LEIKATTU, SAMA VARTIJA KUIN MINIATYYREILLA; LUONNEHDINNAT VAIN 7 MAALLE (FRA 13, DEU 16, ITA 20, ESP 19, GBR 4, POL 16, AUT 9 = 97) → FABLE: TILAUS FRA→ESP→ITA→GBR, SITTEN DEU→POL→AUT; GRC HETI PERAAN (LUONNEHDINNAT 13 ALUETTA + KUVAT, OMISTAJA PELAA KREIKKAA); PIDEMMALLA KAIKKI PELIN MAAT JATKUVANA TEHTAVANA TURISTIOPPAIDEN JALKEEN (25.9.2026 klo 17.09)

Maakuntarajat ovat 142 maalle (1.42), luonnehdinnat ja kuvat laajenevat sisältötyönä.

## OMISTAJA klo 17.1x (SITOVA, POIKKEUS LINSSIKIELTOON, RAAMATTUUN): IHMISEN MATKA II NATIIVIIN — NYKYINEN SAILYY, TOINEN VERSIO SAMALLA SISALLOLLA + AIEMMIN SOVITUT TEHOSTEET (KOHDENNETTU VALO/VALOKEILA 23.9., KERROKSELLINEN SUMU, HAVAINNEKUVA VALOKEILASSA 4.9., VANAT RANNIKKOA MAALAAVINA 7.9., AANIMAISEMAT 7.9.) JA VAPAAT KADET VISUAALISIIN TEHOSTEISIIN; TEKSTITYS OLETUKSENA POIS + CC-NAPPI YLAPALKKIIN (ENSIMMAINEN KYSYMYSTEKSTI JAA); HAVAINNEKUVAT ISOMMALLA, KARTTA VAISTAA SIVUUN; VARILLISTEN LEVIAMISREITTIEN RAIDOITUS JA VARIN LEVIAMINEN KUVAAN KORJATAAN; LINSSISEPPA VETAA OPUKSEN MAX-TILASSA (set_session_effort max), NATIIVISEPPA VALOKEILA/HAMARRYS/SUMU RAJAPINTANA, NATIIVI-UI CC-NAPPI; OMISTAJA ARVIOI BUILDISTA (25.9.2026 klo 17.18)

Järjestys: pariteettikierros 4 ensin (build 15 -junan käännöksen jälkeen), sitten suunnitelma (yksi sivu) ja erät videoineen.

## LOYDOS 117 KORJATTU (PELIKOODARI pelikoodari/valot-kohdemaa, MERGE-PYYNTO BUILD 16): WEB NAYTTAA VARIPALLOJEN VALOT VAIN KOHDEMAASSA (NAYTA_VAIN_KOHDEMAAN_NOSTOT), NATIIVIN AiheValot SYTYTTI VALOT KOKO MAAILMAAN → RAJATTU, KUVAPARI lokit/loydos117-valot/; SAVUKKEEN KULKU KORJATTU (PR #3212): KYLMANA ALOITUSVERHO OSUU YHA KATTOON 8 s (PALLO 60 %) JA MUSTA VERHO 5 s (41 %) — LAMPIMANA 1,9–2,8 s (NATIIVISEPPA) → BUILD 16:N VERHOTYON PITAA KATTAA MYOS KYLMA KAYNNISTYS (25.9.2026 klo 17.19)

Omistajan ensikokemus on kylmä käynnistys (löydös 80).

## OMISTAJA klo 17.2x (SITOVA, BUILD 14): 118 'VINTILTA LOYTYI ISOISAN MATKALAUKKU' -LUENTA SAMAAN ALOITUSRUUTUUN KUIN ALOITA SEIKKAILU -PAINIKE, TAUSTALLA SAMA ANIMAATIO JA MUSIIKKI JATKUU (NATIIVI-UI + PELIKOODARI); 119 PALLOSSA VIELAKIN PALJON REIKIA, JOISTA NAKYY LAPI (NATIIVISEPPA, KARTTASEPPA); 120 LENTOKONEKOHTAUS OUTO, KAMERA POMPPII LIIAN VILLISTI — OPUS MIETTII PAREMMAKSI: YKSI YHTENAINEN AJO ILMAN HYPPYJA, NOPEUDET VAIHTELEVAT (NATIIVISEPPA); SEURAAVA NUMERO 121 (25.9.2026 klo 17.22)

Lisätty docs/raportit/omistajan-loydokset-b13-20260925.md.

## OMISTAJA klo 17.2x: NATIIVISEPPA (OPUS) MAX-TILAAN LENTOKAMERAN (LOYDOS 120) MIETTIMISEEN — set_session_effort max; LINSSISEPPA JO MAX-TILASSA (IHMISEN MATKA II). FABLE 70 % → LUOVUTUS -20260925-c.md + ALOITUSVIESTI (a19a719bd), NOLLAUS; POSTIVAHTI LAHETTAA ALOITUSVIESTIN UUDELLE FABLELLE (25.9.2026 klo 17.26)

Max-tila pidetään, kunnes 120 ja Ihmisen matka II ovat valmiit; sen jälkeen takaisin high.

## RAAMATTU-SYNKKA #3211 MAINISSA (YLARAJA, ESILATAUS, MOBIILI = WIFI, IHMISEN MATKA II); NATIIVISEPPA: MAAKUNTATAYTTO + 113 VALMIS (f163d393, 5 SAVYA 34 %, SEEPIAVIIVA 0,45 VAIN PELAAJAN MAASSA); KYLMA VERHOMITTAUS: ALOITUS 8,0 s KATTOON (ASTE 25 %) — CESIUM PIIRTAA 11 s VAIN 2 JUURILAATTAA (3 VERKKOHAKUA/LAATTA, forbidHoles ODOTTAA TASON) → KORJAUS: PALLON POHJA Z0–Z5 (POHJA, MAASTO, VEKTORIT, BM Z0–Z4) PAKETTINA BUILDIIN; 119 JA 120 AGENTEILLA. KARTTASEPPA: KOEPYRAMIDIN NOSTOT KORJATTU (JUURISYY: NOSTOTASO POLTETTU ILMAN --nostot-ilman-nimioita, KORJATTU 2026-09-25c-nostot + NIMIOTASO 2026-09-22g; PR #3214 TYOKALUT) → FABLE: KOODI-PR (pallo.js/sw.js LAATTAVERSIO 25-pohja) + JULKAISIJA KOPIOI koe/2026-09-25/pyramidi.json → pyramidi.json = OSOITINVAIHTO (25.9.2026 klo 17.27)

Fable nollautuu tämän vuoron lopussa; uusi Fable jatkaa luovutuksesta -c.

## FABLE JATKAA NOLLAUKSEN JALKEEN: SESSION ID ENNALLAAN local_593b89a1, RC PAALLA; ALOITUSLUKEMINEN TEHTY (CLAUDE.md, YDINAJATUS 2, LUOVUTUS -c, LOYDOKSET 80–120, LOKIN 40 OTSIKKOA, TILATAULU); KAIKILLE 10 ROOLILLE YHDEN RIVIN ALOITUS; JONO: 1) BUILD 15 (juna/b13 c7091b7c → LAITETESTAAJAN PASS → JULKAISIJA 1.0.15 → OMISTAJALLE RIVI → SIIRTOSEPALLE 1.42), 2) #3211 JO MAINISSA, 3) OSOITINVAIHTO ODOTTAA KARTTASEPAN KOODI-PR:AA (25.9.2026 klo 17.31)

Uusi konteksti aloitti klo 17.29; edellinen luovutus viesti-fable-luovutus-20260925-c.md. Ei uusia päätöksiä.
...
## 115 ETENEE (SISALTOKIRJURI): 97 MAAKUNNAN PIKKUKUVATILAUS POSTILAATIKOSSA, GRC 14 LUONNEHDINTAA PR #3219; FABLE: GRC:N RAJAT OVAT 1.42:SSA JA 2026-09-25a-VEKTOREISSA (webin maakuntarajat.json 128 ALUETTA = WEB-VELKA) → TILAUS LAAJENEE GRC:HEN; CODEXIN #3207/#3209/#3210/#3213 KUITATTU, #3215 CI KESKEN; JULKAISIJAN vaihda-pyramidi-osoitin PR #3217, BUILD 15 proto_ref 4a813e60 (25.9.2026 klo 17.41)

Sisältökirjuri jatkaa turistiopas-erällä 20 (viimeiset 3/30).

## BUILD 15 SAVUKIERROS PASS (LAITETESTAAJA, proto_ref 4a813e60, iPHONE + iPAD YDINKULKU, RAPORTTI 36083f4a9; AVOINNA 94/102-NAPIT EIVAT LOYDY UI-PUUSTA, 100 EI PAIKANNETTU, 96b EI VAHVISTETTU, EI REGRESSIOTA) → FABLE: BUILD 1.0.15 JULKAISIJALLE; #3217 vaihda-pyramidi-osoitin.yml MAINISSA, #3216 ODOTTAA SAVUKKEITA (25.9.2026 klo 17.47)

Laitetestaaja lepää, laitteet sammutettu.

## IHMISEN MATKA II -SUUNNITELMA HYVAKSYTTY (LINSSISEPPA PR #3221, docs/raportit/ihmisen-matka-2-suunnitelma-20260925.md): OMA LINSSI ihmisen-matka-2 JA NAKYMA IhmisenMatka2Kerros, YDIN JA SISALTO ENNALLAAN; ERA 0 LINSSI LAUKUSSA, ERA 1 OMISTAJAN KOLME VAATIMUSTA (CC-NAPPI + TEKSTITYS OLETUKSENA POIS, KUVAT iPHONE 92 % / iPAD 55 % JA KARTAN VAISTO LINSSISIIRROLLA, KAISTAT TASAISIKSI), ERAT 2–5 VALO, SUMU, AANIMAISEMAT, VAPAAT KADET; FABLEN PAATOKSET: 1) RAIDAT KORJATAAN JAETTUUN Vana.shaderiin (JUURISYY: KAKSINKERTAINEN ALFA LIITOKSISSA + discard + ZTest LEqual → STENCIL + ZTest Always + fwidth), I KORJAANTUU SAMALLA; 2) II ERILLINEN LINSSI LAUKUSSA; 3) AANIMAISEMAT FREESOUND CC0 / CC BY ATTRIBUUTIOLLA aanihaku-PUTKELLA, AVAIN VAIN MACIN YMPARISTOSSA; ALOITUS PARITEETTIKIERROKSEN 4 JALKEEN, JOKAISESTA ERASTA VIDEO + KEHYSAIKA (25.9.2026 klo 17.49)

Rajapinnat: Natiiviseppä Valokeila (työn alla), Sumu, uusi Linssisiirto(dx, dy, kestoS); Natiivi-UI CC-nappi ja KuvanAlue; Pelikoodari maisemasoitto ristihäivytyksellä.

## TURISTIOPASPAKETTI VALMIS (SISALTOKIRJURI): 56 KOHDETTA (60 GAO/MURZUK/AL KUFRAH MUKAAN), 20 ERAA, VIIMEINEN PR #3223, TYOLISTA #3224; PIKKUKUVATILAUS 111 ALUETTA (7 MAATA + GRC) POSTILAATIKOSSA; FABLE: SEURAAVAKSI 108 VALIMERI + MESSINANSALMI NOSTODATA, SITTEN MAAKUNTIEN LUONNEHDINNAT KAIKILLE PELIN MAILLE JATKUVANA (LYHYT ENSIN, GRC PITKA/PULU ENSIMMAISENA); #3221 JA #3219 MAINISSA (25.9.2026 klo 17.57)

Linssiseppä koodaa Ihmisen matka II:n erät 0–1 TF-viennin aikana ilman simulaattoreita; kierros 4 kun build 15 on TF:ssä.

## BUILD 15 TESTFLIGHTISSA klo 17.5x: 1.0.15, CFBundleVersion 202609251449, PROTO 4a813e60, AJO 36149871805, SISAINEN RYHMA, LASKURI 15, LuoPallo AJETTU; OMISTAJALLE PUSH-RIVI 17.58; SIIRTOSEPALLE LUPA VIEDA 1.42 1.x-TUOTANTOON; NATIIVISEPALLE BUILD-MERGE; LINSSISEPALLE KIERROS 4; PELIKOODARILLE ESILATAAJA-ERAT 118:N JALKEEN; NATIIVI-UI TODENTAA 94/102/96b; #3216:N SAVUKKEET UUDELLEEN AJOSSA (25.9.2026 klo 17.59)

Build 16 -juna jatkuu tapahtumaohjattuna juna/b13:ssa.

## BUILD 15 PROTO-MASTERISSA 6ab9d45c (JUNA c7091b7c, PUU = TF 1.0.15 4a813e60); BUILD 16 -ERAT ALKAVAT JUNAAN: 117 VALOT-KOHDEMAA, MAAKUNTATAYTTO + 113; VERHOT, 119, 120 JA VALOKEILA MITTAUSTEN JALKEEN (25.9.2026 klo 17.59)

Siirtosepälle 1.42-lupa annettu 17.58.

## MAAKUNTIEN LUONNEHDINNAT KAIKILLE PELIN MAILLE (SISALTOKIRJURI): LAAJUUS 121 MAATA / 2 305 ALUETTA; FABLE: NATIIVI NAYTTAA RAJAT 1.42:N 138 MAALLE (WEBIN 8 MAATA = WEB-VELKA), JARJESTYS ISOISAN 1873-REITIN MAAT → MUU EUROOPPA → LOPUT AAKKOSITTAIN, LYHYT ENSIN, PITKA/PULU PERASSA, ERAT MAITTAIN SISALTOJUNAAN LAHDEVIITTEIN; GRC PITKA/PULU AGENTILLA (25.9.2026 klo 18.00)

Maat ilman rajadataa 1.42:ssa jätetään pois.

## NATIIVI-UI: 118 (AVAUSTEKSTI SAMAAN ALOITUSRUUTUUN, PALLO/LENTO/MUSIIKKI JATKUVAT), 114 'POIS', 115 PIKKUKUVA, 116 'LUE LISAA' VALMIIT JA TODENNETTU iPHONELLA (08260b0d), MERGE-PYYNTO NATIIVISEPALLA; AVOIN: AVAUSLUENTA ALKOI ~4 s PAINALLUKSESTA → FABLE: AVAUSLUENNAN MP3 BUILDIIN (ESILATAUSPOLITIIKKA KOHTA 1), PELIKOODARI MITTAA; CC-NAPPI SAA ALKAA 117:N JALKEEN (25.9.2026 klo 18.00)

Kuvat ja video b13o/*b14*.

## 94/102/96b TODENNETTU BUILD 15 -SISALLOLLA (NATIIVI-UI b87da286, VIDEO b13o/video-b15-todennus-94-102-96b-iphone.mp4): KOKORUUTU + RASTI, SUURENNOS 2. NAPAUTUKSELLA, MINIPULUN VASTAUS YLIMPANA; LAITETESTAAJAN PUUTE JOHTUI SIITA, ETTA UITK-ELEMENTIT EIVAT NAY iOS:N UI-PUUSSA → SAVUKIERROKSESSA UITK-NAPIT TODENNETAAN KUVASTA; LOYDOSRAPORTTI 22 RIVIA KORJATTU (4948a5267); 118 PUHEVIIVE: PELIKOODARI MITTAA UUDELLEEN AVAUSLUENTA BUILDISSA -COMMITILLA (25.9.2026 klo 18.13)

Natiivi-UI siirtyy CC-nappiin.

## OMISTAJA klo 18.2x (KORTTI, SITOVA, RAAMATTUUN): LAMPO JA VIRRANKULUTUS NATIIVISSA — PELI KUUMENTAA PUHELINTA JA iPADIA; SYY: NATIIVI PIIRTAA PALLON NAYTON TAYDELLA TAAJUUDELLA (120 Hz PROMOTION / 60 Hz) MYOS LEVOSSA (KehysMittari NOSTAA targetFrameRaten), LEHDEN ALLA JOKA 4. KEHYS, EI LAMPOTILASEURANTAA, HDR JA VARJOT PAALLA; WEB LEPAA LEPOPIIRROLLA. LAMPOERA BUILD 16:EEN NYT (OMISTAJA VALITSI): 1) DYNAAMINEN RUUDUNPAIVITYS + LEPOPIIRTO OnDemandRenderingilla (PELIKOODARI), 2) thermalState/LOW POWER → 30 fps, renderScale 0,7, BLOOM POIS, ESILATAAJA PYSAHTYY KUUMANA (PELIKOODARI), 3) HDR/VARJOT/ANTURI/MITTARIKIRJAUS KUVAPARILLA (NATIIVISEPPA), 4) LAITTEELLA 10 min LAMPO- JA AKKUMITTAUS ENNEN/JALKEEN + SAVUKEVARTIJA (LAITETESTAAJA); LIIKKEEN 60 fps EI SAA HUONONTUA (25.9.2026 klo 18.22)

Raamattuun NATIIVI PELI ETUSIJALLE -osioon ESILATAUSPOLITIIKAN perään; Julkaisija synkkaa mainiin.

## PELIKOODARI VALMIS: 118 AVAUSLUENTA JA ETUSIVUN MUSIIKKI BUILDISSA (PUHE 31 ms PYYNNOSTA, ENNEN 1–4 s; AIEMPI 'EI ESILATAUSTA' JOHTUI SIMULAATTORIN LUENNAT-KYTKIMESTA) + ESILATAAJA ERA 1 (JONO, UUSINTA, OSUMA-%, uusin.json KERRAN ISTUNNOSSA; LAATAT LAATTAPALVELIMEN OMASSA JONOSSA), MOLEMMAT MERGE-PYYNNOSSA BUILD 16, RAPORTTI PR #3227; FABLE: LAMPOERA ENNEN ESILATAAJAN ERAA 2 (25.9.2026 klo 18.23)

Löydös 118 merkitty raporttiin.

## LAMPOERAN LAITEMITTAUS: LAITETESTAAJALLA EI FYYSISTA LAITETTA (OMISTAJAN iPHONE JA iPAD 11 unavailable, iPAD PRO 13 ON LINSSISEPAN/NATIIVISEPAN) → FABLE: MITTAUS NATIIVISEPALLE iPAD PRO 13:LLA (VUORO LINSSISEPAN KANSSA), PELIKOODARI KIRJAA thermalState + AKKU-% + TILAJAKAUMAN KEHYSAJAT-LOKIIN, LAITETESTAAJALLE VAIN SAVUKEVARTIJA SIMULAATTORISSA; iPHONE OMISTAJAN TUNTUMALLA BUILD 16:STA (25.9.2026 klo 18.24)

Raamatun kohta 4 (MITTARI) tarkentuu näin; Raamattua ei muuteta.
...
## LINSSIPARITEETTI KIERROS 4 VALMIS BUILD 15:LLA (LINSSISEPPA PR #3229): KIERROKSEN 3 RIVIT KUNNOSSA KAIKILLA LAITTEILLA (iPAD 31 LAPPU, 39 PILLERI, KOTIMAAN KEHA JA RELIEFI); 43 ISOISA VAIN NATIIVISSA; AVOIN NATIIVI-UI:LLE iPADIN YLAPALKIN PILLERI −27…+17 px; FABLE: RIVI 42 KARTTAPALLO = HYVAKSYTTY POIKKEAMA (NATIIVIN KARTTA ON AINA PALLO, EI ERILLISTA TILAA); IHMISEN MATKA II ERAT 0–2 TOIMIVAT VIDEOSSA, MERGE ODOTTAA LINSSISIIRRON URP-VIRHEEN KORJAUSTA (NATIIVISEPPA) JA CC-NAPIN SIJAINTIA (NATIIVI-UI) (25.9.2026 klo 18.34)

GLO-30: 18.29 n. 6 200/26 450 ruutua, 190/589 Gt, 22 Mt/s, valmis ~23–00 (omistajalle kerrottu).

## RAAMATTU-SYNKKA #3228 MAINISSA (LAMPO JA VIRRANKULUTUS NATIIVISSA + LOKI); JULKAISIJA MERGEAA #3216:N SAVUKKEIDEN JALKEEN JA AJAA OSOITINVAIHDON (#3217) PAGES-AJON PERAAN; SISALTO-PR:IEN SAVUKKEET PERUTTU AJURIN VAPAUTTAMISEKSI; #3229 (KIERROS 4) MAINISSA (25.9.2026 klo 18.36)

Fable ei mergeä #3216:ta itse.

## #3216 PIDOSSA: SAVUKKEET KATKESIVAT 20 min AIKARAJAAN 47/84 (3 RINNAKKAIN, SIMULAATTORIT PAALLA), PYRAMIDI-KOE EI EHTINYT; UUDET PUNAISET laattaohjelmat-chromium 2/5, TOPOGRAFIALINSSI 12/14, SUMU 3/5 + KUORMAPUNAISET → FABLE: UUSINTA ~19.15 SIMUVUOROJEN JALKEEN, MERGE JA OSOITINVAIHTO VASTA KARTTASEPAN OK:N JALKEEN; LAATTAPUNAISET SAAVAT JOHTUA OSOITTIMEN JA LAATTAVERSION EROSTA, TOPOGRAFIA/SUMU SELITETTAVA ERIKSEEN (25.9.2026 klo 18.38)

Julkaisija kysyi Karttasepältä.

## #3216:N PUNAISET SELITETTY (KARTTASEPPA): TOPOGRAFIALINSSIN LOKI 'PALLON SARJA JA PYRAMIDI ERI VERSIOTA' (TUOTANTO 23a, PR 25); LAATTAOHJELMAT, ASTRO, SUMU JA PARIISI-LIUSKA NOJAAVAT SAMAAN LEPOKERROKSEEN; K6 SIMULOITU VAIHTO 12/12 → EHTO TAYTTYY; JULKAISIJA: JUNA #3230 → jono.sh 3216 (VERSIONOSTO) → PAGES → vaihda-pyramidi-osoitin sarja=2026-09-25 → SAVUKKEET MAINISSA ~19.25 (PUNAINEN SIELLA = REGRESSIO, KARTTASEPPA KORJAA) (25.9.2026 klo 18.43)

Omistajan 'vaihda' annettu klo 17.0x.

## KONTEKSTI YLI 70 %: NATIIVISEPPA 73, LINSSISEPPA 76, SISALTOKIRJURI 79 (POSTIVAHTI) → FABLE: KAIKILLE KOLMELLE LUOVUTUS + clear_session self (NATIIVISEPPA MERGE-ERAN JALKEEN, SISALTOKIRJURI PR:N JALKEEN, LINSSISEPPA HETI); ALOITUSVIESTIT FABLELTA POSTIVAHDIN KUITTAUKSEN JALKEEN (25.9.2026 klo 18.46)

Kiintiö 33 %, nollautuu 22.30; juna kunnossa.

## OMISTAJA klo 19.0x (KORTTI, SITOVA, LOYDOS 120, RAAMATTUUN ALOITUSLENNON KAMERAKASIKIRJOITUS → TARKENNUS): NATIIVISEPAN VIDEOPARI (lento-spline f9d785c9, C2-SPLINE 10 s) EI VIELA KELPAA — LENTOKONE PITAA OLLA KOKO AJAN NAKYVISSA (KAMERA EI KADOTA KONETTA RUUDUSTA), JA LENNON ALKU (NOUSU LAHTOKAUPUNGISTA) PITAA NAKYA VAIKKA KAUKAA; UUSI VIDEOPARI NATIIVISEPAN SEURAAJALTA. IHMISEN MATKA II ERAT 0–2 JUNASSA juna/b13 3d2fad7c (BUILD 16: II-LINSSI, CC, ISOT KUVAT + KARTAN VAISTO, RAITOJEN KORJAUS MYOS I:SSA, VALOKEILA; URP-VIRHEET 0, KEHYS MED 16,7 ms / p99 27 ms), ERA 4 AANIMAISEMAT AMPARISSA (15 kpl, −30 LUFS, PR #3231) + SOITTO 6d16dbe1 TODENNUS SEURAAVALLA SIMUVUOROLLA. LAMPO: BUILD 15 iPAD 13 DEV-KAANNOS 11 min THERMAL serious, KEHYSAIKA 60–70 ms MYOS LEVOSSA (EI VERTAILUKELPOINEN: KUUMA LAITE, DEV) → TOISTO RELEASE-KAANNOKSELLA, KAAPELI SAA JAADA, AKKU-% POIS. 119: HALKEAMA LAATTATASOJEN SAUMASSA → VARAPALLO + LAATTARAJOJEN LAAJENNUS TULOSSA (25.9.2026 klo 19.00)

Raamattuun lisätty TARKENNUS ALOITUSLENNON KAMERAKÄSIKIRJOITUS -kohdan TEMPO-osan eteen.

## OMISTAJA klo 19.0x (LISAYS 120): LENTO SAA KESTAA 2 s PIDEMPAAN (10 → 12 s), JOTTA KONE PYSYY NAKYVISSA JA LENNON ALKU NAKYY; RAAMATUN TARKENNUKSEEN LISATTY (25.9.2026 klo 19.00)

Uusi videopari Natiivisepän seuraajalta luovutuksen jälkeen.

## NATIIVI-UI VALMIIT: IHMISEN MATKA II UI (15827520) JUNASSA 3d2fad7c — CC iPHONELLA VUOSILUVUN RIVIN OIKEASSA PAASSA, OTSIKKO 'Ihmisen matka II'; LAMPOERAN UI-OSA natiivi-ui/lampo 24e945f7 MERGETTY pelikoodari/lampoon (UiRauhassa isDirty, TRANSITIOT JA KEHYSANIMAATIOT HERATTAVAT TAYDEN TAAJUUDEN, LEHDEN PEITTO PeittaaRuudun — LEHTI EI PEITA KOKO RUUTUA iPAD 11 VAAKA / iPAD 13); 113/114 EI UI-MUUTOKSIA; iPAD-PILLERIN ERO OLI MITTAUSTYOKALUN VIRHE (RAAKA +1…+2 px); 115 ODOTTAA PIKKUKUVADATAA (25.9.2026 klo 19.01)

Pelikoodari mittaa lämpöerän laitteella.

## PELIKOODARI VALMIS: LAMPOERA pelikoodari/lampo 97f97fa4 MERGE-PYYNNOSSA (BUILD 16): TAYSI TAAJUUS LIIKKEESSA, LEVOSSA 30 fps, LEHDEN ALLA PALLON KAMERA POIS; serious/VIRRANSAASTO → 30 fps + renderScale 0,7 + BLOOM POIS + ESILATAAJA 4–5 SEIS, critical → 20 fps; SIMULAATTORISSA LIIKE EI HEIKKENE (p95 17,7 ms, MAX 19,6 vs 66); KEHYSMITTARIN RIVILLE thermal/AKKU/TILAT/PIIRRETTY, LAITETESTAAJALLA VARTIJA; AVOIN: LEPOPIIRTO (PAIKALLAAN) EI TOTEUDU, UiRauhassa PYSYY EPATOTENA → NATIIVI-UI SELVITTAA. NATIIVISEPPA LUOVUTUS e (82ad7ef0a) JA LINSSISEPPA NOLLATTU → ALOITUSVIESTIT LAHETETTY (NATIIVISEPALLE 120:N TARKENNUS MUKANA), RC TAKAISIN; SISALTOKIRJURI 79 % VIELA AKTIIVINEN (25.9.2026 klo 19.01)

Natiiviseppä mittaa iPad 13:lla build 15 vs 16 Release-käännöksellä.

## WEBIN PERUSKARTTA 2026-09-25 TUOTANNOSSA klo 19.00: #3216 (v2233) PAGESISSA (AJO 36157909802) JA OSOITINVAIHTO vaihda-pyramidi-osoitin sarja=2026-09-25 (pyramidi.json sha256 c2d39c7b… → c5f976bc…, CDN PALAUTTAA UUDEN); VARMUUSKOPIO julisteet/pyramidi/pyramidi-20260925-1900.json (PALAUTUS palauta=pyramidi-20260925-1900.json); SAVUKKEET MAINISSA ILMAN SIMULAATTOREITA ~19.25, PUNAISET KARTTASEPALLE (25.9.2026 klo 19.02)

Jono kohta 3 valmis.

## SISALTOKIRJURI: MAAKUNTAERA 1 VALMIS PR #3226 (23 MAATA, 348 ALUETTA); #3226 SULKEUTUI SQUASH-JUNASSA ILMAN mergedAt:IA JA 6 MAATA (CHE/PRT/HUN/SWE/NOR/IRL) JAI ORVOKSI → REOPEN + UUDELLEENRAKENNUS origin/mainista, OPPI LUOVUTUKSESSA; LUOVUTUS PR #3233, NOLLAUS KAYNNISSA (25.9.2026 klo 19.04)

Fable lähettää aloitusviestin Postivahdin kuittauksen jälkeen.
...
## PELIKOODARI NOLLATTU → ALOITUSVIESTI LAHETETTY (pelikoodari-tyo-20260923, LUOVUTUS -yo2), RC TAKAISIN; #3233 (SISALTOKIRJURIN LUOVUTUS) MAINISSA; TANAAN NOLLATTU 5 SESSIOTA (NATIIVI-UI, NATIIVISEPPA, LINSSISEPPA, SISALTOKIRJURI, PELIKOODARI) (25.9.2026 klo 19.11)

Julkaisija 31 %, Karttaseppä 55 %, Siirtoseppä 30 %, Laitetestaaja 24 % — ei nollausta.

## LINSSISEPPA (UUSI KONTEKSTI, LUOVUTUS b bee4f07ad): II:N ERAT 4–5 TODENNETAAN JULKAISIJAN VUOROLLA ~19.30 KAANNOKSELLA b4428138 (SIS. JUNAN 3d2fad7c), MERGE-PYYNTO NATIIVISEPALLE; ERA 4 KORJAUS af3be0bb (AANIMAISEMA RIIPPUU VAIN AANET-KYTKIMESTA, EI KERTOJASTA — WEBIN KAAVA); 5b KALLISTUS: LAHIKUVAT ~9 300 km JA PalloKierto NOLLAA KALLISTUKSEN YLI 7 000 km → FABLE: LASKE II:N LAHIKUVAT RAJAN ALLE, EI JATETA 5b:TA POIS (25.9.2026 klo 19.14)

Pelikoodari kuittasi uuden kontekstin.

## OMISTAJA klo 19.2x (KORTTI): GLO-30 TAYDELLA VAUHDILLA HETI — SYY HITAUTEEN: COPERNICUS-AMPARI ANTAA ~3 Mt/s PER YHTEYS JA AJO OLI 4 YHTEYDELLA (21 Mt/s), LIITTYMA JA NAS (NFS) EIVAT RAJOITA (KOE +4 VIRTAA → 31 Mt/s); FABLE VAIHTOI 24 YHTEYTEEN klo 19.24 (glo30-maailma-24.sh pid 90221, nosta-8-klo22.sh PYSAYTETTY) → 39 Mt/s ENSIMITTAUKSESSA, 0 VIRHETTA; ARVIO VALMIS ~21–22; VAHINKO: TOINEN KOPIO KAYNNISTYI VAHINGOSSA (setsid PUUTTUU MACISTA, ENSIMMAINEN KAYNNISTYS OLI HIDAS) JA TAPETTIIN, 24 ORPOA .tmp-TIEDOSTOA JAAVAT (EIVAT VAIKUTA EHEYSTARKISTUKSEEN) (25.9.2026 klo 19.25)

Karttaseppä tekee eheystarkistuksen VALMIS-rivin jälkeen; Postivahti hälyttää vain jos virtoja 0 tai seurantarivi puuttuu yli 40 min.

## MAININ SAVUKKEET OSOITINVAIHDON JALKEEN FAILURE (AJO 36158002209): VAIHDON PUNAISET VIHREITA (SUMU, TOPOGRAFIA, LAATTAOHJELMAT, NOSTOT); UUDET: ranskan-nostot-lukossa 9/11, laivamatka-tanger 3/4, astro-sumu 0/0 JA 10 CHROMIUM-SAVUKETTA 0/0 AIKAKATKAISULLA 180 s → FABLE: EI PALAUTUSTA KUORMAPUNAISISTA; TODENNAKOINEN SYY GLO-30 24 VIRTAA klo 19.24 ALKAEN (39 Mt/s SAMALLA MACILLA) — AIKALEIMAT TARKISTETAAN; AIDOT REGRESSIOT KORJATAAN ETEENPAIN, OSOITIN PALAUTETAAN VAIN JOS PELI ON RIKKI; KARTTASEPAN ARVIO ~15 min (25.9.2026 klo 19.26)

Palautus valmiina: palauta=pyramidi-20260925-1900.json + #3216 revert.

## KARTTASEPAN ARVIO: EI PALAUTUSTA — OSOITINVAIHTO KORJASI PR:N AIKAISET PUNAISET; AIKAKATKAISUT, LAIVAMATKA JA ASTRO-SUMU KUORMAA (SELAIN EI KAYNNISTYNYT, UUSINTA MAINISSA); ranskan-nostot-lukossa 9/11 SISALTOREGRESSIO v2216:STA (#3149 camargue/dune-du-pilat UUSIN TUNNUKSIN, nostoankkurit-fra.js VANHOILLA) → KARTTASEPPA KORJAA PR:LLA; astro-pallo-puhelin 43/47b (25-SARJAN NAVAN ILME) SELVITYKSESSA, PELATTAVUUS EI ESTY. KARTTASEPPA 66 % → LUOVUTUS -d KORJAUS-PR:N JALKEEN. PELIKOODARI KAYNNISSA 18 %; juna/b13 YLARAJA LAUKESI 19.18 (29 min), KAANNOS KAYNNISSA. NATIIVISEPPA: 120 v2 AGENTILLA, VIDEOPARI 19.45–21.00, LAMPOERA JUNASSA b37d2b3e, 119 POHJAPALLO AGENTILLA. SISALTOKIRJURI: MAAKUNTAERA 2 PR #3234 (12 MAATA, 201 ALUETTA), #3220 SULJETTU (KUVAT JO MAINISSA), ERA 3 ALKAA (25.9.2026 klo 19.27)

Kiintiö 52 %.

## LAMPOVARTIJA PASS SIMULAATTORILLA (LAITETESTAAJA, juna/b13 fb5c2ebf = BUILD 16): LEVOSSA 30 fps (p50 33,3 ms), LAMPOTILAT auto/kuuma/kriittinen 60/30/20 fps JA renderScale 0,8/0,7/0,7; LEPOPIIRTO (paikallaan>0) TODENNETAAN KUN NATIIVI-UI:N RAUHAKORJAUS ON JUNASSA; RAPORTTI 441826c43 (25.9.2026 klo 19.27)

Oikea lämpö ja akku fyysiseltä laitteelta Natiivisepältä.

## OMISTAJA klo 19.3x: iPAD PRO 13 ON FYYSISESTI MAC STUDION PAALLA JA VOI PYSYA KUUMANA SEN TAKIA → iPADIN thermalState-MITTAUKSIIN EI LUOTETA; LAMPOERAN LAITEMITTAUS PERUTTU, OMISTAJA TESTAA LAMMON OMALLA iPHONELLAAN BUILD 16:STA; NATIIVISEPPA KESKITTYY 120 v2:EEN JA 119:AAN; LEVYN LASKU (171 → 160 Gt) ON UNITY-KAANNOKSIA, EI VUOTOA (25.9.2026 klo 19.31)

Simulaattorin lämpövartija (Laitetestaaja) jää käyttöön; se todentaa säännöt, ei lämpöä.

## LAMPO, BUILD 15 RELEASE iPAD PRO 13 (NATIIVISEPPA 19.18–19.29, docs/raportit/lampo-mittaus-20260925.md): thermalState 0 KOKO AJAN, MUTTA KEHYSAIKA LEVOSSA 50–67 ms (LIIKE 42–59 ms) = LAITE TAYDELLA KUORMALLA MYOS PAIKALLAAN → FABLE: UUSI ERA 'KEHYKSEN HINTA LEVOSSA' NATIIVISEPAN AGENTILLE — UNITY PROFILER + XCODE GPU CAPTURE iPADILLA, VIISI KALLEINTA KOHTAA ms:INA ENNEN MUUTOKSIA (docs/raportit/kehyksen-hinta-20260925.md), TAVOITE STAATTINEN KEHYS ≤ 16 ms iPAD / ≤ 20 ms iPHONE; KORJAUKSET KUVAPARILLA; 30 fps:N KATTO EI RIITA, LEPOPIIRTO AUTTAA VAIN TAYSIN PAIKALLAAN (25.9.2026 klo 19.32)

Omistajan huomio: iPad Mac Studion päällä → thermalState ei luotettava; tässä se oli 0.

## KARTTASEPPA LUOVUTUS -d (a62bce15f, karttaseppa-tyo-20260922): #3235 ANKKURIT FRA 27/27 JULKAISIJALLA; laivamatka-tanger PAIKALLISESTI 14/14 (KUORMAA); astro-pallo 43/47b VANHA (62/64 MYOS 23a:LLA); GLO-30 EHEYSTARKISTUS SEURAAVALLE KARTTASEPALLE; AJOKANSION NAS-SIIRTO JATKUU; NOLLAUS KAYNNISSA (25.9.2026 klo 19.43)

Fable lähettää aloitusviestin nollauksen jälkeen.
...
## SIIRTOSEPPA JUMISSA HILJAA: 1.42 VALMIINA LUONNOS-PR:SSA #3225 (TESTIT 91/0) MUTTA EI VIETY, KOSKA LUULI NATIIVISEPAN KUITTAUKSEN PUUTTUVAN (ANNETTU 17.5x) JA SendMessage-ESTO (10/VUORO) ESTI VASTAAMASTA — EI KAYTTANYT mcp send_message -VARAKANAVAA → FABLE: VIE NYT, #3225 VALMIIKSI, JULKAISIJA MERGEAA; MUISTUTUS KAIKILLE: VARAKANAVA TOIMII ILMAN OMISTAJAA (25.9.2026 klo 19.50)

Fable havaitsi jumin lukemalla session transkriptin (list_events).

## LEPOPIIRRON ESTE KORJATTU (NATIIVI-UI natiivi-ui/lampo 62c5d0be): SULJETUN RADIOLINSSIN PISTENAYTTO VIERITTI PIILOSSA ~9 KERTAA SEKUNNISSA JA PITI LINSSIKERROKSEN LIKAISENA (MITATTU LAITTEELLA 'ui rauha' -LASKUREILLA, MUUT KERROKSET 0); PELIKOODARI MERGEAA JA TODENTAA VUOROLLAAN 20.05 (25.9.2026 klo 19.53)

Lämpöerän viimeinen avoin kohta.

## SISALTOPAKETTI 1.42 (MAAKUNTARAJAT 138 MAATA) TUOTANNOSSA: #3225 MAINISSA v2235 (TESTIT 4329/0), VIENTI AMPARIIN AJO 36163900360 VIHREA klo 20.01; NATIIVISEPAN KUITTAUS 17.5x (BUILD 15 TUKEE MAAKOHTAISIA MAAKUNTIA); JONON KOHTA 1 KOKONAAN VALMIS (25.9.2026 klo 20.01)

Siirtosepältä odotetaan ämpäritarkistuksen rivi (1.x-osoittimen versio).

## LAMPOERA KOKONAAN BUILD 16 -JUNASSA JA KAANNETTY (juna/b13 6177184c → 281e1059 klo 20.06): PELIKOODARIN Ruudunpaivitys, Lampo JA MITTARI; NATIIVISEPAN PallonLepo, KARTAN ANIMAATIOKYTKENNAT, hdr-/varjot-KYTKIMET (VARJOT OLIVAT JO POIS), ANTURI 0, LOKIT ILMAN PINOA; 113/114 OLETUSRAJAT; PallonLepo KYTKETAAN Ruudunpaivitykseen SEURAAVASSA ERASSA. FABLEN PAATOS: IDLE-ANIMAATIOT (AARREPISTEEN SYKE, SIIRTOKOHTEIDEN HALO, ALOITUSVALINNAN RENKAAT) PYSAYTETAAN 3 s LEVON JALKEEN JA JATKUVAT KOSKETUKSESTA — PALAUTETAAN JATKUVIKSI 30 fps:LLA KUN STAATTINEN KEHYS ≤ 16 ms; ALOITUSPORTTI 30 fps (25.9.2026 klo 20.07)

Perustelu: kehys maksaa 50–67 ms, joten 30 fps:n syke on täysi kuorma.

## FABLE (TYONJOHTAJAN HARKINTA): BUILD 16 LEIKATAAN TANA ILTANA HETI KUN PELIKOODARIN PallonLepo-KYTKENTA JA LEPOPIIRRON TODENNUS OVAT JUNASSA (~20.45) — EI ODOTETA 119/120 v2:TA EIKA VERHOJA, NE MENEVAT BUILD 17:AAN; SYY: OMISTAJA TESTAA LAMMON OMALLA iPHONELLAAN; LAITETESTAAJAN SAVUKIERROS (YDINKULKU + LAMPOVARTIJA + II + MAAKUNNAT POIS) → JULKAISIJA 1.0.16 (ARVIO 21.00–21.30) (25.9.2026 klo 20.07)

Build 16 sisältö: lämpöerä, Ihmisen matka II erät 0–2, maakuntatäyttö + 113, 114–118, 117, kermahuntu.

## JUMI → FABLE (JULKAISIJA): CI-SAVUKEAJURILLA (SamiMacStudio2, samireivinen) 10 NAYTTOA KAYTTAVAA CHROMIUM-SAVUKETTA KAATUU browserType.launch 180 s, 'CVDisplayLinkCreateWithCGDisplay failed' — AJURIKAYTTAJALLA EI NAYTTOISTUNTOA (KONSOLI KOODAUKSELLA), EI 25-SARJAN VIKA → FABLE: A, TEKIJA KARTTASEPPA (PELIKOODARI BUILD 16:N POLULLA): HEADLESS + --use-angle=metal TAI PERUSTELTU OHITUS ILMAN NAYTTOA, TODENNUS MAINISSA; OMISTAJAN NAYTONHERATYS (B) HYLATTY; PR-PORTTI EI ESTY (25.9.2026 klo 20.08)

Sama juurisyy selittää aiemmat 0/0-aikakatkaisut osoitinvaihdon jälkeen.

## JUNA #3239 v2236 MAINISSA (MAAKUNNAT ERA 1 #3226); ERAT 2–4 (#3234 #3236 #3238) JAIVAT POIS — PINOTTUJA, SAMA KOHTA maakunnat-luonnehdinnat.js + TESTIEN LUKUMAARAT → FABLE: SISALTOKIRJURI YHDISTAA YHDEKSI PR:KSI MAININ PAALLE, JATKOSSA YKSI MAAKUNTA-PR KERRALLAAN (25.9.2026 klo 20.17)

Julkaisija ajaa heti kun numero tulee.

## OMISTAJA klo 20.3x (KORTTI): LOYDOS 120 v2 HYVAKSYTTY — natiiviseppa/lento-spline 5cc1597c JUNAAN (12 s: AVAUS 450 km NOUSU LONTOOSTA, KUMINAUHALAHESTYMINEN, HIDAS PANOROINTI, KIIHTYVA IRTAUTUMINEN, MATKA, KIERTO JA LASKU 11,0 s; KONE AINA KUVASSA, MARGINAALI ≥ 21 %/23 %; EI HYPPYJA); HUOMIO: IRTAUTUMISESSA VAALEA LAATTA → REITIN LAATTOJEN ESILATAUS AVAUKSEN AIKANA OMANA ERANA; BUILD 16 JOS EHTII ENNEN KIERROSTA, MUUTEN 17. SISALTOKIRJURI: ERAT 2–4 YHDISTETTY PR #3241 (TESTIT 103/103), ERA 5 ODOTTAA (25.9.2026 klo 20.20)

Video: proto-3d/lokit/lento-spline/videopari-v1-v2-20260925.mp4.

## LOYDOS 120 v2 JUNASSA (lento-spline c8b03f98 → juna/b13 8e53cb03, TESTIT 227/227); JUNASSA MYOS pohja-buildiin JA NATIIVI-UI:N LENTOPOHJA (b8670c7c): KYLMANA ALOITUSVERHO 8,0 → 3,8 s; 119 POHJAPALLO TULOSSA (JUNAMERGE KESKEN); VAALEAN LAATAN ESILATAUS OMA PIENI ERA; LOYDOSRAPORTTI: NATIIVISEPAN RIVI 120 MERGETTY FABLEN HAARAAN (25.9.2026 klo 20.23)

Build 16 -juna: lämpöerä, II 0–2, 113–118, 117, 120 v2, pohja-buildiin, lentopohja.

## LOYDOS 119 JUNASSA (natiiviseppa/reiat-119 6b8d45f0 → juna/b13 35424e12, TESTIT 248/248): POHJAPALLO (PERGAMENTTI #e5d0a7, WGS84 3 km ALEMPANA, YKSI PIIRTOKUTSU < 0,1 ms) + MAASTOLAATTOJEN UUSINTA; MAGENTAKOE 308 px (ALPIT) / 34 px (KAUKAA) → 0; KUVAPARIT lokit/reiat-119/koe2/; JUURISYYT (LAATTASAUMA LATAUKSESSA, PISTEREIAT) JAAVAT POHJAPALLON PEITTOON; POHJAPALLON SAVY LENNOLLA JA LINSSEISSA KUVAAMATTA → TARKISTETAAN BUILD 16:N KUVISTA (25.9.2026 klo 20.26)

Build 16 -juna 35424e12 sisältää nyt 119:n ja 120:n.

## IHMISEN MATKA II ERAT 4–5 TODENNETTU (LINSSISEPPA linssiseppa/ihmisen-matka-2 ed684ce7, MERGE-PYYNTO NATIIVISEPALLA): 15 AANIMAISEMAA SOIVAT (KORJATTU: MAISEMA RIIPPUI KERTOJASTA, 'ALOITA ALUSTA' AANETON), 5b v2 KAIKKI 16 KOHDETTA 4 000 km / 28° SAMALLA KAAVALLA iPHONE+iPAD, 5a AAMUNKOITTO + HEHKU + LOPUSSA KAIKKI VANAT HEHKUVAT; KEHYS MED 16,7 ms, p99 48 ms, > 33 ms 1,3 %; VIDEO lokit/ihmisen-matka-2-era4-5b/; FABLE: CC BY -TEKIJAT lahteet.js:IIN HETI SAMAAN MERGEEN (EI OMISTAJAN KUUNTELUN JALKEEN); SUMU OMANA KERROKSENA LINSSIT-PUOLELLE NATIIVISEPAN LUVALLA, LAATTAVARJOSTIN NATIIVISEPAN; SEURAAVAKSI ERA 3 JA ERAN 5 LOPUT (HIUKKASET, SOIHTU, SAATTOLENTO) (25.9.2026 klo 20.29)

Build 16 tai 17 mergen ajoituksen mukaan.

## ESILATAAJA ERAT 2–3 VALMIIT (PELIKOODARI pelikoodari/esilataaja-3 64794fe8, MERGE-PYYNTO NATIIVISEPALLA, RAPORTTI PR #3240): SAAPUMINEN 0 ms KYLMANA JA LAMPIMANA (ALOITUSPUHE 515 → 0, LUENTA 798 → 0), JOUTILAS + ENNAKOINTI, SEIS VIRRANSAASTOSSA JA KUUMANA, KYLMAN KAYNNISTYKSEN KILPAILUTILANNE KORJATTU; KUSTANNUS: MAAN KAIKKI NOSTOKUVAT ENSIKAYNNILLA (GRC 124 KUVAA ~95 Mt); LEPOPIIRTO TODENNETTU (NATIIVI-UI d0a187db): PAIKALLAAN 2–3 PIIRRETTYA KEHYSTA 150:STA → FABLE: PallonLepo-KYTKENTA HETI juna/b13 35424e12:N PAALLE, BUILD 16 LEIKATAAN SIITA (25.9.2026 klo 20.30)

Erä 4 (LRU, 2 Gt siivous, linssien listat) vasta build 16:n jälkeen.

## 5 h -KIINTIO 95 % klo 20.40 (NOLLAUTUU 22.30): SISALTOKIRJURI, LINSSISEPPA JA NATIIVI-UI LEPAAVAT 22.30:EEN (POSTIVAHTI LAHETTI), BUILD 16:N POLKU JATKAA (PELIKOODARI, LAITETESTAAJA, JULKAISIJA, NATIIVISEPPA); #3240 MAINISSA (25.9.2026 klo 20.40)

Karttaseppä jatkaa CI-korjausta kevyesti; GLO-30 ei kuluta kiintiötä.

## IHMISEN MATKA II:N AANIMAISEMIEN ATTRIBUUTIO PR #3244 (LINSSISEPPA): lahteet.js + README — 6 CC BY -AANITYSTA NIMINEEN, TEKIJOINEEN JA FREESOUND-OSOITTEINEEN, 9 CC0-AANITTAJAA, MUOKKAUSMERKINTA, TESTIT 21/21; HAVAINTO: README:N KAKSI VANHAA AANET-RIVIA SANOVAT 'CC BY-NC' VAIKKA NC-AANET ON KORVATTU → SIIRTOSEPALLE KORJAUS; ERA 3 SUMU TEHTY LINSSIT-PUOLELLE NATIIVISEPAN LUVALLA (8c3befc8), VIDEO JA A/B SEURAAVALLA SIMUVUOROLLA (25.9.2026 klo 20.44)

Linssiseppä lepää 22.30:een kiintiön takia.

## MAAKUNTIEN LUONNEHDINNAT: ERA 5 MAINISSA v2238, ERA 6 PR #3245 (ARG COL ECU BOL PER VEN URY PRY IDN PAK BGD LKA NPL) JULKAISIJALLA; TEHTY 65/138 MAATA; NIMIDATAN VIRHEET 5 CHIPISSA; SISALTOKIRJURI LEPAA 22.30:EEN, SITTEN ERA 7 (25.9.2026 klo 20.45)

Yksi PR kerrallaan -kaava toimii.

## FABLE (TYONJOHTAJAN HARKINTA): PELIKOODARI KESKEN ESILATAAJAN ERAA 4 EIKA LUKENUT KYTKENTAKASKYA → BUILD 16 -JUNAN KOKOAMINEN NATIIVISEPALLE: PallonLepo↔Ruudunpaivitys-KYTKENTA, natiivi-ui/lampo d0a187db JA II ERAT 4–5 (ed684ce7) JUNAAN, KAANNOS, SHA LAITETESTAAJALLE; PELIKOODARI VIE ERAN 4 MERGE-PYYNTOON JA LEPAA 22.30:EEN; SYY: KIINTIO 95 %, BUILD PITAA SAADA LIIKKEELLE ENNEN NOLLAUSTA (25.9.2026 klo 20.46)

Havaittu list_events-luvulla.

## ESILATAAJA ERA 4 VALMIS (PELIKOODARI pelikoodari/esilataaja-4 a9df0cc9, MERGE-PYYNTO): LEVYSIIVOUS > 2 Gt VANHIMMASTA (PAKETIN VARASTO JA LAATAT JAAVAT), KUVIEN MUISTI-LRU 200/300 Mt, SIIRTOSEPAN TIEDOSTOVAYLA Range-JATKO TODENNETTU (200/206/416), SAAPUMINEN 0 ms, 278/278; KOHTA 6 LINSSISEPPA RAJAPINNAN KAUTTA; LEHTIEN KUVAT WKWebView'N VALIMUISTISSA (NATIIVI-UI); FABLEN PAATOS: TASO MUU (PAKETIN PAIVITYS = POLITIIKAN KOHTA 2) JATKAA MYOS VIRRANSAASTOSSA JA KUUMANA — VAIN TASOT 4–5 PYSAHTYVAT (RAAMATUN SANAMUOTO, SIIRTOSEPAN SUUNNITELMA OIKEIN) (25.9.2026 klo 20.51)

Esilataaja erät 1–4 valmiit; PallonLepo Natiivisepällä.

## CI-SAVUKKEIDEN NAYTTOKORJAUS PR #3243 (KARTTASEPPA, AJURIN AJO 36168226113: 1805/1826, 12 KAATUNUTTA VIHREITA): JUURISYY AJURI (KOODAUS) JAI ILMAN NAYTTOA klo 13.10 KUN samireivinen OTTI KONSOLIN — 11 WEBKIT-KAYNNISTYSTA + astro-sumu CVDisplayLink-SEGV; KORJAUS: aja-sarja KOKEILEE WEBKITIN KERRAN, ILMAN NAYTTOA RIVIT CHROMIUMILLA (HEADLESS + ANGLE METAL), 3 -webkit-RIVIA OHITETAAN KUN -chromium-PARI AJETAAN; JALJELLA 3 VANHAA PUNAISTA (pariisi-lahizoom LIUSKA, astro-pallo-puhelin 8b VERSAILLES); PR JULKAISIJALLE; GLO-30 SEURANTA 9 972/26 450 klo 19.55 (AIEMPI 18 462 OLI VAARA LASKENTA), VALMIS ~22 (25.9.2026 klo 20.53)

Fable mergeää #3243 kun vihreä.

## PELIKOODARI: PAKETIN PAIVITYS JATKAA KUUMANA JA VIRRANSAASTOSSA (TODENNETTU PAKOTETULLA lampo kuuma), MERGE-PYYNTO pelikoodari/esilataaja-4 4e4fc18b (BUILD 17); RUUTU/VERKKO/LEVY/LAMPO KIRJAUTUVAT ok-RIVINA; PALLONLEPO NATIIVISEPALLA; PELIKOODARI LEPAA 22.30:EEN; #3243 MAINISSA (25.9.2026 klo 20.57)

Esilataaja kokonaan build 17:ään (erät 2–4).

## BUILD 16 -JUNA KOOSSA: juna/b13 1aa7c558 KAANNETTY 7f3979b0 klo 20.58, ASENNETTU LAITETESTAAJAN JA PARITEETTIAJON SIMULAATTOREIHIN; UUTTA: PallonLepo↔Ruudunpaivitys 165521fc, IDLE-SYKE JAATYY 3 s, PORTTI 30 fps, natiivi-ui/lampo d0a187db; II ERAT 4–5 JO JUNASSA (3506a19c); esilataaja-4 → BUILD 17; KAKSI AGENTTIA (LENNON ESILATAUS, KEHYKSEN HINTA) PYSAYTETTY KIINTION VUOKSI, JATKUVAT 22.30 → LAITETESTAAJAN SAVUKIERROS KASKETTY (25.9.2026 klo 20.59)

Build 16 sisältö: lämpöerä + lepopiirto, II erät 0–5, 113–120, 117, pohja-buildiin, lentopohja (verho 3,8 s), kermahuntu.

## BUILD 16 SAVUKIERROS PASS (LAITETESTAAJA, proto_ref 1aa7c558, KAANNOS 7f3979b0, RAPORTTI 204dbe5b1): LAMPOVARTIJA iPHONE+iPAD LEVOSSA 30 fps, LEPOPIIRTO PIIRRETTY 2–3/151, LAMPO 60/30/20; KYLMA KAYNNISTYS → VALINTA → LENTO v2 → ATEENA → NOSTO, II AVAUTUU JA PYORII, MAAKUNNAT 'POIS', LIIKE ATEENA→SOFIA; AVOIN: CC-NAPPI EI LOYTYNYT UI-PUUSTA (UITK, VUOSILUKURIVIN OIKEA PAA → KUVASTA ENSI KIERROKSELLA) → FABLE: BUILD 1.0.16 JULKAISIJALLE (25.9.2026 klo 21.14)

Odotetaan TF-riviä; kiintiö voi katkaista 22.30:een.

## BUILD 16 PROTO-MASTERISSA bf70290d (MERGE juna/b13 1aa7c558, PUU = 7f3979b0): LAMPOERA + LEPOPIIRTO, 117–120 (LENTO v2), POHJAPALLO, MAAKUNTIEN OLETUSRAJAT, LAATTAPAKETTI JA VERHOT, ESILATAAJA 1–3, IHMISEN MATKA II 0–5; UNITY KIINNI, TF-VIENTI VAPAA; CC-NAPIN HAVAINTO LINSSISEPALLE JA NATIIVI-UI:LLE (25.9.2026 klo 21.14)

Odotetaan Julkaisijan TF-riviä.

## SIIRTOSEPPA: 1.42 TUOTANNOSSA 1.x v121 (VIENTI v2235 klo 20.01), 2.0 v63, AMPARITARKISTUS 499/499, MAAKUNTARAJAT 138 MAATA / 2 546 ALUETTA; README:N AANILISENSSIT KORJATTU PR #3246 (EI NC-VIITTEITA); 1.43 (maakuntarajat.vari) LUONNOS #3237 ODOTTAA NATIIVISEPAN KUITTAUSTA; SIIRTOSEPAN VIESTIT ESTETTYINA 18–20 (10/VUORO) KUNNES OMISTAJA KIRJOITTI (25.9.2026 klo 21.20)

Laitetestaaja: build 16 lisäkohdat PASS (äänimaisema rms 0,092, aloituslento 12–14 s), raportti 5609d79d7.

## BUILD 16 TF-VIENTI KAYNNISSA (proto-3d TestFlight AJO 36172168911, ALKOI 21.14); #3246 DIRTY (README-RISTIRIITA #3244:N KANSSA) → SIIRTOSEPPA REBASEAA (25.9.2026 klo 21.20)

1.0.16 arvio TF:ssä ~21.45.

## BUILD 16 TESTFLIGHTISSA klo 21.22: 1.0.16, PROTO bf70290d (JUNA 1aa7c558, KAANNOS 7f3979b0), AJO 36172168911, LASKURI 16; SISALTO: LAMPOERA + LEPOPIIRTO (LEVOSSA 30 fps, PAIKALLAAN EI PIIRTOA, IDLE-SYKE JAATYY 3 s, KUUMANA 30 fps + KEVENNYKSET), IHMISEN MATKA II ERAT 0–5, 113–120 (LENTOKAMERA v2 12 s, POHJAPALLO), POHJA BUILDISSA (VERHO 3,8 s), ESILATAAJA 1–3, KERMAHUNTU; OMISTAJALLE PUSH 21.23 — OMISTAJA TESTAA LAMMON iPHONELLA; SEURAAVA LOYDOSNUMERO 121. 1.43 KUITATTU (NATIIVISEPPA: MiniJson OHITTAA TUNTEMATTOMAN KENTAN, +10 kt) → SIIRTOSEPPA SAA VIEDA (25.9.2026 klo 21.23)

Build 17 -jono: Esilataaja 4, II erä 3 (sumu) ja erän 5 loput, lennon laattojen esilataus, kehyksen hinta -korjaukset, 115 kuvat, CC-napin kuvatodennus.

## GLO-30 KOKO MAAILMA VALMIS klo 22.10 (26 450/26 450 RUUTUA, 589,1 Gt NAS:ISSA dem/copernicus-glo30, EHEYS OK MAARA JA KOKO; 24 VIRTAA 19.24 →); KARTTASEPPA TEKEE OMAN EHEYSTARKISTUKSEN JA SIIVOAA ORVOT .tmp:T. 5 h -KIINTIO 100 % klo 21.24 → NOLLAUTUI 22.30, POSTIVAHTI HERATTAA LEPAAVAT; HUOM: extraUsage PAALLA (7,74 €/13 € KUUKAUSIRAJASTA) — OMISTAJALLE KERROTTU (25.9.2026 klo 22.32)

Fablen sessio jatkui 22.31 omistajan viestistä.

## PELIKOODARI HERASI 22.32, ESILATAAJA 2–4 JUNASSA (ac0aaadc), JONO TYHJA → FABLE: SEURAAVA ERA KEHYKSEN HINTA LEVOSSA, CPU-PUOLI (PlayerLoop, 52 Update-SILMUKAN KUORMA, UI TOOLKIT, CESIUM-TRAVERSAL, ESILATAAJAN JONO) — VIISI KALLEINTA ms:INA RAPORTIN CPU-OSIOON, SITTEN KORJAUKSET (UPDATE → TAPAHTUMAOHJATTU); LAITEMITTAUKSEN TUKI TOISEKSI (25.9.2026 klo 22.32)

Natiivisepän agentti: GPU ja laatat iPadilla.

## LAITETESTAAJAN KORJAUS b16-PASSIIN: AJOI IHMISEN MATKA I:N (linssi ihmisen-matka), EI II:TA → II JA CC TODENTAMATTA, MUUT PASS-KOHDAT ENNALLAAN (0a8ba628a); FABLE: II + CC AJETAAN NYT iPHONELLA, PUUTE OLISI LOYDOS BUILD 17:AAN. SIIRTOSEPPA: #3246 KORJATTU MAININ PAALLE (12/0), 1.43 TUOTANNOSSA v127 (499/499), TAUSTAPAIVITYKSEN VAIHE 1 PR #3247 (JULKAISIJAN JUNAAN). POSTIVAHTI: HERATYKSET 22.32, KIINTIO 4 %, extraUsage POIS (25.9.2026 klo 22.33)

Linssisepän herätys jonossa.

## IHMISEN MATKA II + CC PASS iPHONELLA BUILD 16 (LAITETESTAAJA 897de6749): JOHDANTOKORTTI 'Ihmisen matka II', VALOKEILA AFRIKAN YLLA + HAMARA PALLO, CC VUOSIRIVIN OIKEASSA PAASSA, PAALLE/POIS TOIMII; iPADIN CC JA MAAKUNNAT 'POIS' ENSI KIERROKSELLA; NATIIVISEPPA: BUILD 16 KAYTTAA 1.43:N vari-KENTTAA (WEBIN VARIT), BUILD 15 OHITTAA; #3246 MAINISSA (25.9.2026 klo 22.35)

Build 16 -savukierros nyt täysi.

## OMISTAJA klo 22.3x (SITOVA, BUILD 16 → BUILD 17): 121 ALOITUSRUUDUN ALAOTSIKKO POIS (NATIIVI-UI); 122 LENTOKOHTAUKSEN TEKSTITYS POIS, KENTTA JARKYTTAVAN ISO (NATIIVI-UI + PELIKOODARI); 123 OHITA PIENEMMAKSI JA LAPINAKYVAKSI (NATIIVI-UI); 124 'ATEENA, PAIVA 1/80' ~1 s PIDEMPAAN (NATIIVI-UI + NATIIVISEPPA); 125 ATEENAN NOSTOISTA PUUTTUU SYMBOLEITA, TEKSTIT EPASELVIA (NATIIVISEPPA + PELIKOODARI, WEBIN MITAT); 126 MEREN JA MAAN TUPLARAJA → VEKTORIRANTAVIIVA POIS (NATIIVISEPPA); 127 MAANRAJA VAIN MAIDEN VALILLA, EI RANNIKKOA PITKIN, KEVYEMPI (KARTTASEPPA DATA + NATIIVISEPPA PIIRTO); 128 KERMAHUNTU PEITTAA LIIKAA MUITA MAITA → PEITTO ALAS KUVAPARILLA (NATIIVISEPPA + KARTTASEPPA); 129 MEREN SYVYYSEROT LIIAN VAHAN → SAVYLIUKU VOIMAKKAAMMAKSI, KUVAPARI ENNEN POLTTOA (KARTTASEPPA); SEURAAVA NUMERO 130 (25.9.2026 klo 22.38)

Raportti da3443163; roolit merkitsevät KORJATTU.

## GLO-30 EHEYS OK (KARTTASEPPA): 26 450 RUUTUA LISTAA VASTEN, TIFF-IFD JA SIJAINTI = TIEDOSTONIMI 0 VIRHETTA, OTANTA 300 PURETTU (−5,7…6 060 m), OTANTA 100 md5 = S3 ETag 100/100; 24 ORPOA .tmp POISTETTU; AJOKANSIO NAS:ISSA; KARTTASEPPA ALOITTAA 127/129/128. NATIIVISEPPA: 125–128 AGENTEILLA, 124 SOVITTU NATIIVI-UI:N KANSSA (25.9.2026 klo 22.45)

GLO-30 koko maailma NAS:issa: 589,1 Gt, dem/copernicus-glo30. Jono kohta 7 valmis.

## LINSSISEPPA 71 % → LUOVUTUS -c JA NOLLAUS KASKETTY (ERA MERGE-PYYNTOON ENSIN); CODEXIN MINIATYYRIEN VARIKORJAUS ERA 1 (13 KUVAA, POSTI 39141ee4a) → SISALTOKIRJURI TARKISTAA JA VIE SISALTOJUNAAN; KIINTIO 16 %, extraUsage POIS (25.9.2026 klo 22.54)

Postivahti kuittaa nollauksen.

## CODEXIN VARIKORJAUS ERA 1 TARKISTETTU (13/13 SHA, VARTIJAT) → PR #3249 JULKAISIJALLE, KUITTAUS POSTISSA 21fdb4d18; MAAKUNTAERA 6 MAINISSA (72 MAATA), ERA 7 PR #3251 (DZA MAR TUN IRN IRQ SAU SYR JOR NGA TZA ETH GHA) (25.9.2026 klo 22.58)

Yksi PR kerrallaan.

## LENNON ESILATAUS (NATIIVISEPPA): VAALEA LAATTA POISSA (REITIN LAATAT KAMERARADAN JARJESTYKSESSA); MUSTA VERHO YHA 5,0 s KATTO, PALLO ~47 % — JUURISYY CESIUMIN OMA LATAUSJONO (~60 LAATTAA/s) 450 km:N AVAUKSESSA; KOKEILEE CESIUMIN RINNAKKAISUUTTA (A/B KYLMANA) → FABLE: SEURAAVAKSI AVAUKSEN LAATAT CESIUMIN VALIMUISTIIN JO ALOITUSRUUDUSSA (RAAMATTU), SITTEN MATALAMPI VALMIUSRAJA VAIN JOS EI NAY; KEVYEMPI AVAUS HYLATTY (v2 HYVAKSYTTY); TAVOITE ≤ 2 s LAMPIMANA, ≤ 3 s KYLMANA; HAVAINTO: LENNON TEKSTIPANEELI PEITTAA ALAPUOLISKON → 122 KORJAA (25.9.2026 klo 23.04)

Pieni erä build 17:ään.

## OMISTAJA klo 22.5x (SITOVA, BUILD 16 → 17): 130 NOSTOKUVA ISOMPANA + KORTTI LEVEAMPI; 131 KUVA PYSYY PAIKALLAAN, TEKSTIT YMPARILLE; 132 KOKORUUDUN KUVAN TAUSTA SUMENNETAAN; 133 (x) POIS NOSTOSTA; 134 NOSTO AUKEAA VALITTOMASTI KARTALTA; 135 KAIKKI NOSTOT SAMAAN KOKOON JA TYYLIIN (LYON PIENI), SKANDAALEISSA VAIN TYYLI; 136 PULUN CHAT NOSTON PAALLE, NOSTO JAA AUKI; 137 NOSTOJEN VIERITYS TOKKII + RAAHAUS POIS; 138 ISOISAN JA PULUN KUVISTA KEHYS JA KUVATEKSTI POIS; 139 MATKAKIRJA AUKEAA TUMMANA → VAALEA; 140 LINSSIT POIS MATKALAUKUSTA KAIKILLA LAITTEILLA; 141 PIENENNETTY KARTUSSI iPADILLA LIIAN ISO; 142 SUURENNETUN KARTUSSIN VERTAILUTIEDOT ANIMOITUNA LUKUJEN PERAAN (ENSILUOKKAINEN LIIKE); 143 PITKAT MAANNIMET KAHDELLE RIVILLE, RADIONAPPI YLIMMAN RIVIN MUKAAN; 144 LIPUT AALTOILEMAAN ARVOKKAASTI (TOTEUTETAAN, NATIIVISEPPA TEKNIIKKA); ROOLIT: NATIIVI-UI PAAOSIN, PELIKOODARI 134/135/137, NATIIVISEPPA 132/144; SEURAAVA NUMERO 145. KARTTASEPPA: 127 MAA–MAA-RAJAT AMPARISSA (maamaa.geojson, PR #3248), 129 KUVAKOLMIKKO OMISTAJALLE (PR #3252), 128 p060/p045 EHDOTETTU (25.9.2026 klo 23.06)

Raportti 61abeadb5.

## OMISTAJA klo 23.0x (KORTTI, LOYDOS 129): MEREN SYVYYSLIUKU = VAHVEMPI (LITISTYS 1 + KONTRASTI 1,35, KESKIMMAINEN KUVAKOLMIKOSTA docs/raportit/kuvapari-loydos129-meri-20260925.jpg) → KARTTASEPPA KIRJAA RESEPTIN JA POLTTAA PALLOSARJAN Z0–Z9 YOLLA TAYSILLA UUTENA SARJANA, OSOITINVAIHTO ERIKSEEN (25.9.2026 klo 23.08)

Peruskartan reseptiin tarkennus meren sävyliukuun; Raamattu päivitetään sarjan nimen kanssa.

## CODEXIN VARIKORJAUS ERA 2 (50 KUVAA, POSTI 82088e488) → SISALTOKIRJURI TARKISTAA; LINSSISEPPA 74 % (NOLLAUSKASKY JONOSSA); LEVY 138 Gt (UNITY-KAANNOKSET), KIINTIO 22 % (25.9.2026 klo 23.09)

Postivahdin katsaus 23.1x.

## NATIIVISEPPA: 127 JA 128 (KUVAPARI p080/p060/p045) AGENTILLA, 132 JA 144 JONOSSA (3 WORKTREEN KATTO); 132 KAAVA HYVAKSYTTY: KuvaSumea-TASOPARAMETRI + KOKORUUDUN AJAKSI TAUSTAN KAAPPAUS SUMENNETTUNA JA PALLON KAMERA POIS. NATIIVI-UI: 124 SAAPUMISKORTTI 2 s (ff42e3cf, MERGE-PYYNTO); 113 AVOIN — OLETUSTILA JA POIS PIKSELILLEEN SAMAT (0e7206eb) → NATIIVISEPPA SELVITTAA; 115 ODOTTAA DATAA (25.9.2026 klo 23.09)

Natiivi-UI sai 130–144-listan jonoonsa.

## OMISTAJA klo 23.1x (KORTTI): LYRIA-MUSIIKKIEHDOTUS (16 NYKYISTA RAITAA, ~28 UUTTA: ALOITUSLENTO, SAAPUMINEN, 9 MAANOSAA, 6 TUNNUSKAUPUNKIA, KOHTAAMISET, YOVERSIOT, LOPPU, II) HYVA, MUTTA ENSIN MIETITAAN TYYLI, JOKAISELLE LINSSILLE OMA MUSIIKKI TUNNELMAN MUKAAN JA AANITEHOSTEET → EI GENEROINTIA VIELA; PELIKOODARI + LINSSISEPAN SEURAAJA TEKEVAT MUSIIKKI- JA AANISUUNNITELMAN (docs/raportit/musiikki-ja-aanisuunnitelma-20260926.md: TYYLI JA JOHTOAIHE, RAITALISTA KOHTAUKSITTAIN JA LINSSEITTAIN, AANITEHOSTELISTA, KERROKSELLISUUS, JARJESTYS JA KUSTANNUS), OMISTAJA HYVAKSYY. LOYDOS 145 KIRJATTU (KOHTAAMISEN KYNNYS 2 → 1, LEHDEN KAUTTA AVAUS POIS). PELIKOODARI: KEHYKSEN HINTA CPU 2,8–4,0 ms (URP CPU 1,5, CESIUM 0,55, UITK 0,42, KaupunkiMerkit 0,24) → GPU ON PULLONKAULA; kehys-cpu-KORJAUS JA MITTARI MERGE-PYYNNOSSA (PR #3250). LINSSISEPPA: II ERA 3 SUMU JA LINSSIEN ESILATAUS JUNASSA 49945738 (BUILD 17), LUOVUTUS -c (040ea16f1), NOLLAUS. SISALTOKIRJURI: VARIKORJAUS ERA 2 PR #3255, MAAKUNTAERA 8 TULOSSA. #3252 MAINISSA, #3248 AUKI (25.9.2026 klo 23.17)

Seuraava löydösnumero 146.

## OMISTAJA klo 23.2x (LOYDOS 146): KAUPUNGIN PIENI VALIKKO — AUKEAA VALITTOMASTI, SISALTO ANIMOIDUSTI, KUVA ISOMPANA; FABLEN POSTIKORTTIEHDOTUS (PERGAMENTTIKORTTI, HEROKUVA 3:2 VINJETILLA PALJASTUU 180 ms, NIMI + POSTILEIMA 150 ms, RIVIT 40 ms PORRASTUKSELLA, PISTEET SYTTYVAT, < 350 ms EASE-OUT, EI (x), iPAD KAUPUNGIN VIERESSA / iPHONE ALAREUNASTA) → NATIIVI-UI TEKEE VIDEOMALLIN OMISTAJAN HYVAKSYTTAVAKSI, PELIKOODARI ESILATAUS (134); SEURAAVA NUMERO 147 (25.9.2026 klo 23.18)

Raportti 09c92eb89.

## LINSSISEPPA NOLLATTU → ALOITUSVIESTI LAHETETTY (linssiseppa-tyo-20260923, LUOVUTUS -c) + LINSSIEN TUNNELMAT MUSIIKKISUUNNITELMAAN, RC TAKAISIN; #3248 (MAA–MAA-RAJAT) MERGETTY; TANAAN NOLLATTU 7 SESSIOTA (25.9.2026 klo 23.19)

Kello 23.2x.

## KEHYKSEN HINTA LEVOSSA — JUURISYY LOYTYI (NATIIVISEPPA, docs/raportit/kehyksen-hinta-20260925.md a34201722, iPAD PRO 13, BUILD 16 -JUNA): STAATTINEN KEHYS 66,7 ms ON GPU-SIDONNAINEN (GPU 97–98 %); (1) ALOITUSPORTIN PIILOTETUN KERROKSEN BLUR-SUOTIMET (Etusivulento, display:none, UNITY PIIRTAA SILTI) 46–50 ms = ~70 %; (2) LAATTOJEN VARJOSTUS 14,3 ms, JOSTA ALPHA-TESTI 4,5 ms; (3) PAASAIE 5,8–7,0 ms; (4) KAMERAN PERUSHINTA + SKAALAUS 4,3 ms; (5) PIIRTOSAIE 2,5 ms; SUOTIMET POIS → 16,9 ms, ALPHA-TESTI POIS (KUVA SAMA) → 14,1 ms (TAVOITE ≤ 16 ms TAYTTYY), iPHONE ARVIO ~8 ms; 41 → 67 ms JOHTUI GPU:N MEDIUM-TASOSTA TAYDELLA KUORMALLA → FABLE: KORJAA 1 JA 2 BUILD 17:AAN KUVAPAREIN, MITTAA LAITTEELLA, PALAUTA IDLE-ANIMAATIOT JATKUVIKSI 30 fps:LLA KUN ≤ 16 ms, YLEINEN VARTIJA: PIILOTETTU KERROS EI SAA PIIRTYA (25.9.2026 klo 23.25)

Lämmön todellinen juurisyy: piilotettu blur-kerros piirtyi joka kehys.

## LINSSIEN AANITOIVEET PELIKOODARILLE (LINSSISEPPA docs/raportit/linssien-aanitoiveet-20260925.md c9efd54f0, 8 LINSSIA): NATIIVISTA PUUTTUVAT ASTRONAUTIN HUMINA SEKA KEKSINTOJEN KILAHDUS JA VUOSINAKSAHDUS (PARITEETTIPUUTE → LINSSISEPPA LISAA); LINSSISEPPA JATKAA ESILATAUKSEN LOPPUJA JA II:N ERAA 5 (25.9.2026 klo 23.28)

Musiikkisuunnitelma kokoaa nämä.

## PELIKOODARI: 134 NOSTO AVAUTUU SAMASSA KEHYKSESSA (KORTTI 267 → 67 ms, VALMIS 466 → 267 ms; SYY SISAKKAISET KORUTIINIT 6 KEHYSTA, EI VERKKOA; MERGE-PYYNTO nosto-avaus), LOPPU NATIIVI-UI:N HAIVYTYS; 145 WEB-PR #3256 + NATIIVI loydos145 (KYNNYS 1) — PULUN OHJE YKSIKOSSA HYVAKSYTTY, RAAMATTUUN KOHTAAMISEN AVAUS; 125 SYMBOLILISTA NATIIVISEPALLE (VUORET/MERET/JOET/SAARET/JARVET HARMAITA PISTEITA, KUVAMERKIT VAARIN, HEHKUPISTE PUUTTUU), laji-KENTTA SIIRTOSEPALTA; 135 FABLE: MYOS WEB SAMAAN KOKOON (LISAKAUPUNKI 34rem / KUVATON 24rem → SAMA); 137 SEURAAVANA, 122 ODOTTAA NATIIVI-UI:TA (25.9.2026 klo 23.32)

Raamattu-synkka mainiin Julkaisijalta myöhemmin (Kohtaamisen avaus).

## OMISTAJA klo 23.3x (SITOVA, BUILD 16 → 17): 147 II:N CC → ☰-VALIKKOON KYTKIMEKSI 'TEKSTITYS' (NATIIVI-UI); 148 II:N JATKA/TAUKO → PLAY/PAUSE-TOGGLE + KELAA ALKUUN (ALUSTA) JA KELAA LOPPUUN (TUTKI KARTTAA ITSE) (NATIIVI-UI + LINSSISEPPA); 149 KARTTANOSTOJEN KUVAT EIVAT LATAUDU AINA (PELIKOODARI + VARTIJA); 150 NOSTOKUVA NAPAUTUKSESTA KOKO SIVUN KOKOISEKSI (NATIIVI-UI); 151 II:N LUENTA-ANIMAATION KAMERALIIKKEET LIIAN AKKINAISIA KARTAN VAISTAESSA → PEHMEAMMIN (LINSSISEPPA + NATIIVISEPPA); 152 II:N ALKU: TAHDET JA PALLO FEIDAUTUVAT RAUHASSA MUSTASTA, PALLO ZOOMAUTUU SAMALLA LAHEMMAS (LINSSISEPPA); SEURAAVA NUMERO 153 (25.9.2026 klo 23.33)

Raportti pushattu.

## OMISTAJA klo 23.3x: VARMISTA LOYDOS 82 — ALOITUSNAYTON KOHDEKAUPUNGIN VALINNASSA VAIN KOHDEKAUPUNGIT, EI MUIDEN KAUPUNKIEN PISTEITA EIKA NIMIA → NATIIVISEPPA TODENTAA BUILD 16:LLA JA KORJAA 17:AAN, LAITETESTAAJA LISAA PYSYVAN SAVUKEKOHDAN JA AJAA NYT (25.9.2026 klo 23.34)

82 ei ollut vielä KORJATTU-merkitty.

## LOYDOS 82 TODENNETTU BUILD 16:LLA (LAITETESTAAJA 9c4d3844d): VALINTANAKYMASSA VAIN LONTOO + MOSKOVA/ISTANBUL/ATEENA/KAIRO, EI MUITA PISTEITA EIKA NIMIA — PASS, PYSYVA SAVUKEKOHTA; #3256 MAINISSA (25.9.2026 klo 23.34)

Natiivisepälle ei korjattavaa 82:sta.

## PERUSKARTAN RESEPTI 2026-09-26 (KARTTASEPPA PR #3258): 2026-09-25 + MEREN LITISTYS 1 JA --syvyyskontrasti 1.35 (LOYDOS 129); POLTTO 23.33 ALKAEN 16 YTIMELLA (klo 07 → 4 YDINTA), SARJA julisteet/pallo/laatat/2026-09-26-pohja-20260926/, EI OSOITINMUUTOSTA; 128: KERMASARJAT p060 JA p045 POLTETTU (33 948 KUMPIKIN), VIENTI KAYNNISSA, PR #3254 (--peitto); KERMA POLTETAAN MYOS 26-POHJASTA KUN PEITTO VALITTU; RAAMATTUUN RESEPTI 2026-09-26 (25.9.2026 klo 23.35)

Osoitinvaihto webissä ja natiivissa erikseen sarjan valmistuttua.

## OMISTAJAN KYSYMYKSET klo 23.5x: 1) NOSTOJEN ERIKOKOINEN NAYTTO KARTALLA TARKEYDEN MUKAAN EI OLE KAYTOSSA — NIMION KOKO VAIHTELEE VAIN ZOOMIN MUKAAN, TYYPPIMERKIT EROTTAVAT LAJIT (FABLE VASTASI; UUSI SAANTO VAIN OMISTAJAN PAATOKSELLA); 2) POLTTO: LAATTA ON YKSI KUVA, JOTEN VAIN VETTA SISALTAVAT LAATAT MUUTTUVAT — 26-POLTTO MENEE LOPPUUN KOKONAISENA, KARTTASEPPA TEKEE DELTA-TILAN (VESIMASKI, MUUT LAATAT KOPIOIDAAN EDELLISESTA SARJASTA) HUOMENNA (25.9.2026 klo 23.38)

Karttasepälle viesti delta-tilasta.

## RAAMATTU-SYNKKA #3259 MAINISSA (KOHTAAMISEN AVAUS + ILLAN LOKI); MAINISSA MYOS #3237 v2240 (1.43), #3241/#3242/#3245 + JUNA #3253 v2241 (MAAKUNNAT 2–7, VARIT 1), #3255 v2242 (VARIT 2); #3257 (MAAKUNNAT 8) MENOSSA, #3246/#3247/#3260 JARJESTYKSESSA (25.9.2026 klo 23.38)

Julkaisijan ilta.

## LEVY 135 → 110 Gt 11 min:SSA klo 23.38 (wt/ 48 WORKTREETA 24 Gt, /private/tmp 19 Gt, proto-3d 71 Gt, 26-POLTTO + KERMA-SYNC); SWAP 12 Gt (CI:N CHROME-GPU + UNITY) → FABLE: POSTIVAHTI KASKEE KAIKKIA POISTAMAAN MERGETYT WORKTREET (ENINTAAN 3/ROOLI) JA VANHAT KAANNOSVALITUOTTEET; KARTTASEPPA ILMOITTAA POLTON LEVYTARPEEN JA SIIVOAA AMPARIIN VIEDYT SARJAT LEVYLTA; HALYTYS ALLE 80 Gt (25.9.2026 klo 23.40)

Poltto jatkuu.

## LEVYSIIVOUS: 110 → 140 Gt (23.41), WORKTREET 48 → 34 (SIIRTOSEPPA, JULKAISIJA 14 KANSIOTA, LAITETESTAAJA); NATIIVISEPALLE LUPA vapauta-levy-natiiviseppa-20260925b.sh --aja (VAIN LOKIT-KANSIOIDEN .app-KOPIOT 2,8 Gt, EI KUVIA/KONSOLIA/RAPORTTIA; KOEAJO ENSIN), Build/dd-laite VASTA LAITEKAANNOSTEN JALKEEN (~03.45) (25.9.2026 klo 23.41)

Linssiseppä, Natiivi-UI, Pelikoodari, Karttaseppä ja Sisältökirjuri eivät vielä vastanneet siivouskäskyyn.

## OMISTAJA klo 23.5x (LOYDOS 146, MALLI v1): EI HYVAKSYTTY — PEITTAA LIIKAA JA ON RASKAS, LIIKAA TYHJAA TILAA, LEIMA TURHA; KYSYI MALLIN JA EFFORTIN (FABLE 5.1 high SPEKSI, NATIIVI-UI OPUS 5.5 high TOTEUTUS) → FABLE KORJASI SPEKSIN: KAPEA KORTTI KAUPUNGIN VIERESSA (iPHONE ~60 % LEVEYDESTA, iPAD ~300 pt), EI LEIMAA EIKA KORISTEITA, NIMI KUVAN PAALLA, RIVIT TIIVIISTI, < 250 ms, KORKEUS ≤ 45 % → NATIIVI-UI TEKEE MALLIN v2. NATIIVI-UI: 121–123 JA 138–140 JUNASSA (36688d49), 134 UI-OSA nostot-130 5250be77, 130–137 JA 141–143 TODENNUS SEURAAVAKSI (25.9.2026 klo 23.55)

Oppi: pieni valikko pysyy pienenä; ensimmäinen speksi oli liian koristeellinen.

## OMISTAJA klo 23.5x: 146-VIDEOT NAKYIVAT LIIAN PIENINA (PUHELIMEN RUUTU KAPEANA KAISTALEENA 16:9-KANKAAN KESKELLA) → FABLEN SAANTO KAIKILLE: OMISTAJALLE MENEVAT VIDEOT JA KUVAT RAJATAAN LAITTEEN RUUTUUN ILMAN TYHJAA REUNAA (PYSTYVIDEO PYSTYNA ~1600 px KORKEA, iPAD VAAKANA, EI LETTERBOXIA), KUVAPARIT VIEREKKAIN ILMAN MARGINAALEJA, HIDASTUS OMANA TIEDOSTONA; POSTIVAHTI VALITTAA (25.9.2026 klo 23.56)

Natiivi-UI:n v2-videot tällä kaavalla + pysäytyskuvat.

## OMISTAJA 26.9. klo 00.0x (KORTTI, SITOVA): ELAVA KARTTA — ISOISAN MUSTE, KOHDAT 1–5 PROTOTYPOIDAAN VIDEOKSI (SAAPUMINEN MUSTEENA, NOSTOJEN KOLME KOKOA + HIMMEAT JALJET, HERAAVAT MAAKUNNAT, KIRJOITETTU MAAILMA YOVALOINEEN, ELAVAT HETKET); SUUNNITELMA docs/raportit/elava-kartta-suunnitelma-20260926.md, RAAMATTUUN NATIIVI PELI ETUSIJALLE; LINSSISEPPA VETAA VIDEON, NATIIVISEPPA PALLO, NATIIVI-UI KARTUSSI, PELIKOODARI KOKOLUOKAT, KARTTASEPPA DATA (LAIVAREITIT/RAUTATIET 1873, YOVALOT), SISALTOKIRJURI LUOKITUS (GRC), SIIRTOSEPPA SKEEMA; PELATTAVA VERSIO BUILD 18 (26.9.2026 klo 00.05)

Omistajan kysymys nostojen koosta 23.5x johti tähän.

## CODEX → FABLE: 504 MINIATYYRIN VARIKORJAUS ERA 1 (60 KUVAA, POSTI 78e5a333e) → SISALTOKIRJURI; VIIKKOKIINTIO (KAIKKI MALLIT) 68 % — POSTIVAHTI SELVITTAA NOLLAUTUMISAJAN, HALYTYS 85 %; LEVY 141 Gt, SWAP 11,2 Gt VAKAAT (26.9.2026 klo 00.07)

Omistajalle kerrottu viikkokiintiöstä.

## POSTIVAHTI: VIIKKOKIINTIO 70 % klo 00.06; KORJAUS: 5 h -KIINTIO NOLLAUTUU klo 03.30 EEST (00.30 UTC), EI 00.30 EEST; JUNA KAANTAA (29 min, EI JUMI). NATIIVISEPPA KUITTASI ELAVAN KARTAN 7 RAJAPINTAA (NYKYISET ERAT ENSIN, RAJAPINTALUONNOS LINSSISEPAN KANSSA). KARTTASEPPA: 26-POLTON LEVYTARVE ~6–8 Gt, LEVYVAHTI 25 Gt; 135 → 110 Gt -PUDOTUS EI OLLUT POLTOSTA (AJOKANSIO 0,3 Gt), LEVY TAAS 142 Gt; KERMA p060/p045 AMPARISSA → NATIIVISEPAN KUVAPARI 128 VOI ALKAA; 25b/25c/kerma-25/maakunnat-25a NAS:ISSA JA POISTETTU LEVYLTA (26.9.2026 klo 00.08)

Viikkokiintiön nollautumisaika Postivahdilta odottaa.

## VIIKKOKIINTIO (KAIKKI MALLIT, TILI B) 70 % klo 00.07, NOLLAUTUU TI 29.9. klo 02.00 (74 h); VAUHTI 6,1 %/h (2 % → 70 % 11 h:SSA) → TAYNNA ~LA 05.00; KESTAVA VAUHTI 0,4 %/h → FABLE (TYONJOHTAJAN HARKINTA): YOVAUHTI-SAANTO HETI — VAIN BUILD 17:N JA ELAVAN KARTAN VIDEON POLKU JATKAA, EI UUSIA AGENTTEJA, SISALTOJUNA/MAAKUNTAERAT/DATATYOT TAUOLLE AAMUUN; OMISTAJALLE TIEDOKSI, TILINVAIHTO ON OMISTAJAN PAATOS AAMULLA; POSTIVAHTI 74 % → LUOVUTUS JA NOLLAUS (26.9.2026 klo 00.09)

5 h -kiintiö nollautuu 03.30.

## NOSTOJEN KOKOLUOKITUS GRC VALMIS (SISALTOKIRJURI PR #3263, js/packs/nostojen-kokoluokat.js: 12 PAAKOHDETTA / 31 KOHDETTA / 19 PIENTA = 62 + VARTIJA); SALAISUUSEHDOTUKSET GRC (14 MAAKUNTAA, ATHOS) AGENTILLA; MAAKUNTAERA 9 PR #3261, ERA 10 (VIIMEINEN) ODOTTAA; YOVAUHTI-SAANTO LAHETETTY 9 ROOLILLE (26.9.2026 klo 00.10)

Maakuntaerä 10 aamulla.

## POSTIVAHTI NOLLATTU (LUOVUTUS -20260926 454ed335d) → ALOITUSVIESTI LAHETETTY (YOVAUHTI, VIIKKO-% JOKA KIERROS, 85 % → PUSH OMISTAJALLE, EEST), RC TAKAISIN; TANAAN NOLLATTU 8 SESSIOTA; KARTTASEPPA SIIVOSI WORKTREET 7 → 2, LEVY 143 Gt; SISALTOKIRJURI LEPAA (AGENTTI PYSAYTETTY) (26.9.2026 klo 00.12)

Fable jatkaa yön yli kevyellä vauhdilla.

## RAAMATTU-SYNKKA #3262 MAINISSA (ELAVA KARTTA, RESEPTI 2026-09-26, SUUNNITELMA, LOKI); #3247 v2244 MAINISSA; #3261 JONOSSA, #3260 JA #3263 AAMUUN; TUNTIHAKU POIS YOKSI; POSTIVAHTI 00.14: VIIKKO 71 %, 85 % ~02.30 (26.9.2026 klo 00.13)

Yövauhti voimassa.

## OMISTAJA 26.9. klo 00.2x: VAIHTAA TILIA KUN VIIKKOKIINTIO TAYTTYY → YOVAUHTI PURETTU (POSTIVAHTI VALITTAA), NORMAALI VAUHTI; TILINVAIHDON VALMISTELU: VIIKKO ≥ 90 % → KAIKKI ROOLIT KIRJOITTAVAT LUOVUTUKSEN + ALOITUSVIESTIN JA JATKAVAT, 97 % → PUSH OMISTAJALLE; FABLE KIRJOITTAA OMAN LUOVUTUKSENSA ≥ 92 %:SSA; UUDEN TILIN SESSIOT RAAMATUN KAAVALLA (26.9.2026 klo 00.16)

Aloitusviestit origin-haaroissa kuten 25.9. tilinvaihdossa.

## KARTTASEPPA: YOVALOSARJA VALMIINA AMPARISSA julisteet/pallo/yovalot/2026-09-25/ (BLACK MARBLE 2016 Z0–Z6, 5 461 LAATTAA + -alkup/), ELAVAN KARTAN KOHTAAN 4 MASKATTAVAKSI; 26-POLTTO 43 % (POHJA ~01, PALLO ~02); 1873-REITTIEN LAHDESELVITYS ALKAA (26.9.2026 klo 00.18)

Natiivisepälle tieto sarjasta.

## POSTIVAHTI 00.23: VIIKKO 72 % (6 %/h), 5 h 73 %; SWAP 13,2 Gt NOUSUSSA (RAJA 16); JUNA KAANTAA 46 min (4 HAARAA, EI HALYTYSTA); LINSSISEPPA 70 % → LUOVUTUS -d JA NOLLAUS KASKETTY (KASIKIRJOITUS PUSHIIN ENSIN) (26.9.2026 klo 00.23)

Kolmas Linssisepän nollaus tänään.

## OMISTAJA 00.3x KYSYI MAX-TILAT: NATIIVISEPPA MAX → HIGH (120 v2, 119 JA PROFILOINTI VALMIIT, EI TARVETTA), LINSSISEPPA PYSYY MAX ELAVAN KARTAN VIDEON AJAN (LUOVA KOREOGRAFIA), SITTEN HIGH; MUUT HIGH. SIIRTOSEPAN KYSYMYS (SKEEMA 1.45): MAAKUNTIEN SYTTYMISJARJESTYS ISOISAN REITISTA → A: SISALTOKIRJURI KOKOAA REITIN KAANONISTA js/packs/isoisan-reitti-1873.js, FABLE TARKISTAA, SIIRTOSEPPA LASKEE; EI ETAISYYSJARJESTYSTA (26.9.2026 klo 00.25)

Efforttien muutos kirjattu.

## JUMI → FABLE (SISALTOKIRJURI): KAANONISSA EI OLE ISOISAN KIINTEAA 1873-REITTIA (KAUPUNGIT MISSA JARJESTYKSESSA TAHANSA, EI ALKUA EIKA LOPPUA) → FABLE: (a) MAAKUNNAT SYTTYVAT SAAPUMISKAUPUNGISTA ULOSPAIN ETAISYYSJARJESTYKSESSA (SAMA SATEITTAINEN LIIKE KUIN HUNNUN KUIVUMINEN); REITTIA EI KEKSITA, isoisan-reitti-1873.js PERUTTU; RAAMATTU JA SUUNNITELMA KORJATTU, SIIRTOSEPPA LASKEE ETAISYYDESTA (26.9.2026 klo 00.26)

Aiempi ohje A peruttu.

## ELAVAN KARTAN KASIKIRJOITUS HYVAKSYTTY (LINSSISEPPA docs/raportit/elava-kartta-kasikirjoitus-20260926.md, KREIKKA 18 s, KOLME NAYTOSTA + LOPPUKUVA, RAJAPINNAT TEKIJOITTAIN, TEKOTAPA: AIKAJANA + PAIKKAMERKIT → VIDEO HETI) — YKSI KORJAUS: MAAKUNNAT SYTTYVAT ETAISYYSJARJESTYKSESSA ATEENASTA, EI 1873-REITIN (KAANON); LINSSISEPAN LUOVUTUS -d (9585a7951), LAATTAESILATAUS 05e54878 MERGE-PYYNNOSSA, RADION ESIKUUNTELU BUILD 18:AAN, II ERA 5 COMMITEISSA ODOTTAA VIDEOTA, 148/151/152 JA PARITEETTIAANET ANALYSOITU, NOLLAUS (26.9.2026 klo 00.34)

Aloitusviesti Linssisepälle nollauksen jälkeen.

## GRC MAAKUNTASALAISUUDET (SISALTOKIRJURI, #3263: maakuntasalaisuudet.js + -grc.js, 14 EHDOTUSTA: ATHOS, ELEUSIS, NEKROMANTEION, KEROS, ABDERA, MELISSANI, GLA, KASTAN KUMPU, GORTYN, CHLEMOUTSI, DISPILIO, PAVLOPETRI, POLIOCHNI, ALONNISOS) → FABLE HYVAKSYI SISALLON (LEGENDAT JA KIISTAT SANOTTAVA TEKSTISSA), MERGE KUN VIHREA; JUNAJUMI-EPAILY (pid 29155, 0 % CPU) → NATIIVISEPPA TARKISTAA; CODEX 504 ERA 2 (57 KUVAA) SISALTOKIRJURILLE; VIIKKO 73 % (26.9.2026 klo 00.35)

Salaisuudet muille maille videon hyväksynnän jälkeen.

## OMISTAJA 00.4x (LOYDOS 146 MALLI v2): 'KORTTI AIKA HYVA' → TOTEUTETAAN BUILD 17:AAN (iPHONE 241×310 pt KAUPUNGIN YLAPUOLELLA, iPAD 300×349 pt VIERESSA, HERO 3:2, NIMI KUVAN PAALLA, 250 ms), MUUTOKSET PELISTA; OMISTAJAN SOITIN NAYTTAA PYSTYVIDEOT 1:4 → SAANTO: PYSAYTYSKUVAT ENSISIJAISIA, VIDEO VAIN LIIKKEELLE (POSTIVAHTI VALITTAA); #3263 MAINISSA (JULKAISIJALLE OK); LINSSISEPPA NOLLATTU → ALOITUSVIESTI + KASIKIRJOITUKSEN KORJAUS LAHETETTY, RC TAKAISIN (26.9.2026 klo 00.43)

Tänään nollattu 9 sessiota (Linssiseppä 3 kertaa).

## JUNAJUMI PURETTU 00.35 (NATIIVISEPPA): KAANNOS JUMITTUI IL2CPP_CodeGen-VAIHEESEEN, il2cpp KUOLLUT, UNITY JA bee_backend ODOTTIVAT 0 % CPU 26 min → UNITY (35718) JA bee_backend TAPETTU, LUKKO VAPAUTUI, NATIIVI-UI:N KAANNOS (nostot-130, kartussi-141, im2-147-148) KAYNNISTYI, JUNA KAANNETAAN PERASSA; OPPI: VAHDIN PITAA HAVAITA 0 %-CPU-JUMI (IL2CPP KUOLLUT) JA PURKAA SE ITSE (26.9.2026 klo 00.44)

Toimenpide: käännösvahtiin il2cpp-jumin tunnistus.

## POSTIVAHTI 00.45: VIIKKO 74 % (5,5 %/h), 5 h 82 % (NOLLAUTUU 03.30); 3 KAANNOSTA JONOSSA (JUNA-NIPPU, LENTO-ESILATAUS, VIERITYS), VIIMEISIN KAANNETTY 21.36; SWAP 11,6 Gt, LEVY 143 Gt; CODEX 504 ERA 2 PR #3265 (26.9.2026 klo 00.45)

Ei toimia.

## IL2CPP-JUMIVAHTI KAYTOSSA JUNAVAHDISSA (NATIIVISEPPA juna-ajo.sh, jumivahti c6f09ec3 → juna/b13 0eaf47bd): LUKKO > 15 min + EI il2cpp-PROSESSIA + UNITY-PUU < 1 s CPU / 20 s → TAPPAA UNITY-PUUN, LUKKO VAPAUTUU, RIVI juna.logiin, UUSINTA KERRAN (jumi-viimeisin.txt), TOISELLA KERRALLA VAIN KIRJAUS (26.9.2026 klo 00.46)

Postivahti seuraa jumi-rivejä.

## ELAVA KARTTA -DATA ERA 1 (KARTTASEPPA PR #3266, AMPARI julisteet/pallo/vektorit/reitit1873-2026-09-26/reitit1873.json): RAUTATIET 1873 OpenHistoricalMap CC0 ~108 000 km (AUKKO: RANSKAN PAARADAT, KREIKASSA VAIN ATEENA–PIREUS), 4 HOYRYLAIVALINJAA (MESSAGERIES, LLOYD ×2, P&O); SIIRTOSEPPA SKEEMA 1.46; DELTA-TILAN ARVIO Z8/Z9: MEREN MUUTOS KOSKEE 67/65 % LAATOISTA, KERMA/RAJAT 44/42 %, AIKASAASTO MERESSA SUUREMPI (MAA-LAATAT KALLIIT) — PR PAIVALLA; 26-POLTTO z8 (26.9.2026 klo 00.50)

Fable mergeää #3266 kun vihreä.

## POSTIVAHTI 00.56: VIIKKO 75 %, 5 h 86 %; JUNA: VAHTI KAYNNISTI UUDEN KAANNOKSEN 00.46 (pid 94836), VANHAT proto-kaanna.sh 29155/36009 0 % CPU → NATIIVISEPPA TARKISTAA ORVOT; CODEX 504 ERA 3 (52 KUVAA) → SISALTOKIRJURI; #3266 MAINISSA (26.9.2026 klo 00.56)

Ei muuta.

## ELAVAN KARTAN SKEEMA JULKAISIJALLA (SIIRTOSEPPA, NATIIVISEPPA KUITTASI): 1.45 #3267 (KOKOLUOKKA, MAAKUNTA PISTEESTA — RANNIKOLLA LAHIN ≤ 30 km, SALAISUUS; EI REITTIJARJESTYSTA), 1.46 #3269 (REITIT1873: 4 LAIVALINJAA + 1 364 RAUTATIERYHMAA CC0); JARJESTYS #3260 (1.44 laji) → #3267 → #3269 (26.9.2026 klo 01.03)

Julkaisija ajaa aamun junassa.
...
## KEHYKSEN HINTA -KORJAUS JUNASSA (NATIIVISEPPA kehys-hinta-1 3c636115 → juna/b13 ff457958): iPAD PRO 13 RELEASE TAYSI PIIRTO p50/p95 50,1/58,4 → 12,9/25,0 ms, GPU 30 fps:N KATOLLA 14,1 ms (TAVOITE ≤ 16 ms TAYTTYY), SUODINPASSIT 34,4 → 0 ms; PORTIN SUOTIMET VAIN NAKYVALLE KERROKSELLE, ALPHA-TESTI POIS, IDLE-SYKE PALAUTETTU JATKUVAKSI 30 fps (GPU ~42 %), PiiloVartija (0 SUODINTA PIILOSSA); iPHONE-ARVIO ~6 ms; KUVAPARIT IDENTTISET (lokit/kehys-hinta-1/); RAPORTTI ef1a5380d (26.9.2026 klo 01.14)

Lämmön juurisyy korjattu build 17:ään.

## 5 h -KIINTIO TAYTTYI ~01.45 (KAIKKI SESSIOT PYSAHTYIVAT, MYOS FABLE) JA NOLLAUTUI 03.30 → FABLE JATKAA 03.31: POSTIVAHTI HERATTAA ROOLIT, LINSSISEPPA JATKAA ELAVAN KARTAN AJOA (linssiseppa/elava-kartta e731cf06, KASIKIRJOITUS KORJATTU b47e0e5ad), NATIIVI-UI TODENTAA 146 v2:N (kaupunki-146 e137d243); JUNASSA NATIIVI-UI:LTA 121–124, 130–143, 147–148, KEN BURNS (26.9.2026 klo 03.32)

Viikkokiintiö ~78 % ennen taukoa; Postivahti raportoi.

## POSTIVAHTI 03.32: LEPAAVAT HERATETTY; VIIKKO 82 % (LEPOVAUHTI 1,8 %/h; 85 % ~05.15, 90 % LUOVUTUSPYYNTO ~08), 5 h 3 % (NOLLAUTUU 05.30); JUNA KAANNETTY dc3d61a7 01.59; POSTIVAHDIN KIERROSKETJU KATKESI 01.28–03.32 (KIINTIO); CODEX 504 ERAT 6–7 (19 + 64 KUVAA) → SISALTOKIRJURI (26.9.2026 klo 03.32)

Build 17 leikataan aamulla junan kärjestä.

## FABLE: BUILD 17 LEIKATAAN klo 06.30 JUNAN KARJESTA (NATIIVISEPPA MERGEAA VALMIIT: 125, 126–128, 146 v2, 137/149/122, 148/151/152, PARITEETTIAANET), LAITETESTAAJAN KIERROS 06.30–07.15 (KUVAT, EI VIDEOITA), JULKAISIJA VIE ~07.15 (1.0.17); KESKENERAISET BUILD 18:AAN (26.9.2026 klo 03.33)

Omistaja herää aamulla build 17:ään.

## JUNASSA 802b185b (NATIIVISEPPA): 126 RANTAVIIVA POIS; 127 MAARAJAT VAIN MAA–MAA (maamaa.geojson) OLETUSPAINO KEVYT (1,0–1,8 pt, PEITTO 0,8); 128 KERMASARJA VAIHDETTAVISSA, OLETUS p080; 113 OLETUSMAAKUNTARAJAT PEITOLLA 0,45 (SYY OLI 0,297-PEITTO); 125 KARTTA-OSA (UI-PATCH NATIIVI-UI:LLA); OMISTAJALLE KAKSI VALINTAA AAMULLA (PNG-KUVAPARIT lokit/rajat-126-128/kuvat/): 127 PAINO KEVYT/KEVEIN/WEB, 128 KERMA p080/p060/p045 — VAIN VAKIOT Maaraja.OletusPaino JA Kermasarja.Oletus; NATIIVI POIKKEAA WEBISTA TARKOITUKSELLA (KEHA EI RANNIKOLLA); KARTTASEPALLE: SAMOS 7,4 km JA KORFU 0,8 km SALMET LUOKITELTU MAARAJAKSI (26.9.2026 klo 03.34)

Kuvat lähetetty omistajalle proaktiivisesti; kortti aamulla.

## CODEXIN 504-SARJAN VARIKORJAUS ERAT 4–7 TARKISTETTU JA PR:ISSA (#3270, #3271, #3276 = ERAT 6+7 YHDESSA 83 KUVAA), KUITTAUKSET POSTISSA; JULKAISIJALLA JONOSSA #3261, #3264, #3265, #3268, #3270, #3271, #3276; MAAKUNTAERA 10 ODOTTAA #3261:TA (26.9.2026 klo 03.34)

Erien 6+7 yhdistäminen OK.

## MAIN PUNAINEN 00.37 → 03.5x: FABLEN MERGEAMA #3263 (KOKOLUOKAT + SALAISUUDET) LISASI KOLME MODUULIA MODULES-LISTALLE ILMAN SELAINTUOJAA → tarkista-niputus KAATUI, KAIKKI PR:T PUNAISIA; JULKAISIJA KORJAA #3277 (NIPUTTAMATTOMAT), SITTEN JUNA; OPPI: FABLE EI MERGEA KOODI-/PAKETTI-PR:IA ITSE OHI JULKAISIJAN JUNAN — VAIN DOKUMENTIT JA RAPORTIT (26.9.2026 klo 03.36)

Virhe Fablen; kirjattu muistiin.

## 26-POLTTO VALMIS 01.44 (KARTTASEPPA): POHJA 2026-09-26-pohja 144/144 EHEYS OK, VIIVATON PALLO Z0–Z9 349 525 LAATTAA, VIENTI julisteet/pallo/laatat/2026-09-26-pohja-20260926/ KAYNNISSA (~40 min), EI OSOITINMUUTOSTA; WEBIN PYRAMIDI koe/2026-09-26 AAMULLA (VARITASOT JA NOSTOT TUOTANNON LUETTELOSTA); SALMIKORJAUS PR #3278 (SAMOS, KORFU, SUISTOT), AMPARISSA maarajat-2026-09-26; DELTA-AGENTTI JATKAA (26.9.2026 klo 03.37)

Osoitinvaihto (web + natiivi) kuvaparilla omistajalle myöhemmin; #3278 Julkaisijan junaan.

## ELAVAN KARTAN ENSIMMAINEN VIDEO VALMIS (LINSSISEPPA linssiseppa/elava-kartta 5c7903cc, TESTIT 267/267; lokit/linssiseppa-elava-20260926/omistajalle/: 5 KUVAA RINNAKKAIN + ERIKSEEN, VIDEO 736×1600 19,9 s, HIDASTUS): HUNTU KUIVUU ATEENASTA, MAAKUNNAT ETAISYYSJARJESTYKSESSA, NOSTOT PUTOAVAT, ATTIKA HERAA (KASIALANIMI, 1/4), LAIVA SAVUINEEN, HAMARA PALLO REITTEINEEN JA HEHKUVINE KAUPUNKEINEEN; KEHYS SIMULAATTORISSA MED 16,7 / p95 18,2 ms; PAIKKAMERKIT: HUNTU, VIIVAPIIRTO, MAAKUNTAVARIT, NOSTOT, LAIVA, YOVALOT; JOET KASIN (KARTTASEPALTA OIKEAT UOMAT); HAVAINTO: NAVAN KANSI TUMMANA KIEKKONA HAMARASSA (NATIIVISEPPA); OMISTAJALLE LAHETETTY AAMUN ARVIOON; SEURAAVAKSI II 151/152/148 + PARITEETTIAANET KAANNOKSEEN (26.9.2026 klo 03.41)

Omistajan arvio aamulla korttina.

## POSTIVAHTI 03.43: VIIKKO 84 % (11 %/h TAYDELLA VAUHDILLA, 100 % ~05.00), 5 h 11 %; LEVY 136 Gt; CODEX ERA 8 (55 KUVAA) → FABLE (TYONJOHTAJAN HARKINTA): BUILD 17 LEIKATAAN HETI JUNAN KARJESTA ENNEN KIINTION TAYTTYMISTA (NATIIVISEPPA SHA → LAITETESTAAJA HETI → JULKAISIJA ~04.30), LOPUT BUILD 18:AAN; CODEX ERA 8 AAMULLA (26.9.2026 klo 03.43)

Omistaja vaihtaa tilin herättyään; build 17 valmiina silloin.

## BUILD 17 LEIKATTU: juna/b13 d04841a0 (146 v2, 125 KOKONAAN, 126–128 + 113 maamaa-26:LLA, KEHYKSEN HINTA -KORJAUS, JUMIVAHTI, NATIIVI-UI:N 121–124/130–143/147–148 + KEN BURNS, LENTO v2 12 s); KAANNOS JONOSSA SIIRTOSEPAN TESTIKAANNOKSEN PERASSA → LAITETESTAAJA → JULKAISIJA; JUNA EI OTA MUUTA ENNEN KIERROSTA (26.9.2026 klo 03.44)

Loput build 18:aan.

## NATIIVI-UI: 146 v2 JA 125 JUNASSA (f499aea0); 132 TODENNETTU (SUURENNOKSEN TAUSTA SUMENEE); 150 EI TAYTY iPHONE PYSTYSSA (KEHYSTETTY KORTTI 353 → 355 pt) → FABLE: A — KOKORUUDUN TUMMA NAKYMA ILMAN KEHYSTA, CONTAIN, NIPISTYSZOOMI + PANOROINTI, EI KUVATEKSTIA (138), SULKU NAPAUTUKSESTA/PYYHKAISYLLA, BUILD 18; 141 LAITETESTAAJAN iPAD-KIERROKSELLE (26.9.2026 klo 03.44)

Julkaisija: main vihreä (#3277), yöajon kaksoisvienti estetty.

## POSTIVAHTI 03.48: VIIKKO 85 % (PUSH OMISTAJALLE LAHETETTY), 90 % LUOVUTUSPYYNTO ~04.15; LEVY 133 Gt LASKEE 3 Gt/5 min (RAJA 80); juna d04841a0 ODOTTAA NIPUTUSTA (26.9.2026 klo 03.48)

Build 17 -polku etenee.

## BUILD 17 -JUNA KAANNETTY 03.48: juna/b13 d04841a0 → KAANNOS 6fd19114, ASENNETTU SIMULAATTOREIHIN → LAITETESTAAJAN KIERROS KASKETTY; NATIIVISEPPA KIRJOITTAA LUOVUTUKSEN -f JA NOLLAA (MASTER-MERGE PASSIN JALKEEN SEURAAJALTA) (26.9.2026 klo 03.49)

Julkaisija vie PASSin jälkeen.

## JUMI → FABLE (JULKAISIJA, LOYDOS 149): KAKSI GRC-NOSTOKUVAA PUUTTUU AMPARISTA (404: heraion, korintin-apollon-temppeli; TIEDOSTOT siirto-sisaltokirjuri/karttanostot-20260921/), JULKAISIJALTA AMPARIKIRJOITUS ESTETTY → FABLE: VIEDAAN 'Peilaa media R2:een' -TYONKULULLA (SISALTOKIRJURI LISAA LAHTEESEEN PR:LLA AAMULLA + VARTIJA KAIKILLE NOSTOKUVILLE), EI AVAIMIA EIKA TOISEN ROOLIN KAUTTA (26.9.2026 klo 03.50)

Pelikoodarin 149-selvitys (lataus ei aina) jatkuu erikseen.

## NATIIVISEPPA NOLLATTU (LUOVUTUS f a5d25c9d6) → ALOITUSVIESTI LAHETETTY (MASTER-MERGE PASSIN JALKEEN, BUILD 18 -JONO), RC TAKAISIN; TANAAN/YOLLA NOLLATTU 10 SESSIOTA (26.9.2026 klo 03.50)

Odotetaan PASSia.

## KREIKAN JOET AMPARISSA (KARTTASEPPA julisteet/pallo/vektorit/joet-2026-09-26/GRC.geojson, 154 VIIVAA, PR #3281): LAHDE GEOGLOWS v2 (TDX-Hydro) CC BY-SA 4.0 → FABLE HYVAKSYI (RAAMATTU: JAKOEHDOLLISET SAMALLA LISENSSILLA + ATTRIBUUTIO), HydroRIVERS HYLATTY (LISENSSI KIELTAA JAKELUN), OSM ODbL; MUUT PELIN MAAT SEURAAVAKSI; DELTA-POLTTO LUONNOS #3280 (PYRAMIDI MERI 71 %/MAA 34 %, PALLO MERI 89 %/MAA 32 % PIIRRETAAN), ENSIMMAINEN AJO VALVOTTUNA; 26-PALLON VIENTI KAYNNISSA (26.9.2026 klo 03.51)

PR:t Julkaisijan junaan.

## LOYDOS 149 LAAJENI (SISALTOKIRJURI): 288/2 804 KARTTANOSTOKUVAA 404 (KAIKKI POLUSSA 20260921, 16 MAATA), 280 TIEDOSTOA LEVYLLA (195 Mt) KOPIOITU siirto-sisaltokirjuri/karttanostot-20260921/; PEILAA-TYONKULKU EI SOVI (COMMONS-NIMET) → FABLE: JULKAISIJA TEKEE workflow_dispatch 'vie-karttanostot-ampariin' SELF-HOSTED-AJURILLA ACTIONS-SECRETEILLA (KUIVA-AJO, SHA-LISTA, EI YLIKIRJOITUSTA), AJO BUILD 17:N JALKEEN; BELGIAN 8 PUUTTUVAA → SISALTOKIRJURI; VARTIJA 'KAIKKI NOSTOKUVAT 200' TESTEIHIN (26.9.2026 klo 03.53)

Ei avaimia sessioihin.

## VIE-KARTTANOSTOT-AMPARIIN PR #3282 (JULKAISIJA): workflow_dispatch, KANSIO VAIN siirto-sisaltokirjuri/-ALTA (pwd -P -TARKISTUS), pvm VAIN NUMEROITA, KUIVA OLETUS, self-hosted testit-AJURI, VAIN .jpg image/jpeg immutable, OLEMASSA OLEVAT OHITETAAN, SHA-LISTA YHTEENVETOON → FABLE TARKISTI JA MERGEAA (TYONKULKU, EI NIPUTUSTA); AJO BUILD 17:N JALKEEN KUIVA → OIKEA (26.9.2026 klo 03.54)

Sama kaava kuin #3217.

## LOYDOS 149: BELGIAN 8 KUVAA LOYTYIVAT LEVYLTA (bel/kuvat/), 288/288 VALMIINA VIENTIIN; VARTIJA PR #3283 tests/nostokuvat-ampari.test.mjs (MUOTOTESTI AINA, HEAD-TARKISTUS NOSTOKUVAT_VERKKO=1) — JULKAISIJAN JUNAAN; VIENTI #3282:LLA BUILD 17:N JALKEEN (26.9.2026 klo 03.55)

Laitetestaaja ajaa kierroksen.

## PELIKOODARI VALMIS (BUILD 18 ERA 1): 137 VIERITYS (HITAUSLIIKE HERATTAA TAYDEN TAAJUUDEN, LIUKU 31 → 60 fps, HITAAT ASKELEET 46 → 1; SYY 101:N KAAVA); 149 KOLME KORJAUSTA (media.json EI JAA TYHJANA MUISTIIN, ATOMINEN LEVYKIRJOITUS, 404 EI UUSITA; VARTIJA 'nostokuvat GRC' 58/60); 122 TODENNETTU (EI TEKSTIA, LUENTA KUULUU rms 0,044); MUSIIKKI- JA AANISUUNNITELMA PR #3272 (8 PAATOSTA OMISTAJALLE: JOHTOAIHE, −33 vs −18 LUFS, TUNNUSKAUPUNGIT, YOVERSIOT, TOPOGRAFIAN/VESISTOJEN TAUSTAAANET + ASTRON SULJIN, ZOOM-AANI POIS, HAPTIIKKA, BUDJETTIKATTO); LINSSIEN AANIRAJAPINTA JUNASSA; 135 WEB PR #3274; SEURAAVAKSI NOSTOJEN KOKOLUOKAT JA HIMMEAT JALJET (26.9.2026 klo 03.56)

Musiikkisuunnitelma omistajalle korttina aamulla (yhdessä videon, 127 ja 128 kanssa).

## PAKETIN TAUSTAPAIVITYS VAIHE 2 MERGE-PYYNNOSSA (SIIRTOSEPPA siirtoseppa/paketti-paivitys 99f049ec, BUILD 18): ENSIKAYNNISTYS PELAA NORMAALISTI JA LATAA v136:N TAUSTALLA (465 TIEDOSTOA, 18 Mt, TIIVISTEET OK), TOINEN KAYNNISTYS VARASTOSTA ILMAN LATAUKSIA, 260/260; ELAVAN KARTAN SKEEMAPINO #3260 → #3267 → #3269 JULKAISIJALLA (26.9.2026 klo 03.56)

Esilatauspolitiikan kohta 2 toteutuu.

## BUILD 17 SAVUKIERROS PASS KAHDELLA POIKKEAMALLA (LAITETESTAAJA a147973d8, proto_ref d04841a0): PASS 82, LENTO 12 s + OHITA, 125 SYMBOLIT, 146 POSTIKORTTI HETI, NOSTOT ISO KUVA / EI (x) / VAALEA MATKAKIRJA, II SOITIN + TEKSTITYS ☰, 141 iPAD, MAAKUNNAT VAIN OMA MAA + POIS; FAIL: LEPOPIIRTO EI TOTEUDU (150/150 'Lepo (ui)', b16 2–3/151) JA 143 RIVITTYY 3 RIVILLE → FABLE: VIEDAAN SILTI (KEHYS 13 ms, KIINTIO TAYTTYY), MOLEMMAT BUILD 18:AAN (NATIIVI-UI + NATIIVISEPPA); BUILD 1.0.17 JULKAISIJALLE, NATIIVISEPPA MERGEAA MASTERIIN (26.9.2026 klo 04.01)

Sisäiset löydökset S1–S2 raportissa.

## FABLE 70 % → LUOVUTUS -20260926 PAIVITETTY (klo 04.0x: BUILD 17 TF-TARKISTUS, S1/S2, 149 VIENTI, AAMUN KORTIT: VIDEO, 127, 128, MUSIIKKISUUNNITELMA 8 PAATOSTA) JA NOLLAUS; POSTIVAHTI LAHETTAA ALOITUSVIESTIN (RC POIS → send_message → RC PAALLE) (26.9.2026 klo 04.04)

Sessio id säilyy (local_593b89a1).
...
## S1 JUURISYY (NATIIVI-UI MITTASI): KERROS 12 NOSTOMERKKIEN HEHKUSYKE LIKAINEN 230/244 KEHYKSESSA, KOSKA KEHYKSEN HINTA -ERA PALAUTTI JOUTOSYKKEEN JATKUVAKSI (Lampopaatos.SykeJaatyy = false) → FABLE: a) SykeJaatyy = true (3 s KUTEN BUILD 16), NATIIVISEPPA TEKEE BUILD 18 -JUNAAN; OMISTAJAN SAANTO 'LEVOSSA EI PIIRTOA' SITOVA, HALPA KEHYS EI OLE NOLLA KEHYSTA; SAMA LEPOEHTO 144:N LIPULLE JA POSTIKORTILLE. NATIIVI-UI BUILD 18: 143b b499b6ef (TODENNA LAITTEELLA ENNEN MERGE-PYYNTOA), 132/150 HYVAKSYTTY (sumea-132), 144 LIPPU HYVAKSYTTY TUOTANTOON VIDEOSTA (liput-144 a6da2b0a, ARVOKAS AALTO) LEPOEHDOLLA (26.9.2026 klo 04.23)

Kuvat proto-3d/lokit/natiivi-ui-b18/ (käännös 94f2343c).

## BUILD 18 -JUNA 4bdab584 (NATIIVISEPPA): LINSSISEPAN ESILATAUS, II ERA 5 (148/151/152) + PARITEETTIAANET, sumea-132 + 150 (LAITTEELLA OK), 143b (2 RIVIA); KOEMERGE 0 VIRHETTA, TESTIT 278/279/300; FABLE VAHVISTI SykeJaatyy = true — LIPUT ASETTUVAT LEVOSSA SUORIKSI PEHMEASTI SAMASTA 3 s:N KELLOSTA, KOSKETUS HERATTAA; liput-144 JUNAAN; BUILD 18 VASTA OMISTAJAN HERATTYA (26.9.2026 klo 04.24)

Fable 04.2x.

## PELIKOODARI VALMIS: ELAVAN KARTAN PELILOGIIKKA pelikoodari/elava-kartta 3ef13a97 → BUILD 18 -JUNAAN (KOKOLUOKAT, UNOHDETTU/LOYDETTY-TILA TALLENNUKSEEN, MAAKUNNAN LASKURI, SALAISUUS-NOSTO; DATA 1.45/1.47) — FABLE: VAIN NATIIVI, WEB ENNALLAAN (RAAMATTU VOITTAA 00.0x:N TEHTAVANANNON); SEURAAVA ERA: ESILATAUKSEN MITTARIT (OSUMAPROSENTTI + 'PELAAJA ODOTTI VERKKOA' ms PER VAIHE LOKIIN JA SAVUKKEESEEN — PUUTTUVAT NATIIVISTA KOKONAAN); DOCS-PR #3250 (KEHYKSEN HINTA, CPU-OSIO) MERGETTY (26.9.2026 klo 04.25)

Fable 04.2x.

## POSTIVAHTI 04.27: VIIKKO 88 % (5,5 %/h, 90 % ~04.50 → LUOVUTUSPYYNTO ROOLEILLE), 5 h 25 %, LEVY 130 Gt; juna/b13 99bf0fe5 KAANTAMATTA 23 min (VAHTI KAYNNISTAA); CODEX ERA 10 (23 KUVAA) → SISALTOKIRJURI ERIEN 8–9 PERAAN (KUITTASI 8–9) (26.9.2026 klo 04.27)

Fable 04.2x.

## BUILD 18 LEIKATAAN HETI juna/b13 541092d9 (NATIIVISEPPA: SykeJaatyy = true 5367e436, PELIKOODARIN elava-kartta 3ef13a97, liput-144 fc0bbc93; KOEMERGE 0 VIRHETTA, TESTIT 278/284/300; LEPOPIIRTO MITATTU 688e1f5c: KARTTA 247/247, UI 0, PAIKALLAAN ~2,5/150 ≤ 3 TAYTTYY, KARTUSSI+LIPPU AUKI PAIKALLAAN) → KAANNOS NYT, LAITETESTAAJAN LYHYT KIERROS (≤ 25 min, KUVAT), BUILD 1.0.18 PASSIN JALKEEN — TYONJOHTAJAN HARKINTA: LEPOPIIRTOKORJAUS TESTFLIGHTIIN ENNEN VIIKKOKIINTION TAYTTYMISTA (~05.00), KESKEYTYESSA SEURAAJA JATKAA (26.9.2026 klo 04.34)

Fable 04.3x. Sisältö build 18:ssa lisäksi: 137/149/122, sumea-132 + 150, 143b, II 148/151/152 + pariteettiäänet, Linssisepän esilataus, tehoste-rekisteri.

## PELIKOODARI: ESILATAUKSEN MITTARIT OLIVAT JUNASSA BUILD 16:STA (VerkkoOdotus: ms VAIHEITTAIN + OSUMA-%, SAVUKKEEN RAJA SAAPUMINEN 0 ms); LISATTY VARTIJA 'verkko raja' JA KEHITTAJATILAN RIVI (pelikoodari/verkko-raja); MITTAUS ATEENA BUILD 18 -JUNA: SAAPUMINEN 0 ms PASS KYLMANA JA LAMPIMANA, ISTUNTO KYLMANA 1 214 ms (OSUMA 32 %), LAMPIMANA 313 ms (84 %), KAIKKI KAYNNISTYKSEN SISALTOA; LISAKSI pelikoodari/humina-muunnelmat (EI KOMPRESSORIA, 600 ms ULOSFEIDI) → FABLE: MOLEMMAT JUNAAN HETI BUILD 18:N KIERROKSEN JALKEEN; SEURAAVAKSI: MIKA KAYNNISTYKSEN 1 214 ms:STA KUULUU POLITIIKAN KOHTAAN 1 (BUILDISSA MUKANA) → LISTA NATIIVISEPALLE (26.9.2026 klo 04.37)

Fable 04.4x.

## BUILD 18 -JUNA KAANNETTY 04.38: juna/b13 541092d9 → KAANNOS e85255cd (PUU d3206794 = TULEVA MASTER-MERGE), ASENNETTU LAITETESTAAJAN JA PARITEETIN SIMULAATTOREIHIN, JUNA SULJETTU KIERROKSEN AJAKSI; MASTER-MERGE PASSIN JALKEEN (OHJE NATIIVISEPAN LUOVUTUKSESSA g 5c17fe37c) (26.9.2026 klo 04.39)

Fable 04.4x. Laitetestaajan lyhyt kierros käynnissä.

## NATIIVI-UI: 132/150, 143b JA 144 JUNASSA 541092d9; 144 LEPO LAITTEELLA PAIKALLAAN (VAIN PULUN LEPOELEET); 143b PASS iPAD (7d8aedda7), FONTTI 30,4 → 23,7 pt = 22 %; SEURAAVAKSI LINSSISEPAN OHJAUS-RAJAPINNAN KAYTTOONOTTO (148) BUILD 19:N ENSIMMAISENA, ELAVAN KARTAN KARTUSSI-UI VIDEOARVION JALKEEN, 115 ODOTTAA DATAA (26.9.2026 klo 04.41)

Fable 04.4x.

## ESILATAUS KAYNNISTYKSESSA (PELIKOODARI, proto-3d/lokit/kohta1-kaynnistys-20260926.md): KYLMA KAYNNISTYS ODOTTI SISALTOA 1 410 ms, JOSTA uusin.json-VERSIOTARKISTUS 1 259 ms (RIKKOO POLITIIKAN KOHTAA 2); KOHTA 1 PUUTTUU BUILDISTA: NOSTOTYYPPIEN KUVAKKEET (8), PULUN KUVA, ALOITUSDATA ~3 Mt (KAUPUNGIT, REITIT, MAARAJAT, maamaa.geojson), SATELLIITTI Z5 → NATIIVISEPPA PAKKAA; MUUT: kaupungit.json HAETAAN 4×, LINSSIEN ~20 DATATIEDOSTOA JA kaupunkilehdet.json (16 Mt) LATAUTUVAT KAYNNISTYKSESSA, II:N KUVAT VERHON AIKANA → FABLE BUILD 19: 1) VERSIOTARKISTUS TAUSTALLE (YHTEEN SIIRTOSEPAN 99f049ec:N KANSSA), 2) YHTEINEN HAKU, 3) KOHTIEN 3 JA 6 SISALTO POIS KAYNNISTYKSESTA; HAKULOKI MATKAKIRJA_HAUT=1 verkko-raja-HAARASSA (26.9.2026 klo 04.45)

Fable 04.4x.

## BUILD 18 SAVUKIERROS PASS (LAITETESTAAJA 6e344dd41, proto_ref 541092d9, KAANNOS e85255cd): S1 LEPOPIIRTO PASS (PAIKALLAAN ~40 s, 2–3/150, 30 fps), 143b PASS, 132+150 PASS, II SOITIN ⏮⏸⏭ JA KAMERAT SUJUVAT, ESILATAUS TOPOGRAFIA 1,0 s, LENTO 12 s + OHITA, NOSTO HETI, AANET rms 0,092, NOSTOKUVAT GRC 60/60, VIERITYS 0 HIDASTA ASKELTA; AVOINNA 144 AALTOILU (VIDEO), UUSI S3: LAAJENNETTU NOSTOKORTTI JAA AUKI LINSSIN AVAUKSEN YLI → NATIIVI-UI BUILD 19 → BUILD 1.0.18 JULKAISIJALLE, NATIIVISEPPA MERGEAA MASTERIIN (26.9.2026 klo 04.52)

Fable 04.5x. Löydösraporttiin S3.
...
## LINSSISEPPA: tehoste-rekisteri 859b937a MERGE-PYYNNOSSA BUILD 19 -JUNAAN (KEKSINNON JA VUODEN KLIPIT TEHOSTEVAYLALTA MUUNNELMINA; KLIKKIEN RMS 0,00732 → 0,00799, HUMINA 0,020 KUTEN WEBISSA, ENNEN 0,042); OHJAUS-RAJAPINTA KYTKETTY SOITTIMEEN (im2-ohjaus); LUOVUTUS e + ALOITUSVIESTI PUSHATTU; JONO TYHJA, ODOTTAA OMISTAJAN ARVIOTA ELAVAN KARTAN VIDEOSTA → PELATTAVA VERSIO (26.9.2026 klo 04.55)

Fable 04.5x.

## CODEXIN VARIKORJAUSERAT SUORAAN SISALTOKIRJURILLE (FABLE 04.5x): POSTIVAHTI ILMOITTAA UUDET ERAT SISALTOKIRJURILLE, JOKA TARKISTAA JA TEKEE PR:N ILMAN FABLEN VALIKASKYA, RIVI FABLELLE PER PR; ERA 11 (23 KUVAA) VALITETTY; POSTIVAHTI 04.59: VIIKKO 89 % TASAINEN, 5 h 29 %, juna/b13 4586288e ODOTTAA NIPUTUSTA (26.9.2026 klo 04.59)

Rutiini, ei päätöstä sisällöstä.

## SISALTOKIRJURI: CODEX VARIKORJAUS ERA 11 (23 KUVAA, bc00381fa) 23/23 SHA OK → PR #3292 JULKAISIJALLA; ERAT 8–9 #3288 (v2248), ERA 10 #3291 (v2250), KOR #3290 (v2249) MAINISSA; JATKAA CODEX-ERAT SUORAAN (26.9.2026 klo 05.00)

Fable 05.0x.

## BUILD 18 TESTFLIGHTISSA 05.0x: 1.0.18 (CFBundleVersion 202609260152, AJO 36209851560, proto 43a6347c = PUU d3206794 = juna 541092d9, LASKURI 18, YOMERKKI 43a6347c) → PUSH OMISTAJALLE; MAINISSA #3267 v2251 (PAKETTI 1.45), #3288 v2248, #3290 v2249 (KOR, MAAKUNNAT VALMIIT), #3291 v2250 (26.9.2026 klo 05.01)

Sisältö: S1 lepopiirto (SykeJaatyy), 143b, 132/150, 144 liput, II 148/151/152 + pariteettiäänet, Linssisepän esilataus, elävän kartan pelilogiikka, 137/149/122.

## OMISTAJA 05.0x (KORTTI, 4 PAATOSTA, SITOVA): 1) ELAVAN KARTAN VIDEON SUUNTA HYVAKSYTTY → PELATTAVA VERSIO BUILD 19 (LINSSISEPPA + NATIIVISEPPA RAJAPINNAT, KOHTA 1 SAAPUMINEN ENSIN, NATIIVI-UI KARTUSSIN HERAAMINEN, PELIKOODARIN LOGIIKKA JUNASSA); 2) LOYDOS 127 MAARAJAN PAINO KEVYT (NYKYINEN OLETUS, EI MUUTOSTA); 3) LOYDOS 128 KERMAHUNTU p060 → Kermasarja.Oletus = p060, KARTTASEPPA POLTTAA 26-POHJASTA p060:LLA; 4) MUSIIKKI- JA AANISUUNNITELMAN (#3272) KAIKKI 8 SUOSITUSTA HYVAKSYTTY → PELIKOODARI GENEROI ERISSA, VAIHE 1 ENSIN, JOKAINEN ERA OMISTAJALLE KUUNNELTAVAKSI; SISALTOKIRJURI: CODEX ERA 12 (12 KUVAA, a361c071b) PR #3293 (26.9.2026 klo 05.19)

Kortti avattu 05.03 build 18:n pushin jälkeen; omistaja vastasi heti. Kaikki roolit informoitu 05.0x.

## NATIIVISEPPA: OMISTAJAN 05.0x PAATOKSET LUOVUTUKSEEN g (selvittaja-3d-luovutus) BUILD 19 -TYOJONOKSI (127 EI MUUTOSTA, 128 p060 KUN SARJA AMPARISSA, ELAVAN KARTAN RAJAPINNAT, KOHTA 1 -PAKETOINTI); ISOT TYOT SEURAAJALLE TILINVAIHDON JALKEEN (VIIKKO 89 %) — FABLE HYVAKSYI; BUILD 19 -JUNA bbb8583b (verkko-raja, humina, im2-ohjaus, tehoste-rekisteri, osoitin-taustalle, S3) (26.9.2026 klo 05.21)

Fable 05.1x.

## LINSSISEPPA ALOITTAA ELAVAN KARTAN PELATTAVAN VERSION KOHDASTA 1 (SAAPUMINEN ≤ 5 s, OHITETTAVA, KERRAN MAATA KOHDEN), RAJAPINTAEHDOTUS NATIIVISEPALLE, KREIKAN JOET (GEOGLOWS v2 CC BY-SA) KAYTTOON; EFFORT MAX → HIGH (OMISTAJAN 00.25 PAATOS: MAX VAIN VIDEON AJAN), FABLE VAIHTOI (26.9.2026 klo 05.21)

Fable 05.1x.

## KORJAUS: LINSSISEPAN EFFORT-VAIHTOA MAX → HIGH EI VOITU TEHDA (LUOKITIN ESTI set_session_effort FABLEN SESSIOSSA, LINSSISEPPA EI VOI VAIHTAA OMAANSA) → PYSYY MAX, KUNNES OMISTAJA VAIHTAA APPISTA (Linssiseppä-sessio, effort-valikko) (26.9.2026 klo 05.21)

Fable 05.2x. Kirjattu omistajalle riviksi.

## PELIKOODARI: osoitin-taustalle BUILD 19 -JUNASSA (AJOITUS MITTAAMATTA, PAKETTI VAIHTUI KESKEN); YHTEINEN HAKU EI LAHETETTY — HIDASTI (KYLMA SISALTOODOTUS 1 159/915 ms → 1 438/1 496 ms, HAUT SIIRTYIVAT KAYNNISTYKSEN ODOTUSIKKUNAAN), KOKEILEE JAKOA VAIN Sisalto-REITIN SISALLA; MUSIIKIN VAIHE 1 GENEROINTI JONOSSA; KAIKKI LUOVUTUKSESSA (26.9.2026 klo 05.22)

Fable 05.2x: oikea päätös olla lähettämättä hidastavaa muutosta — mittaus voittaa.

## FABLEN LUOVUTUS -20260926-b (e23d962dc) KIRJOITETTU VIIKON 90 %:SSA; SISALTOKIRJURI: LUOVUTUS + ALOITUSVIESTI PR #3295, CODEX 503 LOPPUERA 13 (36 KUVAA, 4eb49ebb0) 36/36 OK → PR #3296; KUN #3293 + #3296 MAINISSA, KOKO 503 PELISSA (26.9.2026 klo 05.23)

Fable 05.2x.

## OMISTAJA 05.2x: 'JATKA 98 ASTI' → ROOLIT JATKAVAT TYOTA VIIKKOKIINTION 98 %:IIN (LUOVUTUKSET AJAN TASALLA, EI PYSAHDYSTA 90 %:SSA); POSTIVAHTI VALITTAA, 98 %:SSA LEPOKASKY + PUSH 'VAIHDA TILI' (26.9.2026 klo 05.25)

Fable 05.2x. Natiiviseppä voi aloittaa build 19:n isot työt (kohta 1 -paketointi, elävän kartan rajapinnat).

## MUSIIKKI- JA AANISUUNNITELMA #3272 MERGETTY MAINIIN (DOCS; TESTIT VIHREAT update-branchin JALKEEN) — OMISTAJAN 8 PAATOSTA VOIMASSA, GENEROINTI ERISSA PELIKOODARILLA (26.9.2026 klo 05.26)

Fable 05.2x.

## SISALTOKIRJURIN LUOVUTUS + ALOITUSVIESTI #3295 MERGETTY (DOCS) (26.9.2026 klo 05.28)

Fable 05.3x.

## LAITETESTAAJA b18 iPAD-TAYDENNYS PASS (7fc314fa7): II OTSIKKO KOKONAAN, SOITIN ⏮⏸⏭ YLARIVILLA, ☰ TEKSTITYS-KYTKIN TOIMII; ODOTTAA BUILD 19:N KUTSUA (26.9.2026 klo 05.28)

Fable 05.3x.

## RAAMATTU-PR #3294 MAINISSA (128 p060, 127 KEVYT, ELAVA KARTTA HYVAKSYTTY → BUILD 19); JULKAISIJAN LUOVUTUS f07177502 (26.9.2026 klo 05.29)

Fable 05.3x.

## POSTIVAHTI 05.32: VIIKKO 91 % (5 %/h → 98 % ~07), 5 h 35 % — KORJAUS: 5 h NOLLAUTUU 08.30 EEST (EI 05.30; UTC-SEKAANNUS); LINSSISEPAN ELAVA KARTTA -KAANNOS KAYNNISSA; CODEX 503 LOPPUERA 13 KUITATTU (#3296) (26.9.2026 klo 05.32)

Fable 05.3x.

## NATIIVI-UI: ELAVAN KARTAN KARTUSSIOSA MERGE-PYYNNOSSA (natiivi-ui/elava-kartussi d525ec5e; TUTKIMUSPALKKI, MAAKUNNAN HERAAMINEN KASIALANIMI + MUSTEPISTEET 1/7, NIMI KARTALLA, LIPPU LIEHUU VASTA MAAN VALMISTUESSA, LEPO PAIKALLAAN; KUVAPARI OMISTAJALLE); DATAN VARASSA SALAISUUSNOSTOT 1.47, PIKKUKUVA 115, KESKIPISTE; MAAKUNTANIMET SUOMEKSI (FABLE): 'Attiki' → 'Attika' — VAKIINTUNEET EKSONYYMIT SUOMEKSI, MUUTEN PAIKALLINEN; SISALTOKIRJURI LISTAA, SIIRTOSEPPA LISAA nimi_fi 1.45:EEN, GRC ENSIN (26.9.2026 klo 05.43)

Fable 05.4x.

## MAAKUNTANIMET SUOMEKSI OLIVAT JO TAULUSSA js/packs/maakunnat-nimet.js (MAAKUNNAT_KAIKKI, AVAIN 'GRC:<avain>'): ATTIKA KORJATTU #3297:AAN (488 SUOMENNOSKORJAUSTA 138 MAALLE, EPAVARMAT IRN/SAU/ETH/GHA/VEN/AZE/ISL/KWT/BLR PR:N KUVAUKSESSA) → NATIIVI-UI LUKEE NIMEN TAULUSTA, SIIRTOSEPPA VIE SAMAN TAULUN (EI nimi_fi-KENTTAA); KOTUS-TARKISTUSKIERROS MYOHEMMIN (KIINTIO) (26.9.2026 klo 05.43)

Fable 05.4x.

## SIIRTOSEPPA: MAAKUNTANIMET #3297:STA ILMAN SKEEMAMUUTOSTA (maakuntarajat.json.gz AJETTU, NATIIVI LUKEE karttatyokalu-maakunnat.json); PINO JULKAISIJALLA #3269 → #3285 → #3298 (1.48 KAUPUNKILEHDET KAUPUNGEITTAIN — VASTAA PELIKOODARIN KAYNNISTYSLOYDOKSEEN kaupunkilehdet.json 16 Mt) (26.9.2026 klo 05.45)

Fable 05.5x.

## MUSIIKIN VAIHE 1 KUUNNELTAVISSA (PELIKOODARI, LYRIA): musa-johtoaihe-lyria.mp3 (63 s, D–G–F–E–D–C–D PIANO → JOUSET + KLARINETTI), musa-aloituslento-lyria.mp3 (62 s), musa-saapuminen-valimeri-lyria.mp3 (100 s, LYHENNETTAVA), musa-loppu-lyria.mp3 (72 s) — media.matkakirja.app/audio/; LYRIA EI NOUDATA KESTOJA → LEIKKAUS HYVAKSYNNAN JALKEEN; 1 HUKKAKUTSU (KANSIOVIRHE, KORJAUS pelikoodari-musiikki-vaihe1); RAIDAT EIVAT VIELA SOI PELISSA → KORTTI OMISTAJALLE. LISAKSI pelikoodari/lehdet-perassa MERGE-PYYNNOSSA: KYLMA ALOITUSVERHO 8–9,8 → 5,3 s (UiSisalto LATAA KAUPUNKILEHDET PERAAN, MUKANA NATIIVISEPAN KOHTA 1) (26.9.2026 klo 05.55)

Fable 06.0x.

## OMISTAJA 06.0x (KORTTI): MUSIIKIN VAIHE 1 KAIKKI 4 RAITAA HYVAKSYTTY → PELIKOODARI LEIKKAA KESTOT, KYTKEE PELIIN BUILD 19 (WEB + NATIIVI), ALOITTAA VAIHEEN 2 (MAANOSAT, TUNNUSKAUPUNGIT) SAMALLA ERAMALLILLA. PELIKOODARI: ELAVAN KARTAN KETJU TODENNETTU v149/1.47 (SALAISUUS PIILOSSA KUNNES MAAKUNNAN KAIKKI NOSTOT LOYDETTY, ATHOS 1/1 → ATHOS-JATTILAINEN), MAAKUNTA-KENTTA KARTTAVALOISSA 2 782/2 963 RIVILLA (EI LISAYSTA); lehdet-perassa JA lehti-kaupungeittain (1.48: LEHTI 81 kt LENNOLLA, ENNEN 16 Mt; KYLMA VERHO 8–9,8 → 4,1 s) MERGE-PYYNNOSSA BUILD 19; NATIIVI-UI TEKEE SALAISUUS-KORTIN. KARTTASEPPA: RESEPTI 26 + KERMA p060 AMPARISSA (PALLO 2026-09-26-pohja-20260926 349 525 jpg, KERMA 2026-09-26-p060 34 216 webp KAYTOSSA BUILD 19; WEB julisteet/pyramidi/2026-09-26-pohja 92 968 webp + koe/2026-09-26), JOET 127 MAATA joet-2026-09-26b; WEBIN OSOITINVAIHTO VASTA OMISTAJAN KUVAPARISTA (KARTTASEPPA TEKEE PARIN), LUOVUTUS -20260926 (26.9.2026 klo 08.10)

Fable 06.0x.

## BUILD 19 -JUNA 0249a248 (NATIIVISEPPA): KOHTA 1 -PAKETOINTI KOKONAAN BUILDISSA (NOSTOTYYPPIEN KUVAKKEET, PULU, 23 TEHOSTEAANTA, bmng Z5 + maamaa.geojson LAATTAPAKETISSA 27,3 Mt, SISALTOPAKETIN TILANNEKUVA v145 1,9 Mt); ELAVAN KARTAN PALLOPUOLI (HUNNUN PALJASTUS TODENNETTU lokit/huntu-paljastus-b19/izmir/, NostoKerros.Saapuminen, SaapuminenAlkaa/Paattyi, MaakunnanKeskus); 128 p060 OLETUS; LISAKSI lehdet-perassa, ELAVA KARTUSSI, MAAKUNTIEN KESKIPISTEET; 'YHTEINEN HAKU' JUNASSA → FABLE TARKISTAA PELIKOODARILTA ETTEI OLE HIDASTAVA VERSIO (26.9.2026 klo 08.11)

Fable 06.1x.

## KOOSTE 06.1x–08.0x (FABLEN KORTTI SITOI SESSION): SIIRTOSEPPA — MAAKUNTANIMET TUOTANNOSSA v148 (ATTIKA), 1.46 REITIT1873 v146, #3285 (1.47) JA #3298 (1.48) JULKAISIJALLA. LINSSISEPPA — ELAVAN KARTAN KOHTA 1 SAAPUMINEN JUNASSA (ed136705, 314/314; 4,8 s, OHITETTAVA, VERKKOHUNTU KOSKA LAATTAHUNTU PALJASTAISI NAAPURIT; KUVAPARI lokit/linssiseppa-saapuminen-20260926/omistajalle/) JA KOHTA 3 MAAKUNTA HERAA (d7395a81 + NATIIVISEPAN c05835ef, TODENNETTU fdc47632 v151: MARATHON → GRC:Attiki 1/14 → TULVA 83 km + KASIALANIMI → PYSYVASTI HERANNYT; KUVAPARI lokit/linssiseppa-herays-20260926/omistajalle/); DATA-JUMI (KARTTAVALOISSA EI 'maakunta') PURETTU: TUNNUS kohde:<id>, SIIRTOSEPAN KORJAUKSET JUNASSA. NATIIVISEPPA — JUNA b2a5fb4a → e5ed36bd → fdc47632; KIIREELLINEN: 1.0.18:N TAUSTAPAIVITYKSEN SIIVOUS POISTAA LADATUN VERSION SAMALLA KAYNNISTYKSELLA → LAITE JAA VANHAAN SISALTOON (NATIIVI-UI LOYSI, SIIRTOSEPAN KORJAUS siivous-korjaus 13e5bcf4 JUNASSA); POHJA 26 KUVAPARI lokit/pohja-26/kuvapari.jpg (25 vs 26, KERMA p060, ERO HIENOVARAINEN, EI REGRESSIOTA; HAARA natiiviseppa/pohja-26 c4c46662). NATIIVI-UI — SALAISUUSKORTTI JUNASSA (elava-kartussi), TODENNUS SIIVOUSKORJAUKSEN JALKEEN. POSTIVAHTI 08.03: VIIKKO 93 % (EI LIIKKUNUT 06.43 JALKEEN), 5 h 46 %. → FABLE 08.0x: BUILD 19 LEIKATAAN HETI JUNAN KARJESTA ILMAN pohja-26:TA (1.0.19 KORVAA VIALLISEN 1.0.18:N), LAITETESTAAJAN KIERROS PAINOPISTEENA TAUSTAPAIVITYS; POHJA 26 → OMISTAJAN KORTTI → BUILD 20 + WEBIN OSOITINVAIHTO; LINSSISEPPA JATKAA KOHTA 2 (PIIRTO) → 4 → 5 (26.9.2026 klo 08.13)

Oppi: omistajan kortti voi olla auki tunteja — ennen kortin avaamista jaetaan roolien jonot valmiiksi, ja Postivahti pushaa omistajalle jos roolit odottavat päätöstä yli 30 min.

## OMISTAJA 08.1x (KORTTI): POHJA 26 TUOTANTOON NATIIVIIN JA WEBIIN → NATIIVISEPPA pohja-26 c4c46662 BUILD 20 -JUNAAN, JULKAISIJA VAIHTAA WEBIN OSOITTIMEN 2026-09-26-pohjaan + PALLO_LAATTAVERSIO (workflow_dispatch, VARMUUSKOPIO ENSIN); KARTTASEPAN HAVAINTO: WEBIN KOHDEMAANAKYMASSA MEREN SAVYN ANTAA VARITASO (2026-09-14b-tasoitus, OMA SYVYYSRAMPPI) → RESEPTI 26 NAKYY WEBISSA VAIN LAATIKON ULKOPUOLELLA → FABLE: VARITASOT POLTETAAN RESEPTI 26:N MERIKONTRASTILLA, GRC ENSIN (KUVAPARI), SITTEN KAIKKI MAAT DELTA-POLTTONA (#3280 ENSIMMAINEN VALVOTTU AJO); PELIKOODARI: JUNAN YHTEINEN HAKU 7875bd13 ON KORJATTU NEUTRAALI VERSIO (Sisalto.HaePaketista-REITTI), KUMOTTU 3b5dd807 HIDASTI (26.9.2026 klo 08.22)

Fable 08.1x.

## MUSIIKIN VAIHE 1 LEIKATTU JA AMPARISSA (PELIKOODARI): JOHTOAIHE 60,5 s, ALOITUSLENTO 26,0 s, SAAPUMINEN-VALIMERI 9,4 s, LOPPU 69,1 s; TASO −11 LUFS (EI −33): PELIN NYKYISET RAIDAT MITTAAVAT −11 (POHJA −10,8, AARRE −11,3, ETUSIVU −11,4), SUUNNITELMAN −33 OLI VAARA OLETUS → FABLE HYVAKSYI (OMISTAJAN 'SAMA KUIN NYKYISET' TOTEUTUU), SUUNNITELMA KORJATAAN DOCS-PR:LLA; KYTKENTA WEB (AGENTTI) + NATIIVI (AIHEET AARREAIHEEN PAIKALLA, TUNNUS ENSIMMAISELLA KAYNNILLA VALIMEREN KAUPUNGISSA) → BUILD 20; VAIHE 2 SEURAAVAKSI (26.9.2026 klo 08.23)

Fable 08.1x.

## BUILD 19 LEIKATTU juna/b13 fdc47632, KAANNOS 343ca803 (PUU adcf61d8) ASENNETTU LAITETESTAAJALLE, POHJA-26 EI MUKANA, JUNA KIINNI KIERROKSEN AJAN; MASTER-MERGE PASSIN JALKEEN (26.9.2026 klo 08.23)

Fable 08.2x.

## ELAVAN KARTAN KOHTA 2 VALMIS (LINSSISEPPA muste-jaljet + natiivi-ui/nosto-muste, MERGE-PYYNTO); KOHTA 4 JAKO HYVAKSYTTY: PELIKOODARI TUO JARJESTETYN REITTIHISTORIAN (KAUPUNKI, KULKUTAPA) NATIIVIIN WEBIN LOGIIKASTA + TAPAHTUMA UUDESTA OSUUDESTA; LINSSISEPPA KYNAVIIVA (UUSI OSUUS ~1 s SAAPUMISEN JALKEEN, LEVOSSA STAATTINEN) + KAYTYJEN KAUPUNKIEN HEHKU KAUKANA (VALIAIKAINEN); NATIIVISEPPA YOVALOT VAIN KAYDYISSA (MASKI LAATTAVARJOSTIMESSA, KORVAA HEHKUN); NATIIVI-UI LUONNOKSET KAYTYJEN MERKEISSA; LINSSISEPPA SOPII SUORAAN PELIKOODARIN KANSSA. POSTIVAHTI 08.19: VIIKKO 95 % (7,5 %/h → 98 % ~08.50 LEPOKASKY + PUSH), 5 h 51 % (26.9.2026 klo 08.24)

Fable 08.2x.

## KARTTASEPPA MITTASI: WEBIN TASOITUSLAATTA (2026-09-14b-tasoitus) ON PELKKA KERMA ALFA 0,88 KAIKKIALLA PAITSI KOHDEMAAN MAALLA (13.9. PAATOS 4: ALUEVESI TASOITETAAN MUUN MEREN MUKANA) → LAATIKON SISALLA MERI NAKYY ~12 % → RESEPTI 26:N UUDELLEENPOLTTO EI MUUTA MITAAN; 'SAMAA MERTA' VAATISI HARSON VAIN MAALLE (MERI ALFA 0 KUTEN NATIIVIN KERMAHUNTU) → FABLE: OMISTAJAN VALINTA (KUMOAISI 13.9. PAATOKSEN) → GRC KOKEENA + KUVAPARI TUOTANTO VS KOE → KORTTI; MUITA MAITA EI POLTETA ENNEN PAATOSTA (26.9.2026 klo 08.24)

Fable 08.2x.

## BUILD 19 SAVUKIERROS PASS RAJATAPAUKSIN (LAITETESTAAJA b117edc23, juna/b13 fdc47632, KAANNOS 343ca803): TAUSTAPAIVITYS KORJATTU (1. KAYNNISTYS TILANNEKUVA + LATAA v151, 2.–3. KAYTOSSA v151), verkko raja 0 ms PASS, SAAPUMINEN 4,8 s + OHITA + VERKOTON PASS, LEPOPIIRTO SAAPUMISEN JALKEEN 2–3/150; AVOIMET → BUILD 20: A) KYLMA VERHO SIMULAATTORISSA 5,4–6,1 s (RAJA 5,3; LAITEMITTAUS), B) KOHTA 3 HERANNEEN MAAKUNNAN PYSYVA VARI EI NAY (MaaKartan TAYTTO OLETUKSENA POIS), C) LEPOPIIRTO EI LASKE VERKOTTOMASSA TESTITILASSA (ui offline -RIVI), D) SALAISUUSKORTIN LAUKAISIJA → FABLE: BUILD 1.0.19 JULKAISIJALLE (KORVAA VIALLISEN 1.0.18:N), NATIIVISEPPA MERGEAA MASTERIIN (26.9.2026 klo 08.25)

Fable 08.3x. Viikko ~96 %.

## MUSIIKIN VAIHE 2 SUUNNITELMAN §5 MUKAAN (FABLE TARKENSI): PELIN KULKU 3 + SAAPUMISTUNNUKSET 8 + VALIMERI JA POHJOIS-/LANSI-EUROOPPA; VAIHE 3 = LOPUT 7 MAANOSAA + 6 TUNNUSKAUPUNKIA VAIHEEN 2 KUUNTELUN JALKEEN; NATIIVIN KYTKENTA pelikoodari/musiikki-vaihe1 (285/285) BUILD 20, DOCS-PR #3302 (−11 LUFS -KORJAUS) (26.9.2026 klo 08.27)

Fable 08.3x.

## BUILD 19 PROTO-MASTERISSA 41dd79c7 (PUU adcf61d8 = KAANNOS 343ca803 = juna fdc47632), TF-AJO 36220773751 KAYNNISSA 08.26; BUILD 20 -JONO A–D + pohja-26; B TARKENNUS: PYSYVA TAYTTO NAKYY KUN Heraannyt PALAUTTAA true (9d9eb1bd), KARTTAVALOISTA PUUTTUU maakunta-KENTTA → MUSTEELLA EI MAAKUNTIA (RISTIRIITA PELIKOODARIN 'kohde:<id> → GRC:Attiki' KANSSA — NATIIVISEPPA TARKISTAA nosto-muste fed603b9:LLA); WEB POHJA 26: KOODI-PR #3301 ODOTTAA PELIKOODARIN KUITTAUSTA, OSOITINVAIHTO PAGES-AJON PERAAN (26.9.2026 klo 08.28)

Fable 08.3x.

## B-RISTIRIITA PURETTU (NATIIVISEPPA): 'KARTTAVALOISTA PUUTTUU maakunta' OLI LINSSISEPAN SIMULAATTORISTA, JOSSA PAKETTI JAI v145:EEN SIIVOUSVIAN TAKIA; KOODIKORJAUSTA EI TARVITA (MaaKartta NAYTTAA HERANNEEN TAYTON KUN MUSTE ANTAA MAAKUNNAN, ATTIKI TODENNETTU); S7 SULJETAAN LAITETESTAAJAN BUILD 20 -KIERROKSELLA v151:LLA (26.9.2026 klo 08.29)

Fable 08.3x.

## BUILD 19 TESTFLIGHTISSA 08.36: 1.0.19 (AJO 36220773751 success, proto 41dd79c7 = PUU adcf61d8 = juna fdc47632, LASKURI 19) → PUSH OMISTAJALLE; KORVAA VIALLISEN 1.0.18:N (TAUSTAPAIVITYKSEN SIIVOUS); SISALTO: SIIVOUS-KORJAUS, KOHTA 1 -PAKETOINTI, ELAVAN KARTAN KOHDAT 1 JA 3, LYKATTY LINSSIDATA, ELAVA KARTUSSI + SALAISUUSKORTTI, lehdet-perassa, 128 p060, verkko-raja, humina, im2-ohjaus, tehoste-rekisteri, S3 (26.9.2026 klo 08.37)

Fable 08.3x. Viikko 96 %, lepokäsky ~08.50.

## KARTTASEPAN KORJAUS: WEBIN TASOITUSHARSO EI PEITA MERTA KOHDEMAAN NAKYMASSA (KOE 2026-09-26m MERI ALFA 0 = TAVULLEEN SAMA) → LAATIKKO JA ULKOPUOLI OVAT JO SAMAA MERTA, VARITASOJA EI POLTETA, MEREN HARSO -KORTTI PERUUTETTU; RESEPTI 26:N ERO PIENI EGEALLA KOSKA MATALA (< 500 m; EGEA −3,4, KREETANMERI −6,2, JOONIANMERI −12,5 LUMINANSSIA), NAKYY SYVISSA ALTAISSA; JOS OMISTAJA HALUAA NAKYVAMMAN ERON MATALAAN MEREEN, SE ON RESEPTIN KONTRASTI 0–1000 m (EI VARITASO); WEBIN KUVAPARI pyramidi-poltto/ajo-20260926/kuvapari/web-tuotanto-vs-26-kreikka.png; WEBIN OSOITINVAIHTO JATKUU PAATOKSEN MUKAAN (26.9.2026 klo 08.37)

Fable 08.4x.

## JULKAISIJA VAHVISTI 1.0.19 (CFBundleVersion 202609260528, YOMERKKI 41dd79c7); #3303 (NATIIVIN OFFLINE-SARJA 26) PIDOSSA SIIRTOSEPAN PYYNNOSTA BUILD 20:EEN; #3301 (WEB POHJA 26) ODOTTAA PELIKOODARIN KUITTAUSTA (26.9.2026 klo 08.38)

Fable 08.4x.

## OMISTAJA 08.4x (BUILD 19, KALLISTETTU KREIKKA) LOYDOKSET 153–155: 153 NOSTOT (MERKIT + NIMIOT) HAIPYVAT HORISONTIN KANSSA (NATIIVISEPPA + PELIKOODARI RAJA); 154 HORISONTTI/TAIVAS HIEMAN SINISEMMAKSI → KUVAPARI 2–3 SAVYLLA OMISTAJALLE (NATIIVISEPPA); 155 NOSTOISSA EI VIELA SYMBOLEITA (125 JATKUU: USEIMMAT YMPYROITA, VAIN DELFOI/NAFPLIO/TASSU) → PELIKOODARI SELVITTAA TYYPIT DATASTA VS WEB, NATIIVISEPPA PIIRTO; BUILD 20; KUVA docs/raportit/kaappaukset/omistaja-20260926/ (26.9.2026 klo 08.44)

Fable 08.4x. Löydösraporttiin lisätty. Seuraava numero 156.

## TILINVAIHDON ALOITUSVIESTI KIRJOITETTU (docs/raportit/viesti-fable-aloitus.md, 08.5x): UUSI FABLE LUO ROOLISESSIOT ITSE RAAMATUN KAAVALLA (POSTIVAHTI ENSIN), ROOLITAULU KANSIO/MALLI/HAARA, JONO LUOVUTUS -b:N MUKAAN; NATIIVISEPPA: 153–155 LUOVUTUKSEEN g (65d5349ac) RATKAISUEHDOTUKSINEEN (Nosto.Horisontti, Taivas.shader-KUVAPARI, LAJI-/KATEGORIAKETJU + NostoMerkit), BUILD 20 -JUNA 3f2db11b (pohja-26, nosto-muste, offline-lepo C; B TODENNETTU, D LAITETESTAAJALLA, A KIERROKSELLA), #3303 PIDOSSA 1.0.20:EEN (26.9.2026 klo 08.46)

Fable 08.5x. Viikko 97 %.

## DELTA-POLTON (#3280) ENSIMMAINEN VALVOTTU KOEAJO (KARTTASEPPA, z6-KAISTA, MERI-DELTA 25 → 26): PIIRRETYT 664/664 TAVULLEEN SAMAT KUIN TAYSI POLTTO; VIKA LOYTYI JA KORJATTIIN — KARTAN YLIN JA ALIN RIVI (TAYTTO SEURAA MEREN SAVYA) OLISIVAT JAANEET VANHOIKSI (31/167 → 0/88); AMPARIN KOPIO/VERTAILU-VAIHEET AJETAAN SEURAAVASSA OIKEASSA MUUTOKSESSA VALVOTTUNA (26.9.2026 klo 08.51)

Fable 08.5x.

## LOYDOS 155 SELVITETTY (PELIKOODARI, proto-3d/lokit/loydos155-symbolit.md): NATIIVI PIIRTAA KUTEN WEB — ALLE ZOOMKERTOIMEN 4 HISTORIA/KULTTUURI/KAUPPA/KAUPUNGIT OVAT HARMAITA PISTEITA (FABLEN PAATOS 22.9.), OMISTAJAN KUVA KERTOIMELLA ~3; 125:N KORJAUKSET OVAT BUILD 19:SSA (LAJI KAIKILLA 2 963 NOSTOLLA) → FABLE: KYNNYS 4 → 2,5 WEBIIN JA NATIIVIIN SAMALLA ERALLA, MERKKI PIENENEE KAUKANA, KUVAPARI OMISTAJALLE ENNEN TUOTANTOA, KOELIPPU symbolitkaukana POISTUU; TASO 1 -KUVAMERKIT (DELFOI) NAKYVAT AINA, ELAVAN KARTAN MUSTE HIMMENTAA VAIN TASOT 2–3 (NATIIVISEPPA + LINSSISEPPA); 153 TEHTY pelikoodari/loydos153 e6a2f829 (HORISONTTIUSVA WEBIN PAPERIUSVAN KAAVALLA), TODENNUS ENNEN MERGE-PYYNTOA (26.9.2026 klo 08.52)

Fable 08.5x.

## ELAVAN KARTAN KOHTA 2 TARKENNUS (NATIIVI-UI + LINSSISEPPA, FABLE KUITTASI): LOYTAMATON TASON 1 NOSTO NAKYY HIMMEANA KUVAMERKKINA (PEITTO 0,5, WEBIN MAAMERKIN MITOILLA) ILMAN NIMEA, TASOT 2–3 MUSTEJALKINA, NIMI JA TAYSI MERKKI LOYDOSTA; BUILD 20 (26.9.2026 klo 08.53)

Fable 08.5x.

## PELIKOODARIN LUOVUTUS (viesti-pelikoodari-luovutus-20260925-yo3.md OSIOT 17–19): BUILD 20 -JUNASSA MUSIIKKI VAIHE 1 NATIIVI + KULJETTU REITTI (JUNA 2ab54860); WEB PR #3304 (MUSIIKKI VAIHE 1 + TYOKALUT) JULKAISIJALLE, DOCS-PR #3302; 153 KAANNETTY, KUVAPARI UUSITTAVA → MERGE-PYYNTO SEURAAJALTA; 155 KIRJATTU, EI ALOITETTU; MUSIIKKI VAIHE 2: 5/14 GENEROITU, 9 AJOSSA 36222088349, LEIKKAUS JA LINKIT OMISTAJALLE SEURAAJALLE (26.9.2026 klo 08.56)

Fable 09.0x. Viikko ~98 %.

## DOCS-PR #3302 MERGETTY (MUSIIKKISUUNNITELMAN 1.3: TASO −11 LUFS MITATTU, EI −33) (26.9.2026 klo 08.57)

Fable 09.0x.

## WEB: POHJA 26 TUOTANNOSSA 08.56 (JULKAISIJA): #3301 MAINISSA v2259, PAGES 36221932991, sw.js LAATTAKANSIO 2026-09-26-pohja-20260926, OSOITIN pyramidi.json = koe/2026-09-26 (AJO 36222259815, sha 90b071f8), VARMUUSKOPIO pyramidi-20260926-0856.json; SAVUKKEET AJOSSA (26.9.2026 klo 08.57)

Fable 09.0x. Omistajan 08.1x päätös toteutettu webissä; natiivi build 20:ssa.
...
## ROOLISESSIOT LUOTU 09.1x–09.2x RAAMATUN KAAVALLA (FABLE, ILMAN OMISTAJAA): Postivahti local_a24c43c0-8094-4141-b734-90b9555f5044, Julkaisija local_5cb16c00-98db-4cd9-8d7c-1b0bc8ced914, Natiiviseppa local_674b9ec4-e2f3-48e9-a810-a129f20a4f03, Pelikoodari local_7fcab04b-864c-4ec2-98bd-46e171326701, Natiivi-UI local_44392b3c-86ee-4873-9d76-82f9aaa6b832, Linssiseppa local_771b401b-80a3-4ada-a0d9-d17c6cb9c2c4, Siirtoseppa local_86d0c984-aeeb-430d-bc85-3112f27b9437, Karttaseppa local_eec7f158-d9f3-4b93-9368-c50935bd19ab, Sisaltokirjuri local_be1a3375-18cf-4068-94f3-887d55f0e196, Laitetestaaja local_af48ba1e-41c2-4921-9068-28cf5cc71b0d; FABLE local_5df52e10-10e4-4b72-9554-0049db300dfe (26.9.2026 klo 09.23)

Kaikki 10 roolisessiota luotu osascript-kaavalla 09.12–09.22, kaikki RC päällä, effort high, mallit Opus (7) / Sonnet (Postivahti, Sisältökirjuri, Laitetestaaja). Kaavan tarkennus tällä kerralla: appi koko näytön tilassa → System Eventsin click at ei osu (Avaa-nappi, mallichippi); Avaa = Return valitsimessa, malli = '/model claude-opus-5-5' tai '/model claude-sonnet-5' kenttään + Return, kansio ja malli periytyvät seuraavaan luonnokseen; appi hyppäsi kahdesti Fablen sessioon kesken luonnoksen (luonnos säilyi, File > New Session palautti sen). Trust workspace -ikkunaa ei tullut.

## KAIKKI 10 ROOLIA KUITTASIVAT 09.2x; FABLEN JAKO: NATIIVISEPPA 154 KUVAPARI ENSIN → 153 TODENNUS (e6a2f829) → 155 PIIRTO → JUNA KOKOON; PELIKOODARI 153 MERGE-PYYNTO, 155 KYNNYS 2,5 WEB+NATIIVI, MUSIIKKI 2 LEIKKAUS + LINKIT; LAITETESTAAJA BUILD 20 -ESIKIERROS aed733c9 (A–D, MUSIIKKI, POHJA 26, TAUSTAPAIVITYS) → LOPULLINEN KIERROS 153–155:N JALKEEN; KARTTASEPPA: DELTA-POLTTOA EI AJETA (EI OIKEAA MUUTOSTA), JATKAA 1873-REITIT + BLACK MARBLE; SISALTOKIRJURI: ERA 13 JO MAINISSA → 504-ERAT POSTISTA (26.9.2026 klo 09.25)

Kuittaukset: Julkaisija (pino mainissa, build 20 odottaa PASSia, #3303 pidossa), Natiiviseppä (juna 2ab54860 auki), Pelikoodari (153 kuvapari, musiikki 2 ajo 36222088349, 155), Natiivi-UI (taso1-155 d262c1e2 merge-pyyntöön), Postivahti (tili C viikko 0–1 %, 5 h 2 %, juna KÄÄNNETTY 09.13 aed733c9), Karttaseppä, Linssiseppä (kohdat 4+5 käännös bc093f2f → simulaattoriajo + kuvapari), Siirtoseppä (1.48 v152 770/770, #3303 luonnos), Sisältökirjuri, Laitetestaaja (valmiina).

## MUSIIKIN VAIHE 2 KUUNNELTAVISSA (PELIKOODARI dad9e0bd4): 14 RAITAA — KOHTAAMINEN 70 s, RATKAISU 4,3 s, EPAONNISTUMINEN 4,0 s, 9 SAAPUMISTUNNUSTA 7,4–10,6 s, MAANOSA VALIMERI 65,9 s, MAANOSA LANSI-EUROOPPA 69,3 s; TASO −11,3…−13,0 LUFS; LOOPIT EIVAT SAUMATTOMIA (LYRIA HAIVYTTAA LOPUN); LYRIA HYLKASI 2 KEHOTETTA → MUOTOILTU UUDELLEEN → FABLE AVAA OMISTAJAN KORTIN 09.2x; POSTIVAHTI 09.23: TILI C 5 h 4 % (NOLLAUS 13.59), VIIKKO 1 % (FABLE 2 %) (26.9.2026 klo 09.26)

Linkit docs/raportit/musiikki-vaihe2-kuunneltavaksi.md (pelikoodari-tyo-20260923). Vaihe 3 (loput 7 maanosaa + 6 tunnuskaupunkia) vasta kuuntelun jälkeen. Ennen korttia roolien jonot jaettu 09.25.

## OMISTAJA 09.2x (KORTTI): MUSIIKIN VAIHE 2 KAIKKI 14 RAITAA HYVAKSYTTY → PELIKOODARI KYTKEE PELIIN (NATIIVI BUILD 20 + WEB) JA ALOITTAA VAIHEEN 3 (LOPUT 7 MAANOSAA + 6 TUNNUSKAUPUNKIA) SAMALLA ERAMALLILLA, ERA OMISTAJALLE KUUNNELTAVAKSI (26.9.2026 klo 09.27)

Kortti auki 09.26, vastaus heti. Loopit: soitin toistaa häivytyksen jälkeen alusta (hyväksytty sellaisenaan).

## NATIIVI-UI: LOYDOS 155 TASO 1 -ERA MERGE-PYYNNOSSA (natiivi-ui/taso1-155 d262c1e2, NostotKartalla.cs): LOYTAMATON TASON 1 NOSTO HIMMEANA KUVAMERKKINA ILMAN NIMEA, TASOT 2–3 MUSTEJALKINA; KAANNOS 9a677a78, LEPO PAIKALLAAN 0 KEHYSTA; KUVAPARI proto-3d/lokit/natiivi-ui-b20-155/ — FABLE KATSOI: VASTAA 08.53 TARKENNUSTA, BUILD 20 -JUNAAN; OMISTAJAN 155-KORTTI VASTA PELIKOODARIN KYNNYS 2,5 -KUVAPARIN KANSSA (KUVASSA NATIIVI NAYTTAA YHA HARMAITA PISTEITA SIINA MISSA WEB NAYTTAA MERKIT JA NIMET) (26.9.2026 klo 09.29)

Natiivi-UI avoinna: salaisuuskortti ja Attika todennus build 19:n siivouskorjauksella, 115 odottaa pikkukuvadataa.

## KARTTASEPPA: REITIT 1873 ERA 2 VALMIS — PR #3305 (e0d348bc6) JULKAISIJAN JUNAAN: EGYPTIN RADAT 1854–69 (+1 118 km), PIREUS–ATEENA 1869 (CC0-TAYDENNYS), ROPiT ODESSA–KONSTANTINOPOLI; AMPARI reitit1873-2026-09-26b/ (1 373 REITTIA), SKEEMA 1.46 ENNALLAAN, TESTIT 4372/0; BLACK MARBLE Z0–Z6 VALMIS 25.9. (5 461 LAATTAA) → FABLE: KARTTASEPPA OTTAA PUNAISET SAVUKKEET astro-pallo-puhelin + pariisi-lahizoom (VERSAILLES PUUTTUU), JULKAISIJA vientibudjetin; #3305/#3278/#3281/#3304 JUNAAN (26.9.2026 klo 09.31)

Lisää 1873-laivalinjoja ei tilata. Mainin Savukkeet punainen 25.9. alkaen (Julkaisijan havainto 09.1x).

## OMISTAJA 09.3x (BUILD 19, MAAKUNNAT) LOYDOKSET 156–158: 156 MAAKUNTIEN SELAIN VETAMALLA KUTEN NOSTOJEN SELAIN (NATIIVI-UI); 157 VALITUSSA MAAKUNNASSA EI VAHVENNETTUJA RAJOJA VAAN VAHVEMPI VARI KARTALLA (NATIIVISEPPA MaaKartta + NATIIVI-UI); 158 KUVAT KAIKKIIN MAAKUNTANOSTOIHIN JA PIKKUKUVIIN (SISALTOKIRJURI KUVAT PD/CC, SIIRTOSEPPA PIKKUKUVADATA = 115:N DATA, NATIIVI-UI NAYTTO); BUILD 20 JOS EHTII, MUUTEN 21 (26.9.2026 klo 09.32)

Raportti docs/raportit/omistajan-loydokset-b13-20260925.md. 156–157 UI-eriä, 158 sisältö+data-erä.

## SAVUKE-VIENTIBUDJETTI B4 PUNAINEN 25.9. ALKAEN: JUURISYY YMPARISTO — #3243:N JALKEEN AJURI AJAA CHROMIUM-HEADLESSINA (EI NAYTTOISTUNTOA), pohjaOsuus 55–85 % MYOS VASTAKOKEESSA, 15 %:N RAJA KALIBROITU WEBKITILLE → FABLE: B4 VAIN WEBKITILLA, CHROMIUM-VARAPOLULLA INFO-RIVI PROSENTTEINEEN (EI FAIL), RAPORTTIIN 'ajuri: chromium/webkit'; JULKAISIJA KORJAA PR:NA JUNAAN; NAYTTOISTUNTOA EI VAADITA (26.9.2026 klo 09.35)

Juna #3305/#3278/#3281/#3304 käynnissä 09.3x.

## OMISTAJA 09.3x (KORTTI): LOYDOS 154 TAIVAAN SAVY = UTU (VAIHTOEHDOT NYT/UTU/VAALEA/SINI, NATIIVISEPAN SARJA proto-3d/lokit/taivas-154/omistajalle/, HAARA natiiviseppa/taivas-154 63dde24f) → UTU OLETUKSEKSI BUILD 20 -JUNAAN, KOMENTO 'taivas kartta utu|vaalea|sini' SAILYY (26.9.2026 klo 09.38)

Kortti auki 09.36, vastaus heti.

## LOYDOS 158 DATASOPIMUS (SIIRTOSEPPA v152, FABLE KUITTASI): GRC TAVALLISET NOSTOT 66/66 KUVA ON; PUUTTUU GRC 14 MAAKUNTASALAISUUDEN KUVAA + 14 MAAKUNNAN PIKKUKUVAA (MUUT 7 MAATA 97 ALUETTA KORTIN KUVA VARANA, 115-TILAUS POSTISSA) → YKSI KENTTA pikkukuva (AMPARIOSOITE) MAAKUNNILLE JA SALAISUUKSILLE, NATIIVI-UI LUKEE SEN (EI kuva[0].pikku); ASSET-LAJI maakunnat ASSET_KANSIOIHIN, SKEEMA 1.49 → NATIIVISEPAN KUITTAUS; SISALTOKIRJURI HAKEE GRC 14+14 ENSIN; POSTIVAHTI 09.36: TILI C VIIKKO 3 % (~9 %/h), 5 h 8 % (~18 %/h), 85 % VASTA ~18.45, LEVY 115 Gt (26.9.2026 klo 09.39)

Kontekstit 13–24 %, ei jumeja.

## OMISTAJA 09.4x LOYDOKSET 159–160: 159 VEKTORIREITIT HAIPYVAT HORISONTISTA ENEMMAN (SAMA HAIVYTYS KUIN 153) → NATIIVISEPPA (LINSSISEPPA KYNAVIIVA); 160 KOLMIULOTTEISET SYMBOLINOSTOT KARTALLE KUN 3D-MALLIT ON TEHTY TAI TILATTU, SAMA HORISONTTIHAIVYTYS KUIN MUILLE → NATIIVISEPPA TEKEE SUUNNITELMAN (MITKA NOSTOT, MALLIEN LAHDE PD/CC VAI OMAT, KOKO, KEHYSHINTA) → OMISTAJAN KORTTI ENNEN TILAUSTA (26.9.2026 klo 09.41)

Raportti omistajan-loydokset-b13-20260925.md.

## BUILD 20 -JUNA juna/b13 b2c6c153 (NATIIVISEPPA): 154 UTU OLETUS (taivas-154 d9efc9f1), PELIKOODARIN 153 e6a2f829 MUKANA (TAIVAS LUKEE USVARAJAA), UNITY 0 VIRHETTA; 153:N LAITETESTI KAYNNISSA iPAD (JUNA + 153 + 3D-MERKKIEN USVA usva-153 + 155b); 157 KOODATTU (valinta-157 f40680df), KUVAPARI KAANNOKSEN JALKEEN (26.9.2026 klo 09.41)

Fable: junaan vielä 155 (Pelikoodarin kynnys 2,5 + piirto), 159 reittien häivytys ja musiikin vaihe 2 -kytkentä; sitten Laitetestaajan lopullinen kierros.

## BUILD 20 -ESIKIERROS aed733c9 (LAITETESTAAJA 01a7fa27f): C OFFLINE-LEPO PASS, D ATHOS-SALAISUUSKORTTI PASS, G TAUSTAPAIVITYS v152 PASS; A KYLMA VERHO 7,6–8,9 s SIMULAATTORISSA (KONE KUORMASSA, S6 LAITEMITTAUS OMISTAJALTA); E: ALOITUSLENTO + LOPPU SOIVAT, SAAPUMINEN-VALIMERI EI SOI KOSKAAN ATEENASSA (AaniTaulut.Maat EI POPULOITU?) → PELIKOODARI KORJAA; B TESTAAMATTA → LOPULLINEN KIERROS; POHJA 26 / p060 -TUNNISTEET EIVAT LOYTYNEET → NATIIVISEPPA VAHVISTAA (26.9.2026 klo 09.42)

Lopullinen kierros kun 155 + 159 + musiikkikorjaus (+ vaihe 2 -kytkentä jos ehtii) ovat junassa.

## LAITETESTAAJA 09.4x: POHJA 26 JA KERMA p060 LOYTYVAT aed733c9:STA OLETUKSINA (rasteriPohja 2026-09-26-pohja-20260926 Pallo.unity/KarttaKerrokset.cs, Kermasarja.Oletus = 2026-09-26-p060) — F KUITATTU KOODISTA, VISUAALINEN TARKISTUS LOPULLISELLA KIERROKSELLA; MUSIIKKI VAIHE 1 ebur128: ALOITUSLENTO −12,4, LOPPU −11,5, SAAPUMINEN-VALIMERI −12,5 LUFS (PELIN NYKYISTEN HAARUKASSA) (26.9.2026 klo 09.43)

Natiivisepän vahvistusta ei tarvita.

## OMISTAJA 09.4x (KORTTI, SITOVA): 161 KOLMIULOTTEINEN MEGA-LIPPUTANKO KOHDEMAAHAN, 1873-LIPPU LIEHUU OIKEISSA VAREISSAAN — KARTAN AINOA TAYSVARINEN KOHDE, YKSI MAA KERRALLAAN; LIEHUU SAAPUMISEN AJAN JA KOSKETUKSEN JALKEEN HETKEN, JAHMETTYY LEVOSSA; HAIPYY HORISONTIN MUKANA (153); KOE BUILD 21 (NATIIVISEPPA, LINSSISEPPA 144:N LIEHUNTA). 160 TARKENNUS: TARKEIMMAT NOSTOT KOLMIULOTTEISINA JA LIIOITELLUN KOKOISINA, VARIT HILLITYT — SAMA PALETTI KUIN CODEXIN YHTENAISTAMISSA KAUPUNKINAHTAVYYKSISSA (KEVYT PALETTI, YLEISILME YKSIVARINEN), OMAT LOW-POLY-MALLIT YHDELLA MATERIAALILLA JA KARKIVAREILLA (EI TEKSTUUREJA, EI PD/CC-SEKAMALLEJA), GRC TASO 1 KOKEENA, SAMA HORISONTTIHAIVYTYS; LIPPUTANKO ENSIN, 3D-NOSTOT PERAAN (26.9.2026 klo 09.49)

Fablen suositus hyväksytty sellaisenaan. Kaupunkinähtävyyksien paletti: Codexin 503/504-värikorjauserät (Sisältökirjuri tietää tarkan paletin).

## OMISTAJA 09.5x (SITOVA, KAYTTOON HETI): JOS OPUS-SESSION EFFORT NOSTETAAN KORKEAMMAKSI KUIN HIGH (xhigh/max), SESSION NIMEEN LISATAAN EFFORT NAKYVIIN — ESIM. 'Linssiseppä (max)' — NIIN PITKAKSI AIKAA KUIN SE ON KAYTOSSA; PALAUTUS HIGHIIN POISTAA LISAYKSEN; POSTIVAHTI VALVOO KIERROKSELLAAN; RAAMATTUUN PR:NA JULKAISIJAN JUNAAN (FABLE EI MERGEA JS:AA). TILA 09.5x: KAIKKI 7 OPUS-ROOLIA HIGH, EI NIMILISAYKSIA (26.9.2026 klo 09.50)

Syy: omistaja näkee sivupalkista, mikä sessio kuluttaa kiintiötä korotetulla effortilla. Efortin nostaa Fable set_session_effortilla (tai omistaja appista), samalla set_session_title.

## OMISTAJA 09.5x: LIPULLE 30 fps RIITTAA; KARTALLE JA VARSINKIN LINSSEIHIN TULEE MUUTAKIN ANIMOINTIA → YLEINEN ELAVA KERROS (ERISTETTY RUUTUPAIVITYS): KARTTA PIIRRETAAN KERRAN KUN KAMERA ON PAIKALLAAN (VARI + SYVYYS TALTEEN), VAIN REKISTEROIDYT ANIMOIDUT KOHTEET (LIPPU, KYNAVIIVA, MUSTEPISTEET, PULU, LINSSIEN ANIMAATIOT) PIIRRETAAN OMALLA KERROKSELLA 30 fps, KERROS PYSAHTYY 0 KEHYKSEEN KUN MIKAAN EI ANIMOI; KAMERAN LIIKE → TAYSI PIIRTO. FABLE: NATIIVISEPPA TOTEUTTAA 161:N VAIHTOEHDON B YLEISENA KERROKSENA, LINSSISEPPA ENSIMMAINEN LINSSIKAYTTAJA, MITTAUS A vs B LAITTEELLA → KORTTI (26.9.2026 klo 09.53)

Natiiviseppä samalla: 160-suunnitelma valmis (proto-3d/lokit/suunnitelma-160-3d-symbolinostot.md, 9 kohtaa: omat low-poly Blender-mallit, 8 arkkityyppiä + erikoismallit, ≤ 1 500 kolmiota, < 1,5 Mt buildissa, ≤ 0,3 ms/kehys, lepopiirto säilyy, prototyyppi 3 mallilla build 21) → omistajan kortti; 153 todennettu laitteella (38baee24, lokit/k153-laite-0943/), 159 koodattu (usva-153 064cc259, Horisonttiusva.hlsl), 157 korjattu (a1212134), yhdistelmäkäännös käynnissä; Raamattu-PR #3308 (effort nimessä) Julkaisijan junaan.

## OMISTAJA 09.5x (KORTTI, SITOVA): LOYDOS 160 -SUUNNITELMA HYVAKSYTTY SELLAISENAAN — OMAT LOW-POLY BLENDER-MALLIT YHTENAISELLA KAIVERRUSTYYLILLA (TASAVARJOSTUS, MUSTE JA SEEPIA, HILLITTY PALETTI), 8 ARKKITYYPPIA + ERIKOISMALLIT 3–5/MAA, ≤ 1 500 KOLMIOTA, < 1,5 Mt BUILDISSA (ESILATAUS KOHTA 1), ≤ 0,3 ms/KEHYS, LEPOPIIRTO SAILYY, SAMA HORISONTTIUSVA JA 155:N KYNNYKSET; PROTOTYYPPI DELFOI/OLYMPOS/AKROPOLIS BUILD 21 + KUVAPARI JA KEHYSMITTAUS OMISTAJALLE, ARKKITYYPIT JA GRC BUILD 22; NATIIVIN POIKKEAMA WEBISTA OMISTAJAN TILAUKSESTA (26.9.2026 klo 09.54)

Työnjako suunnitelman kohdan 8 mukaan: Natiiviseppä mallit + Symbolimallit.cs + varjostin, Natiivi-UI 2D-merkin piilotus ja napautus, Pelikoodari kohdelista ja laji → arkkityyppi. Järjestys: build 20 -juna → 161 lipputanko (A/B-mittaus) → 160 prototyyppi.

## ELAVAN KARTAN KOHDAT 4+5 VALMIIT SIMULAATTORISSA (LINSSISEPPA): KOHTA 4 KULJETTU REITTI KYNANJALKENA + KAYTYJEN HEHKU KAUKANA, KOHTA 5 LAIVA/PARVI/SADE/JUNA 3 s KUKIN (SUURENNETTU 334 km:N NAKYMAAN), 0 POIKKEUSTA, LEPOPIIRTO PALAA; KUVAT lokit/linssiseppa-matka-20260926/omistajalle/ → OMISTAJALLE; 159 USVA KYNAVIIVAAN/VANAAN/LAIVAAN/PEHMEAPISTEESEEN (linssiseppa/usva-159 90f23fb5, POHJANA usva-153) → YKSI MERGE-PYYNTO NATIIVISEPALLE BUILD 20. SIIRTOSEPPA: SKEEMA 1.49 LUONNOS PR #3307 (0 fail), pikkukuva-KENTTA LUONNEHDINNOISSA JA SALAISUUKSISSA (REPOPOLKU/AMPARITUNNUS/COMMONS/HTTPS), ASSET-LAJI maakunnat js/media.js + vie-assetit.yml, VALMIS KUN GRC-KUVAT AMPARISSA JA NATIIVISEPPA KUITTAA (26.9.2026 klo 09.55)

Fable kysyy omistajalta kuljetun reitin värin: punainen kuten webissä vai muste (omistajan 09.4x linja: vain lippu täysvärinen).

## OMISTAJA 09.5x (KORTTI): KULJETTU REITTI NATIIVIN KARTALLA TUMMANPUNAINEN, LAPINAKYVA MUTTA LEVEA (EI WEBIN KIRKAS PUNAINEN) → LINSSISEPPA usva-159-HAARAAN. NATIIVISEPPA: JUNA e86fd248 SISALTAA 153 + 159 (usva-153) + 155 (PELIKOODARI c09aacc3 + NATIIVI-UI taso1-155b f8cd2f38), KOEMERGE 0ce20ba1 KAANTYI; 157 VALMIS (KUVAPARI lokit/maakunta-157/omistajalle/, PELOPONNESOS PALETIN VARILLA PEITTO 0,6, KOROSTUSRAJA POIS) → FABLE: JUNAAN HETI, RANNAN 1,2 km:N PORRAS LEIKATAAN MAAMASKILLA (BUILD 20 JOS EHTII, MUUTEN 21), PEITTO KOKEILLAAN 0,45; SISALTOKIRJURI: GRC 14 MAAKUNTAKUVAA COMMONSISTA AMPARIIN + NLD/BEL/DNK LUONNEHDINNAT 31/31 PR #3309, FABLE PYYSI VARMISTAMAAN ETTA SEKA SALAISUUDET 14 ETTA PIKKUKUVAT 14 ON KATETTU (26.9.2026 klo 09.58)

Junasta puuttuu vielä Linssisepän usva-159 (+ reitin väri) ja Pelikoodarin musiikkikorjaus → käännös Laitetestaajalle.

## NATIIVI-UI: 156 MAAKUNTIEN SELAIN VEDOLLA VALMIS (maakunnat-veto 9ae176c9, LEPO 0 KEHYSTA, KUVAPARI lokit/natiivi-ui-b20-156/) → FABLE: JUNAAN 157:N KANSSA; 155b JUNASSA; ATTIKA JA SALAISUUSKORTTI (KESKI-KREIKKA → GLA) TODENNETTU BUILD 19 -DATALLA; 158 pikkukuva-158 68e9dc2f (KENTTA pikkukuva, VARANA KORTIN KUVA) MERGE-PYYNTONA; SIIRTOSEPPA: GRC:N 14 MAAKUNTAKUVAA TULEVAT #3309:N MUKANA PAKETTIIN ILMAN 1.49:AA (kuva[0].osoite), 1.49 ODOTTAA 14 SALAISUUSKUVAA JA KUVAPUTKEN PIKKUKUVIA (26.9.2026 klo 09.59)

Natiivi-UI:n jono tyhjä → 160:n 2D-merkin piilotus -rajapinta ja ehdotus seuraavasta isosta UI-erästä (radiolinssin uudistus natiivissa).

## OMISTAJA 10.0x (SITOVA): 161 LIPUN ANIMOINTI PIDETAAN KOKO AJAN PAALLA (YLEINEN ELAVA KERROS 30 fps, KARTTA 0 KEHYSTA) — A/B MITATAAN SILTI LAITTEELLA TIEDOKSI, MUTTA VALINTA ON B; 160 LAAJENNUS: ANIMOIDUT ERIKOISMALLIT ELAVALLA KERROKSELLA, ESIM. LONTOON MAAILMANPYORA (LONDON EYE, KARTALLA HIEMAN SIVUUN SIIRRETTYNA) JA KOOPENHAMINAN PYORIVA TIVOLI; TESTATAAN YKSI KERRALLAAN LAITTEELLA MITEN TOIMII KAYTANNOSSA, LIPPU ENSIN (26.9.2026 klo 10.00)

Järjestys ennallaan: build 20 → 161 lipputanko + elävä kerros (mittaus) → 160 prototyyppi (staattiset 3) → ensimmäinen animoitu erikoismalli kokeena.

## NATIIVI-UI: RADIOLINSSIN UI-OSA TEHTY JO BUILD 12:SSA (VU | LCD | LAMPPU, KUVAPUTKEN PINNAT, VIIVAIMEN VETO); SEURAAVA ISO ERA = NATIIVIN UI-PARITEETTIKIERROS WEBIA VASTEN (KAIKKI NAKYMAT iPHONE + iPAD, MITATTU KUVAPARI PER NAKYMA, ERI-RIVIT ERINA; AVOIMET: LINSSIPARITEETTI 4 RIVI 31, VESISTOT-LAPPU, KAIUTINKUVAKE) — FABLE HYVAKSYI (ENINTAAN 2 SIMULAATTORIA PAIVALLA, VAISTAA LAITETESTAAJAN KIERROSTA); 160:N UI-OSA ODOTTAA NATIIVISEPAN Symbolimallit-HAARAA (26.9.2026 klo 10.01)

Web on malli mitattuna; kuvat vain lokit/-kansioon.

## BUILD 20 -JUNA 12679a12 (NATIIVISEPPA): 153, 155, 157 (PEITTO 0,45), 159-RAJAT, 154 UTU, NATIIVI-UI:N 156 JA 158; LINSSISEPAN usva-159 7f5291f4 (159 + REITIN VARI + ELAVAN KARTAN KOHDAT 4+5) MERGETAAN KUVIEN TULTUA → FABLE: KOHDAT 4+5 BUILD 20:EEN, LEPOPIIRTO (0 KEHYSTA HETKEN JALKEEN) LAITETESTAAJAN KIERROKSELLA; 157:N RANTAPORRAS-MASKI BUILD 21; JUNASTA PUUTTUU ENAA PELIKOODARIN MUSIIKKIKORJAUS (SAAPUMINEN-VALIMERI) (26.9.2026 klo 10.02)

Sisältökirjuri: pikkukuvat 14/14 (#3309), salaisuuskuvat 0/14 haussa.

## OMISTAJA 10.0x (SITOVA, KOKO PELI): JOHTOAJATUS VISUAALISUUDESTA = NIUKKUUS YHDISTETTYNA SULAVAAN JA ELAVAAN ANIMOINTIIN — YKSINKERTAISTEN ELEMENTTIEN ANIMOINTI ON TARKEIN ASIA; KARTTA SAA NAYTTAA AAVISTUKSEN TIETOKONEPELILTA MUTTA VISUAALISESTI RAJOITETTUNA, EI SEKAVA; LISAA IDEOITA: HITAASTI KAVELEVAT ELAIMET (ESIM. AFRIKKA), LONTOON MAAILMANPYORA, KOOPENHAMINAN TIVOLI → ENSIN SELVITYS SOPIVISTA IDEOISTA EUROOPAN MUUTAMAAN KAUPUNKIIN ERI AIHEINEEN (LINSSISEPPA VETAA, SISALTOKIRJURI AIHEET, NATIIVISEPPA KEHYSBUDJETTI) → OMISTAJAN KORTTI → KOKEILLAAN YKSI KERRALLAAN LAITTEELLA; RAAMATTUUN PR:NA (26.9.2026 klo 10.04)

Kirjataan Raamatun NATIIVI PELI ETUSIJALLE -osioon ELÄVÄ KARTTA -kohdan perään.

## RAAMATTU-PR #3310 (JOHTOAJATUS VISUAALISUUDESTA — NIUKKUUS JA ELAVA ANIMOINTI, ELAVA KERROS, ANIMOINTI AINA PAALLA, IDEASELVITYS) JULKAISIJAN JUNAAN (ee554ed66, DOCS-TESTI VIHREA); #3308 (EFFORT NIMESSA) SAMAAN JUNAAN; LINSSISEPPA VETAA ELAVIEN ELEMENTTIEN IDEASELVITYKSEN (6–8 EUROOPAN KAUPUNKIA, ELAIMET AFRIKKAAN), SISALTOKIRJURI AIHEET, NATIIVISEPPA KEHYSBUDJETTI (26.9.2026 klo 10.06)

Oppi: Raamattuun ei saa viitata tiedostoon, jota ei vielä ole (tests/dokumentit.test.mjs kaatuu) — polku lisätään kun tiedosto on olemassa.

## ELAVAT ELEMENTIT -SELVITYS VALMIS (LINSSISEPPA 476b07a93, docs/raportit/elavat-elementit-selvitys-20260926.md): YHTEISET NIUKKUUSSAANNOT (YKSI LIIKKUVA AIHE/KAUPUNKI, ENINTAAN 2 RUUDULLA, SYKLI ≥ 4 s, AMPLITUDI ≤ 1/3 MALLISTA, EI UUTTA VARIA PAITSI TERRAKOTTA-AKSENTTI, VAIN 15–600 km, VAHENNETTY LIIKE/VIRRANSAASTO PYSAYTTAA; BUDJETTI ≤ 0,15 ms/KOHDE, ERIKOISMALLI ≤ 3 000 KOLMIOTA, ELAIN ≤ 500 × 8, KERROS ≤ 0,5 ms); IDEAT: AMSTERDAMIN MYLLYT (ENSIN, TESTAA KERROKSEN), TIVOLIN KARUSELLI, PARIISIN KIINNITETTY PALLO (GIFFARD), VENETSIAN GONDOLIT, LONTOO (MAAILMANPYORAA EI 1873 → VAIHTOEHTO THAMESIN SIIPIRATASHOYRY), RIGIN HAMMASRATA 1871, VESUVIUKSEN SAVU 1872, MYOHEMMIN AFRIKAN KULKUE → OMISTAJAN KORTTI (26.9.2026 klo 10.06)

Aloitus vasta build 20:n jälkeen; jokaisesta kuvapari + lyhyt video + kehysmittaus ennen seuraavaa.

## OMISTAJA 10.0x (KORTTI, SITOVA): ELAVAT ELEMENTIT -LISTA JA KOKEILUJARJESTYS HYVAKSYTTY (MYLLYT → TIVOLI → PARIISI → VENETSIA → LONTOO → RIGI + VESUVIUS → AFRIKKA, KUVAPARI + VIDEO + KEHYSMITTAUS JOKAISESTA); LONTOO: MAAILMANPYORA — 'KARTASSA ELETAAN NYKYAJASSA JA VAIN ESTETIIKKA ON VANHAA, KIRJAA RAAMATTUUN, YLEINEN SEKAANNUS KOKO AJAN' → UUSI KOHTA AIKA YDINAJATUKSEN ALKUUN (RAAMATTU-PR #3310 + CLAUDE.md): NYKYAJAN KOHTEET SALLITTUJA, 1873-TARKISTUSTA EI TEHDA NYKYAJAN KOHTEILLE, KUKAAN EI HYLKAA IDEAA 'KOSKA SITA EI OLLUT 1873'. SISALTOKIRJURI: 158 VALMIS — SALAISUUDET 14/14, PIKKUKUVAT 14/14 (#3309), JATKAA NLD/BEL/DNK KUVA-KENTTAAN (26.9.2026 klo 10.10)

Thamesin höyrylaiva jää varalle, ei tarvita.

## OMISTAJA 10.1x: THAMESIN SIIPIRATASHOYRY MUKAAN ELAVIIN ELEMENTTEIHIN MAAILMANPYORAN LISAKSI ('KUULOSTAA HAUSKALLE') — SIJOITUS LINSSISEPAN HARKINNASSA (LONTOO TOISENA AIHEENA JOS EI SEKAVA, MUUTEN TOINEN JOKIKAUPUNKI) (26.9.2026 klo 10.10)

Kokeilujärjestys ennallaan.

## 158 DATA VALMIS: SIIRTOSEPAN #3307 (SKEEMA 1.49) JA SISALTOKIRJURIN #3309 (GRC 14 SALAISUUSKUVAA + 14 PIKKUKUVAA, 28/28 OSOITETTA 200, KOEYHDISTELMA OK) JULKAISIJAN JUNAAN (#3309 ENSIN); SISALTOKIRJURI TOIMITTI LINSSISEPALLE 8 KAUPUNGIN AIHEET (LONTOO/KOOPENHAMINA/VENETSIA/AMSTERDAM/LISSABON/WIEN/PRAHA ORLOJ/TUKHOLMA) + AFRIKKA (SAHARA KAMELI, KILIMANDZARO NORSU, NAMIB KIRAHVI); LINSSISEPPA: SIIPIRATASHOYRY LONTOON TOINEN AIHE (25 s + 40 s TAUKO, VARALLA TONAVA), ALPEILLE KOYSIRATA (76fba31e7) (26.9.2026 klo 10.14)

Siirtoseppä ilmoittaa paketin version tuotannon jälkeen.

## JULKAISIJA 10.1x: MAINISSA #3305 (REITIT 1873 ERA 2), #3278 (SALMET), #3281 (JOET, v2260), #3304 (WEB-MUSIIKKI, v2261), #3306 (VIENTIBUDJETTI B4 VAIN WEBKIT + AJURIRIVI), #3308 (EFFORT NIMESSA) JA #3310 (JOHTOAJATUS + AIKA) — RAAMATTU PAIVITETTY; SEURAAVAKSI #3309 → #3307; FABLE POISTI WORKTREET wt/fable-raamattu-effort-nimi JA -niukkuus (26.9.2026 klo 10.31)

Vientibudjetin vihreä main-rivi tulee mainin Savukkeet-ajon jälkeen.

## LOYDOS 155 VALMIS (PELIKOODARI): WEB pelikoodari-loydos155 6ad5b1f65 (4355/0, TYYPPIMERKKISAVUKE 13/13 + z7-TASO), NATIIVI c09aacc3 (288/288) JUNASSA e86fd248; KYNNYS 4 → 2,5, MERKIT 0,7-KOKOISINA KAUKANA; KUVAPARIT lokit/loydos155/ (WEB + NATIIVI, PELOPONNESOS KERROIN ~3) → OMISTAJAN KORTTI ENNEN WEB-PR:AA; BUILD 20 E (SAAPUMINEN-VALIMERI): EI VIKAA — LAITETESTAAJAN FAIL JOHTUI EDELLISEN TESTIN SOIVASTA LOPPU-AIHEESTA (TUNNUS EI KATKAISE AIHETTA, KUTEN WEB) → JUNA VALMIS KAANNETTAVAKSI; 160-ARKKITYYPIT lokit/loydos160-arkkityypit.txt NATIIVISEPALLE (26.9.2026 klo 10.37)

Jos merkit liian pieniä kertoimella 3, 0,7 → 0,85 on yhden luvun muutos.

## BUILD 20 LEIKATTU (NATIIVISEPPA): KAANNOS 894f1feb = MASTER 41dd79c7 + JUNA c8cd1d94 (PUU 671b0f44) LAITETESTAAJALLE LOPULLISEEN KIERROKSEEN — MUKANA 153/159, 154 UTU, 155, 156, 157 (0,45), 158, ELAVAT HETKET 4+5, POHJA 26 + p060, MUSIIKKI VAIHE 1, KULJETTU REITTI; KARTTA-TESTI 278/278; 161 ELAVA KERROS TOIMII SIMULAATTORISSA (KAAPPAUS KERRAN, 106 KERROSKEHYSTA ILMAN KARTTAA, PIKSELIERO ≤ 1/255 MUUALLA KUIN TANGOSSA), LAITEMITTAUS A/B → KORTTI; FABLE KUTSUI LAITETESTAAJAN KIERROKSEN A–N (26.9.2026 klo 10.38)

PASS → BUILD 1.0.20 Julkaisijalle → push omistajalle.

## OMISTAJA 10.4x (KORTTI): LOYDOS 155 HYVAKSYTTY — TYYPPIMERKIT KERTOIMESTA 2,5 ALKAEN, KOKO KAUKANA 0,85 (EI 0,7) WEBIIN JA NATIIVIIN SAMALLA ERALLA → PELIKOODARI: WEB-PR JULKAISIJAN JUNAAN, NATIIVIIN YHDEN LUVUN MUUTOS (BUILD 20 JOS ENNEN BUILD-KASKYA, MUUTEN 21) (26.9.2026 klo 10.47)

Kuvaparit lokit/loydos155/.

## BUILD 20 LOPULLINEN KIERROS (LAITETESTAAJA 69b566d93, c8cd1d94): PASS E (SAAPUMINEN-VALIMERI SOI TUOREELLA PELILLA), D ATHOS, 155 SILMAMAARAISESTI; B/S7 ATTIKI KAYNNISTYY LOKISSA MUTTA VARI EI NAY KUVISSA (SAMA KUIN b19); 153/154/156/157/158/159/4+5/REITIN VARI TESTAAMATTA (KALLISTUS JA UI-KOORDINAATIT PUUTTUVAT) → FABLE (TYONJOHTAJAN HARKINTA): BUILD 1.0.20 = 894f1feb NYT — EI REGRESSIOITA, TESTAAMATTOMAT TEKIJOIDEN TODENTAMIA, B EI REGRESSIO; NATIIVISEPPA MERGEAA MASTERIIN JA TARKISTAA B:N TESTIASKELEET (VIKA → BUILD 21); 155:N 0,85 BUILD 21; LAITETESTAAJA KOKOAA TESTIRESEPTIN (KEHITTAJAKOMENNOT) JA AJAA TAYDENNYSKIERROKSEN H–N TF 1.0.20:LLA (26.9.2026 klo 10.49)

Pelikoodari: johtoaihe natiivin etusivulle vasta kun Siirtoseppä vie paikkaraita-rivin etusivu → musa-johtoaihe (sopivat suoraan); vaihe 2 -kytkentä ja vaihe 3 -generointi jonossa.

## OMISTAJA 10.5x (KORTTI): KULJETUN REITIN VIIVA = B (PEITTO 0,65, 5,5 pt, TUMMANPUNAINEN LAPINAKYVA) MUTTA KATKOVIIVANA + ASETUKSIIN KYTKIN PIILOTTAA KULJETTU REITTI (NATIIVI-UI ☰ → KARTTA, LINSSISEPPA LUKEE) → BUILD 21; BUILD 20 LAHTI A:LLA (0,5). NATIIVISEPPA: BUILD 20 = PROTO-MASTER 1a57cc39 (JUNA c8cd1d94, PUU 671b0f44 = KAANNOS 894f1feb) SHA JULKAISIJALLE TF 1.0.20; B/S7 TESTAUSVIRHE, EI VIKA — 'elava herata' AJAA VAIN ANIMAATION, PYSYVA VARI TULEE LOYDOSTA ('muste loyda <valo>'), NATIIVI-UI TODENSI 3ec54edd; TESTIASKELEET + KALLISTUS-/USVAKOMENNOT LAITETESTAAJALLE; JUNA AUKI BUILD 21:LLE (155 0,85, 16c9ee36, 161, 160) (26.9.2026 klo 10.57)

Kuvat lokit/linssiseppa-reittivari-20260926/omistajalle/.

## MUSIIKIN VAIHE 3 KUUNNELTAVISSA (PELIKOODARI 7a638f038, docs/raportit/musiikki-vaihe3-kuunneltavaksi.md): 8 MAANOSALOOPPIA (50–72 s) + 6 TUNNUSKAUPUNKIA (PARIISI, LONTOO, ROOMA, ISTANBUL, KAIRO, PIETARI, 64–74 s), −11,5 LUFS, EI KYTKETTY → OMISTAJAN KORTTI; VAIHEEN 2 KYTKENTA TYON ALLA (WEB + NATIIVI). JULKAISIJA: BUILD 20 TF-AJO 36228178994 KAYNNISSA 10.54 (proto_ref 1a57cc39, ORDINAALI 20). LAITETESTAAJA 5e13c26df: H (153/159 USVA) JA I (154 UTU) PASS KALLISTETTUNA ('kallista 70'), C/D/E/J/G PASS; B TESTATTU HERATYKSELLA (EI LOYDOLLA) → UUSINTA muste loyda -ASKELEILLA; K/L/M/N/F/A TF-TAYDENNYSKIERROKSELLE. SIIRTOSEPPA: 1.x v159 (SKEEMA 1.49) TUOTANNOSSA, 770/770, SALAISUUDET 14/14 + GRC-MAAKUNNAT 14/14 KUVINEEN (158 DATA VALMIS) (26.9.2026 klo 10.58)

Lyria hylkäsi Istanbulin kehotteen (sana-suodatin), paikka kuvattu ilman nimeä; Kairo samoin.

## OMISTAJA 11.0x (KORTTI): MUSIIKIN VAIHE 3 KAIKKI 14 RAITAA HYVAKSYTTY → PELIKOODARI KYTKEE VAIHEEN 2 PERAAN (WEB + NATIIVI BUILD 21), MUSIIKKISUUNNITELMA KOKONAAN TUOTANNOSSA SEN JALKEEN. LAITETESTAAJA BUILD 20: B PASS (muste loyda kohde:marathon → ATTIKI 1/14, PYSYVA VARI + KASIALANIMI) JA 157 PASS (PELOPONNESOS VIHREA ILMAN RAJAA); TESTIRESEPTIT docs/raportit/laitetestaaja-reseptit.md ac153e7e4 (26.9.2026 klo 11.01)

S7 suljettu.

## KARTTASEPPA: PUNAISET SAVUKKEET KORJATTU — PR #3312 (05e8fd142) JUNAAN: astro-pallo 43/47b OIKEA VIKA (pallo.js tahdistaPohjanNakyvyys AVASI globe.gl:N LAATTAMOOTTORIN, JONKA ASTRONAUTIN KAMERA OLI SULKENUT → z2-LAATAT + NAPAKANSI LINSSIPALLON PAALLA; NAKYI VASTA POHJA 26:N MYOTA; PALAUTUS VAIN KUN LAATTAOSOITE ON), pariisi-lahizoom 8b VERSAILLES = #3168 LYHENSI NIMION 'PEILISALI', SAVUKE HAKEE NYT MYOS TUNNISTEELLA; PAIKALLISESTI VIHREAT, npm test 0 fail; JALJELLA 8l4 LIUSKA × NIMIO (UI) JA VIENTIBUDJETIN MAIN-RIVI → SEURAAVAKSI 157:N MAAMASKI NATIIVISEPALLE (JOS TARVITSEE) JA ELAVIEN ELEMENTTIEN POLKUDATA LINSSISEPALLE (CANAL GRANDE, THAMES, TONAVA, RIGI, SAVANNIPOLKU) (26.9.2026 klo 11.02)

Jono muuten tyhjä.

## BUILD 20 TESTFLIGHTISSA 11.07: 1.0.20 (AJO 36228178994 success, CFBundleVersion 202609260759, PROTO 1a57cc39, LASKURI 20, SISAINEN RYHMA) → PUSH OMISTAJALLE; SISALTO: POHJA 26 + KERMA p060, MUSIIKKI VAIHE 1, 153/159 HORISONTTIUSVA, 154 UTU-TAIVAS, 155 TYYPPIMERKIT (0,7), 156 MAAKUNTIEN SELAIN VEDOLLA, 157 VALITUN MAAKUNNAN TAYTTO, 158 PIKKUKUVAT, ELAVAN KARTAN KOHDAT 2/4/5 (KULJETTU REITTI, ELAVAT HETKET), OFFLINE-LEPO, SALAISUUSKORTTI, TAUSTAPAIVITYS; SISALTOKIRJURI: FIN/EST/SVN PR #3313 (45 ALUETTA) JUNAAN (26.9.2026 klo 11.08)

ASC-käsittely 10–20 min.

## KATKOVIIVAREITTI VALMIS JA BUILD 21 -JUNASSA (LINSSISEPPA usva-159 1308bfec → juna/b13 4ae6df79): VARI B 0,65, 5,5 pt, KATKOJAKSO ~16 pt (60 % VIIVAA) KAHDEN POTENSSIIN PYORISTETTYNA (EI LIU'U ZOOMATESSA), HAIPYY USVAAN; PIILOTUS NATIIVI-UI:N KYTKIMELLA 'KULJETTU REITTI' (natiivi-ui/kuljettu-kytkin → ElavaMatka.NakyvissaKysely), 0 POIKKEUSTA, LEPOPIIRTO PALAA; KUVA lokit/linssiseppa-katko-20260926/omistajalle/ → OMISTAJALLE; KARTTASEPAN KANSSA SOVITTU POLKUDATAN MUOTO (CANAL GRANDE ENSIN, KOYSIRATA CHAMONIX) (26.9.2026 klo 11.11)

Linssiseppä odottaa elävän kerroksen haaraa → myllyt.

## MUSIIKIN VAIHEET 2+3 KYTKETTY (PELIKOODARI): WEB PR #3314 (4370/0) JUNAAN, NATIIVI pelikoodari/musiikki-vaihe2 dab360d2 (297/297) BUILD 21:EEN; MAANOSALOOPIT ALUERAIDAN VARAREITTINA POHJAVIREEN PAIKALLE (2.2: EUROOPASSA ALUERAITA VOITTAA), TUNNUSKAUPUNGIT OMINA KAPPALEINA, KOHTAAMINEN TILARAITANA (VISA VOITTAA), RATKAISU/EPAONNISTUMINEN VAIN KOHTAAMISEN KYSYMYKSESSA (FABLE: PIDETAAN, NIUKKUUS), JOHTOAIHE ETUSIVULLA PAKETISSA v157; DOCS-PR 'KAIKKI VAIHEET TUOTANNOSSA' KUN MAINISSA. SISALTOKIRJURI: NLD 15 MAAKUNNAN KUVAT VALMIIT HAARASSA, PR KUN #3313 MAINISSA (26.9.2026 klo 11.20)

Pelikoodarille seuraavaksi 8l4 liuska × nimiö -savuke ja Esilataajan mittarit.

## TF 1.0.20 ASC VALID 11.07 (BUILD f2178f22), ASENNETTAVISSA → PUSH OMISTAJALLE; #3312 MAINISSA v2265; JULKAISIJAN JONO #3303 (OFFLINE-SARJA 26, PITO PAATTYI 1.0.20:N MYOTA) → #3314 → #3313; JULKAISUSARJA 36229149241 (26.9.2026 klo 11.21)

Push lähetetty 11.2x.

## KARTTASEPPA VALMIS: 157 MAAMASKI PR #3316 (vektorit/maamaski-maittain-2026-09-26/, 138 MAATA GSHHG FULL + NE-JARVET, 20 Mt gzip, NATIIVISEPPA HYVAKSYI MUODON, BUILD 21/22) JA ELAVIEN ELEMENTTIEN POLUT PR #3315 (vektorit/elavat-polut-2026-09-26/: CANAL GRANDE WORLDCOVER-KESKITETTY CC BY 4.0, THAMES, TONAVA BUDAPEST, KOYSIRATA CHAMONIX–AIGUILLE DU MIDI KORKEUKSINEEN, AMBOSELIN KULKUE) → JULKAISIJAN JUNAAN; RIGI EI TARVITA (LINSSISEPPA VALITSI CHAMONIXIN) (26.9.2026 klo 11.21)

Karttasepälle seuraavaksi delta-polton ämpärivaiheiden kuivaharjoitus.

## NATIIVI-UI BUILD 21 -ERAT MERGE-PYYNNOSSA (lokit/natiivi-ui-b21-erat/): KULJETTU REITTI -KYTKIN ☰ KARTTA (602ea18a, OLETUS PAALLA, KYTKETTY KYNAVIIVAAN), UI-PARITEETTI RIVI 9 KOKORUUTU MAALEHDEN KARTALLA (9d114de5), 158 SALAISUUSKORTIN KUVA + LAHDE (49bbf06b, v162 GLA NAKYY); UI-PARITEETTI b20-ui-1: 27 ERI-RIVISTA VAIN 2 AITOA EROA (luokittelu.md); VALKOINEN NOSTOMERKKI = KUVAMUISTIN LRU → KORJAUS kuvat-kiinteat bbbbb501 TODENNUKSESSA; RIVI 31 SULJETTU LINSSIPARITEETTI 4:SSA. SIIRTOSEPPA: #3303 TUOTANNOSSA 1.x v162 (770/770), NATIIVIN OFFLINE-RASTERI = POHJA 26; JONOSSA MUSIIKKIAIHEET SKEEMA 1.50 KUN #3314 MAINISSA (26.9.2026 klo 11.31)

Kaikki build 21 -junaan Natiivisepän kautta.

## 161 A/B MITATTU iPAD (NATIIVISEPPA, RELEASE, 10 min/VAIHE, lokit/ab161-ipad13/raportti.md): A JAHMETTYY 22,5/150 KEHYSTA 71 ms/s GPU; B ELAVA KERROS LIPPU 30 fps 150/150, 5,3 ms/KEHYS = 166 ms/s; C ILMAN KERROSTA 486 ms/s; LAMPO 0; TAYSI/KERROS-KUVAT BITILLEEN SAMAT → FABLE: B BUILD 21:EEN (lipputanko-161 b0ac1efe). 160 PROTOTYYPPI (symbolimallit-160 d640987a): DELFOI 388 JA METEORA 129 KOLMIOTA, KUVAT lokit/symbolit-160c/omistajalle/ → OMISTAJAN KORTTI; AKROPOLIS ATEENAN SISAINEN NOSTO (EI KARTALLA); 2D-MERKIN PIILOTUS NATIIVI-UI:LTA. 157 MAAMASKI JUNASSA (maamaski-157 091f812b): GSHHG-POLYGONIT RASTEROIDAAN 4× TARKEMMIKSI (GRC 3580×2956, 36 ms), TAYTTO SEURAA RANTAVIIVAA, MASKI MAITTAIN VALIMUISTIIN (GRC 0,56 Mt), KUVAPARI lokit/maski-157/omistajalle/ (26.9.2026 klo 11.33)

Build 21 -juna: 155 0,85, katkoviiva + kytkin, musiikki 2+3, 161, 157-maski, Natiivi-UI:n erät; 160 odottaa korttia.

## OMISTAJA 11.3x (KORTTI): 160-PROTOTYYPPI — JATKA, TARKENNA TYYLIA: SIISTIMMAT MUODOT, EI SINISTA (AKSENTIT SAGE/TERRAKOTTA), 2D-KUVAKE POIS MALLIN ALTA (NATIIVI-UI), BUILD 21:EEN VASTA KUN SIISTI (UUSI KUVAPARI FABLELLE); 161 LIPPUTANKO BUILD 21 -JUNAAN HETI (26.9.2026 klo 11.37)

Fable ei avaa uutta korttia ellei tyyli muutu olennaisesti.

## OMISTAJA 11.4x (SITOVA), 161 TARKENNUS: LIPPUTANKO MAAN OIKEAAN (ITAISEEN) REUNAAN, EI PAAKAUPUNKIIN — EI KUORMITA PAAKAUPUNGIN YMPARISTOA; SIJOITUS MAALLE MAAMASKIN/MAAKUNTARAJOJEN ITAREUNAAN, EI NOSTOJEN PAALLE; TARVITTAESSA KARTTASEPPA LASKEE ANKKURIPISTEEN MAITTAIN DATAAN; KUVAPARI GRC:STA ENNEN BUILD 21 -JUNAA (26.9.2026 klo 11.38)

Natiivisepälle annettu.

## MAININ JULKAISUSARJA VIHREA (JULKAISIJA, AJO 36229149241): VIENTIBUDJETTI 6/6 (AJURI CHROMIUM, B4 INFO), astro-pallo-puhelin 64/64, pariisi-lahizoom 1400 16/16; JALJELLA VAIN 8l4 LIUSKA × NIMIO (390, VANHA, PELIKOODARILLA); MAINISSA #3303 JA #3314 (WEB-MUSIIKKI VAIHEET 2+3) v2266; JONO #3313 → #3316 → #3315 (26.9.2026 klo 11.38)

Savukkeet punaisina 25.9. alkaen → vihreät 26.9. klo 11.4x.

## POSTIVAHTI 11.30 HALYTYS: SWAP 5,6 → 19 Gt JA LEVY 102 → 90 Gt 12 MINUUTISSA; FABLE 11.4x: EI YHTA SYYLLISTA — SIMULAATTORI 1,3 Gt, KOLME PLAYWRIGHT-CHROMIUMIA ~3 Gt (JULKAISUSARJA + SAVUKKEET RINNAKKAIN), mds_stores 1,4 Gt (SPOTLIGHT INDEKSOI proto-3d/lokit 38 Gt), dotnet 0,9 Gt, DerivedData 9,6 Gt, EI JUMIA → POSTIVAHTI SEURAA, sudo purge JOS SWAP > 24 Gt TAI LEVY < 85 Gt, LISTAA LOKIT-KANSION SUURIMMAT YLI 24 h VANHAT ALIKANSIOT OMISTAJAN SIIVOUSTA VARTEN (EI POISTOJA) (26.9.2026 klo 11.39)

Lokikansiot-sääntö: poistot omistajalle skriptillä.

## SWAP-PIIKIN OSASYY (POSTIVAHTI 11.39): SIMULAATTORIIN FBBD41D7 KOHDISTUI NELJA proto-kaanna.sh-AJOA SAMANAIKAISESTI (symbolit-160b, symbolimallit-160, KAKSI juna/b13) → FABLE: YKSI KAANNOS/AJO PER SIMULAATTORI KERRALLAAN, VAHTI JONOTTAA, PAIVALLA ENINTAAN 2 SIMULAATTORIA BOOTTINA (NATIIVISEPPA + NATIIVI-UI OMILLA UDID:ILLA); SWAP 16 Gt JA LEVY 91 Gt RAJOJEN SISALLA, EI PURGEA; LOKIT-LISTA TILATAULUN KOHDASSA 6 (26.9.2026 klo 11.43)

32 Playwright/Chromium-prosessia = ~3 selainta apuprosesseineen (julkaisusarja + savukkeet).

## NATIIVI-UI: VALKOISEN NOSTOMERKIN KORJAUS kuvat-kiinteat bbbbb501 TODENNETTU (MUISTIRAJA 1 Mt) MERGE-PYYNNOSSA; 160: symbolit-160b 2486228c PIILOTTAA 2D-KUVAMERKIN KUN 3D-MALLI ON; 161: lipputanko-161 a500a778 LUKEE ANKKURIN lippu_lonlat, ILMAN ANKKURIA EI TANKOA → KARTTASEPPA LASKEE lippu_lonlat MAITTAIN (ITAREUNA MAALLA, ≥ 30 km RANNASTA, KAUKANA KAUPUNGEISTA; GRC ENSIN) (26.9.2026 klo 11.44)

Karttasepälle annettu ennen delta-harjoitusta.

## 161 LIPPUTANKO ITAREUNASSA TODENNETTU (NATIIVISEPPA, GRC TRAAKIA 41,08/25,95, KUVAPARI lokit/tanko-161b/omistajalle/ → OMISTAJALLE): LIPPU LIEHUU MAAN ULKOPUOLELLE, EI PEITA PAAKAUPUNKIA EIKA NOSTOJA; KAPEALLA iPHONELLA VOI OSUA RUUDUN REUNAAN → ANKKURI ≥ 15 km SISAMAAHAN (KARTTASEPAN SPEKSISSA ≥ 30 km RANNASTA); JUNASSA 55b54dbc PALLOPUOLI + NATIIVI-UI:N KYTKENTA, ANKKURI PAKETIN POLUSTA kartta/lippu_lonlat.json (KARTTASEPPA → SIIRTOSEPPA), ILMAN DATAA EI TANKOA. SISALTOKIRJURI: NLD KUVAT PR #3318, JATKAA BEL (26.9.2026 klo 11.45)

Siirtosepälle ilmoitettu polusta.

## OMISTAJA 11.5x (BUILD 20) LOYDOS 162: KARTAN SAAPUMISANIMAATIO VASTA PULUN LUENNAN JALKEEN — MUUTEN SE EI NAY PELAAJALLE; ELAVAT HETKET EIVAT LUENNAN/KORTIN AIKANA → LINSSISEPPA (AJOITUS, ODOTTAA 'LUENTA PAATTYI' -TAPAHTUMAA, OHITETTAVUUS SAILYY, ILMAN AANTA KORTIN SULKEUDUTTUA) + PELIKOODARI (TAPAHTUMA; TARKISTAA WEBIN); BUILD 21 (26.9.2026 klo 11.53)

Raportti omistajan-loydokset-b13-20260925.md.

## 160 TYYLI TARKENNETTU (NATIIVISEPPA symbolimallit-160 61ad4a47 + natiivi-ui/symbolit-160b, lokit/symbolit-160e/omistajalle/): DELFOI STYLOBAATTI + DOORILAISET PYLVAAT + THOLOS TERRAKOTTAKATOLLA + PARNASSOS + OLIIVIPUUT (1 382 KOLMIOTA), METEORA PYOREAT PILARIT + LUOSTARI (338), EI SINISTA, 2D-KUVAKKEET POIS, USVA JALKAPISTEESTA → FABLE: VIELA KAKSI TARKENNUSTA ENNEN JUNAA (DELFOIN VUORILAATTA POIS/MATALAKSI, METEORAN PILAREILLE KALLIOFASETIT JA LUOSTARI LAELLE), SITTEN BUILD 21 -JUNAAN ILMAN UUTTA KORTTIA; MUSTEJALKI MALLIN PAALLA = NATIIVI-UI:N ERILLINEN KORJAUS (26.9.2026 klo 11.55)

Kuva omistajalle tiedoksi.

## OMISTAJA 11.5x, 162 TARKENNUS (SITOVA): LUENNAN OHITA-KASKY ALOITTAA MYOS SAAPUMISANIMAATION — 'LUENTA PAATTYI' NOUSEE LOPPUMISESTA, OHITUKSESTA JA KORTIN SULKEMISESTA ILMAN AANTA; LINSSISEPPA TODENTAA KOLME POLKUA, PELIKOODARI TAPAHTUMA (MYOS WEB) (26.9.2026 klo 11.56)

Build 21.

## KARTTASEPPA: #3280 DELTA-POLTON KUIVAHARJOITUS VALMIS (9343f43c1, 4407/0, --kuiva: SUUNNITELMA, PALVELINKOPIO DRYRUN, DELTA-LISTA, VERTAILU) — OPPI: MERI-DELTA 25→26 OLISI ERONNUT TAYDESTA 26:STA 1 577 MAALAATALLA, KOSKA 24 791 GLO-30-RUUTUA SAAPUI POLTTOJEN VALISSA → LUETTELO KANTAA AINEISTOTIIVISTEEN, DELTA KIELTAYTYY JOS TIIVISTE EROAA (POIKKEUS --delta-aineisto-sama); 26→26 HARJOITUS 0 EROA, POHJA 26 KELPAA SEURAAVAN RESEPTIN LAHTEEKSI → FABLE: #3280 JUNAAN. #3321 LIPPUANKKURIT 138 MAATA (vektorit/lippuankkurit-2026-09-26.json) SIIRTO- JA NATIIVISEPALLE; #3315 PAIVITETTY LINSSISEPAN KENTILLA; SEURAAVAKSI Z10-KATTAVUUSLISTA (≤ 1 SIVU), EI POLTTOA PAIVALLA (26.9.2026 klo 12.01)

Julkaisijalle #3280, #3321, #3315, #3318.

## OMISTAJA 12.0x, 161 TARKENNUS (SITOVA): LIPPU ANIMOIDAAN PAREMMIN — KANKAASSA PIENI KIILTO JA VALON VAIHTELUT KANKAAN MUODOISSA (AALLON MUKAISET NORMAALIT, KEVYT SPEKULAARI AURINGON SUUNNASTA, VARJO LASKOKSISSA); JOS LIIAN RASKAS, LAPINAKYVANA VIDEONA (ESIRENDEROITY KANGASSIMULAATIO, ALPHA-LOOPPI, 30 fps) → NATIIVISEPPA: ENSIN VARJOSTINVERSIO (≤ 0,3 ms), MITTAUS, MUUTEN VIDEO; LYHYT VIDEO + KUVAPARI OMISTAJALLE; LINSSISEPPA AUTTAA VALAISTUKSESSA (26.9.2026 klo 12.01)

Build 21.

## OMISTAJA 12.0x: LIPPUVIDEO TODENNAKOISESTI HUONO 3D:N TAKIA (KAMERA KIERTAA JA KALLISTUU) → ENSISIJAINEN VARJOSTINLIPPU 3D-MESHINA (KARKIAALTO, NORMAALIT, KIILTO), VIDEO VAIN VIIMEISENA VARANA (26.9.2026 klo 12.02)

Natiivisepälle annettu.

## LEVYN LASKUN SYY (FABLE 12.0x): CoreSimulator/Devices 78 Gt, 19 LAITETTA (ISOIMMAT 12/9,8/8,7/8,3 Gt) — #3303:N JALKEEN JOKAINEN SIMULAATTORIPELI LATAA OFFLINE-SARJA 26:N DOCUMENTSIIN (~2 Gt/LAITE) + SIMULAATTORIN PRBPosterExtensionDataStore 4,4 Gt/LAITE; PURGE EI AUTA (OIKEAA LEVYKAYTTOA) → LAITETESTAAJA POISTAA YLI 24 h KAYTTAMATTOMAT NIMEAMATTOMAT LAITTEET JA ERASEAA OMANSA (EI TOISTEN NIMETTYJA, EI shutdown all); SIIRTOSEPPA + NATIIVISEPPA: OFFLINE-PAKETIN LATAUS SIMULAATTORISSA OLETUKSENA POIS (KEHITTAJAKOMENTO KYTKEE) BUILD 21; SISALTOKIRJURIN KONTEKSTI 70 % → LUOVUTUS + NOLLAUS BEL-PR:N JALKEEN (26.9.2026 klo 12.06)

Levy 84 Gt, swap 15,8 Gt klo 11.54.

## PELIKOODARI: 8l4 LIUSKA × NIMIO KORJATTU — PR #3319 JULKAISIJAN JONOON: JUURISYY VARTION AJOITUSKILPAILU (ESTEET LUETTIIN ENNEN KUIN SOVITTELU PIILOTTI LIUSKAN ALLE JAAVAT NIMIOT), VARTIO LUKEE UUDELLEEN KUNNES ASETTUU (≤ 3 s) JA OHITTAA NAKYMATTOMAN MUSTEEN; MYOS 8k LAPI → MOLEMMAT POIS TUNNETUISTA PUNAISISTA; MUSIIKKI 2+3 NATIIVI SIMULAATTORI PASS; ESILATAAJAN MITTARI HAARASSA esilataaja-mittari (307/307), SAVUKEAJO KYLMANA/LAMPIMANA MENOSSA (26.9.2026 klo 12.07)

Mainin viimeinen tunnettu punainen poistuu, kun #3319 on mainissa.

## SIMULAATTORISIIVOUS (LAITETESTAAJA): 19 LAITETTA — NIMETYT ROOLIEN LAITTEET 41,5 Gt JA LAITETESTAAJAN OMAT 19,3 Gt KAYTOSSA; POISTOEHDOKKAAT 503000D1 iPad Pro 11 (13,1 Gt, 25.9.) + 7 KAYNNISTAMATONTA OLETUSLAITETTA (0,02 Gt) = 13,3 Gt; xcrun simctl delete ESTYI LUOKITTIMESSA → FABLE EI KIERRA (LUPAPESU), KOMENTO ANNETTU OMISTAJALLE; ISOMPI SAASTO BUILD 21:N OFFLINE-LATAUS-POIS-SIMULAATTORISSA JA ROOLIEN OMIEN LAITTEIDEN ERASE PAIVAN PAATTEEKSI; LEVY 84 Gt (26.9.2026 klo 12.08)

Postivahti seuraa 80 Gt:n rajaa.

## 160 BUILD 21 -JUNASSA (NATIIVISEPPA symbolimallit-160 6ecdbbbf + natiivi-ui/symbolit-160b, KAANNOS 3656d7cb): PARNASSOS POIS, METEORAN PILAREISSA 7 FASETTIA, LUOSTARI LAELLA; KUVAPARI VIIVASTYY MUISTIPAINEEN TAKIA (SWAP 15,7/17,4 Gt: SESSIOIDEN NODE-PROSESSIT 5 × 1,2–1,7 Gt, PARITEETTISIMULAATTORI 1,7 Gt, PLAYWRIGHT) → POSTIVAHTI PYYTAA JOUTILAAT SIMULAATTORIT KIINNI OMILLA UDID:ILLA JA PLAYWRIGHT-AJOT PERAKKAIN. BUILD 21 -JUNA: 157-MASKI, 161 (KERROS + UI + ANKKURIT #3321), 160, MUSIIKKI 2+3, 155 0,85, REITIN VARI + KATKOVIIVA, NATIIVI-UI:N ERAT; PUUTTUU 162 JA LIPUN VARJOSTIN (26.9.2026 klo 12.09)

Käännös Laitetestaajalle kun 162 ja lipun varjostin ovat junassa.

## Z10-KATTAVUUS (KARTTASEPPA, docs PR #3322 MERGETTY, FABLE): KAUPUNGIT ±1° 28 167 LAATTAA 1,1 Gt ~55 min; FOKUSMAAT 14 = 10 661; MAAKUNTAMAAT 138 = 371 011 (14 Gt, ~12 h); KOKO MAA-ALA 541 012 → FABLE TILAA: Z10 POHJA 26:LLE KAUPUNGIT ±1° + FOKUSMAAT TANA YONA TAYSILLA YTIMILLA (ALKU ≥ 23.00, JULKAISIJAN KANSSA SOVITTU VUORO, EI PR-CI:TA POLTON AIKANA), VALVOTTU AJO, RAPORTTI AAMUKSI; MAAKUNTAMAAT MYOHEMMIN; DELTA EI KATA SYVASARJAA (Z0–Z8). #3321 SAI REPOPOLUN assets/data/lippu-lonlat.json; NATIIVISEPPA HYVAKSYI GRC-ANKKURIN (26.9.2026 klo 12.09)

Karttaseppä lepää iltaan asti.

## SISALTOKIRJURI NOLLASI KONTEKSTIN 70 %:SSA (LUOVUTUS viesti-sisaltokirjuri-luovutus-20260926-b.md + ALOITUSVIESTI MAINISSA; BEL/DNK/SVK/LVA/LTU KUVA-KENTAT VALMIINA HAAROISSA, JONOSSA #3318:N JALKEEN) → FABLE LAHETTI ALOITUSVIESTIN SAMAAN SESSIOON (id ENNALLAAN) (26.9.2026 klo 12.15)

Kontekstin nollaus -kaava: self-clear + Fablen aloitusviesti session id:llä.

## MAINISSA UUSI PUNAINEN savuke-nimiot-elavat.mjs (SISALTOKIRJURIN HAVAINTO 12.1x, TODENNAKOISESTI #3315:N ELAVIEN POLKUJEN MERGESTA) → KARTTASEPPA TUTKII JA KORJAA PR:NA; JULKAISIJA MERGEAA #3318:N (NLD KUVAT) JOS VAIN TAMA RIVI PUNAINEN; SISALTOKIRJURI JATKAA FIN/EST/SVN KUVA-KENTILLA (26.9.2026 klo 12.17)

Sisältökirjuri käynnistyi nollauksen jälkeen normaalisti.

## ESILATAAJAN MITTARI (PELIKOODARI esilataaja-mittari ff733a40, 307/307, JUNAAN): KYLMANA OSUMA 17 % (11/65) — ALOITUS/KAYNNISTYS/LENTO 0 %, KAUPUNKI 71 %, ODOTUS YHT. 16,4 s (MEDIAANI 188 ms); LAMPIMANA KAIKKI LEVYLTA, 'SAAPUMINEN 0 ms' PASS → FABLE: ESILATAUSPOLITIIKAN KOHDAT 2–3 TOTEUTETAAN BUILD 22:EEN (PELIKOODARI JONO + SISALTO, NATIIVISEPPA LAATAT Z7–Z10 + LENNON PINTA), TAVOITE KYLMANA OSUMA ≥ 80 % JA ODOTUS < 3 s; MAANOSA PUUTTUI 18 KAUPUNGILTA (MAAILMA-LAUTA, JERUSALEM, ST. HELENA) → EI SAAPUMISTUNNUSTA/MAANOSARAITAA — WEB PR #3323, NATIIVI JUNASSA eb50704f; 162 TYON ALLA (26.9.2026 klo 12.19)

Raportit proto-3d/lokit/esilataaja-mittari/.

## NATIIVI-UI: lippu-kiinnitys a3a40cd6 MERGE-PYYNNOSSA (KORJAA LIPPUTANKO-161:N FormatExceptionin KUN ANKKURIDATA PUUTTUU, KIINNITTAA KOHDEMAAN LIPUN KUVAMUISTIIN); UI-PARITEETIN TYOKALURIVIT 2/24/35 KORJATTU; RIVI 2 AITO KARTTAERO (NATIIVI NAYTTAA ALOITUSVALINNASSA KAIKKI KAUPUNKINIMET, WEB VAIN 4) → FABLE: WEB ON MALLI, NATIIVI NAYTTAA VAIN 4 VAIHTOEHDON NIMET (NATIIVISEPPA); 162:N KORTIN TILA LINSSISEPAN MERGE-PYYNNOSSA (26.9.2026 klo 12.22)

Build 21 jos pieni, muuten 22.

## PERUUTUS: iPad Pro 11 503000D1 ON NATIIVI-UI:N KAYTOSSA iPAD-PARITEETTIIN (JAETTU NATIIVI-UI/LAITETESTAAJA) → EI POISTOEHDOKAS, OMISTAJALLE ANNETTU POISTOKOMENTO MITATON; POSTIVAHTI 12.25: SWAP 12,7 Gt, LEVY 88 Gt, EI RINNAKKAISIA SAVUKKEITA — MUISTIPAINE HELPOTTAA (26.9.2026 klo 12.25)

Simulaattoripoistoja ei tarvita nyt.

## savuke-nimiot-elavat PUNAINEN = AIKAMITTAUS KUORMASSA (65 SAVUKETTA RINNAKKAIN: 390 px 5. LADONTA 12,10 ms vs RAJA 12 ms), EI #3315:N SYYTA; RIVI 273 ON vaadi EIKA vaadiAika (OMISTAJAN 20.9. LINJAUS: AIKAVARTIOT EIVAT KUULU PR-PORTTIIN) → KARTTASEPPA VAIHTAA vaadiAika-MUOTOON PR:NA JUNAAN, RIVI PELIKOODARILLE (26.9.2026 klo 12.26)

Karttaseppä lepää sen jälkeen iltaan (Z10 klo 23).

## 162 VALMIS (PELIKOODARI saapumisluenta-162 23f262bf, 311/311, MERGE-PYYNTO NATIIVISEPALLE): SaapumisluentaKesken LASKEE KUN LUENTA LOPPUU, OHITETAAN, KORTTI SULJETAAN, PELAAJA LAHTEE, AANI POIS TAI LUENTAA EI OLE; LINSSISEPAN ElavaKartta ODOTTAA SITA (linssiseppa/saapuminen-luennan-jalkeen); WEBISSA EI VIKAA (ELAVA KARTTA VAIN NATIIVISSA); #3319 (8l4) MAINISSA → MAIN VIHREA; ESILATAAJA-5 KAYNNISSA (Tehtava-API b80ec5a6, HUTELISTA) (26.9.2026 klo 12.27)

Build 21 -junasta puuttuu enää Linssisepän 162-haara ja lipun varjostin.

## 161 LIPPU VARJOSTINVERSIONA VALMIS (NATIIVISEPPA): KANGAS 24×12-VERKKO, KARKIVARJOSTIN TAIVUTTAA 144:N AALLOILLA, VALO KANKAAN NORMAALEISTA (LASKOSTEN VARJO ±20 %, KIILTO AURINGOSTA, REUNAHOHDE), LIPPU 28° VIISTOSSA; MITTAUS iPAD RELEASE 3 min: KERROSKEHYS 3,1 ms (RT-LIPPU 5,3 ms), LEPO 0, LIPUN OSUUS < 0,3 ms → VIDEOTA EI TARVITA; KUVAPARI + 3 s VIDEO lokit/lippu3d-ipad-b/omistajalle/ → OMISTAJALLE; JUNAAN. KARTTASEPPA: #3326 (vaadiAika) JUNASSA, LEPO, Z10 KLO 23. BUILD 21 -JUNASTA PUUTTUU ENAA LINSSISEPAN 162-OSUUS (26.9.2026 klo 12.33)

Fable: lippu näyttää hyvältä, ei korttia — omistaja arvioi build 21:stä.

## ESILATAAJA ERA 5 KOHTA 2 (PELIKOODARI esilataaja-5 6ced5c90, 309/309): KAYNNISTYKSESSA ESILADATAAN 44 LAISKAA KOKOELMAA → KYLMANA SISALLON OSUMA 15 → 62 %, ODOTUS 20,6 → 11,6 s (LENTO 100 %, ALOITUS 69 %, SATELLIITTILINSSIN MUSTA 5,3 → 1,8 s); JAANNOS LAATAT 10,4 s (ALOITUSVERHO 5,4 s PALLON LAATAT, ALOITUSLENNON MUSTA 5,0 s) = NATIIVISEPAN BUILD 22 -OSA; KAYNNISTYKSEN SISALTO 1,5 s → FABLE PAATTI: KYLMA KAYNNISTYS KAYTTAA SISALTOTILANNEKUVAA HETI 11 KAYNNISTYSKOKOELMALLE JA PAIVITTAA TAUSTALLA (STALE-WHILE-REVALIDATE, POLITIIKAN KOHTA 2), TUORE KAYTTOON JOUTILAANA/SEURAAVASSA KAYNNISTYKSESSA, RAJA ≤ 2 VERSIOTA VANHA, MITTARIIN 'VANHAA SISALTOA KAYTETTY' (26.9.2026 klo 12.41)

Build 22.

## NATIIVISEPPA KONTEKSTI 71 % → LUOVUTUS viesti-natiiviseppa-luovutus-20260926-h.md + ALOITUSVIESTI (selvittaja-3d-luovutus 4940859ca), NOLLAUS NYT (JUNA 19e5415e ODOTTAA LINSSISEPAN 162:TA, BUILD 22 -JONO LUOVUTUKSESSA); FABLE LAHETTAA ALOITUSVIESTIN SAMAAN SESSIOON (26.9.2026 klo 12.42)

Nollauskaava.

## VANHA SISALTO TOTEUTETTU (PELIKOODARI esilataaja-5 e0fddaee, 309/309): KAYNNISTYKSEN 11 KOKOELMAA TILANNEKUVASTA, TUORE TAUSTALLA, MITTARIIN vanhaaKaytetty → FABLE TARKENSI RAJAN AJAKSI: LEVYN VIIMEISIN LADATTU TILANNEKUVA AINA HETI (EI IKARAJAA), BUILDIN TILANNEKUVA HETI JOS ≤ 14 vrk VANHA (VERSIORAJA 2 TAYTTYISI TUNNEISSA, v144 → v167 TANAAN), MITTARIIN IKA; BUILDIN TILANNEKUVAN LAAJENNUS 5 → KAIKKI KAYNNISTYSTIEDOSTOT (+12,3 Mt, MAAKUNTARAJAT 8,4 Mt) HYVAKSYTTY NATIIVISEPAN KOKOKUITTAUKSELLA, SIIRTOSEPPA LISAA. NATIIVI-UI: iPAD-UI-PARITEETTI b21-ui-ipad — 4 AITOA ASETTELUERAA (16 VISA, 17/26 NOSTOKORTTI, 9/36 MAALEHDEN ETUSIVU, 21c SAHKE), ENSIMMAINEN ipad-visa f3dec87a KAANTYY (26.9.2026 klo 12.44)

Build 22.

## NATIIVI-UI: iPAD-PARITEETIN 3 ERAA MERGE-PYYNNOSSA (ipad-visa f3dec87a, ipad-maalehti 8a88ef60, ipad-sahke f15b238c; KUVAPARIT lokit/pariteetti-ajo/b21-ui-ipad-2/), RIVI 17 HYVAKSYTTY POIKKEAMA (130/135); UI-PARITEETTI iPHONE + iPAD KAYTY → SEURAAVAKSI VAAKA-iPHONE JA iPAD 13 (FABLE OK). PELIKOODARI: AIKARAJA TOTEUTETTU (LEVYN VERSIO AINA, TILANNEKUVA ≤ 14 vrk julkaistu-AJASTA, MITTARIIN LAHDE + IKA) (26.9.2026 klo 12.53)

Yksi simulaattori kerrallaan.

## JULKAISIJA 12.5x: MAINISSA #3280 (DELTA-POLTTO + --kuiva), #3315 (ELAVIEN POLUT), #3318 (NLD KUVAT, v2268, 4398/0), #3319 (8l4), #3321 (LIPPUANKKURIT), #3316 (MAAMASKI), #3317 (PAKETTI 1.50), #3313 v2267, #3314 v2266; JONOSSA #3320, #3324, #3326 (nimiot-elavat); #3325 PIDOSSA YOPOLTON LOPPUUN; Z10-POLTTO KUITATTU 23.00–01.30 (26.9.2026 klo 13.02)

Main vihreä.

## NATIIVI-UI: UI-PARITEETTI AJETTU 4 KOOLLA (iPHONE PYSTY/VAAKA, iPAD 11, iPAD 13; lokit/pariteetti-ajo/b2*-ui*/), AIDOT EROT KORJAAVAT ipad-visa/-maalehti/-sahke (RAJA > 560 pt, MYOS VAAKA-iPHONE), TYOKALU #3324 MAINISSA; NOSTOKORTIN LEVEYS iPAD 13:LLA LAHES KOKO RUUTU (130/135 KUVAN KORKEUDESTA) → FABLE: KATTO 620 pt iPADILLA JA VAAKA-iPHONELLA (WEBIN ~34 rem), 130/135 PATEE KATON ALLA; KUVAPARI iPAD 13 (26.9.2026 klo 13.33)

Build 21.

## NATIIVI-UI: NOSTOKORTIN KATTO 620 pt iPADILLA HAARASSA ipad-nostokortti 51338a36 (KAANNOS c04438db, KAIKKI 4 iPAD-ERAA); iPAD 13 EROT WEBIIN: 17 NOSTOKORTTI 332 → 64 px, 16 VISA 186 → 21, 9 MAALEHTI 871 → 292, 26 436 → 238; KUVAPARIT lokit/pariteetti-ajo/b21-ui-ipad13-2/ → OMISTAJALLE TIEDOKSI; NATIIVISEPAN MERGE-PYYNNOSSA BUILD 21 (26.9.2026 klo 13.46)

Fable katsoi: vastaa webin leveyttä.

## BUILD 22 LAATTAESILATAUS ERA 1 ALOITUS (NATIIVISEPPA laatta-esilataus 8a818853, KAANNOS 5db2322c): JUURISYY — AVAUSNAKYMA (LONTOO 450 km) TARVITSEE ~460 VERKKOLAATTAA, CESIUM ETENEE TASO KERRALLAAN → KYLMANA 7,3–8,1 s, VERHO LAHTI PALLO 46–57 %; KORJAUS: LAHIALUE ESILADATAAN ALOITUSNAYTOSSA (Esilataaja.Tehtava SeuraavaRuutu), KATSEEN KIILA LENNON ALUSSA → KYLMANA PALLO 83–85 %, AVAUS 5,25 s, ALOITUSVERHO 5,4 → 3,7 s; SAAPUMINEN PASS 0 ms, LAATTAOSUMA 13 → 20 %; VIRTUAALIKAMERA HYLATTY; JUNAAN BUILD 21:N JALKEEN; SEURAAVAKSI KOHDEKAUPUNKIEN Z7–Z10 (26.9.2026 klo 13.50)

Raportti proto-3d/lokit/laatta-esilataus/RAPORTTI.md.

## NATIIVI-UI: UI-PARITEETIN UUSINTA JUNALLA 38887fd3 (KAANNOS fecf345e) — PYSTY-iPHONE EI REGRESSIOITA (18 232 → 117 px, 35 PUUTTUU → 50), VAAKA-iPHONE 9 175 → 52, 16 148 → 26, 21c 136 → 31; JALJELLA HYVAKSYTYT POIKKEAMAT JA TYOKALUN AJOITUS; UI-PARITEETTIKIERROS VALMIS → SEURAAVAKSI MUSTEJALKI 3D-MALLIN PAALLA JA RAAMATUN NATIIVI-UI-LINJAUSTEN TODENNUSLISTA. LINSSISEPPA: 162 EI VIELA PASS (MATKAKOMENNOT EIVAT PAASSEET UUTEEN MAAHAN) → DETERMINISTINEN TESTI, MERGE-PYYNTO ~20–30 min (26.9.2026 klo 14.16)

Build 21 odottaa 162:ta.

## 162 PASS KOLMELLA POLULLA (LINSSISEPPA saapuminen-luennan-jalkeen 64f7625d, SIS. PELIKOODARIN JA NATIIVI-UI:N OSAT, KOEMERGE PUHDAS): A LUENTO LOPPUU → ANIMAATIO 14,3 s KOHDALLA, B OHITA → 0,6 s, C AANI POIS + KORTTI → ALKU VASTA ~11 s KORTIN SULKEMISEN JALKEEN (SUMENNUS TAI MERKINTA PITAA KARTTAA VARATTUNA) → FABLE: C LYHENNETAAN ≤ 1 s:IIN (30 min → BUILD 21, MUUTEN 22); NATIIVISEPPA MERGEAA 162:N JA LEIKKAA BUILD 21:N VIIMEISTAAN 30 min:N PAASTA → LAITETESTAAJAN KIERROS (26.9.2026 klo 14.19)

Kuvat lokit/linssiseppa-162-20260926/.

## BUILD 21 KOOSSA (NATIIVISEPPA): juna/b13 a0852275 (162 + iPAD-PARITEETTI), KAANNOS 5556ce91 ASENNETTU LAITETESTAAJALLE 14.21 → FABLE KUTSUI KIERROKSEN (162 KOLME POLKUA, 161 LIPPU, 160, 155 0,85, KATKOVIIVA + KYTKIN, 157, MUSIIKKI 2+3, iPAD-ERAT, REGRESSIOT) → PASS → MASTER-MERGE → TF 1.0.21 (26.9.2026 klo 14.22)

Linssisepän C-polun lyhennys tulee perässä (build 21 jos ehtii ennen mergeä, muuten 22).

## NATIIVI-UI: MUSTEJALKI 3D-MALLIN ALTA (jalki-mallin-alta 46d394f2) MERGE-PYYNNOSSA; RAAMATUN NATIIVI-UI-LINJAUKSET TODENNETTU JUNALLA (YLAPALKKI, ☰-VALIKKO, LOGO LAUKUSSA, SUMENNUS KUVIEN AIKANA, LINSSIEN YLAPALKKI ✓); PUUTTUU: ☰-VALIKON NIMIEN KATKEAMINEN iPHONELLA (SEURAAVA ERA) JA VIERITYS-PIILOTUKSEN LAITETODENNUS (LAITETESTAAJAN RESEPTIIN) (26.9.2026 klo 14.25)

Lipputanko näkyy jo Kreikan itäreunassa junassa.

## NATIIVI-UI KONTEKSTI 70 % → LUOVUTUS viesti-natiivi-ui-luovutus-20260926-s.md (f03559d8d, natiivi-ui-luovutus-m), ALOITUSVIESTI PAIVITETTY, NOLLAUS (FABLE LAHETTAA ALOITUSVIESTIN SAMAAN SESSIOON). LAITETESTAAJA: 5556ce91 EI LOPULLINEN (LINSSISEPAN C-POLKU ~14.52), ESITESTI: 157 TAYTTO SEURAA RANTAVIIVAA, C/D/E/G PUHTAITA; 161 LIPUN PAIKKA (TRAAKIA 41,08/25,95) LISATTY RESEPTIIN (26.9.2026 klo 14.26)

Nollauskaava.

## 162 C-VIIVEEN SYY (LINSSISEPPA): LUENNAN KUVAPAKKA JAA NAKYVIIN 6 s HILJAISUUDEN JALKEEN (LoppuMs) JA PITAA KARTAN SUMEANA — SELITTAA MYOS A:N 14,3 s; KORJAUS: PAKKA LENTAA KORTTIIN HETI KUN PUHE JA KORTIT OVAT OHI, ANIMAATIO 0,2 s:N PAASTA (LINSSISEPPA b1f4328b VALMIS, NATIIVI-UI:LTA Hiljeni(0)-KYTKENTA ENNEN NOLLAUSTA) (26.9.2026 klo 14.28)

Ehtiikö build 21:een: Linssiseppä ilmoittaa Natiivisepälle suoraan.

## NATIIVI-UI: Hiljeni(0)-KYTKENTA VALMIS (kuvapakka-lahtee 2d850f73, FF b1f4328b:N PAALLE, UNITY 0), SHA LINSSISEPALLE (MERGE + C-POLKU HANELLA); NATIIVI-UI NOLLASI → FABLE LAHETTI ALOITUSVIESTIN SAMAAN SESSIOON (HUOM. JONOTETUT VANHAT VIESTIT VOIVAT SAAPUA NOLLAUKSEN JALKEEN — ALOITUSVIESTISSA OHJE OLLA TOISTAMATTA) (26.9.2026 klo 14.29)

Oppi nollauskaavaan: älä jätä viestejä jonoon nollauksen ajaksi.

## BUILD 21 LEIKATTU (NATIIVISEPPA): KAANNOS 4b52b8f0 = MASTER 1a57cc39 + juna/b13 64887a7a, ASENNETTU LAITETESTAAJALLE 14.32 LOPULLISEEN KIERROKSEEN; MUKANA 162 JATKOKORJAUKSINEEN (2d850f73 = LINSSISEPAN b1f4328b + NATIIVI-UI:N Hiljeni(0)), 161 VARJOSTINLIPPU + ANKKURIT, 160, 155 0,85, KATKOVIIVA + KYTKIN, 157-MASKI, MUSIIKKI 2+3, iPAD-ERAT, kuvat-kiinteat, jalki-mallin-alta, MAANOSAKORJAUS; LINSSISEPPA TODENTAA C-POLUN SAMALLA KAANNOKSELLA; PASS → MASTER-MERGE → TF 1.0.21 (26.9.2026 klo 14.32)

Laitetestaajan kierros kutsuttu 14.22.

## OMISTAJA 14.4x: Z10-POLTON VOI ALOITTAA HETI; OMISTAJA EI OLE KONEELLA 26.–27.9. → FABLE: KARTTASEPPA ALOITTAA KAUPUNGIT ±1° + FOKUSMAAT NYT PUOLILLA YTIMILLA (LAITETESTAAJAN KIERROS JA TF 1.0.21 KESKEN), TAYDET YTIMET TF:N JALKEEN; SEN JALKEEN MAAKUNTAMAIDEN Z10 (371 011 LAATTAA, ~12 h) TAYSILLA YTIMILLA YON YLI; JULKAISIJA: TF 1.0.21 HETI KUN SHA TULEE, PR-CI:T POLTON TAUOISSA; POSTIVAHTI: EI MITTAUSIKKUNAA, KORTTIMUISTUTUS 2 h:N VALEIN, LAMPO JA LEVY SEURANTAAN (26.9.2026 klo 14.36)

Avoimet kysymykset omistajalle (ISS-linssi, lokikansion siivous) odottavat hänen paluutaan.

## OMISTAJA 14.4x (KORTTI, SITOVA): LOKIKANSIOIDEN SIIVOUS — FABLE SAA POISTAA ITSE, JA JATKOSSA AUTOMAATTISESTI: POSTIVAHTI POISTAA KIERROKSELLAAN proto-3d/lokit-KANSION YLI 48 h VANHAT ALIKANSIOT JA YLI 24 h VANHAT .app-KOPIOT (KAANNOSPALVELU); KORVAA 25.9. SAANNON 'POISTOT OMISTAJALLE SKRIPTILLA'; RAAMATTUUN PR:NA; NYT POISTETTU YLI 24 h VANHAT KANSIOT (50 kpl, 6,5 Gt) JA YLI 12 h VANHAT .app-KOPIOT (26.9.2026 klo 14.37)

Ehto: omistajalle näytetyt kuvat on toimitettu viestissä, raportit reposta; tämän päivän kansiot jäävät roolien käyttöön.

## LOKISIIVOUKSEN JAKO TARKENNETTU: POSTIVAHTI EI AJA rm-POISTOJA (OMA TURVASAANTO) → POSTIVAHTI LISTAA KANDIDAATIT (> 48 h LOKIT-ALIKANSIOT, > 24 h .app-KOPIOT, Gt) TILATAULUUN JA RIVINA FABLELLE KERRAN VUOROKAUDESSA TAI KUN > 5 Gt; FABLE POISTAA OMISTAJAN 14.4x LUVALLA (26.9.2026 klo 14.38)

Kertasiivous 14.37: levy 81 → 90 Gt.

## OMISTAJA 14.4x: ISS-LINSSIN TARKENNUS — VAIN MAAPALLO NYKYISELLA TOPOGRAFIAKARTALLA + EFEKTIT (PILVET YM.), ISS:N VAUHTI JA RATA TODELLISET (MISSA ISS JUURI NYT), LISAKSI KAUPUNKIEN VALOT JA OIKEA AURINGON VALON SUUNTA, VAPAAT KADET LISAIDEOILLE → FABLE: LINSSISEPPA TEKEE YHDEN SIVUN SUUNNITELMAN (TLE/SGP4, KAMERA, EFEKTIT, BUDJETTI, OFFLINE), EI KOODIA; TOTEUTUS BUILD 22:N JA MYLLYJEN JALKEEN; OMISTAJA KUITTAA SUUNNITELMAN PALATTUAAN (POIKKEUS LINSSIKIELTOON OMISTAJAN OMA TILAUS) (26.9.2026 klo 14.39)

Black Marble Z0–Z6 on jo ämpärissä (Karttaseppä 25.9.).

## BUILD 21 -KIERROS (LAITETESTAAJA 943447211, 4b52b8f0): PASS 157 RANTAVIIVATAYTTO, 161 LIPPUTANKO (ELAVA KERROS -TILA: LIPPU 30 fps KARTAN LEVOSTA RIIPPUMATTA, PALLO LEPO -TEKSTIIN OMA RIVI), C, D; FAIL MUSIIKKI VAIHE 2: 'aani aihe ratkaisu/epaonnistuminen' EI KUULU aani mittaa -TULOKSESSA → PELIKOODARI TARKISTAA (TESTIPOLKU VAI VIKA), BUILD 1.0.21 ODOTTAA; 155/156/158/160/162/VAIHE 3/iPAD/KYTKIN TESTAAMATTA (AIKA); simctl-ASENNUSREKISTERI DESYNKKASI RINNAKKAISASENNUKSESSA (EI BUILD-VIKA) (26.9.2026 klo 14.40)

Tekijät ovat todentaneet testaamattomat kohdat itse.

## BUILD 21 MUSIIKKI-FAIL OLI TESTIPOLKU (PELIKOODARI): RATKAISU/EPAONNISTUMINEN EIVAT KATKAISE SOIVAA AIHETTA (KUTEN WEB), LAITETESTAAJA AJOI ENSIN LOPPU-AIHEEN (69 s); TODENNETTU SIMULAATTORISSA (lokit/musiikki-v23/todennus.log) → FABLE: BUILD 1.0.21 — NATIIVISEPPA MERGEAA 64887a7a MASTERIIN, JULKAISIJA AJAA TF; LAITETESTAAJAN TAYDENNYSKIERROS TF:LLA (RESEPTIIN: TEHOSTEET TUOREESSA ISTUNNOSSA + aani mittaa 2) (26.9.2026 klo 14.41)

Sama ilmiö kuin build 20:n E-kohdassa.

## 162 KORJATTU JA TODENNETTU BUILD 21:N KOODILLA (LINSSISEPPA, 4b52b8f0): AANI POIS + KORTTI → ANIMAATIO ≤ 1 s, LUENTO → 0,2 s, OHITA → 0,6 s, 0 POIKKEUSTA; ISS-LINSSIN SUUNNITELMA VALMIS (docs/raportit/iss-linssi-suunnitelma-20260926.md): CELESTRAK TLE ACTIONSISTA AMPARIIN 6 h VALEIN + BUILDIIN, SGP4 C#, MEEUS-AURINKO, KOLME KAMERAA (KAUKO/SEURANTA/CUPOLA), TERMINAATTORI + BLACK MARBLE -VALOT + ISS MAAN VARJOSSA, PILVIKUORI, SEURAAVA YLILENTO, OFFLINE-PORRASTUS TLE:N IAN MUKAAN, BUDJETTI ≤ 1,5 ms, RATA KYNANJALKENA, 1873-TYYLI KORTEISSA → OMISTAJAN KORTTI (26.9.2026 klo 14.42)

Linssiseppä siirtyy myllyihin kun elävä kerros on valmis.

## OMISTAJA 14.4x (KORTTI, SITOVA): ISS-LINSSIN SUUNNITELMA HYVAKSYTTY SELLAISENAAN → TOTEUTUSJONOON BUILD 22:N JA MYLLYJEN JALKEEN (LINSSISEPPA: SGP4 + KAUKONAKYMA → TERMINAATTORI + VALOT (NATIIVISEPPA) → SEURANTA + CUPOLA → YLILENTO; SIIRTOSEPPA TLE-ACTIONS; NATIIVI-UI KORTTI); OMISTAJAN POIKKEUS LINSSIKIELTOON OMALLA TILAUKSELLA (26.9.2026 klo 14.43)

Vain natiivi.

## OMISTAJA 14.5x, ISS-LINSSIN LISAYS (SITOVA): ETUALALLE REKVISIITTAA — LASIAUKKO (CUPOLA-IKKUNA KEHYKSINEEN), JONKA LAPI MAAPALLO NAKYY, TEKSTUURIT KUVAPUTKELTA (TILAUS CODEX-POSTIIN SISALTOKIRJURIN KAUTTA); ISS:N LENTOKORKEUS ~420 km HUOMIOIDAAN → REALISTINEN NAKYMA (HORISONTTI ~2 300 km, KAAREVUUS, ILMAKEHAN KAARI, KENTTAKULMA LASIN MUKAAN) → LINSSISEPPA PAIVITTAA SUUNNITELMAN (26.9.2026 klo 14.43)

Ikkuna-osio + Kuvaputken tilaus.

## BUILD 21 = PROTO-MASTER 8d4a48fd (MERGE juna/b13 64887a7a, PUU d1f9954e = KAANNOS 4b52b8f0), SHA JULKAISIJALLE TF 1.0.21; VIENNIN JALKEEN BUILD 22 -JUNA AUKI: ENSIMMAISENA LAATTAESILATAUS ERA 1 (laatta-esilataus + esilataaja-5) (26.9.2026 klo 14.44)

Odotetaan TF-ajon tulosta.

## NATIIVI-UI 14.4x: ☰-NAPIT NIMENSA LEVYISIKSI (valikkonapit 79adce1b, KAIKKI 6 NIMEA KOKONAAN) MERGE-PYYNNOSSA BUILD 22; RESEPTIRIVI YLAPALKIN VIERITYSPIILOTUKSESTA LAITETESTAAJALLE (dea2c4461); jalki-mallin-alta JUNASSA; LIPPUANKKURIT PAKETISSA v169 (kartta/lippu_lonlat.json) — FRA/DEU/ITA/FIN TANKO ANKKURISSA JA NAKYVISSA (26.9.2026 klo 14.44)

Natiivi-UI kirjoittaa luovutuksen ja odottaa 1.0.21-löydöksiä.

## ISS-SUUNNITELMA PAIVITETTY (LINSSISEPPA ac3eded9b): IKKUNATILA SGP4-KORKEUDESSA ~420 km, HORISONTTI 2 350 km JA 20,3° ALAPUOLELLA, MAA TAYTTAA 139° NAKOKENTASTA, ILMAKEHAN KAARI 100 km, KENTTAKULMA ~80° (CUPOLAN 80 cm KESKILASI), KAMERA 55° ALAS — KOKO PALLO EI NAY; ETUALALLA CUPOLA-KEHYS + HEIJASTUS OMANA KERROKSENA; KUVAPUTKEN TILAUS (3 PNG × 2 KOKOA, NASA PD -VIITTEET) SISALTOKIRJURILLE CODEX-POSTIIN; MYLLYT KOKEILU 1 KOODATTU (linssiseppa/myllyt ad003265), SIMULAATTORIAJO KAYNNISSA. LAITETESTAAJA 1cd2a162a: BUILD 21 EI YHTAAN VAHVISTETTUA FAILIA (MUSIIKKI 2/3 JA 162 PASS OIKEALLA PELIKULULLA) (26.9.2026 klo 14.48)

Testaamattomat kohdat TF 1.0.21:n täydennyskierrokselle.

## BUILD 21 TESTFLIGHTISSA 14.51: 1.0.21 (AJO 36239662370 success, CFBundleVersion 202609261142, PROTO 8d4a48fd, LASKURI 21, ASC VALID) → PUSH OMISTAJALLE; SISALTO: 155 MERKIT 0,85, 156/157/158, 160 PROTOTYYPPI (DELFOI, METEORA), 161 VARJOSTINLIPPU MAAN ITAREUNASSA + ANKKURIT (v169), 162 SAAPUMISANIMAATIO LUENNAN JALKEEN, KATKOVIIVAREITTI + KYTKIN, MUSIIKKI VAIHEET 2+3, iPAD-ASETTELUT, MAANOSAKORJAUS, kuvat-kiinteat, jalki-mallin-alta; KARTTASEPPA SAI TAYDET YTIMET Z10:EEN, MAC-CI:N POLTTOVAHTI PAALLA (04-TF JA 05.30-YOPORTTI PERUUNTUVAT) (26.9.2026 klo 14.52)

Push lähetetty 14.5x.

## POSTIVAHTI 14.55 HALYTYS: Z10-POLTON ALETTUA SWAP 12 → 20,5 Gt JA LEVY 91 → 81 Gt 12 min:SSA (pyramidi-poltto/ 13 Gt KASVAA) → FABLE: KARTTASEPPA PITAA AJOKANSION ≤ 20 Gt (SHARDIT AMPARIIN JA POIS), YTIMET 16 → 10 JOS LEVY < 78 TAI SWAP > 24 Gt, MAAKUNTAMAIDEN Z10 VASTA SIIVOUKSEN JALKEEN; POSTIVAHTI 5 min VALEIN, LEVY < 75 Gt → 'KESKEYTA POLTTO'; KUVAPUTKEN TILAUS ISS CUPOLA-KEHYS POSTISSA (af811bdc3) (26.9.2026 klo 14.59)

Build 22 -juna 8348ef62 auki (laattaesilataus erä 1 + valikkonapit).

## KARTTASEPPA 14.59: YTIMET 16 → 10 (SWAP 20,2 Gt), --siivoa POISTAA SHARDIN KANSION HETI VIENNIN JALKEEN (AJOKANSIO 0,2 Gt); pyramidi-poltton 13 Gt:N KASVU OLI VANHOJA KANSIOITA (ajo-20260926 8,7 Gt, ajo-20260924-e28-syva 3,6 Gt) → SIIRTO NAS:IIN JA POISTO LAHTEESTA; MAAKUNTA-Z10 VASTA KUN ENSIMMAINEN POLTTO AMPARISSA JA NAS-SIIRTO VALMIS. LAITETESTAAJA TF 1.0.21 TAYDENNYS 12d678c30: MAANOSAKORJAUS PASS, 160/158 DELFOI TOIMII; iPAD-VUORO POLTON JALKEEN (26.9.2026 klo 15.00)

Postivahti seuraa 5 min välein.

## Z10-POLTTO KESKEYTETTY 15.10 (KARTTASEPAN VAHTI: SWAP 31,8 Gt, LEVY 70 Gt) — SYY: SAMAAN AIKAAN TOISEN ROOLIN XCODE-KAANNOS (32 clang); PYSAYTYKSEN JALKEEN SWAP 20,5 Gt, LEVY 81 Gt; 8 SHARDIA AMPARISSA; JATKO 6 YTIMELLA KUN clang ON LOPPUNUT (ODOTUSVAHTI), NAS-SIIRTO KAYNNISSA → FABLE: POLTON AJAKSI KAANNOKSET ERIIN (YKSI XCODE/UNITY-KAANNOS KERRALLAAN, VAIN TODENNETTAVAA, ILMOITUS KARTTASEPALLE ENNEN), MAAKUNTA-Z10 YOLLA ≥ 23.00 TAYSILLA YTIMILLA (26.9.2026 klo 15.12)

Natiiviseppä välittää säännön Natiivi-UI:lle ja Linssisepälle.

## ELAVAT ELEMENTIT KOKEILU 1 VALMIS (LINSSISEPPA linssiseppa/myllyt 383b6d04, MERGE-PYYNTO BUILD 22): ZAANDAMIN 3 MYLLYA (SAGE-RUNKO, TERRAKOTTALAKKI, RISTIKKOSIIVET), SIIVET 7–9 s ERI TAHDISSA, POP-UP-ASENTO NAKYY MYOS YLHAALTA, ELAVA KERROS 30 fps NAKYVISSA / 0 KUN EI; HETKIEN JA REITIN SIIRTO ELAVAKERROKSELLE MUKANA; KUVAPARI + VIDEO lokit/linssiseppa-myllyt-20260926/omistajalle/ → OMISTAJAN KORTTI; CUPOLA-KUVAT CODEXILTA LAADUKKAAT (KEHYS ~40 % RUUDUSTA) (26.9.2026 klo 15.22)

Seuraava kokeilu Kööpenhaminan karuselli omistajan hyväksynnän jälkeen.

## OMISTAJA 15.2x (KORTTI): ELAVAT ELEMENTIT KOKEILU 1 (AMSTERDAMIN MYLLYT) HYVAKSYTTY SELLAISENAAN → BUILD 22 -JUNAAN; LINSSISEPPA JATKAA KOKEILUUN 2 (KOOPENHAMINAN KARUSELLI) (26.9.2026 klo 15.25)

Kuvapari + video + kehysmittaus jokaisesta ennen seuraavaa.

## OMISTAJA 15.3x (BUILD 21, ALANKOMAAT) LOYDOS 163: PALLO JAA VIELAKIN HELPOSTI PIIRTYMATTA — MAAKUNTANAKYMASSA POHJAN LAATAT PUUTTUVAT (TASAINEN PERGAMENTTI), VAIN VEKTORIT PIIRTYVAT; TOISTUVA → NATIIVISEPPA JUURISYY (LAATAT EIVAT SAAVU VAI PIIRTO EI HERAA LAATTOJEN SAAPUESSA LEPOPIIRROSSA) + PELIKOODARI (ESILATAAJA/MITTARI), BUILD 22 ENSIMMAISENA; LOYDOS 164: BRYSSELI-NIMIO LIMITTYY MAAN OTSIKKORIVIN PAALLE (NATIIVI-UI) (26.9.2026 klo 15.27)

Kuva docs/raportit/kaappaukset/omistaja-20260926/loydos163-pallo-ei-piirry-alankomaat.png.

## OMISTAJA 15.3x LOYDOS 163b: KOHDEMAAN (NLD) OMA KARTTA PUUTTUU KOKONAAN, YMPAROIVAT MAAT PIIRTYVAT RELIEFEINEEN → VIKA KOHDEMAAN OMASSA LAATTAKERROKSESSA (OFFLINE-SARJA 26 / KERMAHUNTU / KOROSTUS), EI KOKO PALLOSSA — NATIIVISEPPA + SIIRTOSEPPA (OFFLINE-SARJA 26 NLD:N KATTAVUUS/OSOITE); LOYDOS 165: MAAKUNTAVALITSIN TOIMII OUDOSTI (GELDERLAND KOROSTETTU VAIKKA PELAAJA AMSTERDAMISSA) → NATIIVI-UI TUTKII; LIPPU NLD:N ITAREUNASSA NAKYY OIKEIN (26.9.2026 klo 15.28)

Kuva docs/raportit/kaappaukset/omistaja-20260926/loydos163b-kohdemaan-kartta-puuttuu.png.
