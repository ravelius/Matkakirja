...
| Opus 17 (nähtävyysjutut) | session_01EXSD5hhjxxTZA2GqXn1tdG (omistajan tilaus 15.8.: omat artikkelit v693:n uusille kohteille — Panthéon, Luxembourgin puisto, Kallion kirkko, Linnanmäki; laatu ensin; vain nahtavyysjutut.js, EI maakartat.js:ää; haara claude/opus17-nahtavyysjutut; ei vuoron päätöstä ennen PR:ää; raportointi viesti-fable.md:llä, EI trigger-työkaluja) | 15.8.2026 |
| Opus 16 (etukäteispuskuri) | session_011GRm3rKWYQwEyaTVyjutam (omistajan tilaus 15.8.: molempien lehtien etusivut + lukijaäänen 1. pala puskuriin saavuttaessa, seuraava sivu valmiiksi lehteä luettaessa; periaate kirjattu CONTRIBUTING.md:hen (alk. periaatteet.md); haara claude/opus16-esipuskuri; EI kosketa Opus 15:n karttafunktioihin; ei vuoron päätöstä ennen PR:ää; raportointi viesti-fable.md:llä, EI trigger-työkaluja) | 15.8.2026 |
