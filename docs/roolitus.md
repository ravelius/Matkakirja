...
| Opus 24 (äänet R2:een) | session_01E5Y9qMZyQwULAVUvzHy6vB — VALMIS 16.8.2026 (paketti A1, julkaistu v774): esilataus 242→62 Mt, 9/9-savuke, ehjä varareitti; raportissa sitova käyttöönottojärjestys ja rajaushavainnot. | 16.8.2026 |
| Opus 25 (opas 2.0) | session_01SuUo9cn1n2qQNo7BN2MgbE — VALMIS 16.8.2026 (paketti O1, julkaistu v776): jaksotaitto, laatikot, nosto, paletti, kulmalappu; regressiotaulukko kaikista kaupungeista, ilmastoluvut lähteineen, bongasi speksin domain-virheen (parisjetaime.com). | 16.8.2026 |
| Opus 27 (opas 2.2) | session_01N5Fu9io7QiDUM7tKCM6hj5 — VALMIS 16.8.2026 (paketti O3, julkaistu v782): kaikki viisi osaa yhdessä vuorossa, neljä checkpoint-committia, portit ajettuna. Mallisuoritus todentamisesta: ilmastoluvut rivi riviltä lähteestä, regressio kaikkiin kaupunkeihin mitattuna eikä arvattuna, ja Commonsin Featured picture hylättynä `Restrictions: personality` -kentän takia — juuri se tarkistus, jonka pelkkä lisenssikatsaus ohittaisi. | 16.8.2026 |
| Opus 26 (opas 2.1) | session_015uPuZED8gqwLsG4j6xxxNM — VALMIS 16.8.2026 (paketti O2, julkaistu v780): paletti 2.1 hierarkialla (terrakotta johtaa, petrooli tukee), kainalopari mitatuin taittoperusteluin, display-otsikko, lämmin FP-avauskuva; raportissa WCAG-kontrastit mitattuina ja hylätyt vaihtoehdot perusteltuina — mallisuoritus suunnitteluvapaudesta. | 16.8.2026 |
