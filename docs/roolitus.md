...
| Opus 18 (Kööpenhaminan nähtävyydet) | session_01JDTLbjWJz6UCAayjpJQb5c (paketti K1: 3 uutta kohdetta + jutut + kuvat haaralla claude/opus18-kobenhavn-nahtavyydet; EI mergeä itse — Fable katselmoi ja julkaisee; raportointi viesti-fable.md:llä) | 15.8.2026 |
