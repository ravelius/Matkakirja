...
- Pelikoodari vahvisti: maakunta paketista kaikille maille (v151 FRA 97/100 …, 2 782/2 963), ei ajossa. Linssisepän FRA-diagnoosin syy joko tunnussekaannus (nosto:<id> vs kohde:<id>) tai vanha paketti (< v146). Välitetty Linssisepälle.
