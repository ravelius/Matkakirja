...
- Skeemaversio on **1.7** (`manifest.skeemaversio`): versiossa 1.1
...
- **Skeeman major.minor.** Nykyinen on 1.7 (`SKEEMAVERSIO_TARKKA`,
  ...
  linssiaineisto. Raakaoliot (`data`) eivät kuulu sopimukseen: niiden kentät
