...
- Skeemaversio on **1.8** (`manifest.skeemaversio`): versiossa 1.1
...
- **Skeeman major.minor.** Nykyinen on 1.8 (`SKEEMAVERSIO_TARKKA`,
  ...
  linssiaineisto; 1.8 kokoelma aanitaulut. Raakaoliot (`data`) eivät kuulu sopimukseen: niiden kentät
