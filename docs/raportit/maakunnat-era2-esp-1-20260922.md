# Espanjan maakunnat, erä 2 — osa 1/2 (10 ensimmäistä aluetta)

Sisältökirjuri-sessio, 2026-09-22. Tehtävä: `pitka`- ja `kuva`-kentät
seuraaville ESP-alueille (toinen agentti tekee loput 9, ei päällekkäisyyttä):
Castilla y León, Andalucía, Castilla-La Mancha, Aragón, Extremadura,
Cataluña, Galicia, Valenciana, Asturias, Murcia.

HUOM Fablelle: tämä on raportti, ei suoraan koodiin viety muutos.
`js/packs/maakunnat-luonnehdinnat.js`-tiedostoa ei ole muokattu.
...
## Lähdeviitteet (faktantarkistus)

- Cantonal rebellion 1873 (Cádiz, Andalusia): https://en.wikipedia.org/wiki/Cantonal_rebellion
- Canton of Cartagena 1873–74: https://en.wikipedia.org/wiki/Canton_of_Cartagena
- Francesc Pi i Margall, First Spanish Republic president 1873: https://en.wikipedia.org/wiki/Francesc_Pi_i_Margall
- Ávila walls / Ribera del Duero: yleistunnettuja, ristiintarkistettu useasta matkailulähteestä
- Toledo "City of Three Cultures", queso manchego DOP, safrani: yleistunnettuja
- Basílica del Pilar, mudéjar-tyyli: https://en.wikipedia.org/wiki/Cathedral_of_the_Savior_of_Zaragoza ja Turismo de Aragón
- Mérida Rooman-teatteri, konkistadorit (Cortés, Pizarro), dehesa/jamón ibérico: yleistunnettuja, ristiintarkistettu
- Sagrada Família rakennusaika: yleistunnettu
- Galician siirtolaisuus Kuubaan/Argentiinaan, "gallegos"-lempinimi Buenos Airesissa: https://www.mironline.ca/reversing-the-tide-galicia-welcomes-its-far-flung-diaspora/
- Albufera/paella-alkuperä: https://gastraval.com/en/la-albufera-of-valencia-the-origin-of-rice-and-the-valencian-paella/
- Picos de Europa, ruskeakarhukanta, Covadongan taistelu 718: National Geographic, spain.info
- Mar Menor, Cartagenan kaivoshistoria ja cante de las minas: yleistunnettuja

## Yhteenveto

Kaikki 10 aluetta saatiin tehtyä onnistuneesti (pitka-teksti + kuva
lähdetietoineen jokaiselle). Ei jäänyt kesken.
