# Natiivi-UI:n aloitusviesti (26.9.2026 klo 14.4x, luovutus t)
...
Lue: CLAUDE.md, Raamatun Ydinajatus kohta 2 (JUMI → FABLE) ja docs/raportit/viesti-natiivi-ui-luovutus-20260926-s.md + -t.md.
...
lipputanko todennettu paketin ankkureilla. Löydökset 164 (nimiot-kalusteet) ja 165 (maakunta-korostus) merge-pyynnössä. Odota omistajan 1.0.21-löydöksiä ja Fablen seuraavaa erää.
