...
| B7-3 | Väritaso/huntu/meri/raja | ❌ FAIL (24c9194 JA f6de924 — yhä rikki) | b7-3-huntu-rikkinainen-suorakulmio.png, b7-3-kreikka-tile-glitch.png, kaappaukset/b7-uusinta-f6de924-20260924/b7-3-varalaatta-f6de924-yha-rikki-390.jpg | Rikkinäinen suorakulmainen laatta (Espanja/Marokko) + puoliksi väärä naapurilaatta (Kreikan vieressä); meri ja Kreikan oma raja OK. Reitetty Natiivisepälle build 9:ään. |
...
| B7-7 | Lennon oikea teksti (ei avausteksti) + UI piilossa | UI-piilotus ✅ PASS; ääni ❌ FAIL 24c9194:llä → ✅ PASS f6de924:llä (KORJATTU) | kaappaukset/b7-uusinta-f6de924-20260924/b7-7-lento-punarengas-lontoo-f6de924-390.jpg | 24c9194: `intro-puhe.mp3` hetken lennon alussa, sitten hiljaisuus. f6de924: `puhe-lento-alku.mp3` soi oikein heti Nousu-vaiheesta. Sivuhavainto f6de924: kone näyttää sumealta/epätarkalta lähikuvassa — reitetty Natiivisepälle build 9:ään. |
| ☰-valikko kaksi riviä | Uusi peli ym. rivit listan yläosaan (löydös 18/20 jatko) | ✅ PASS (f6de924) | kaappaukset/b7-uusinta-f6de924-20260924/valikko-kaksi-rivia-f6de924-390.jpg | Kertoja/Musiikki/Äänimaisema + Uusi peli/Muut/Kehittäjä nyt pikarivistöinä listan yläosassa, ei tarvitse vierittää |
