...
**Päivitetty:** 2026-09-26 10:29 EEST

## 1) Sessiot

Uusi tili klo 10:29: viikko (all models) **5 %**, viikko (Fable) 4 %, 5 h **19 %**. Ei ylityksiä. Effort-tarkistus: kaikki 7 Opus-roolia `high`, ei nimilisäyksiä — sääntömukaista.
...
| Natiiviseppä | local_674b9ec4-e2f3-48e9-a810-a129f20a4f03 (kansio Matkakirja-3d-selvittaja) | 44% | idle | natiiviseppa/lipputanko-161 |
...
| Sisältökirjuri | local_be1a3375-18cf-4068-94f3-887d55f0e196 | 47% | running | konteksti nousee tasaisesti — seurataan |
...
| Pelikoodari | local_7fcab04b-864c-4ec2-98bd-46e171326701 | 31% | running | PR #3304 mergetty |
...
- **5 h -kiintiö:** 19 % (uusi tili, nollautuu 11:00 UTC = 14:00 EEST). extraUsage pois päältä. **Viikko (kaikki mallit): 5 %.** **Viikko (Fable):** 4 %.
- **Levy:** 104 Gt vapaana (Fablen hälytysraja 80 Gt, laskenut 141→104 Gt session aikana — seurataan, ei vielä lähellä rajaa). **Swap:** 5,7 Gt / 7 Gt (hälytys >16 Gt). **NAS:** 5,6 Ti vapaana. **wt/-worktreet:** 43 kpl.
...
- **Konteksti:** Sisältökirjuri 47 %, Natiiviseppä 44 %, Fable 39 %, Pelikoodari 31 %, Natiivi-UI 26 %, Karttaseppä 23 %, Siirtoseppä 22 %, Linssiseppä 24 %, Julkaisija 15 %, Laitetestaaja 18 %, Postivahti 23 %. Ei ylityksiä.
- **Juna:** juna/b13 uusi commit c8cd1d94 klo 10:21, odottaa niputusta, viimeisin KÄÄNNETTY 5020425d 10:11 — ei hälytystä.
