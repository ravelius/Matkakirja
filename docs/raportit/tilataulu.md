...
**Päivitetty:** 2026-09-26 10:54 EEST

## 1) Sessiot

Uusi tili klo 10:54: viikko (all models) **7 %**, viikko (Fable) 5 %, 5 h **26 %**. Ei ylityksiä. Effort-tarkistus: kaikki 7 Opus-roolia `high`, ei nimilisäyksiä — sääntömukaista.

| Rooli | Session id | Konteksti | Tila | Odottaa |
|---|---|---|---|---|
| Fable | local_5df52e10-10e4-4b72-9554-0049db300dfe | 43% | running | PR #3308 |
| Postivahti (self) | local_a24c43c0-8094-4141-b734-90b9555f5044 | 27% | running | tämä taulu |
| Julkaisija | local_5cb16c00-98db-4cd9-8d7c-1b0bc8ced914 | 17% | running | PR #3306 mergetty |
| Natiiviseppä | local_674b9ec4-e2f3-48e9-a810-a129f20a4f03 (kansio Matkakirja-3d-selvittaja) | 52% | running | natiiviseppa/symbolimallit-160 |
| Natiivi-UI | local_44392b3c-86ee-4873-9d76-82f9aaa6b832 | 33% | running | — |
| Linssiseppä | local_771b401b-80a3-4ada-a0d9-d17c6cb9c2c4 | 27% | idle | — |
| Sisältökirjuri | local_be1a3375-18cf-4068-94f3-887d55f0e196 | 54% | idle | konteksti nousee ~3 %/10min — seurataan, ei vielä 70 % |
| Laitetestaaja | local_af48ba1e-41c2-4921-9068-28cf5cc71b0d | 31% | idle | — |
| Siirtoseppä | local_86d0c984-aeeb-430d-bc85-3112f27b9437 | 23% | idle | PR #3307 mergetty |
| Pelikoodari | local_7fcab04b-864c-4ec2-98bd-46e171326701 | 39% | running | PR #3304 mergetty |
| Karttaseppä | local_eec7f158-d9f3-4b93-9368-c50935bd19ab | 26% | running | PR #3305 mergetty |
...
- **5 h -kiintiö:** 26 % (uusi tili, nollautuu 11:00 UTC = 14:00 EEST). extraUsage pois päältä. **Viikko (kaikki mallit): 7 %.** **Viikko (Fable):** 5 %.
- **Levy:** 103 Gt vapaana (Fablen hälytysraja 80 Gt, vakiintunut ~103–106 Gt). **Swap:** 5,7 Gt / 7 Gt (hälytys >16 Gt). **NAS:** 5,6 Ti vapaana. **wt/-worktreet:** 43 kpl.
- **Simulaattorit boottina:** 1 (natiiviseppa-iPhone — max 4 päivällä). coreaudiod 6 %. **Chrome-GPU-prosesseja (type=gpu-process):** 0.
- **Konteksti:** Sisältökirjuri 54 %, Natiiviseppä 52 %, Fable 43 %, Pelikoodari 39 %, Natiivi-UI 33 %, Laitetestaaja 31 %, Linssiseppä 27 %, Karttaseppä 26 %, Siirtoseppä 23 %, Julkaisija 17 %, Postivahti 27 %. Ei ylityksiä.
- **Juna:** ei uutta commitia 10:35 jälkeen, proto-kaanna.sh elossa (natiiviseppa/symbolimallit-160) — ei hälytystä.
