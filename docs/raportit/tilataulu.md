...
**Päivitetty:** 2026-09-25 08:43 EEST (YÖTILA — omistaja nukkuu, ei muistutuspusheja)

## 1) Sessiot

| Rooli | Session id | Malli | Konteksti | Tila | Viimeisin valmis erä | Odottaa |
|---|---|---|---|---|---|---|
| Fable | local_742d1717-d642-426a-840b-c5c0e75578bf | Fable 5.1 | 47% | idle | — | — |
...
| Sisältökirjuri | local_e5685e4a-4ed7-41f4-96f0-5899ff6d8d7f | Sonnet | 68% | idle | — | Yhä 68%, ei ylitä 70% |
...
| Postivahti (self) | local_6f3d4c35-be83-4985-82c7-8d641ad18f1d | Sonnet | 45% | busy | (tämä taulu) | — |

## 2) Jumit ja avoimet kortit omistajalle (yön kooste)

Ei avoimia kortteja tiedossa juuri nyt. Kaikki rauhallista.

coreaudiod ja Karttasepän poltto molemmat ratkenneet aiemmilla kierroksilla.
...
**Postilaatikko:** viimeisin commit 3bffaa8c6 "Reconcile all 155 lens IDs and source availability" — muuttumaton kuudellatoista kierroksella.
...
Julkaisijan seuraava juna: tapahtumaohjattu (käännösjuna + sisältöjuna 4-PR/4h-ehdolla). BUILD-sana → automaattinen TestFlight-ajo, ei enää polttoestettä.
...
- **Levy** (/System/Volumes/Data): 153 Gt vapaana. Raja 35 Gt.
- **wt/-worktreet:** 35 kpl.
- **5 h -kiintiö:** 28%, nollautunut 05:20. Raja 95%/98%.
- **Viikkokiintiö (kaikki mallit):** 89%. **Viikkokiintiö (Fable):** 49%. Nollautuu 2026-09-28 klo 01:00.

## 6) Kellonaika

2026-09-25 08:43 EEST. Yön merkkipaalut: kaikki rauhallista, poltto valmis, ei uusia rajanylityksiä.
