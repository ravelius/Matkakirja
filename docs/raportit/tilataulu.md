...
**Päivitetty:** 2026-09-25 03:34 EEST (YÖTILA — omistaja nukkuu, ei muistutuspusheja)
...
| Postivahti (self) | local_6f3d4c35-be83-4985-82c7-8d641ad18f1d | Sonnet | 93% | busy | (tämä taulu) — autocompact hyvin lähellä (97%) | — |
...
- **Yöajo klo 04:00** — lähestyy (~25 min), seurataan.
...
- **wt/-worktreet:** 30 kpl.
- **5 h -kiintiö:** 32%, nollautuu klo 02:20 UTC (05:20 EEST). Raja 95%/98%, tauko vasta 98%:ssa.
- **Viikkokiintiö (kaikki mallit):** 77%. **Viikkokiintiö (Fable):** 44%. Nollautuu 2026-09-28 klo 01:00.

## 6) Kellonaika

2026-09-25 03:34 EEST (`date`-komennolla varmennettu). Yön merkkipaalut: E28 VALMIS, TestFlight-yöajo 04:00 lähestyy.
