...
**Päivitetty:** 2026-09-26 12:25 EEST

## 1) Sessiot

Uusi tili klo 12:25: viikko (all models) **14 %**, viikko (Fable) 8 %, 5 h **50 %**. Effort-tarkistus: kaikki 7 Opus-roolia `high`, ei nimilisäyksiä — sääntömukaista. **Sisältökirjuri kirjoitti luovutuksen ja nollasi kontekstin (75→14 %) — pyyntö toimi.** Natiiviseppä 69 %, lähestyy 70 %-rajaa — seurataan.

| Rooli | Session id | Konteksti | Tila | Odottaa |
|---|---|---|---|---|
| Fable | local_5df52e10-10e4-4b72-9554-0049db300dfe | 56% | running | PR #3308 |
| Postivahti (self) | local_a24c43c0-8094-4141-b734-90b9555f5044 | 43% | running | tämä taulu |
| Julkaisija | local_5cb16c00-98db-4cd9-8d7c-1b0bc8ced914 | 23% | idle | PR #3306 mergetty |
| Natiiviseppä | local_674b9ec4-e2f3-48e9-a810-a129f20a4f03 (kansio Matkakirja-3d-selvittaja) | **69%** | idle | lähestyy 70 %-rajaa |
| Natiivi-UI | local_44392b3c-86ee-4873-9d76-82f9aaa6b832 | 54% | idle | PR #3324 |
| Linssiseppä | local_771b401b-80a3-4ada-a0d9-d17c6cb9c2c4 | 38% | idle | — |
| Sisältökirjuri | local_be1a3375-18cf-4068-94f3-887d55f0e196 | **14%** | idle | **Nollattu — luovutus kirjoitettu, jatkoi käyntiin** |
...
| Pelikoodari | local_7fcab04b-864c-4ec2-98bd-46e171326701 | 58% | running | PR #3304 mergetty |
| Karttaseppä | local_eec7f158-d9f3-4b93-9368-c50935bd19ab | 58% | idle | PR #3305 mergetty |
...
- **5 h -kiintiö:** 50 % (uusi tili, nollautuu 11:00 UTC = 14:00 EEST). extraUsage pois päältä. **Viikko (kaikki mallit): 14 %.** **Viikko (Fable):** 8 %.
- **Levy:** 88 Gt vapaana (raja 85 Gt, korjautunut — muistipainekierros helpotti myös levyä). **Swap: 12,7 / 14 Gt (raja 24 Gt, laskenut merkittävästi — raportoitu Fablelle 12:25).** **NAS:** 5,6 Ti vapaana. **wt/-worktreet:** 52 kpl.
- **Simulaattorit boottina:** 0 (max 4 päivällä; muistipainekierros vapautti kaikki). coreaudiod 6 %. **Chrome-GPU-prosesseja (type=gpu-process):** 0.
- **Konteksti:** Natiiviseppä 69 % (lähestyy rajaa), Fable 56 %, Pelikoodari 58 %, Karttaseppä 58 %, Natiivi-UI 54 %, Postivahti 43 %, Laitetestaaja 37 %, Siirtoseppä 34 %, Linssiseppä 38 %, Julkaisija 23 %, **Sisältökirjuri 14 % (nollattu)**.
- **Juna:** viimeisin KÄÄNNETTY 39df9427 12:19 — ei hälytystä.
