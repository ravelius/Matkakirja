...
**Päivitetty:** 2026-09-25 20:48 EEST
...
- **Paikallinen levy:** 144 Gt vapaana (hälytysraja 60 Gt). **NAS:** 5,6 Ti vapaana (raja 500 Gt). **wt/-worktreet:** 39 kpl. **Swap:** 0 Gt.
- **GLO-30-nouto:** aws-virtoja 24, en0 sisään 39 Mt/s, NAS-kansio 397 Gt, seurantarivi 20:27 (21 min, ok). Ei hälytystä.
- **Simulaattorit boottina:** 1 (pariteetti-iPhone). coreaudiod 20 %. **Chrome-GPU-prosesseja:** 0.
- **5 h -kiintiö:** 98 % klo 20:48 (nollautuu 22:30 EEST, 1 h 40 min) — ilmoitettu Fablelle (98 %-raja). **Viikko (kaikki mallit):** 52 %. **Viikko (Fable):** 20 %.
- **Juna:** yläraja laukesi 20:46 (vanhin 1469 s), käännös käynnissä; edellinen KÄÄNNETTY 20:26.
