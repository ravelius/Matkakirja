...
**Päivitetty:** 2026-09-26 20:25 EEST

## 1) Sessiot

5 h **20 %** (nollautui 19:00, seur. 20:59), viikko (all models) 38 %, viikko (Fable) 26 %. Effort-tarkistus: kaikki 7 Opus-roolia `high`, ei nimilisäyksiä — sääntömukaista. Ei uusia 70 %-ylityksiä.

| Rooli | Session id | Konteksti | Tila | Odottaa |
|---|---|---|---|---|
| Fable | local_5df52e10-10e4-4b72-9554-0049db300dfe | 25% | running | PR #3308 |
| Postivahti (self) | local_a24c43c0-8094-4141-b734-90b9555f5044 | 42% | running | tämä taulu |
| Julkaisija | local_5cb16c00-98db-4cd9-8d7c-1b0bc8ced914 | 37% | idle | — |
...
| Karttaseppä | local_eec7f158-d9f3-4b93-9368-c50935bd19ab | 17% | idle | PR #3305 mergetty |
...
- **5 h -kiintiö:** 20 % (nollautui 19:00, seur. nollaus 20:59 EEST). extraUsage pois päältä. **Viikko (kaikki mallit): 38 %.** **Viikko (Fable):** 26 %.
- **Levy:** 148 Gt vapaana (raja 80/75/70 Gt — kaukana, vakaa). **Muistipaine: normal (1).** **NAS:** 5,6 Ti vapaana. **wt/-worktreet:** 24 kpl.
...
- **Konteksti:** Natiivi-UI 62 %, Postivahti (self) 42 %, Siirtoseppä 44 %, Natiiviseppä 46 %, Linssiseppä 43 %, Julkaisija 37 %, Sisältökirjuri 34 %, Fable 25 %, Pelikoodari 24 %, Karttaseppä 17 %, Laitetestaaja 19 %.
