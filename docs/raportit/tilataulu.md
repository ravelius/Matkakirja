...
**Päivitetty:** 2026-09-25 21:12 EEST
...
| Laitetestaaja | local_c22294e5-4f0f-46ce-b1d3-9d8f3da223b1 | 51% | idle | PR #3153 (savukierros B13) |
...
- **Paikallinen levy:** 147 Gt vapaana (hälytysraja 60 Gt). **NAS:** 5,6 Ti vapaana (raja 500 Gt). **wt/-worktreet:** 38 kpl. **Swap:** 0 Gt.
- **GLO-30-nouto:** aws-virtoja 24, en0 sisään 36 Mt/s, seurantarivi 20:58 (14 min), NAS-kansio 443 Gt. Ei hälytystä. Arvio valmis ~22.
- **Simulaattorit boottina:** 1 (iPad Pro 13" M5). coreaudiod 3 %. **Chrome-GPU-prosesseja:** 0.
- **5 h -kiintiö:** 99 % klo 21:12 (nollautuu 22:30 EEST, 1 h 16 min). **Viikko (kaikki mallit):** 52 %. **Viikko (Fable):** 21 %.
- **Konteksti:** Laitetestaaja 51 %, Natiiviseppä 49 %, Julkaisija 48 %, Fable 39 %, Pelikoodari 33 %. Ei ylityksiä.
