...
**Päivitetty:** 2026-09-25 02:44 EEST (YÖTILA — omistaja nukkuu, ei muistutuspusheja)

## 1) Sessiot

| Rooli | Session id | Malli | Konteksti | Tila | Viimeisin valmis erä | Odottaa |
|---|---|---|---|---|---|---|
| Fable | local_742d1717-d642-426a-840b-c5c0e75578bf | Fable 5.1 | 19% | busy | — | — |
| Julkaisija | local_9922c4b6-320f-4074-aed4-f2811a7c9640 | Opus, high | 13% | busy | PR:t #3123, #3130, #3132 mainiin | PR #3128 (linssikatalogi) |
| Natiiviseppä | local_860f922b-94b8-49da-975d-4233a993bbb8 | Opus | 62% | busy | — | — |
| Natiivi-UI | local_9ed5a7df-5c9c-47e5-be64-bad4353b81b9 | Opus | 72% | idle | — (ILMOITETTU 70%, odota 85%) | Testikäännös käännöspalvelulla |
...
| Karttaseppä | local_445a5c7b-4317-4989-b65d-4cb81bd10056 | Opus | 53% | idle | **E28-pallolaatat valmiit, vienti ämpäriin käynnissä** (199 708 laattaa, 1,5 Gt) | Siirto NAS:iin, ilmoitus Natiivisepälle+Fablelle |
| Postivahti (self) | local_6f3d4c35-be83-4985-82c7-8d641ad18f1d | Sonnet | 87% | busy | (tämä taulu) — autocompact lähestyy (97%) | — |
...
**NAS-siirto valmis:** levy 84→163 Gt, ilmoitettu Fablelle. Uusi postilaatikko-tilaus (linssikatalogi erä 155) odottaa toteutusta.
...
- **Levy** (/System/Volumes/Data): 163 Gt vapaana. Raja 35 Gt.
- **wt/-worktreet:** 29 kpl.
- **5 h -kiintiö:** 29%, nollautuu klo 02:20 UTC (05:20 EEST). Raja 95%/98%, tauko vasta 98%:ssa.
- **Viikkokiintiö (kaikki mallit):** 76%. **Viikkokiintiö (Fable):** 44%. Nollautuu 2026-09-28 klo 01:00.

## 6) Kellonaika

2026-09-25 02:44 EEST (`date`-komennolla varmennettu). Yön merkkipaalut: E28-pallolaatat VALMIIT (vienti ämpäriin käynnissä), TestFlight-yöajo 04:00.
