...
**Päivitetty:** 2026-09-26 11:18 EEST

## 1) Sessiot

Uusi tili klo 11:18: viikko (all models) **9 %**, viikko (Fable) 6 %, 5 h **31 %**. Ei ylityksiä. Effort-tarkistus: kaikki 7 Opus-roolia `high`, ei nimilisäyksiä — sääntömukaista.

| Rooli | Session id | Konteksti | Tila | Odottaa |
|---|---|---|---|---|
| Fable | local_5df52e10-10e4-4b72-9554-0049db300dfe | 46% | running | PR #3308 |
| Postivahti (self) | local_a24c43c0-8094-4141-b734-90b9555f5044 | 31% | running | tämä taulu |
| Julkaisija | local_5cb16c00-98db-4cd9-8d7c-1b0bc8ced914 | 18% | idle | PR #3306 mergetty |
| Natiiviseppä | local_674b9ec4-e2f3-48e9-a810-a129f20a4f03 (kansio Matkakirja-3d-selvittaja) | 57% | running | juna/b13 |
| Natiivi-UI | local_44392b3c-86ee-4873-9d76-82f9aaa6b832 | 39% | running | — |
| Linssiseppä | local_771b401b-80a3-4ada-a0d9-d17c6cb9c2c4 | 32% | idle | — |
| Sisältökirjuri | local_be1a3375-18cf-4068-94f3-887d55f0e196 | **65%** | idle | **LÄHESTYY 70 %-RAJAA** (59→65 tällä kierroksella) — seuraava kierros voi ylittää, valmiina ilmoittamaan Fablelle |
...
| Karttaseppä | local_eec7f158-d9f3-4b93-9368-c50935bd19ab | 36% | running | PR #3305 mergetty |
...
- **5 h -kiintiö:** 31 % (uusi tili, nollautuu 11:00 UTC = 14:00 EEST). extraUsage pois päältä. **Viikko (kaikki mallit): 9 %.** **Viikko (Fable):** 6 %.
- **Levy:** 102 Gt vapaana (Fablen hälytysraja 80 Gt, vakiintunut ~102–106 Gt). **Swap:** 5,6 Gt / 7 Gt (hälytys >16 Gt). **NAS:** 5,6 Ti vapaana. **wt/-worktreet:** 44 kpl.
- **Simulaattorit boottina:** 2 (natiiviseppa-iPhone, iPhone 17 — max 4 päivällä). coreaudiod 7 %. **Chrome-GPU-prosesseja (type=gpu-process):** 0.
- **Konteksti:** Sisältökirjuri 65 % (lähestyy 70 %), Natiiviseppä 57 %, Fable 46 %, Pelikoodari 43 %, Karttaseppä 36 %, Natiivi-UI 39 %, Laitetestaaja 35 %, Linssiseppä 32 %, Siirtoseppä 24 %, Julkaisija 18 %, Postivahti 31 %. Ei ylityksiä (raja 70 %).
- **Juna:** vanhin kääntämätön commit 8 min (juna/b13 4ae6df79, 11:16), viimeisin KÄÄNNETTY 894f1feb 10:35 — ei hälytystä.
