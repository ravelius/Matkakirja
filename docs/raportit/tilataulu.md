...
**Päivitetty:** 2026-09-25 03:22 EEST (YÖTILA — omistaja nukkuu, ei muistutuspusheja)

## 1) Sessiot

| Rooli | Session id | Malli | Konteksti | Tila | Viimeisin valmis erä | Odottaa |
|---|---|---|---|---|---|---|
| Fable | local_742d1717-d642-426a-840b-c5c0e75578bf | Fable 5.1 | 20% | idle | — | — |
| Julkaisija | local_9922c4b6-320f-4074-aed4-f2811a7c9640 | Opus, high | 14% | busy | — | PR #3128 (linssikatalogi), TestFlight-yöajo 04:00 |
| Natiiviseppä | local_860f922b-94b8-49da-975d-4233a993bbb8 | Opus | 62% | busy | — | — |
| Natiivi-UI | local_9ed5a7df-5c9c-47e5-be64-bad4353b81b9 | Opus | 33% | idle | — | Testikäännös käännöspalvelulla |
| Linssiseppä | local_3273f209-099d-4ed3-830e-e4e1b40bcc7d | Opus | 29% | idle | — | Radiouudistus build 12 |
| Sisältökirjuri | local_e5685e4a-4ed7-41f4-96f0-5899ff6d8d7f | Sonnet | 43% | idle | PR #3128 -korjaukset | — |
...
| Postivahti (self) | local_6f3d4c35-be83-4985-82c7-8d641ad18f1d | Sonnet | 91% | busy | (tämä taulu) — autocompact hyvin lähellä (97%) | — |
...
**NAS-siirto valmis:** levy 84→166 Gt, ilmoitettu Fablelle. **E28-pallolaatat valmiit** (199 708 laattaa, 1,5 Gt), ilmoitettu Fablelle. Uusi postilaatikko-tilaus (linssikatalogi erä 155) odottaa toteutusta.
...
- **Yöajo klo 04:00** — lähestyy (~40 min), seurataan.
...
- **wt/-worktreet:** 30 kpl.
- **5 h -kiintiö:** 31%, nollautuu klo 02:20 UTC (05:20 EEST). Raja 95%/98%, tauko vasta 98%:ssa.
- **Viikkokiintiö (kaikki mallit):** 77%. **Viikkokiintiö (Fable):** 44%. Nollautuu 2026-09-28 klo 01:00.

## 6) Kellonaika

2026-09-25 03:22 EEST (`date`-komennolla varmennettu). Yön merkkipaalut: E28 VALMIS, TestFlight-yöajo 04:00 lähestyy.
