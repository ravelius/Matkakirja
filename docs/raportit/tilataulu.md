...
**Päivitetty:** 2026-09-25 03:08 EEST (YÖTILA — omistaja nukkuu, ei muistutuspusheja)
...
| Natiivi-UI | local_9ed5a7df-5c9c-47e5-be64-bad4353b81b9 | Opus | 30% | busy | — | Testikäännös käännöspalvelulla |
...
| Postivahti (self) | local_6f3d4c35-be83-4985-82c7-8d641ad18f1d | Sonnet | 90% | busy | (tämä taulu) — autocompact lähestyy (97%) | — |
...
**NAS-siirto valmis:** levy 84→167 Gt, ilmoitettu Fablelle. **E28-pallolaatat valmiit** (199 708 laattaa, 1,5 Gt), ilmoitettu Fablelle. Uusi postilaatikko-tilaus (linssikatalogi erä 155) odottaa toteutusta.
...
- **Yöajo klo 04:00** — lähestyy, seurataan.
- Käännöspalvelu käytössä: `proto-3d/tyokalut/proto-kaanna.sh <haara>[+<haara>] [UDID…]`.

## 5) Resurssit

- **Levy** (/System/Volumes/Data): 167 Gt vapaana. Raja 35 Gt.
- **wt/-worktreet:** 30 kpl.
...
2026-09-25 03:08 EEST (`date`-komennolla varmennettu). Yön merkkipaalut: E28 VALMIS, TestFlight-yöajo 04:00 lähestyy.
