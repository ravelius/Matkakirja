...
**Päivitetty:** 2026-09-26 20:13 EEST

## 1) Sessiot

5 h **17 %** (nollautui 19:00, seur. 20:59), viikko (all models) 38 %, viikko (Fable) 26 %. Effort-tarkistus: kaikki 7 Opus-roolia `high`, ei nimilisäyksiä — sääntömukaista. Ei uusia 70 %-ylityksiä.

| Rooli | Session id | Konteksti | Tila | Odottaa |
|---|---|---|---|---|
| Fable | local_5df52e10-10e4-4b72-9554-0049db300dfe | 24% | running | PR #3308 |
...
| Natiiviseppä | local_674b9ec4-e2f3-48e9-a810-a129f20a4f03 (kansio Matkakirja-3d-selvittaja) | 45% | idle | — |
| Natiivi-UI | local_44392b3c-86ee-4873-9d76-82f9aaa6b832 | 61% | running | Pulu-korjaus PR-haaraan |
| Linssiseppä | local_771b401b-80a3-4ada-a0d9-d17c6cb9c2c4 | 40% | idle | — |
| Sisältökirjuri | local_be1a3375-18cf-4068-94f3-887d55f0e196 | 28% | idle | — |
...
- **5 h -kiintiö:** 17 % (nollautui 19:00, seur. nollaus 20:59 EEST). extraUsage pois päältä. **Viikko (kaikki mallit): 38 %.** **Viikko (Fable):** 26 %.
- **Levy:** 148 Gt vapaana (raja 80/75/70 Gt — kaukana, hidas tasainen lasku). **Muistipaine: normal (1).** **NAS:** 5,6 Ti vapaana. **wt/-worktreet:** 25 kpl.
...
- **Konteksti:** Natiivi-UI 61 %, Postivahti (self) 40 %, Natiiviseppä 45 %, Siirtoseppä 44 %, Linssiseppä 40 %, Julkaisija 36 %, Sisältökirjuri 28 %, Fable 24 %, Pelikoodari 24 %, Laitetestaaja 19 %, Karttaseppä 14 %.
