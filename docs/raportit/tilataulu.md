...
**Päivitetty:** 2026-09-25 07:55 EEST (YÖTILA — omistaja nukkuu, ei muistutuspusheja)

## 1) Sessiot

| Rooli | Session id | Malli | Konteksti | Tila | Viimeisin valmis erä | Odottaa |
|---|---|---|---|---|---|---|
| Fable | local_742d1717-d642-426a-840b-c5c0e75578bf | Fable 5.1 | 44% | idle | — | — |
...
| **Natiivi-UI** | local_9ed5a7df-5c9c-47e5-be64-bad4353b81b9 | Opus | **87%** ⚠️⚠️ | idle | — | Nousee edelleen kohti autocompactia (97%), ei vielä nollattu — 85% ilmoitettu 07:43 |
...
| Postivahti (self) | local_6f3d4c35-be83-4985-82c7-8d641ad18f1d | Sonnet | 38% | busy | (tämä taulu) | — |

## 2) Jumit ja avoimet kortit omistajalle (yön kooste)

Ei avoimia kortteja tiedossa juuri nyt. Natiivi-UI ei ole jumissa (idle, ei virhettä) — konteksti vain nousee, autocompact hoitaa sen automaattisesti 97%:ssa jos ei nollata sitä ennen.

Karttasepän poltto käynnissä (04:47–~08:45, n. 50min jäljellä). Levy 123 Gt (vakaa).
...
**Postilaatikko:** viimeisin commit 3bffaa8c6 "Reconcile all 155 lens IDs and source availability" — muuttumaton kahdellatoista kierroksella.
...
- **Levy** (/System/Volumes/Data): 123 Gt vapaana. Raja 35 Gt.
- **wt/-worktreet:** 35 kpl.
- **5 h -kiintiö:** 22%, nollautunut 05:20. Raja 95%/98%.
- **Viikkokiintiö (kaikki mallit):** 87%. **Viikkokiintiö (Fable):** 48%. Nollautuu 2026-09-28 klo 01:00.

## 6) Kellonaika

2026-09-25 07:55 EEST. Yön merkkipaalut: Natiivi-UI 87% (nousee kohti autocompactia, ei jumi), Karttasepän poltto käynnissä (n. 50min jäljellä).
