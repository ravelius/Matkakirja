...
**Päivitetty:** 2026-09-25 03:46 EEST (YÖTILA — omistaja nukkuu, ei muistutuspusheja)

## 1) Sessiot

| Rooli | Session id | Malli | Konteksti | Tila | Viimeisin valmis erä | Odottaa |
|---|---|---|---|---|---|---|
| Fable | local_742d1717-d642-426a-840b-c5c0e75578bf | Fable 5.1 | 20% | busy | — | — |
| Julkaisija | local_9922c4b6-320f-4074-aed4-f2811a7c9640 | Opus, high | 14% | busy | — | PR #3128 (linssikatalogi), TestFlight-yöajo 04:00 |
| Natiiviseppä | local_860f922b-94b8-49da-975d-4233a993bbb8 | Opus | 64% | busy | — | — |
| Natiivi-UI | local_9ed5a7df-5c9c-47e5-be64-bad4353b81b9 | Opus | 34% | busy | — | Testikäännös käännöspalvelulla |
...
| Postivahti (self) | local_6f3d4c35-be83-4985-82c7-8d641ad18f1d | Sonnet | 95% | busy | (tämä taulu) — autocompact erittäin lähellä (97%) | — |
...
- **Yöajo klo 04:00** — n. 15 min päässä, seurataan.
...
- **wt/-worktreet:** 30 kpl.
- **5 h -kiintiö:** 33%, nollautuu klo 02:20 UTC (05:20 EEST). Raja 95%/98%, tauko vasta 98%:ssa.
- **Viikkokiintiö (kaikki mallit):** 77%. **Viikkokiintiö (Fable):** 44%. Nollautuu 2026-09-28 klo 01:00.

## 6) Kellonaika

2026-09-25 03:46 EEST (`date`-komennolla varmennettu). Yön merkkipaalut: E28 VALMIS, TestFlight-yöajo 04:00 lähestyy (~15 min).
