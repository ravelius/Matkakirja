...
**Päivitetty:** 2026-09-25 15:26 EEST
...
| Natiivi-UI | local_33ba1387-d688-4e44-8e05-10951e61efc0 | nollattu (ei lukua) | idle, RC pois | Nollattu 15.22; ilmoitettu Fablelle 15.25; konteksti luettavissa vasta seuraavan viestin jälkeen |
...
| Pelikoodari | local_97810d35-a79c-484b-8573-660a4c40eaa6 | 63% | running | — |
...
- **Konteksti:** Natiivi-UI nollattu 15.22 (prosessi pois, RC pois), Pelikoodari 63 % (raja 70 %), Natiiviseppä 53 %, Fable 51 %.
- **Juna:** yläraja laukesi 15:22 (vanhin kääntämätön 1550 s → käännös nyt), käännös käynnissä; edellinen KÄÄNNETTY 14:51. Tarkistetaan seuraavalla kierroksella.
