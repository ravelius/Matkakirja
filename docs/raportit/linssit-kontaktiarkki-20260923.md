...
| 7 | Vertailu, maatiedot | Webissä valittu maa täytetään selvästi (0,3 alfa vaalealla pohjalla); natiivissa täyttö näkyy heikosti reliefin päällä, raja selvästi | Natiiviseppä (MaaTaytto) | Korjattu 7247eb7: paletti oli lineaarinen tekstuuri, nyt sRGB; tarkistetaan iPadilla |
