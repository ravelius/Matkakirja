...
| 3 | Belgia maata napauttamalla | **Ei toimi**: napautukset Belgian kohdalle (loitonnetulla kartalla, kuvat ei tallennettu) avasivat Lille-kortin ("Lille" + postikortti + teksti), eivät Belgia-lehteä. Maailma-tilassa napautus Belgian kohtaan ei tehnyt mitään. Belgian kohdalla ei näy merkkiä eikä nimeä. Tervurenia/Leijonakumpua ei löytynyt. Vakavuus 2. |
