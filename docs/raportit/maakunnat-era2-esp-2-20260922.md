# Espanjan maakunnat, erä 2/2 — pitka + kuva (9 viimeistä aluetta)

Tehty Sisältökirjuri-roolissa 22.9.2026. Alueet: Foral de Navarra, Madrid,
País Vasco, Canary Is., Cantabria, La Rioja, Islas Baleares, Ceuta, Melilla.
Ei koske `js/packs/maakunnat-luonnehdinnat.js`-tiedostoa — tulos tähän
raporttiin Fablen (päätoimittajan) tarkastukseen ja sieltä koodiin.

Kuvat ladattu `tools/hae-commons.mjs`-työkalulla kansioon
`/Users/samireivinen/Matkakirja-nostot-kuvat/maakunnat/ESP/kuvat/`
leveydellä 1800 px. Kaikki lisenssit CC BY-SA (3.0 tai 4.0), tarkistettu
`tiedot`-komennolla ennen latausta.
...
**Yhteenveto:** 9/9 aluetta valmiina (pitka-teksti + kuva molemmat). Ei jäänyt kesken. Faktat tarkistettu web-hauilla (Kolmas karlistisota 1872–1876, Bilbaon piiritys 1873–74, Ensimmäinen Espanjan tasavalta 11.2.1873–29.12.1874, Rioja/filloksera-muutto Ranskasta, Melillan Nieto-modernismi vain taustana valittaessa toista kuva-aihetta). Kuvat ladattu ja tarkistettu lisenssien osalta `tools/hae-commons.mjs`-työkalulla; sha256-tiivisteet laskettu ladatuista tiedostoista.
