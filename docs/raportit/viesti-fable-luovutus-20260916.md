...
| claude/bold-ride-vow4ki-pallo-musta (fc6084e2) | VALMIS: juurisyy iOS Safarin tyhjä kangas (kaksi 4096x2048-kangasta, ei virhettä → musta tekstuuri); korjaus: ladonta ruudun mukaan 2048x1024 puhelimella, yksi kangas, tyhjän kankaan tarkistus + puolitus, 8 s aikakatko, ?pallodiag=1; testit 129/129, savuke-astro-pallo 37/37 × 2; ajamatta savuke-satelliittilinssi. Jatkokysymys: iPad vaaka valitsee 8k:n turhaan (yli Safarin kangaskaton) — sidottava ladontakykyyn |
...
| claude/bold-ride-vow4ki-astro-chatti (7d3c3456) | VALMIS kokonaan: testit 627/627, savuke-astro-valokuva 43/43 × 4 näkymää (myös iPad), savuke-astro-aani 24/24, savuke-satelliittilinssi 34/34 |
...
Omistajalle: kun v1926 on ulkona, avaa Astronautin kamera osoitteella ?pallodiag=1 ja lue vasemman alakulman loki (odotettu kangas=2048x1024, ok=1, syy=blob).
