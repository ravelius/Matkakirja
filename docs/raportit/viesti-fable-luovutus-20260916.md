...
| claude/bold-ride-vow4ki-astro-chatti (4120dfbf) | WIP-commit Fablen tekemä (5 tiedostoa muuttunut), agentin raportti puuttuu → tarkista tila ennen jatkoa | LISAYS 10 kohdat 29–32: minipulun napautus → pulun normaali chatti (2 valmista kysymystä ehdotuksina), selite avautuu pienennettynä, otsikkorivi vihreällä, vinkkiavaus 1. kerralla |
