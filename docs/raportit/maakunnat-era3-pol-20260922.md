# Maakuntien erä 3: Puolan (POL) 16 voivodikunnan pulu-kysymykset

Livia-pöllön esikirjoitetut kysymys-vastaus-parit `pulu`-kenttää varten.
Avaimet ovat Natural Earthin englanninkieliset nimet, samat kuin
js/packs/maakunnat-luonnehdinnat.js:n POL-lohkossa. Faktat on tarkistettu
suhteessa alueen olemassa oleviin lyhyt/pitka-teksteihin (ei toistoa) ja
ovat tarkistettavissa en-Wikipediasta.
