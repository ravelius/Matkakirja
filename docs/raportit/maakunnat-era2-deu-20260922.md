# Saksan (DEU) maakunnat, erä 2 — pitka + kuva

Sisältökirjurin raportti Fablen tarkastukseen 22.9.2026. Ei koskettu
js/packs/maakunnat-luonnehdinnat.js-tiedostoa — vain tämä raportti.
Jokaiselle 16 osavaltiolle on kirjoitettu `pitka`-teksti (Livian äänellä,
3-5 virkettä, ei toista `lyhyt`-kentän asiaa, 1873-kytkös mukana kun
sellainen oikeasti löytyi) sekä yksi Commons-kuva alueesta lisenssitietoineen.

Kuvat ladattu 1800 px leveydellä kansioon
`/Users/samireivinen/Matkakirja-nostot-kuvat/maakunnat/DEU/kuvat/`.
...
16/16 aluetta valmiina: kaikille kirjoitettu `pitka`-teksti Livian äänellä
ja valittu, ladattu ja hashattu Commons-kuva lisenssitietoineen. Mikään ei
jäänyt kesken. Faktat tarkistettu webhausta (mm. Cologne Cathedral,
Neuschwanstein, Gründerkrach 1873, Hampurin liittyminen tulliliittoon
1888, Frankfurtin ja Hannoverin liittäminen Preussiin 1866, Dresdenin
Frauenkirchen jälleenrakennus, Bremerhavenin siirtolaisuus, Saarlandin
jako 1815, Baden-Württembergin synty 1952, Thüringenin herttuakunnat).
