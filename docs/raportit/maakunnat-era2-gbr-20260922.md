# GBR maakunnat, erä 2: pitka + kuva (Sisältökirjuri, 22.9.2026)

Tulos Fablen tarkastukseen ennen tuontia
`js/packs/maakunnat-luonnehdinnat.js`-tiedostoon. Olemassa oleva
`lyhyt`-teksti tarkistettu ennen kirjoitusta (rivit 108-113):

- England: "Lontoossa kuulee kadulla yli 300 kieltä..."
- Scotland: "Skotlannissa viski ei ole vain juoma..."
- Wales: "Walesissa aiempaa useampi lapsi opiskelee kokonaan kymriksi..."
- Northern Ireland: "Belfastin entinen telakka-alue, jossa rakennettiin Titanic..."

Kuvat ladattu `tools/hae-commons.mjs`-työkalulla kansioon
`/Users/samireivinen/Matkakirja-nostot-kuvat/maakunnat/GBR/kuvat/`,
sha256 laskettu ladatuista tiedostoista.
...
Kuva: Broadwayn pääkatu Cotswoldsissa (Worcestershire) – tyypillinen
englantilainen maaseutukylä hunajankivisine taloineen.
...
Kuva: skotlantilainen ylängön vuoristomaisema.
...
Kuva: Snowdonian (Yr Wyddfa) jäätikön muovaama vuoristomaisema
(Llanfrothen).
...
Kuva: Giant's Causeway, kuusikulmaiset basalttipatsaat.

---

## Faktojen lähteet (tarkistettu haulla, ei kirjoitettu muistista)

- Eastbourne Pier: rakennus 1866-1872, virallinen avaus 13.6.1870,
  kokonaan valmis 1872 (National Piers Society, Historic England).
- Open Championship 1873: 13. Open pelattiin ensimmäistä kertaa St
  Andrewsissa (aiemmin aina Prestwick), voittaja Tom Kidd, ensimmäinen
  Claret Jug -pokaalin saaja (theopen.com, Wikipedia).
- Cardiffin hiilivienti: kasvoi 44 350 tonnista (1840) 2,219 miljoonaan
  tonniin (1870); satamasta tuli maailman suurin hiilen vientisatama
  1880-luvulla (Museum Wales, Wikipedia: Cardiff Docks).
- Giant's Causeway / Causeway-hotelli: hotelli rakennettiin 1836,
  valmistui 1841; paikalliset oppaat kilpailivat kävijöistä koko
  viktoriaanisen ajan (Lord Belmont in Northern Ireland -blogi,
  paikallishistoria).

## Yhteenveto

4/4 aluetta tehty onnistuneesti (pitka + kuva molemmat), mikään ei
jäänyt kesken. `js/packs/maakunnat-luonnehdinnat.js`-tiedostoa EI
muokattu tämän tehtävän mukaisesti — Fable vie tekstit ja kuvatiedot
tiedostoon tarkastuksen jälkeen.
