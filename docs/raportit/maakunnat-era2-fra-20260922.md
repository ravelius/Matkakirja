# FRA-maakuntien luonnehdinnat, erä 2: pitka + kuva (22.9.2026)

Sisältökirjurin raportti Fablen (päätoimittajan) tarkastukseen. EI viety
suoraan js/packs/maakunnat-luonnehdinnat.js-tiedostoon.

Kuvat ladattu komennolla `tools/hae-commons.mjs`, leveys 1800 px, kansioon
`/Users/samireivinen/Matkakirja-nostot-kuvat/maakunnat/FRA/kuvat/`.
Kaikki kuvat läpäisivät työkalun lisenssitarkistuksen (OK: PD/CC0/CC-BY/CC-BY-SA).
...
**Yhteenveto:** kaikki 13 aluetta tehty onnistuneesti (pitka-teksti + kuva
ladattu, hajautettu ja lisensoitu). Mitään ei jäänyt kesken. Ladatut
tiedostot: `/Users/samireivinen/Matkakirja-nostot-kuvat/maakunnat/FRA/kuvat/`.
