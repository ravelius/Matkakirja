# ITA-maakuntien pitka + kuva, erä 2 (1/2) — 20260922

Sisältökirjurin raportti Fablen tarkastukseen. Kattaa ITA-alueet
aakkosjärjestyksen ensimmäiset 10: Piemonte, Lombardia, Sicily, Toscana,
Emilia-Romagna, Sardegna, Veneto, Apulia, Lazio, Trentino-Alto Adige.
`js/packs/maakunnat-luonnehdinnat.js` EI ole muokattu — Fable siirtää
hyväksytyt tekstit ja kuvaobjektit sinne itse.
...
Faktatarkistus: Mole Antonellianan rakennustyöt alkoivat 1863 (alun perin
synagogaksi), venyivät vuosikymmeniä ja valmistuivat vasta 1889 —
isoisän 1873-käynnin aikaan rakennus oli siis yhä kesken (en-Wikipedia
"Mole Antonelliana"). Torino oli Italian pääkaupunki 1861–1865, minkä
jälkeen pääkaupunki siirtyi Firenzeen (en-Wikipedia "Turin").
...
Faktatarkistus: Milanon Duomon julkisivu valmistui Napoleonin tilauksesta
1807–1813, mutta koko rakennus valmistui vasta 1965 (en-Wikipedia "Milan
Cathedral"). Como-järven silkkiteollisuus ja Po-tasangon riisinviljely
ovat vakiintuneita, laajasti dokumentoituja Lombardian elinkeinoja.
...
Faktatarkistus: Garibaldin Tuhannen retkikunta valtasi Sisilian 1860, ja
saari liitettiin kansanäänestyksellä uuteen Italian kuningaskuntaan;
"Seitsemän ja puolen päivän kapina" Palermossa ajoittuu 16.–22.9.1866
(en-Wikipedia "Seven and a Half Days Revolt", "History of Sicily").
...
Faktatarkistus: Firenze toimi Italian kuningaskunnan pääkaupunkina
1865–1871 ennen siirtymistä Roomaan; kaupunkia laajennettiin ja muurattiin
auki hallinnon tarpeisiin (en-Wikipedia "Florence", The Florentine
...
Faktatarkistus: Bolognan yliopisto perustettu 1088, vanhin yhtäjaksoisesti
toiminut yliopisto (en-Wikipedia "University of Bologna"). Motor Valley
kattaa mm. Ferrarin, Lamborghinin, Paganin, Maseratin ja Ducatin tehtaat
Emilia-Romagnan alueella (emiliaromagnaturismo.it "Motor Valley"). Kuva
esittää Piazza Galvania, joka sijaitsee Archiginnasio-palatsin
(yliopiston vanhan päärakennuksen) edustalla — sopii pitka-tekstin
yliopistoteemaan.
...
Faktatarkistus: Su Nuraxi di Barumini on UNESCOn maailmanperintökohde
(1997), pronssikautinen nuraghikompleksi (whc.unesco.org). Iglesiasin
seudun sinkki- ja lyijykaivosbuumi kiihtyi 1860-luvulta alkaen kasvaneen
eurooppalaisen kysynnän myötä (camminominerariodisantabarbara.org
"History").
...
Faktatarkistus: Veneto liitettiin Italian kuningaskuntaan 1866 kolmannen
itsenäisyyssodan jälkeen kansanäänestyksellä (yleisesti dokumentoitu
Risorgimento-historia). Spritzin alkuperä 1800-luvun Venetossa,
itävaltalaisten sotilaiden soodavesilisäyksestä paikalliseen viiniin
(provi.com, tuscanynowandmore.com "The Aperol Spritz"). Villa Almerico
Capra ("La Rotonda") on Palladion suunnittelema huvila Vicenzan
liepeillä.
...
Faktatarkistus: Leccen runsas barokkiarkkitehtuuri ("Etelän Firenze") ja
Salenton niemimaan sijainti kahden meren välissä ovat vakiintuneita,
laajasti dokumentoituja faktoja. Ei löydetty riittävän varmaa 1873-kytköstä
tälle alueelle, joten sellaista ei ole keksitty (kytkös jätetty pois
ohjeen mukaisesti).
...
Faktatarkistus: Rooma liitettiin Italian kuningaskuntaan Porta Pian
murron jälkeen 20.9.1870, ja pääkaupunki siirtyi Firenzestä Roomaan 1871
(en-Wikipedia "Roman question", "Capture of Rome").
...
Faktatarkistus: Etelä-Tiroli ja Trentino kuuluivat Itävalta-Unkarin
Tirolin kruununmaahan 1919 asti ja liitettiin Italiaan Saint-Germainin
rauhansopimuksella (en-Wikipedia "South Tyrol", "Trentino"). Ötzi
löytyi 1991 Ötztalin Alpeilta lähellä nykyistä Itävalta–Italia-rajaa ja
on esillä Bolzanon arkeologisessa museossa (yleisesti dokumentoitu).
...
ensimmäisestä heksamerkistä. `js/packs/maakunnat-luonnehdinnat.js`-tiedostoa
ei ole muokattu.
