# Maakunnat, erä 2 — ITA, osa 2/2 (viimeiset 10 aluetta)

Sisältökirjurin raportti Fablen tarkastukseen 22.9.2026. EI muokattu
js/packs/maakunnat-luonnehdinnat.js:ää — vain tämä raportti.

Alueet: Calabria, Campania, Abruzzo, Basilicata, Marche, Umbria,
...
10/10 aluetta valmiina (Calabria, Campania, Abruzzo, Basilicata, Marche,
Umbria, Friuli-Venezia Giulia, Liguria, Molise, Valle d'Aosta) — sekä
`pitka` että `kuva` kaikille, mikään ei jäänyt kesken. Kuvat ladattu
kansioon `/Users/samireivinen/Matkakirja-nostot-kuvat/maakunnat/ITA/kuvat/`
(1800 px leveys), sha256-tarkisteet laskettu ja osoitteet muodostettu
kaavan mukaan. `js/packs/maakunnat-luonnehdinnat.js`-tiedostoon ei
koskettu — tämä raportti odottaa Fablen tarkastusta.
