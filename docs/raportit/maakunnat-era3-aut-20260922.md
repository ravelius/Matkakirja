# Itävallan maakuntien pulu-kysymykset (erä 3, AUT, 22.9.2026)

Sisältökirjuri-session tuotos: 2-3 valmista kysymys-vastaus-paria (`pulu`-kenttä)
kaikille Itävallan 9 osavaltiolle. Kysymykset eivät toista `lyhyt`/`pitka`-kenttien
jo kertomia asioita, vaan täydentävät niitä uusilla, tarkistettavissa olevilla
faktoilla (pääosin en-Wikipediasta). HUOM: tätä raporttia EI ole viety
js/packs/maakunnat-luonnehdinnat.js-tiedostoon — tehtävänanto oli vain
sisällöntuotanto raporttiin.
...
Valmiina: 9/9 aluetta (Niederösterreich, Steiermark, Tirol, Oberösterreich, Kärnten, Salzburg, Burgenland, Vorarlberg, Wien).
