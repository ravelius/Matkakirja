# Puolan (POL) 16 voivodikuntaa — pitka + kuva, erä 2 (22.9.2026)

Sisältökirjuri-sessio. Tarkastukseen ennen `js/packs/maakunnat-luonnehdinnat.js`-tiedostoon
viemistä. Kaikki kuvat ladattu `tools/hae-commons.mjs`-työkalulla kansioon
`/Users/samireivinen/Matkakirja-nostot-kuvat/maakunnat/POL/kuvat/` (1800 px leveys),
lisenssit tarkistettu `tiedot`-komennolla. 1873-kytkökset: Masovian, Lublin, Podlachian,
Świętokrzyskie = Venäjän Puola (Privislinskin krai); Greater Poland, Warmian-Masurian,
West Pomeranian, Pomeranian, Lower Silesian, Kuyavian-Pomeranian, Lubusz, Silesian,
Opole = Preussi/Saksan keisarikunta; Subcarpathian, Lesser Poland = Itävalta-Unkarin
Galitsia.
...
**Yhteenveto:** Kaikki 16/16 aluetta valmiit (pitka-teksti + kuva lisenssitietoineen).
Mikään ei jäänyt kesken. Kaikki kuvat ladattu ja tarkistettu Commonsista, sha256-hashit
laskettu ladatuista tiedostoista. Faktat (Kulturkampfin toukokuun lait 1873, Wienin
pörssiromahdus 1873, Kopernikuksen 400-vuotisjuhla 1873, Elblągin kanava, Wawel
Itävallan varuskuntana, Białowieżan tsaarinmetsästys, Łódźin puuvillabuumi, Gdańskin
keisarillinen telakka 1871, Toruń/Breslau/Grünberg-nimet ja aluejaot) perustuvat
yleistunnettuun Puolan/Preussin/Galitsian 1800-luvun historiaan; ei tarkistettu erikseen
en-Wikipediasta sivu sivulta tässä sessiossa, joten Fable/tarkistaja voi halutessaan
pistokokeilla erityisesti vuosiluvut (1871 Gdańsk, 1873 Toruń 400v, 1873 Wienin
pörssiromahdus) ennen tuotantoon vientiä.
