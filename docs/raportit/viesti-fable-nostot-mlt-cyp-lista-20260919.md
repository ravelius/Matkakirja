...
2. **Kypros on tiheä**: 13 nykyistä nostoa ja pelikaupunki (Nikosia) rajaavat listan 11:een; useat pyytämäsi (Famagusta, Salamis, Larnaca, Lefkara, Omodos, Hala Sultan Tekke) ovat 0–3,8 yksikköä nykyisistä (Pediaios, Cesnolan kokoelma -skandaali, Khirokitia, Olympos). Jos haluat jonkin näistä, sallitaan tiiviimpi väli (Famagusta 1,8 ja Larnaca 0,0 ovat käytännössä samalla paikalla kuin Pediaios ja Cesnolan kokoelma -skandaalimerkki) tai vaihdetaan nykyinen nosto uuteen; kerro, kumpi.
