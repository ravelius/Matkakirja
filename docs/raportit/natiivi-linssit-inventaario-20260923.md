...
| 4 | Keksinnöt | keksinnot.js + aikajana | Pysäkkiajo, valot, tummennus, pysäkkiluennat, tiedeliite, lamppujen napautus, pelaajan X-toive | **= web iPadilla 24.9.**: tummennus (lineaarinen tila, eksponentti 1,75 → 48–54 vs web 49), valojen hehku, reiän peilaus, paalun reikä, pistekerroin Round(dpi/163). Reiän kulku hypyssä (siirraReikaMatkalla) ei ole webin keksinnöissä käytössä (kaarella ei reitti/hyppykamera) |
