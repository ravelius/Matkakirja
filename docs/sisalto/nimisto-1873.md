...
## e) Espanjan historialliset maakunnat/kuningaskunnat 1873 (16 riviä)
...
samalla schemalla. Saksa, Italia ja Espanja tehtiin samassa erässä,
kukin omalla haarallaan, yhdistettynä `sisalto-nimisto-aika`-haaraan.
Loput Fablen antaman järjestyksen mukaisesti.
