...
| Linssikalvot (js/pallolauta/linssit.js, polygonsData) | Ei muutosta: läpinäkyvät kalvot piirretään kerroksen jälkeen (kerros `renderOrder` ≤ 7 < 0? — kerros kirjoittaa syvyyden ja piirretään läpinäkyvien ensimmäisenä kuten lepokerros: `renderOrder = -10 + z`). | Kalvojen korkeus. |
