...
## TV-napit poistettu (omistajan päätös, v434)

TV-napit poistettiin kokonaan pelistä (koodi, tyylit, muutosloki,
worker-ohje) — laukaisivat toistuvasti tietoturvaluokittimen. Radio ja
uutiset jäävät. Tarkistin 9.8.2026: omassa sisällössäni
(`nahtavyysjutut.js`) ei ole tv-nappi-viittauksia — ainoat "tv"-osumat
ovat aidosti asiaankuuluvia (Berliinin "Tv-torni"/Fernsehturm-kohde ja
maininta Prahan Petřínin tornin tv-signaalihistoriasta). Älä lisää
tv-mainintoja jatkossakaan.
