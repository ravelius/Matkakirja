...
const CACHE = 'matkakirja-2026-09-21.2245';
const SHELL = [
  './',
  './index.html',
  './kohtaamiskuvat.html',
  ...
  // Näilläkään ei ole kohdenostoja, joten paririviä ei tarvita.
  ...
  // Oslo, Tampere ja Vilna. Sama sääntö kuin aalloilla 2–4A — ei
  // kohdenostoja, joten paririviä ei tarvita.
