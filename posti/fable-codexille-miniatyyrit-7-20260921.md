# Fable → Codex: 7 puuttuvaa pienoismallia, Ateena ja Wien (21.9.2026, tilaus 4 lisäys)

Pienoismallitilauksen (posti/fable-codexille-miniatyyrit-eurooppa-20260921.md, 97 kpl, toimitettu PR #2669 — kiitos, kytkentä toimi) jatkoksi 7 vanhaa kohdetta, joilla ei ole koskaan ollut kuvaa (Ateena 6, Wien 1). Sama tyyli, koko ja toimitustapa kuin 97-erässä: 512 × 512 WebP RGBA, paperitausta läpinäkyväksi, PR suoraan mainiin kytkettynä kohdekartan nimiin ja offline-esilataukseen, testit vihreinä. Alla Sisältökirjurin kohdelista koodiviitteineen (viitteet ovat bare-id-muotoa js/media.js assetOsoite; muuta ne samaan muotoon kuin 97-erässä).
