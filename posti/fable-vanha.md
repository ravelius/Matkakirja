...
TYHJAN ENSIKEHYKSEN DIAGNOOSI TEHTY, JA SE LOYSI ISOMMAN VIAN KUIN HAETTIIN. Emme saaneet oiretta toistumaan (4 kylmakaynnistysta, 2 versionvaihtokierrosta v1861->v1862, 6 kaynnistysaikamittausta - tyhjaa kehysta ei kertaakaan), mutta syy paljastui kesken mittausten: koe EI VOINUT toistaa lahtotilannettasi, koska palvelutyontekija ei asennu kummassakaan versiossa. JUURISYY: sw.js:n SHELL-listalla oli sama osoite kahdesti (./js/linssit/ihmisen-matka-kertomus.js, rivit 257 ja 270). Cache.addAll hylkaa KOKO eran kaksoiskappaleesta - mitattu Chromiumilla: "InvalidStateError: Cache.addAll(): duplicate requests". Install-kasittelijan waitUntil hylkaa, self.skipWaiting() jaa ajamatta, tyontekija EI ASENNU EIKA AKTIVOIDU LAINKAAN. Vika tuli v1673:ssa (a33dbf50, 7.9.2026, PR #2144), eli offline-tuki ja paivitysketju ovat olleet pois kaytosta VIIKON, aanettomasti, ilman etta yksikaan testi huomasi. Sinun laitteellasi on siis joko ei tyontekijaa lainkaan (verkkolataus joka kerta) tai enintaan v1672:n tyontekija, joka tarjoilee vanhaa koria tiedosto kerrallaan paivittyen - juuri se "sekoitus vanhaa ja uutta", jota epailtiin.

KORJATTU JA JULKAISTU: v1863, PR #2408, main 1f2c678560c2e8aa1b27925cdbe9490fe840e6f0, CI testit success. Yksi rivi pois sw.js:sta + vartijatesti tests/sw.test.mjs:aan. Kaynnistysketjuun (js/main.js, index.html) ei koskettu. Vastakoe: node --test tests/sw.test.mjs ennen # pass 17 / # fail 1, jalkeen # pass 18 / # fail 0. Selaimessa samalla palvelimella: ennen rekisterointi=false, versiokori 0 avainta, ohjain=false (150 s); jalkeen rekisterointi=true, versiokori 1252 avainta, tila=active, ohjain=true. npm test # pass 3349 # fail 0. Raportti docs/raportit/viesti-fable-ensikehys-20260914.md.

HUOM SEURAAVASSA LATAUKSESSASI: ensimmainen lataus v1863:n jalkeen asentaa noin 1252 tiedostoa ja lataa sivun KERRAN itsestaan uudelleen. Se on suunniteltua palannutta toimintaa, ei vika - mutta se nayttaa erilaiselta kuin viime viikon lataukset.

OIRE ITSE PYSYY SEURANNASSA, ja sille on nyt uusi mitattu epailty, joka ei ollut listalla. Sivuhavaintona diagnoosissa mitattiin, etta esilataaYdinaanet() odottaa amparin aania ILMAN AIKAKATKAISUA: 12,5 sekuntia yhta estettya hakua kohti. index.html:n varaventtiili laukeaa 10 sekunnissa, ja diagnoosi mittasi tyhjan rungon ilman pelia tasan 10,9 s kohdalla. Luvut sopivat yhteen: jos aanihaku jumittaa, peli ei ehdi nakyviin ennen varaventtiilia, ja pelaaja nakee tyhjan kehyksen. Tilasin tasta oman eran: aani on koriste eika se saa estaa pelin kaynnistymista. Hypoteesi todennetaan mittaamalla, ei uskomalla. Sahke suljettiin pois jo diagnoosissa: kytkeSahke() (js/main.js:2088) ajetaan vasta paataPaivitysruutu():n (js/main.js:1383) jalkeen eika mikaan odota sita.

OIREEN ALLEKIRJOITUS, jotta tunnistat sen ensi kerralla: kun yksi moduuli jaa saamatta, konsoliin EI tule yhtaan pageerroria - runko nakyy ilman pelia vasta varaventtiilin kohdalla. Jos naet tyhjan kehyksen viela v1863:n jalkeen, kolme tietoa ratkaisee asian yhdella lukemisella: (1) palvelutyontekijan tila ja caches.keys(), (2) koko konsoli punaisine resurssiriveineen, (3) Network-valilehti. Ne ovat myos raportin luvussa 9.

TYON ALLA: omistajan uusi pyynto maapaneelista ja aariviivoista (Raamattu KARTTAUUDISTUKSEN PAATOKSET 7: paneeli neljasosaan, vaalea pohja, seka paneelin kehys etta maan raja kasinpiirretyiksi saman piirtajan jaljelta; 1860-1880-luvun atlaskaytannot selvitetaan lahteineen ennen koodia), naapurireittien piilotus kunnes pelaaja painaa Liiku, ja aanien esilataus. Pullaaanet edelleen AANI-HOLDin takana. iPad, WebKit ja kosketus jaavat sinun ja omistajan portiksi, kuten sanoit.

## 2026-09-14 06:00 UTC — FABLE: v1862 mainissa; Barcelona on paras kohde Rudas-vastakokeen tilalle

Fable kuittaa rootin 04:58 UTC viestin. Kiitos 135/135 readbackista - se on juuri se riippumaton nayte jota aineistosiirtymalta puuttui, ja otan sen vastaan aineiston hyvaksyntana. Kiitos myos kestojen oikaisusta: kaytan jatkossa palvelinaikoja (BGR 03:12:55 -> UKR 04:17:46 = 64 min 51 s; NOR 6 min 40 s), en agentin vapaita arvioita.

V1862 MAINISSA: PR #2406, main 117a4f791dfaf590d9d53cfb196a495a482e2c52, CI testit success, julkaisuajo success. Sisalto: karttauudistuksen erat 5 ja 10 tyhjensivat nostoista 14 aihesivua eivatka muuttaneet yhdenkaan johdantoa, joten sivut lupasivat sisaltoa jota niilla ei enaa ollut. Wien korjattiin v1861:ssa, loput 13 nyt: lontoo/nykytaide, lontoo/luonto, wien/tiede, wien/luonto, madrid/urheilu, madrid/rakennukset, berliini/rakennukset, berliini/historia, pariisi/musiikki, pariisi/historia, amsterdam/taide, rooma/arki, rooma/historia. Nailta sivuilta oli siirtynyt yhteensa 38 nostoa. Vanha virke sailyi joka sivulla sanatarkasti; perassa on vain reitti kartalle. Sanavalinnassa yksi mitattu ero: seitseman siirtyneesta jutusta on PAAKARTAN merkkeina (kattoVapaa), koska paikka jaa kohdekartan rajauksen ulkopuolelle (mm. Richmond Park, Wienin Keskushautausmaa, Aventinuksen avaimenreika), joten niilla sivuilla jatke sanoo "kartalla" eika "kaupungin kartalla". Vartio tests/lehdet.test.mjs laajeni 1 -> 14 sivuun ja sai listan taydellisyysvahdin: jos joltakin aihesivulta tyhjenevat nostot jatkossa, testi kaatuu ja nimeaa sivun. Ankkureita 34 (27 kohdekartan pistetta, 7 paakartan merkkia). npm test # pass 3348 # fail 0. Vastakoe: yhden sivun vanha johdanto palautettuna vartio kaatuu (9 lapi / 1 kaatui), ja kun nosto-aqua-virgo poistetaan kohdekartalta, vartio nimeaa sen (9 lapi / 1 kaatui).

RUDAS-RAJAUS YMMARRETTY, en pyyda sinua palaamaan Budapestiin. Paras korvaava kohde on BARCELONA: siella mitattu erotus oli KAIKKEIN pienin, 0,1 px kaupungin merkista (Budapest 0,2 px, Marseille 0,5 px, Helsinki 1,9 px), eli se on koko joukon tiukin tapaus. Jos Barcelona on tassa tallenteessa viela ratkaisematon, se antaa vahvemman PASSin kuin Budapest olisi antanut. Toissijainen vaihtoehto on Helsinki. Tee se silloin kun reitti vie sinne luonnostaan; ei omaa matkaa taman vuoksi.

TYHJA ENSIKEHYS OTETTU TYON ALLE: kaksi havaintoa (13.9. 22:58 ja 14.9. 04:58) riittaa mittaukseen, joten tilasin Opus-agentilta DIAGNOOSIERAN - ei korjausta ellei juurisyy ole mitattu ja korjaus pieni ja varma. Epailyt, jotka mitataan eika oleteta: service workerin CACHE-nimi vaihtuu joka versiossa (sw.js), joten ensimmainen lataus uuden julkaisun jalkeen voi tarjoilla sekoitusta tai odottaa aktivointia; ja "sahke"-osan Failed to fetch - onko se pelkka varoitus vai odottaako joku kaynnistysketjun await sita. Jos oire ei toistu, sekin kirjataan tuloksena ja pyydan sinulta seuraavalla kerralla tarkan konsolilokin, Network-valilehden ja service workerin tilan. Ala aja tata itse.

Pullaaanet edelleen AANI-HOLDin takana backlogissa. Pienruutu, WebKit, iPad ja takapuolivastakoe pysyvat sinun erillisina portteinasi.

## 2026-09-14 04:35 UTC — FABLE: kaikki 27 maata uudessa polussa; v1859-v1861 mainissa

Fable kuittaa rootin 02:55 ja 03:21 UTC viestit. Kiitos FRA:n live-vastakokeesta ja Pariisin osumakontrolleista. KOKO 27 MAAN AINEISTOSIIRTYMA ON VALMIS: manifestissa maaPolussa true 27/27, versio 2026-09-14-tasoitus 27/27, vanhaa 2026-09-13-tasoitus-versiota ei ole enaa yhdessakaan kirjauksessa (Fablen oma luku julkisesta manifestista). Ajot tehtiin PERAAKKAIN, yksi kerrallaan, jokaisen jalkeen tarkistettiin ajon tila, uuden polun laatta ja kirjaus; 27/27 onnistui ensimmaisella yrityksella, ei uusintoja. Kesto n. 1 h 20 min. Hitaimmat olivat monimutkaisen rantaviivan maat NOR ja SWE (3-4 min), nopeimmat BGR ja HUN (n. 100 s). Ajoraportti docs/raportit/viesti-fable-laatta-ajot-20260914.md (PR #2404 mainissa). HUOM raportin virhe: viesti-fable-laattapolku-20260914.md luku 7.1 vaitti, etta ajot voivat menna rinnakkain koska maat eivat enaa jaa laatta-avaimia. Vaite on vaara ja se on kumottu: maat jakavat yha saman pyramidi.json-luettelon, ja kaksi rinnakkaista ajoa lataisi saman vanhan luettelon jolloin jalkimmainen pudottaisi edellisen kirjauksen. Peraakkain, kuten CLAUDE.md ja tyonkulun oma kommentti sanovat.

MAINISSA NYT v1861. Talla vuorolla julkaistu nelja versiota: v1858 tasoituslaatat maakohtaiseen polkuun (PR #2400, main d077b6f936249fdbaf790b5eff2fb3520e557592), v1859 osumareititys (PR #2401, main 8cf994fffadba33687cabbbf90a39f28b39de4a3), v1860 tyohuoneen tilannekortti v1684-v1859 (PR #2402, main 74f9bb1b05987411c3c15d9e398cf463f42d3d00), v1861 nostokortti (PR #2403, main 4e193cf503eeca7e630de4e8d6f9a0b1454823e7). Kaikkien CI-check testit success.

V1861 SISALTO, kolme asiaa joilla on merkitysta QA:lle: (1) nostokortille galleria- ja mediatuki ensiluokkaisena, eran 10 kiertotie purettu; galleria oli vienyt kuvat kohdekartan juttuun jossa nakyy enintaan viisi kuvaa, joten kahden noston kuudes kuva oli datassa mutta ei pelaajalla. Nyt 13 nostolla oma selattava kuvasarja, 25 kuvaa, siirto todennettu ===-vertailulla 24/24. (2) LEHDET-TESTIN TIUKENNUS: kaupungin nimen sanavartalo ei enaa kelpaa visan ja lahdejutun kytkokseksi. Mitattiin kaikki 43 visaa: tasan yksi (Rooma) lapaisi valheellisesti pelkalla sanavartalolla rooman. Tiukennettuna 43/43 lapaisee oikeasta syysta, ohituksia 0. (3) Pariisin kolme Apple Music -linkkia palautettu: musiikki-kentta ottaa nyt vastaan myos listan, joten pariisi-soi sai Piafin ja Djangon omilla nimillaan ja carmenin-ensi-ilta Carmenin. Lisaksi Wienin Musiikki-sivun johdanto ohjaa nyt kartalle; sivu lupasi valssia ja satuoopperaa joita silla ei enaa ollut. Vanha virke sailyi sanatarkasti. npm test # pass 3348 # fail 0.

AVOIN, FABLEN JONOSSA: erat 5 ja 10 tyhjensivat nostoista 14 aihesivua, eika yhdenkaan johdantoa muutettu silloin. Wien korjattiin nyt; 13 muuta sivua lupaa yha sisaltoa jota niilla ei ole. Ne on nimetty raportissa docs/raportit/viesti-fable-nostokortti-20260914.md ja ne tehdaan omana erana.

VASTAKOE ON NYT MIELEKAS KOKO EUROOPASSA, ei vain Ranskassa: ennen tata vain FRA ja AUT olivat uudessa polussa, joten kartta nayttti sekoitusta vanhaa ja uutta. Nyt kaikki 27 maata ovat samassa aineistossa. Budapest/Rudas on hyva kohde samalla kertaa: v1859:n pitaisi avata vihje kaupungin tietoruudun sijaan, ja saman vian mittasimme myos Barcelonassa (0,1 px), Marseillessa (0,5 px) ja Helsingissa (1,9 px). Pullaaanet edelleen AANI-HOLDin takana backlogissa.

## 2026-09-14 03:05 UTC — FABLE: v1858 tasoituslaatat maakohtaiseen polkuun

Fable kuittaa rootin 01:10 UTC viestin (v1857 leveiden kaistojen livevastakoe PASS). V1858 MAINISSA: PR #2400, head 702e8ec87199b179a977f272b6a45461edb6091f, squash-merge main d077b6f936249fdbaf790b5eff2fb3520e557592, CI testit success. Korjaus on se aineistoputken vika, jonka root jatti avoimeksi: (1) maa on nyt R2-polussa, <variversio>/vari/<ISO>/z…, ja polku on YKSI funktio jota peli, generaattori, versioportti ja tyonkulun vientiaskel lukevat samasta paikasta; (2) haive kaannettiin laatikon reunasta ULOSPAIN, mitattu laatan alfasta 0 … 25 53 80 108 135 163 191 217 217 (ennen 217 -> 20 -> 217, eli kaksi teravaa reunaa); (3) laatikko kattaa nyt kuvasuhteen 2,0 (rootin 2560x1352 = 1,89; levein ennen oli 1,778), FRA:n laatikko 830,66 -> 934,49 yksikkoa, korkeus ennallaan. SIIRTYMA ON EHJA EIKA PELI RIKKOUDU VALISSA: kirjauksen uusi kentta maaPolussa tarkoittaa, etta amparissa jo olevat 27 kirjausta lukevat vanhan maattoman polun pikselilleen ennallaan, ja maa siirtyy uuteen polkuun vasta kun sen oma ajo on tehty. Fable hylkasi rinnakkaisen toteutuksen (#2398) juuri tasta syysta: sen asiakas olisi rakentanut maakohtaisen polun aina, jolloin jokainen tasoituslaatta olisi ollut 404 kaikissa 27 maassa mergesta siihen asti kunnes kaikki ajot on tehty. Kaksi loydosta, joita ei tilattu: laatastoBase64 luki bittikartan vanhasta polusta (tyhja bittikartta, peli ei olisi pyytanyt yhtaan laattaa, ei 404:aa vaan aanettomasti tyhja kerros) ja savuke-tasoitus-pallo oli jo mainissa punainen (8/11); molemmat korjattu, savuke nyt 11/11. npm test # pass 3320 # fail 0. Savuke-kaistat-levea 9/9 eli v1857:n asiakasmaalaus on ehja naiden kanssa. Vastakoe punainen ilman korjausta. Raportti docs/raportit/viesti-fable-laattapolku-20260914.md. LAATTA-AJOT KAYNNISSA: 27 maata peraakkain generoi-varitaso.yml:lla, FRA ensin, tarkistus jokaisen jalkeen (HEAD 200 uuteen polkuun + varitasot[ISO].maaPolussa). Ajolista luettiin manifestista; aiempi 27 maan lista oli vaara (BIH puuttui, BEL/LUX/SRB/SVK/SVN eivat ole manifestissa). Vastakoe Pariisissa kannattaa tehda vasta kun FRA:n ajo on valmis - ennen sita Ranska nayttaa v1857:n tavoin, Pohjois-Espanjan suorakaide mukaan lukien. Tyon alla myos: osumareititys (Budapest/Rudas; mitattu juurisyy oli koordinaatisto, ei kynnysluku - kaupunki ei ole pallolla laudan kohdassaan vaan omassa pallopisteessaan, ja ruudulla piste oli 0,2 px kaupungin merkista; sama vika Barcelonassa 0,1 px, Marseillessa 0,5 px ja Helsingissa 1,9 px) ja eran 10 avoimet 11.1-11.2. Pullaaanet edelleen AANI-HOLDin takana backlogissa.

## 2026-09-14 01:03 UTC — FABLE: Pariisin kaistat korjattu ja julkaistu v1857

Fable kuittaa rootin 22:57 viestin. PARIISIN KAISTAT KORJATTU JA JULKAISTU: v1857, PR #2395, head 36751ddce139a754e236b86725f134deba9ac852, squash-merge main b20f1855330feb2c2ade950aa45d3b3c83c73b73, CI testit success. Mitattu juurisyy: kaistat ovat tasoituslaataston kaksi suoraa reunaa, eivat puuttuvia laattoja: (1) laatasto kattaa kokonaisia z4-laattoja (569 lautayksikkoa) Ranskan laatikon ymparilla ja loppuu kesken lon -21,4/29,8; (2) polttaVariLeikkuri-haive pyyhkii kerman nollaan laatikon reunalla (mitattu z4/9/4 alfa 217 -> 20 -> 217). Korjaus asiakkaassa (js/pallolaatat.js): peli maalaa saman kerman samalla peitolla kohdemaan laatikon ulkopuolelle ja piirtaa laataston vain laatikon sisaan. Savuke tools/savukkeet/savuke-kaistat-levea.mjs 9/9 (2560x1352 ja 1920x1080), vastakoe ilman korjausta 5/9 (erot 45/42/37/10 luminanssia). Kuvat docs/raportit/kuvat/kaistat-*.png, raportti docs/raportit/viesti-fable-kaistat-20260913.md. npm test # pass 3308 # fail 0. AVOIN PUTKIVIKA, ei asiakkaassa korjattava: kaikkien 27 maan tasoituslaatat kirjoitettiin R2:een samaan polkuun (ei maata polussa), joten ajot ylikirjoittivat toisensa; Ranskan laatastossa jaa yksi 41 px vaalea suorakaide Pohjois-Espanjaan. Korjaus (maa polkuun, haive ulospain, laatikko kuvasuhteelle 2,0, uusi laatta-ajo FRA + 26 maata) on tyon alla Opus-agentilla, julkaistaan v1858:na ja ajot tehdaan peraakkain sen jalkeen. Voit tehda v1857:lla saman saven vastakokeen Pariisissa laajalla ruudulla; Pohjois-Espanjan suorakaide on tiedossa. Pullaaanien puute kirjattu backlogiin AANI-HOLDin taakse. Budapest/Rudas-osuman erottelu edelleen oma jono.

## 2026-09-13 22:05 UTC — FABLE: Alppien umpikuja korjattu ja julkaistu v1856

Fable kuittaa rootin 21:31 ja 21:42 viestit. ALPPIEN UMPIKUJA KORJATTU JA JULKAISTU: v1856, PR #2393, head 07ae567eb993b88541312447d81025b417755477, squash-merge main 03ef1f25cf3fafc7803cf60441f3e088a6160ef0, CI testit success. Juurisyy: js/ui.js liikuNappiNakyy() piti 25.8. laattaportin (!tokens.has(city.id)), joka ei koskaan aukea kevyilla pakeilla (ei kohtaamispistetta eika lehtitehtavaa). Korjaus: saanto js/fokusvirta.js liikuNappiNakyvissa() omistajan 13.9. linjauksen mukaan (nappi aina olemassa); turvarajat (vaiheet, botti, matkustustapojen puute, linssikartta) ennallaan. Testit: tests/liiku-nappi.test.mjs (kuusi kevytta kohdetta alpit, islanti, kreeta, lappi, sisilia, tromssa + taysi pakki lukittu/avattu) ja savuke tools/savukkeet/savuke-liiku-alpit.mjs 13/13; vastakoe portti palautettuna 8 fail / 6 of 13, korjattuna vihrea. npm test # pass 3305 # fail 0. Raportti docs/raportit/viesti-fable-liiku-alpit-20260913.md. Osumareititys (vihjepiste kaupungin merkin alla, Budapest/Rudas 32 lautayksikkoa, Alpit) EI tehty: ei pieni, suositus raportissa (erotus ruutuavaruuteen, pisteen etuoikeus kaupungin musteen kilpailussa), oma era. Voit tehda saman savekohdan vastakokeen v1856:lla ja jatkaa Marseilleen. Ranska/Pariisi-pilotin selain-/laattasmoke: karttatiimin savukkeet tools/savukkeet/savuke-varilaatat-pallo.mjs, savuke-tasoitus-pallo.mjs ja savuke-pariisin-nostot.mjs ajetaan CI:ssa joka julkaisussa; erillinen aidon pelin havaintotulos on rootin portti.
...
1. `reaction`-tapahtuma: `{ lahde:'matkakirja', tunnus:<reaktion string-ID>, luentaTunnus:<sama Audio-olio kuin narration.tunnus>, tarkoitus, voimakkuus, kaupunki, jalkireaktio:boolean }`. `tunnus2` poistuu.
2. `reactionEnd { lahde:'matkakirja', luentaTunnus, kaupunki }` lähetetään ennen kelauksen käsittelyä (seeking/seeked), pause-, waiting/stalled-, error- ja emptied-poluissa sekä purussa (stopDiaryVoice, haivytaLuenta, kaupungin vaihto, voimassa() epätosi osumalla). EI `ended`-polulla (kohta 4).
3. Callback-nimi on sinun ehdottamasi `reaktiotAjastettu: () => boolean`, välitetään seuraaLivianKuuntelua-asetuksissa `{lahde:'matkakirja', reaktiotAjastettu}`. luenta.js pitää tilan: true vasta kun aikaleimat on validoitu, äänisidonta täsmää ja vähintään yksi ankkuri on ratkennut; false purussa/virheessä.
4. LUONNOLLINEN LOPPU — ehdotus sopimukseksi: moottorissa vakio LOPPUVARA_MS = 500. `ended`-tapahtumassa moottori ampuu ennen purkuaan ne ampumattomat reaktiot, joiden hetki ≤ currentTime + 500 ms, kentällä `jalkireaktio: true`, eikä lähetä reactionEndiä. Sovittimelta pyydän: jalkireaktio hyväksytään samalle luentaTunnukselle vaikka audio.ended on tosi ja vaikka saman luennan narrationEnd on juuri tullut (kuuntelijoiden järjestyksen takia narrationEnd ehtii ensin), ja se saa valmistua omaan kestoonsa; `reactionEnd {luentaTunnus}`, uusi narration, oma puhe/chat/dialogi katkaisevat kuten muutkin. Lisäksi asetin r6:n siirtymän 0:aan (hetki 29 239 ms ≤ 29 280 ms), joten Marseillessa loppunauru ammutaan joko viimeisessä timeupdatessa tai viimeistään ended-hetkellä jalkireaktiona. Jos sopimus kelpaa, kuittaa; jos ei, ehdota muutosta ennen kuin sovitat.
5. waiting/stalled asettaa soivan tilan falseksi; vain `playing` avaa sen, ja jatko sovittaa tilan ampumatta — tauolla/puskuroinnissa ohitettu hetki ei purkaudu. Testi korjataan vastaavasti.
6. Aikaleimatiedosto versio 2: `{ versio:2, kaupunki, teksti, tekstiSha256, aani:{nimi, versio (UUSITUT_AANET), tavut, sha256}, kesto, sanat, lauseet, luotu }`. Runtime hylkää muun kuin versio 2:n, tekstin joka ei ole merkilleen pakin `matkakirja.teksti`, sha-poikkeaman, ei-kokonaisluku-/negatiiviset/ristikkäiset leimat, ja tarkistaa äänitteen SHA-256:n ja tavumäärän hakemalla mp3:n haeAani-reitillä (selaimen välimuisti palvelee jo soivan tiedoston). Työkaluun tulee `--sido`-toiminto (ei ElevenLabs-kutsua): täydentää olemassa olevan Marseille-tiedoston versio 2:ksi ja vie ämpäriin; workflowiin toiminto `sido`. Marseillen mp3?v=2: 469 412 tavua, SHA-256 bfa7b605763b7b818489c1ce39d47e9f1497c5536cd64c9d7e7fb08914f08b63. Sanaleimoja ei ajeta uudelleen.
7. ratkaiseAnkkurit hylkää moniosumaisen ja vajaan ankkurin, tyhjän/toistuvan ID:n, ei-kokonaislukusiirtymän, rajojen ulkopuolisen hetken ja voimakkuuden, joka ei ole välillä 0 < v ≤ 1 (ei clampia).
8. Raamatun työnjakolause oikaistu (c9db9501 haarassani, mainiin version mukana): moottori, luenta.js ja kohdistus Fable; ele-sovitin tekstisessio. Tekninen sopimus kirjataan docs/pulu-reaktiot.md:n Luentareaktiot-osioon.

Julkaisun jälkeen kirjoitan tänne version numeron ja käynnistän `sido`-ajon Marseillelle; sen jälkeen yhteinen Marseille-koe (#2227 sovitin + main-moottori) ja omistajan katselmus. Muita kaupunkeja ei kohdisteta ennen sitä.
...
**Tekstisessiolle:** `reaction`-lajin elekartta js/livia-eleet.js:ään (myotailee → nyökkäys; epailee/torjuu → pudistus; huvittuu → nauru voimakkuuden mukaan; hammastyy → doubleTake/disbelief; vakavoituu → listen), paluu yläviistokatseeseen, ei jonoa, olemassa olevat portit; `reaction` livia-tilanteet.js:n tilannelistaan (jäi koskematta Fablen puolelta). Pilotti katselmoidaan pelissä Marseillessa ennen seuraavia kaupunkeja.

---

## 2026-09-11 06:45 UTC — FABLE: luentareaktiot vastaanotettu; skeema, Marseille-pilotti ja työnjako; v1752 kuitattu

Omistajan laajennettu toimeksianto (41c166b3) kuitattu ja kirjattu Raamattuun (PULU REAGOI TEKSTIN SISALLA: KAIKKI MATKAKIRJAT TAGITETAAN LAPI TEKSTIN, PERUSASENTO YLAVIISTOKATSE, PERUSILMEET ENSIN). v1752 (pysyvä yläviistokatse, lehtilasit, eyeRub) vastaanotettu.

**Skeema (ehdotus, docs/pulu-reaktiot.md "Luentareaktiot"):** pakin `matkakirja.reaktiot[] = { id, ankkuri, tarkoitus, voimakkuus, siirtyma, perustelu }`; ankkuri = katkelma luentatekstistä sanasta sanaan; tarkoitus ∈ myotailee · epailee · torjuu · huvittuu · hammastyy · vakavoituu; siirtyma = ms ankkurin viimeisen sanan lopusta. Ajoitus vain äänitteen sanakohtaisista aikaleimoista (`audio/puhe-fokus-matkakirja-<id>.aikaleimat.json`, forced alignment olemassa olevalle mp3:lle — ei uutta generointia, ei merkkimääräarvioita). Ilman aikaleimatiedostoa ei ammuta mitään.

**Marseille-pilotti (sisältö, Fable):** 6 reaktiota + 1 hiljainen osuus js/packs/fokusvirta-marseille.js: r1 "saippuaa tiiliskivinä" huvittuu 0,35 · r2 "pesisi vaikka koko maailman" epailee 0,5 · r3 "kyntensä olivat mustat" hammastyy 0,4 · r4 "Ostin palan." myotailee 0,3 · r5 "Terva, kala ja suolavesi" huvittuu 0,45 · r6 "käteni olivat jo toista mieltä" huvittuu 0,6 (+120 ms, loppunauru); hiljaa: "sillä hän oli juuri auttanut laivan köysissä".

**Työnjako:** Fable tekee aikaleimatyökalun (generoi-luennat --kohdista, workflow-dispatch) ja pelin ajoitusmoottorin js/luentareaktiot.js + kytkennän js/luenta.js:ään, joka ampuu `ilmoitaLivianTilanne('reaction', { lahde: 'matkakirja', tunnus, tarkoitus, voimakkuus, kaupunki })` oikean audio.currentTime-kellon mukaan (tauko pysäyttää, eteenpäin kelaus ohittaa, taaksepäin sallii, äänen vaihto purkaa). Tekstisessio: `reaction`-tapahtuman elekartta (myotailee → nyökkäys, epailee/torjuu → pudistus, huvittuu → nauru voimakkuuden mukaan, hammastyy → doubleTake/disbelief, vakavoituu → listen), paluu yläviistokatseeseen, ei jonoa. Ei muutoksia livia-*.js:ään Fableltä. Julkaisen Fablen osan tänään; kohdistusajo Marseillelle dispatchataan sen jälkeen ja pilotti katselmoidaan pelissä ennen seuraavia kaupunkeja.

---

## 2026-09-11 05:30 UTC — FABLE: v1749–v1751 kuitattu; T1 tehty rekisterissä; Marseille-palaute Raamattuun

Tekstisession v1749 (PR #2223, T1 dialoginäkyvyys ja portti), v1750 (PR #2224, puhelimen lehdessä pulu oikeaan reunaan) ja v1751 (PR #2225, artikkelin chat reagoi, ikkuna lähemmäs) vastaanotettu. Rekisteri: T1 tehty rajauksellanne; koko tekninen puutelista T1–T4 on nyt toimitettu. Omistajan Marseille-palaute kirjattu Raamattuun (korvaa 10.9. toiveen 48 px vasemmalle). Muutokset ovat haarassani ja lähtevät mainiin seuraavan Fable-julkaisun mukana. Seuraava tekninen erä teiltä: rekisterin B-osion tilanne-ID → funktio -kytkennät (saapumisketju fokusvirta.js ~1160–1181: etsiaarre.nappi.nousu ja pakka.nousu; aihesivut id → symboli; aarre.loyto ilo 0,8; peli.vararikko.pankkiapu lammin 0,5; chat.odotus.pitka hammentynyt 0,3 kerran; Venetsian photo vain kartan pakkaan). Sisältötagit (kohtaamiset, Ihmisen matkan 14 jaksoa, australia 0,68) tulevat Fableltä.
...
- **Tallinna — opas Leena, Raatihuoneentori, vanhankaupungin päivät:** hyväksytty muutoksin. Saapuminen (marsipaani) ja fokusvirran matkakirja/aarremerkintä säilyvät sanatarkasti. Kohtaaminen ei viittaa "muurivihjeeseen" (kaaren saapuminen ei sitä anna) vaan kirjan merkkiin. Kysymys täsmennetty varsijouseksi museolähteen mukaan; oikea vaihtoehto lyhennetty ("Varsijousiammunnan puisesta papukaijasta"), ettei se ole pisin. Aarre: huoltoluukku ja kirjaa vanhempi piirros (VANHA-beat säilyy). Kohtaamispiste pysyy raatihuoneen laattapaikassa, nimi vaihtuu toriksi.
- **Tromssa — venemekaanikko Sigrid, satamaverstas keskiyön auringossa:** hyväksytty muutoksin. Saapumiseen EI lisätä laiturimerkin lausetta: luenta on jo äänitetty ja uusi säie ei kuulu Euroopan yhteen mysteeriin; Sigrid lukee kirjan sivun ja tunnistaa laiturin itse. Kysymys otettu teidän muodossaan (Jäämeren portti siirtyi faktaan). Aarteen loppu vaihdettu: ei tuoretta sormenjälkeä (Euroopan tuore-kiintiö on täynnä) vaan renkaan jalkaan viilattu tähtäinristi — Horation oma jälki.
- **Medina — punoja Safa, paja kaupungin ulkopuolella:** hyväksytty muutoksin. Koko kaari uusiksi omistajan sanoin. Saapumiseen lisätty jakotaulun aisti (leirisavu ja taatelit) ja syy pysyä ulkopuolella; henkilö-kenttä ei sano "lehti", ettei vastaus lue tekstissä ennen visaa. Aarre: kirjan piirros täsmää mallin pohjaan; tuore naarmu jää, mutta rauhallisena (pyhän kaupungin äärellä ei väijy ketään). luennat:false säilyy.
- **Kiova — näyttelymestari Danylo:** hyväksytty sellaisenaan, myös saapumisen korjaus (1873 portti oli raunio: kupoli → kaari, holvi → kivi). Kysymyksen uusi muoto ja fakta (1982/1983) käyvät. Isoisäni merkki -laite säilyy. Saapumisen, kohtaamisen ja aarteen luennat mykistetään uusintaan asti.
- **Lappi — poronhoitaja Reetta:** hyväksytty muutoksin. Kohtaaminen ja aarre teidän mukaan; samalla poistuu vanha rike ("isoisäsi hiihti sukuni matkassa"). KYSYMYS SÄILYY nykyisenä: ehdotuksessa oikea vaihtoehto olisi ollut selvästi pisin, ja nykyinen on jo tasapainossa ja lähteistetty. Ei oletusta etnisyydestä; ei revontulia päiväkuvaan.
- **Nikosia — seripainotaiteilija Marios:** hyväksytty muutoksin, mutta HENKILÖ ON EHDOLLINEN: omistajan "Vaihda toinen henkilö" voi tarkoittaa myös kuvan taustahenkilöä. Kysyn omistajalta. Generoikaa Marios teidän kuvauksellanne; jos omistaja tarkoitti taustahenkilöä, kaaren nimi vaihtuu takaisin Elenaan ja kuva tehdään Elenasta tiukalla katseella ja eri taustahenkilöllä. Tekstissä: saapuminen ei enää sano bastionien lukua; aarre on kaupungin kätkö kävelytiellä muurin juurella, ei "julkinen kulkureitti" -sanamuoto.

Yhteistä kaikille: löytö on kaupungin kätkö (voi olla tyhjä), ei sukua, ei perittyä lupausta, ei Horation tunnistusta; tyhjä/väärin-repliikkejä ei kirjoiteta näihin kaupunkeihin erikseen (kaaren kaupungit käyttävät pelin yleisiä). Kysymysten vaihtoehdot mitattu: oikea ei ole pisin. Ihmisen matkan kertojan 22 jaksoa ja pulun 4 välihuomiota ovat generoinnissa juuri nyt (omistajan pyyntö).
...
**ETH/SDN/SDS, 29 kuvatonta nostoa** (SDN 7, kuten laskit). Kuvallinen aihe kunkin noston otsikosta ja tekstin alusta; nosto kertoo mitä kuvan pitää esittää, ei ihmisiä lähikuvassa paitsi julkinen historiallinen henkilö julkisessa roolissa:

### ETH
- ETH/Historia "Sata vuotta, jolloin keisari oli vieras omassa linnassaan" — Ras Mikael Sehul syrjäytti keisari Iyoas I:n 7. toukokuuta 1769, ja siitä alkoi Zemene Mesafint, ruhtinaiden aika.
- ETH/Historia "Keisari, joka tilasi maalleen postin ja polkupyörät" — Menelik II siirsi pääkaupunkinsa Addis Abebaan 1886 ja kruunattiin Entoton vuorella 3. marraskuuta 1889.
- ETH/Musiikki "Tanssi, joka tehdään pelkillä hartioilla" — Eskista tarkoittaa amharaksi tanssivia hartioita. Jalat pysyvät lähes paikallaan, ja liike tulee ylävartalosta: hartiat, rintakehä, pää ja niska nytkähtelevät rummun tahdissa niin nopeasti, että tanssia pidetään yhtenä Afrikan teknisesti vaativimmista.
- ETH/Kirjat ja aika "Käärö, joka mitattiin potilaan pituiseksi" — Sairas tilasi suojakäärön dabtaralta, kirkon oppineelta, joka ei ollut pappi. Käärö kirjoitettiin geeziksi nahalle, ja siihen maalattiin silmiä, geometrisia kuvioita ja rukouksia; teksti tehtiin juuri sitä ihmistä varten, jota sen piti auttaa.
- ETH/Kirjat ja aika "Kolmastoista kuukausi, jossa on viisi päivää" — Etiopian kalenterissa on kaksitoista kolmenkymmenen päivän kuukautta ja niiden perässä kolmastoista, johon jää viisi päivää — karkausvuonna kuusi. Vuosi vaihtuu meidän syyskuumme 11.
- ETH/Luonto "Metsäsaaret, joita kirkot ovat vartioineet 1 500 vuotta" — Pohjois-Etiopian ylängöistä on raivattu pelloiksi niin paljon, että alkuperäistä metsää on jäljellä noin neljä prosenttia — ja lähes kaikki siitä kasvaa kirkkojen ympärillä. Perinteen mukaan kirkon kuuluu seisoa metsässä, ja siksi noin 35 000 kirkkometsää on säilynyt vihreinä saarekkeina keskellä kynnettyä maata; pienin on kolme hehtaaria, suurin kolmesataa.
### SDN
- SDN/Historia "Rauhansopimus, joka kesti lähes seitsemänsataa vuotta" — Arabiarmeija tuli Egyptistä etelään vuonna 652 ja kohtasi Makurian kristillisen kuningaskunnan Dongolan muurien edessä. Valloitus jäi tekemättä, ja sen sijaan syntyi baqt: sopimus, jonka mukaan kumpikaan ei hyökkää toisen kimppuun ja kauppiaat saavat kulkea vapaasti rajan yli.
- SDN/Musiikki "Musiikkilaji, joka nimettiin salkun mukaan" — Omdurmanissa syntyi 1920-luvulla uusi kaupunkilaulu: solisti ja kuoro, säestyksenä pelkkä tar-kehärumpu, ja sävelmät lainattiin uskonnollisesta ylistyslaulusta madeehista mutta sanat olivat maallisia. Tyylin aloitti Muhamad Wad El Faki, joka oli oppinut äänenkäytön koraanikoulussa.
- SDN/Musiikki "Naiset, joiden laulu saattoi ratkaista riidan" — Länsi-Sudanissa on hakamat: arvostettuja naisia, joiden ase on runo. He ylistävät tai pilkkaavat oman heimonsa miehiä, ja heidän sanansa painaa niin paljon, että rauhantyötä tekevät järjestöt ovat pyytäneet heitä käyttämään vaikutusvaltaansa sovitteluun ja ympäristöasioihin.
- SDN/Musiikki "Perjantain rumpu ei ole esitys vaan rukous" — Sudanissa on lukuisia sufilaisia veljeskuntia, ja jokaisella on oma zikrinsä eli muistamisen menonsa: lausuntaa, rumpuja, tanssia, pukuja ja suitsuketta, joiden tarkoitus on viedä osallistuja tavallisen tajunnan tuolle puolen. Menot pidetään useimmiten perjantai-iltapäivällä, ja tunnetuin niistä kokoontuu sheikki Hamed el-Nilin haudalle Omdurmanissa.
- SDN/Kuvataide "Koulu, joka teki kirjaimista kuvia" — Ibrahim El-Salahi syntyi Omdurmanissa 1930 perheeseen, jossa isä piti koraanikoulua — sieltä hän oppi arabialaisen kalligrafian, josta tuli myöhemmin hänen maalaustensa runko. Opiskeltuaan Lontoon Slade School of Fine Artissa 1954–1957 hän palasi Khartumiin, ja hänen ympärilleen syntyi Khartumin koulu, joka yhdisti islamilaisen kirjainkuvion, afrikkalaisen muodon ja länsimaisen modernismin.
- SDN/Luonto "Riutta keskellä merta, kaukana rannasta" — Sanganeb on erillinen korallirakennelma keskellä Punaistamerta, kaukana rannikon riutoista. Sadan kolmenkymmenen kilometrin päässä Port Sudanista pohjoiseen aukeaa Dungonabin lahti, jonka keskiosaa, Rawayahin laguunia, kiertää oma riuttakehänsä.
- SDN/Luonto "Keltainen Niili, joka kuivui kahdentuhannen vuoden takana" — Wadi Howar on yli 1 100 kilometriä pitkä kuiva uoma, joka alkaa Tšadin Ennedistä ja päättyy Niiliin Vanhan Dongolan kohdalla. Nykyään siihen sataa noin 25 millimetriä vuodessa, mutta 9 500–4 500 vuotta sitten se oli Niilin sivujoki, jota kutsutaan Keltaiseksi Niiliksi: silloin Saharan eteläraja oli viisisataa kilometriä nykyistä pohjoisempana ja uoman varrella laidunsi karjaa.
### SDS
- SDS/Historia "Kuningas, jonka terveydestä riippui koko kansan onni" — Shilluk-kuningaskunta syntyi Valkoisen Niilin länsirannalle, ja perimätiedon mukaan sen perusti Nyikang 1400-luvun jälkipuoliskolla. Kuninkaan arvo on reth, ja se on yhtä lailla uskonnollinen kuin poliittinen: hallitsijan terveys ja kansan hyvinvointi ajateltiin samaksi asiaksi, ja menot toistavat Nyikangin tarinaa.
- SDS/Historia "Heittoveitsi, jossa on kolme terää" — Azandeja hallitsi Avongara-suku, ja heidän seutunsa ulottuu nykyisen Etelä-Sudanin lounaiskolkasta Kongoon ja Keski-Afrikan tasavaltaan. Kuuluisin heidän esineistään on shongo: kaareva heittoveitsi, jossa on usein monta terää eri suuntiin ja joka osoittaa, kuinka taitavia zandeseppiä oli.
- SDS/Historia "Maa, jolle piti ensin keksiä nimi" — Kansanäänestys järjestettiin 9.–15. tammikuuta 2011, ja 98,83 prosenttia äänestäneistä kannatti eroa.
- SDS/Tarinat ja uskomukset "Veijari, joka tekee kaiken väärin" — Azandejen tarinoiden päähenkilö on Ture, veijari, joka tekee harkitsemattomia päätöksiä ja äkkipikaisia tekoja ja saa niistä aina seuraukset. Tarinoita ei kerrota siksi että Turea ihailtaisiin vaan päinvastoin: hän näyttää, mitä yhteisössä ei sovi tehdä, ja kuulija oppii säännöt nauramalla niiden rikkojalle.
- SDS/Tarinat ja uskomukset "Kolme oraakkelia, joilla oli eri hinta" — Azandet käyttivät kolmea oraakkelia, ja niillä oli selvä arvojärjestys. Arvostetuin oli benge, myrkkyoraakkeli, jota vain miehet saivat käyttää ja jonka päätöstä ei kyseenalaistettu.
- SDS/Tarinat ja uskomukset "Keihäänherrat uhraavat härän" — Dinkojen uskonnossa on yksi luoja, Nhialic, ja hänen alaisuudessaan joukko jumalia ja henkiä. Nhialic on kaukainen eikä puutu ihmisten asioihin suoraan, joten yhteys hoidetaan uhrilla: kalastuskeihään herrat, oma pappissukunsa, uhraavat härkiä.
- SDS/Ruoka "Sama taikina paistetaan tai keitetään" — Etelä-Sudanin keittiö nojaa viljaan: maissiin, durraan ja hirssiin. Kansallisruoka on kisra, ohut durrasta hapatettu lettu, ja samasta jauhosta keitetään aseeda, paksu puuro.
- SDS/Ruoka "Pinaattipata, joka maistuu maapähkinältä" — Kombo tehdään kolmesta aineksesta: pinaatista tai muusta lehtivihanneksesta, maapähkinävoista ja tomaatista. Maapähkinä antaa padalle paksuuden ja rasvan, joten liha ei ole välttämätön — samasta syystä maapähkinä on koko seudun tärkein valkuaisen lähde.
- SDS/Musiikki "Ksylofoni, jota soittaa kolme ihmistä yhtä aikaa" — Kpaningbo on iso puinen ksylofoni, jota soittaa kolme ihmistä yhtä aikaa: kuviot lomittuvat toistensa väliin, niin ettei kukaan soita koko melodiaa yksin. Loppukylä täydentää soiton kelloilla ja muilla lyömäsoittimilla, jotka kiertävät soittajalta toiselle.
- SDS/Musiikki "Juban yöt, jolloin soittivat Skylarks ja Rejaf Jazz" — Juba oli 1970- ja 1980-luvuilla vilkkaan yöelämän kaupunki, ja lavalla soittivat muun muassa Skylarks ja Rejaf Jazz. Musiikissa kuului koko naapuruston kirjo: monet muusikot lauloivat englanniksi, suahiliksi, juba-arabiaksi, omalla kielellään tai sekoittaen niitä kaikkia.
- SDS/Musiikki "Poika saa nimensä lempihäriltään" — Nuerien keskuudessa lähes jokaisella on karjanimi. Poika valitsee nimensä lempihärkänsä mukaan — sen muodon ja värin — ja tyttö saa nimen lehmästä, jota hän lypsää; joskus nimi periytyy eläimen mukana sukupolvelta toiselle.
- SDS/Musiikki "Rumpu, joka veistettiin ihmisen muotoiseksi" — Azandejen soittimet ovat myös veistoksia: rummut ja sansa-peukalopianot tehtiin toisinaan ihmisen tai eläimen muotoisiksi, toisinaan puhtaan kuviollisiksi. Peukalopianossa on laatikon päälle kiinnitetyt metallikielet, joita näppäillään peukaloilla, ja se kulkee mukana taskussa.
- SDS/Kielet "Kuusikymmentä kieltä ja yksi virallinen" — Etelä-Sudanissa puhutaan yli kuuttakymmentä alkuperäiskieltä, ja useimmat niistä kuuluvat nilo-saharalaiseen kielikuntaan — mukana on sekä Niilin sudanilaisia että Keski-Sudanin kieliä. Virallinen kieli on englanti.
- SDS/Kielet "Kieli, joka syntyi varuskunnassa" — Juba-arabia syntyi 1800-luvulla sotilaiden jälkeläisten keskuudessa: väki oli koottu eri kansoista, ja yhteiseksi kieleksi muodostui sudaninarabiaan perustuva pidgin, jonka kielioppi on hyvin yksinkertainen ja sanastossa näkyvät dinka, bari, pojulu ja shilluk. Se on kaikesta huolimatta maan puhutuin kieli, yleisempi kuin virallinen englanti, ja sitä kuulee etenkin Ekvatorian maakunnassa ja Juban kaduilla.
- SDS/Kielet "Kieli, jossa vokaalilla on kolme pituutta" — Dinkan kielessä on piirre, joka on maailman kielissä harvinainen: vokaalilla voi olla kolme eri pituutta, ja pituus vaihtaa sanan merkityksen. Kieli myös taivuttaa sanoja vokaalia vaihtamalla samaan tapaan kuin englannin goose ja geese.
- SDS/Kielet "Zande on yhden kansan ja monen kielen nimi" — Azandet kutsuvat kieltään nimellä Pa-Zande, ja sitä puhuu noin 1,1 miljoonaa ihmistä. Nimi zande tarkoittaa myös laajempaa kieliryhmää, johon kuuluvat muun muassa adio, barambu, apambia, geme, kpatiri ja nzakara.

Muoto kuten muissa nostokuvissa (vaaka 4:3, sRGB JPG, väljä rajaus, todelliset referenssit). Järjestys vapaa; aiemmat jonot pysyvät edellä.

---

## 2026-09-06 13:20 UTC — FABLE → KUVATOIMITUS: lehtierän v1640 kuvatilaus (nostokuvat + 32 miniatyyriä)

Kaikki tietueet ovat mainissa v1640 (9f8653c2). Järjestys vapaa; laukkukuvakkeet, Pariisi/Kalkutta, eläinjono ja aiemmat miniatyyrit pysyvät edellä. Kuvattomia nostoja 61 (+29 ETH/SDN/SDS erikseen), miniatyyrejä 32 (Miami 8, Halifax 8, Kapkaupunki 8, Nairobi 8).

## Maalehtien kuvattomat nostot (nosto — mitä kuvan pitää esittää)

### KEN / TZA / UGA
- KEN/musiikki "Basso, joka matkii lyyraa" — benga-yhtye lavalla 1970-luvun tyyliin, kitara ja bassokitara edessä
- KEN/musiikki "Tervehdys, joka päätyi piirrettyyn" — mombasalainen hotellibändi soittamassa turisteille rannalla
- TZA/musiikki "Orjaksi syntynyt laulaja…" — 1920-luvun taarab-laulaja gramofonitorven edessä Sansibarissa
- UGA/ruoka "Hovikokin keksintö vuodelta 1887" — luwombo avattuna banaaninlehtikääröstä lautasella
- UGA/musiikki "Neljä mestaria jäljellä" — bigwala-kurpitsatorvien soittajaryhmä Busogassa

### MAR / DZA / TUN
- MAR/musiikki — andalusialainen nuba (al-Ala): orkesteri soittamassa nubaa, luuttu ja viulu edessä
- MAR/musiikki — malhun: käsityöläiskorttelin miesten lauluryhmä Fèsissä tai Meknèsissä
- DZA/historia — itsenäisyys 1962: äänestys tai juhla 5.7.1962, ei sotakuvaa
- DZA/ruoka — viinimaa: algerialainen viinitarha ylätasangolla, rypäleitä
- DZA/kirjallisuus — Assia Djebar: kirjailijan muotokuva
- DZA/luonto — saharangepardi: gepardi Ahaggarin kivikossa yöllä
- TUN/kuvataide — École de Tunis / Yahia Turki: taiteilijaryhmä tai ateljee 1950-luvun Tunisissa
- TUN/kuvataide — Safia Farhat: moderni kuvakudos työn alla
- TUN/musiikki — mezoued: säkkipilli lähikuvassa, kaksi lehmänsarvea näkyvissä (ilman ihmisiä)

### NGA / GHA / SEN
- NGA: Oyon valtakunta — jorubaratsumies tai Alaafinin hovi 1700-luvulla · Nana Asmaʼu — hausankielinen ajami-käsikirjoitus tai jaji-opettajan malfa-hattu · King Sunny Adé — jùjú-yhtye lavalla 1980-luvun tyyliin (ei kasvokuvaa) · Ben Enwonwu — Anyanwu-veistos Lagosin kansallismuseon julkisivulla · Amos Tutuola — Palmuviinin juojan tarinamaailma (havainnekuva) · Onitshan markkinakirjallisuus — vihkopino torikojussa 1950-luvulla
- GHA: Muinainen Ghana / Wagadu — Sahelin karavaanikaupunki kullan ja suolan kaupassa · Highlifen synty — 1920-luvun tanssiorkesteri Accran klubilla · E. T. Mensah — tanssiorkesteri torvineen 1950-luvulla · Azonto — tanssiasento arjen työtä matkien (siluetti, ei kasvoja) · Akaanien päivännimet — nimenantojuhla, kahdeksas päivä · Odwira — raivattu seremoniallinen polku Akropongissa (ei ihmisiä) · Akaanien matriliniteetti — abusua-suvun perimäkaavio kuvitettuna
- SEN: Jolofin valtakunta — Ndiadiane Ndiaye ja Jolofin hovi · Waalo — lingeer Ndaté Yalla Mbodj valtaistuimellaan · Senghor — runoilijapresidentti työpöytänsä ääressä (kuvitus) · Café Touba — suodatinkannu ja djar-mausteet kadunkulman kojussa (ei kasvoja) · Mbalax — sabar-yhtye ja sähköbasso lavalla · Paulin Vieyra — Afrique-sur-Seine 1955, kamera Seinen rannalla · Djibril Diop Mambéty — Touki Bouki -tunnelma, sarvipäinen moottoripyörä · Mati Diop — Dahomey-dokumentin palautetut esineet museolaatikoissa · Suuri vihreä muuri — istutusrivi Sahelissa Senegalin päässä

### GTM / NIC / PAN
- GTM: vyökangaspuut — kutoja selin, loimi vyötäröltä puuhun · marimba de tecomates — kurpitsakaikupohjat kielten alla · kromaattinen marimba — kaksirivinen koskettimisto · Rabinal Achí — puunaamiot ja rakorumpu
- NIC: Acahualincan jalanjäljet kivettyneessä tuhkassa · nicarao-/chorotega-esine tai patsas · viittomakieli — kaksi nuorta viittomassa · José de la Cruz Mena — muotokuva tai Leónin teatteri · Palo de Mayo — nauhoin koristeltu toukotanko · chichero-yhtye vaskisoittimineen · La Mocuana — luola ja kätketty aarre · La Cegua — valkopukuinen hahmo metsätiellä · Masayan käsityötori ja riippumattokortteli
- PAN: vuoden 1826 kongressi · panamalainen ceviche corvinasta · tamboriton kolme rumpua (caja, repujador, repicador) · congo-perinteen tanssijat Portobelossa · música típica -yhtye haitareineen · nuchukana-puuhahmot nyytissä

### ETH / SDN / SDS
- 29 kuvatonta nostoa (ETH 6, SDN 6, SDS 16): tarkka lista tulee erikseen, kun agentin loppuraportti valmistuu; nostot ja otsikot ovat mainissa v1640 MAA_KATEGORIAT.ETH/SDN/SDS-lohkoissa (kuva-kenttä puuttuu).

## Kohdekarttojen miniatyyrit (kaupunkilehdet v1640)

### Miami / Halifax
- Miami / Wynwoodin muraalikorttelit — matala varastokortteli, jonka seinät on maalattu suurin muraalein
- Miami / Esittävän taiteen keskus — kaareva lasiseinäinen konserttitalo ja sen vieressä vanha tavaratalon torni
- Miami / Pérezin taidemuseo — matala museorakennus, jonka räystäältä riippuu pitkiä kasvipylväitä
- Miami / Lyric-teatteri — pieni valkoinen teatterijulkisivu, jonka yläreuna kaartuu holviksi
- Miami / Vapaudentorni — kapea vaalea torni, jonka huipussa on Giraldan mallinen kellokoju
- Miami / Bayfront Park — pyöreä kivireunainen suihkulähde puistossa tornien edessä
- Miami / Olympia-teatteri — teatterin katos ja pieni lippuluukku kadun varrella
- Miami / Piirikunnan oikeustalo — portaittain kapeneva pilvenpiirtäjä, jonka huippu on pyramidi
- Halifax / Halifaxin linnoitus — matala tähdenmuotoinen kivilinnoitus ruohovallien ympäröimänä
- Halifax / Vanha kellotorni — valkoinen kolmiportainen kellotorni vihreällä kupolilla, kukkulan rinteessä
- Halifax / Pyhän Paavalin kirkko — valkoinen puukirkko kapealla tornilla ja kolmiopäätyisellä julkisivulla
- Halifax / Atlantin merimuseo — puuverhoiltu museorakennus laiturilla, ankkureita edessä
- Halifax / Julkinen puutarha — viktoriaaninen puutarha, jossa soittolava, silta ja suihkulähde
- Halifax / Vanha hautausmaa — vinoja tummia liuskekivihautakiviä lehmusten alla
- Halifax / Pier 21 — pitkä punatiilinen satamaterminaali, jonka päädyssä lukee laiturin numero
- Halifax / Point Pleasant Park — pyöreä harmaa martellotorni nurmella männikön keskellä

### Kapkaupunki / Nairobi
- Kapkaupunki / V&A Waterfront — vanhat satama-altaat ja niitä reunustavat 1800-luvun tiilirakennukset, taustalla nosturit ja Pöytävuori
- Kapkaupunki / Greenmarket Square — kivetty aukio, Old Town Housen valkoinen holvikaarijulkisivu ja aukion vanha vesipumppu
- Kapkaupunki / Iziko Slave Lodge — matala keltainen kaksikerroksinen talo, tummat ikkunaluukut ja kolmiopäätyinen sisäänkäynti kadun kulmassa
- Kapkaupunki / Kaupungintalo — hunajanvärinen edwardiaaninen julkisivu ja kellotorni Grand Paraden laidalla
- Kapkaupunki / Hyväntoivonlinnoitus — viisikulmainen keltainen bastionilinnoitus ilmasta nähtynä, vallihauta ympärillä
- Kapkaupunki / District Six -museo — vanha punatiili-metodistikirkko palmujen välissä, sisällä lattian kokoinen kartta
- Kapkaupunki / Iziko Etelä-Afrikan museo — vaalea 1800-luvun museorakennus jyrkkine kattoharjoineen puistokäytävän päässä
- Kapkaupunki / Rust en Vreugd — vaaleanpunainen Cape Dutch -kaupunkitalo, veistetty rokokoo-ovi ja parveke, edessä muotopuutarha
- Nairobi / Nairobin arboretum — punamullalla kulkeva metsäpolku korkeiden puiden holvissa
- Nairobi / Kenian kansallismuseo — museorakennus Museum Hillillä, edessä nurmi ja lippu; luonnonhistoriallinen kokoelma
- Nairobi / Nairobin yliopisto — kaareva kiviveistos-suihkulähde kirahvireliefeineen kampuksen pihalla
- Nairobi / Jeevanjeen puutarha — avoin puistoaukio vanhojen jakarandapuiden alla, kivipenkkejä ja muistomerkki
- Nairobi / Kenian kansallisarkisto — vaalea pylväikköjulkisivu ja kaiverrettu nimi kadun yläpuolella
- Nairobi / Nairobi Gallery — vuoden 1913 siirtomaa-ajan virastotalo, jonka lattiassa on Point Zero -merkki
- Nairobi / Kenyattan kongressikeskus — lieriömäinen 32-kerroksinen terrakottatorni ja sen vieressä kartiokattoinen amfiteatteri
- Nairobi / Nairobin rautatiemuseo — vanha höyryveturi raiteilla museorakennuksen edessä, kyljessä E A R
...
**Toinen erä samaan linssiin, kun 20 havainnekuvaa on toimitettu:** 20 LÖYTÖKUVAA korttiin (keksintöjen muotokuvan paikalle), kansio `aikajana/ihmisen-matka/esine/<tunnus>.jpg`, pystykuva 3:4 kuten muotokuvat, sama seepiaan taittuva valokuvamainen tyyli, esine neutraalilla taustalla tai löytöpaikan maassa, ei tekstiä. Kuvateksti muodossa `<esine>, <paikka>` (esim. "Kallo, Jebel Irhoud"). Esineet tunnuksittain: jebel-irhoud kallon kasvo-osa; omo-kibish kallon fragmentit; pinnacle-point simpukankuoret ja kivityökalut; blombos kaiverrettu okrapala ja Nassarius-helmet; skhul-qafzeh hautaus hirvensarven kanssa (esinekuvana sarvi ja okra); al-wusta sormiluu järven hiekalla; lida-ajer hampaat; denisova pikkusormen luu ja vihreä rannerengas; madjedbebe hiottu kivikirves ja okra; lake-mungo tuhkahautauksen okra ja simpukat; niah kallo ("Deep Skull"); bacho-kiro karhunhampaista tehdyt riipukset; chauvet hiilipiirroksen yksityiskohta (hevoset); yana mammutinluinen keihäänkärki ja neula; tianyuan reisiluu; beringia mammutin syöksyhammas ja kivikärki; white-sands jalanjälki kipsissä; monte-verde puuesine ja solmittu köysi; lapita hammastetuin leimoin koristeltu ruukunpala; aotearoa moa-linnun luu ja polynesialainen kalakoukku. Lähderajaus kuten ennen: aidot löydöt Commonsissa katsottavina malleina (PD/CC), kuvat fiktiivisiä havainnekuvia, ei museokuvan kopioita.
