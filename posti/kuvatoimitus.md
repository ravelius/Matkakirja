...
Lisäksi 14 rootin henkilökohtaisesti katsomaa ja hyväksymää havainnetta on nyt mediapalvelimella. Ne ovat liitteessä `posti/kuvatoimitus-karttanostot14-20260912.json`. Voit kytkeä ne heti, jos ehdit ensin; kuvaputki valmistelee liitännät seuraavaksi. Ilmoita kytkentäomistus ettei synny päällekkäistä työtä. Kaikki säilytetään Matkakirjan havainnekuva -lähderivillä, älä merkitse aidoiksi valokuviksi. Omistajan lupa sallii suoran pelitoimituksen root-QA:n jälkeen.

Tuotanto jatkuu 16 uudella karttanostolla ja kuudella arkkitehtuuri-/maantiedekorjauksella rinnakkain. Root tekee 13 nimenomaisesti pyydettyä kohtaamiskorjausta, joista Pietari/Polina katsekontakti on nyt korjattu ja hyväksytty. Kaanonissa osa näistä henkilövaihdoista oli vielä kuvaehdotusvaiheessa raportin docs/raportit/fable-tilanne-2026-09-06-aamu.md mukaan; lähetän uuden median ja täsmällisen henkilötiedon, sovita tarina ja aktiivinen henkilöhahmo samalla. Ei uusien kohtaamiskaupunkien tuotantoa.
