## 2026-09-14 06:08-vuoro — ROOT: aito reduced-motion-vaihto PASS; rajattu selain-QA päättyy, laite-/äänirajat erikseen

Root kuittaa Fablen06:00postin (blob9142ce28e35102f6f8330a2a48d298eb67575e72). Main117a4f791dfaf590d9d53cfb196a495a482e2c52/v1862 ennallaan. Tyhjän ensikehyksen diagnoosi pysyy teillä, root ei aloita rinnakkaista selvitystä. Edellisen05:46viestin Marseille-avatun-vihjeen ja kapean kokonaisen pölynpuistelun PASSit sekä yleisen takapuoli-uusintaportin korjaus säilyvät; lukekaa ne ennen uusien vastakoetehtävien avaamista.

UUSI OIKEA PELI PASS: normaali yksi50p bussimatka Marseille3360→Barcelona3310/pv5keskipäivä, nykyinen Livia-äänite livia-barcelona-3.mp3 (17.668141s). Ei generointia, mediaohjausta, resettiä, save-injektiota tai turvaohitusta. CUA:n dokumentoidun CDP:n välilehtikohtainen Emulation.setEmulatedMedia oli tuettu. Alkutila reduce=false. Todellinen matchMedia-change reduce=true kesken selittää-cuen c1/1839–4759ms: Audio2.298187→2.316205s, paused=false. Palautus features[] kesken c3/13739–17500ms: Audio14.266959→14.284732s, paused=false. Tämä EI ole QA-iframe-alustuksen muutos, matchMedia-monkeypatch tai OS-asetusruudun koe.

VAIN LUKEVA MITTAUS:1265SVG/media-näytettä, tavoite50ms/max61.7ms, Audio-taaksepäinhyppyjä0. c1normaali4näytettä/3SVG-hashia → c1reduced46näytettä(2.336432–4.589401s)/1hash; c2reduced115näytettä(5.085126–10.791768s)/1hash; c3reduced4näytettä/1hash → palautettu c3normaali62näytettä(14.284814–17.337247s)/20hashia. Kaikissa näissä sama vartaloankkuri, ei paused/hidden. Ilme siis staattinen percue reduced-tilassa, vaihtuu seuraavassa cuessa, liikkuu jälleen asetuksen palautuksen jälkeen ilman äänikellon alusta-aloitusta. On c1/off c3, ei väitettä molemmista saman cuen sisällä tai pitkästä sivukävelystä. Root katsoi aidon pelin päälle/palautus/loppukuvat: Pulu näkyy, ei valkoista laatikkoa/jumiasentoa. Luonnollinen audioEnd17.668141s/c3End, gentle-lepo ja alkuperäinen SVGhash. Tämä sulkee viimeisen käytettävissä olevan reduced-motion-livevaihdon hyväksyntäportin.

SIIVOUS varmennettu: features[]→reducefalse, havaintokuuntelijat/ajastimet/QA-olio poistettu, documenthiddenfalse. macOS-/nativeSafari-asetuksia tai savea ei muutettu. Lopuksi Barcelona3310/pv5keskipäivä, normaali koko2560×1352, chat/modalit kiinni, Canaletesin vihje edelleen lukittu. Ei Barcelonan uutta osuma-PASSia eikä pullaostoa; Marseillen avattu vihje jo varmennettu. Handofftab säilyy.

ROOTIN ARVIO: nykyisen rajatun animaatiokierroksen katsottu selainkäyttäytyminen on hyväksyttävä. En anna koko pelin/kaikkien laitteiden/äänellisen kokonaisuuden hyväksyntää. Jäljellä: oikea iPad/touch/WebKit-koe vaatii käyttäjän/testilaitteen; cue-aware uuden Audio-olion vaihdolle ei nykyisessä julkaistussa UI:ssa ole polkua (omistajanread-only05:50), ei todettu bugi; pullaäänet yhä ÄÄNI-HOLDin takana teidän backlogissa. Ei uusia ominaisuuksia, QA-ohjaimia, tekstejä tai ääniä tämänseurannan perusteella.

Tauotan15min root-seurannan ohjeen mukaisesti tähän: nykyiset turvalliset selainkokeet tehty, jäljellä olevien rajojen täydellinen sulkeminen vaatii testilaitteen/käyttäjän osallistumisen tai erillisen valtuutuksen. Tämä EI tauota Fablen omaa työtä tai uutta tekstisessiota eikä arkistoi tehtäviä. Root jatkaa tarvittaessa omistajan uudesta pyynnöstä; älä avaa muuttumattomia suljettuja portteja uudelleen. Tarkka raportti root-työtilassa output/horatio-livia-root-qa-20260913/qa-reduced-motion-live-20260914-0613.md. Toimitus ja kuittaus edelleen erikseen.

## 2026-09-14 05:46 UTC — ROOT: Marseille avattu vihje PASS + 390px chatin koko paluu/pöly/kirja PASS

Kaksi uutta oikean julkaistun pelin hyväksyntähavaintoa 05:17–05:27 UTC, lähteet ja säilynyt QA-tila varmennettu uudelleen 05:46-vuorolla. Main edelleen117a4f791dfaf590d9d53cfb196a495a482e2c52/v1862. js/main.js, js/pollo.js ja js/livia-eleet.js Git-main = HTTP200-origin = todella suoritettu selainlähde. SHA256 main b0f7707297e93fbc3c33b20a374929ad26aa73c18707522dbc0248d2b6ba8cdd; pollo 7f70fbfc466a456183cf08cca1d441dafc290d01e55a185ba6e2b5b867e4f518; livia-eleet c7712f88db16bcf784f242edf457cbe1bb61db0fa128ad75d05ff9df4ce506f3.

MARSEILLE VIHJE PASS: normaali Budapest→Wien→Venetsia→Alpit→Marseille bussireitti, ei resettiä/injektiota. Marseillen brioche oli ostettu aiemmin, vihje avattu ja kohtaaminen ratkaisematta. Esittelyn jälkeisen tavallisen pannun jälkeen data-piste=piste:marseille/opacity1 keskus[980.6990356445312,644.8655395507812], tavallinen keskustaklikkaus avasi ”Marseille — kohtaaminen · yritys1/2”/Baptiste/Aloita peli, EI city-popupia. Kohtaamista ei aloitettu eikä kysymykseen vastattu; Escape sulki. £3360, päivä5keskipäivä, vihje edelleen ratkaisematta. Tämä on yhteisen reitityksen aito vastakoe yhdessä alkuperäisistä päällekkäisyyskaupungeista. Ei väitettä uuden Rudas-kokeen tekemisestä: saman QA-saven Rudas on jo ratkaistu.

KAPEA CHAT PASS:390×844, tavallinen Pulu-chat ja yksi ”Miksi saippua poistaa rasvaa?” -tekstikysymys. Speaker ”Lue vastaukset ääneen” Value0, mikrofoni ”Kysy ääneen” Value0; root luki myös pollo.js:n !aaniPaalla-vartijat. Ei maksullista puhetta tai generointia. Jatkuva30s Page.screencast:1785JPEG-framea, truncated=false. Paluu/pöly4.5–6.8s:138framea/max19.865ms väli. Vastaus alkoi4.8s, paluu noin5.0s, koko pölynpuistelu5.0–6.2s, kirja/silmälasit6.4s alkaen. Root katsoi muun aikajanan lisäksi11alkuperäisruutua0.2s välein4.6–6.6s: vuorottelevat pään/vartalon/siiven ravistukset/pöly, sitten kirja. Ei leikkautumista, valkoista neliötä tai jumiin jäävää asentoa. Tallenteen ainoa yli50ms aukko(251ms) oli lähtövaiheen alussa, ei paluun aikana. Tämä SULKEE vanhan pienruuturaportin puuttuneen jatkuvan pölyhavainnon. Ei kuuluvan chat-vastauksen synkronointi- tai fyysisen iPad/WebKitin hyväksyntää.

TAKAPUOLEN PORTTI KORJATTU: v1855:n todellinen etu–taka–etu näkyvyys-PASS säilyy. Solin rajatun read-only-arvion lisäksi root varmisti merkit.js-blobin identtiseksi v1855/v1859/v1862:ssa(1b052707af54d6f5f770775a704ce9510695efd1), ja nykyinen kohtaamisprioriteetti vaatii edessa(e.lat,e.lng). Aiempi ehdotus yleisen takapuolikokeen uusimisesta uuden osumareitityksen takia oli liian tiukka ilman muuttunutta näkyvyyskoodia/uusia oireita. Poistan tämän uudelleen avatun yleisen portin, en väitä uutta tekemätöntä vihjemerkin takapuoli-UI-koetta tehdyksi.

JÄLJELLÄ RAJATUSTI: (1) prefers-reduced-motionin oikea selain-/OS-asetusvaihto kesken Livia-cuen; (2) cue-aware Livian uuden Audio-olion vaihto olemassa olevalla julkaistulla äänellä (vanha Marseille-lukijareaktion voice-swap ja saman Audion replay jo PASS, ei uusita); (3) fyysinen iPad/touch/WebKit erikseen. Nykyiseltä ainoalta animaatio-omistajalta pyydetty vain read-only nykyisten näkyvien QA-säädinten/toistopolun ohje kohtiin1–2, ei toteutusta/uusia ominaisuuksia/selaintyötä. Pullaäänten kytkentä pysyy teidän backlogissa ÄÄNI-HOLDin takana; ei uusia media- tai liveäänipyyntöjä.

QA selain säilytetty Marseille3360/pv5keskipäivä, chat kiinni, viewport palautettu, screencast/Debugger pois, markHandoff. NativeSafari koskematon. Tekstisessiota ei herätetty tai luettu tällä seurantavuorolla. Ei 27maan135näytteiden tai aiempien suljettujen Pulu-porttien uusinta-ajoja. Raportti root-työtilan output/horatio-livia-root-qa-20260913/qa-marseille-vihje-kapea-chat-20260914-0546.md. Seuranta ACTIVE, ei arkistointia. Tämä on toimitus, kuittaus erikseen.
...
Pelin oma lataus nähtiin: kaikki yhdeksän z4-laattaa x9–11/y3–5 polusta /2026-09-14-tasoitus/vari/FRA/ palautuivat HTTP200/image-webp. CDP-loki oli truncated=true (247 säilynyttä tapahtumaa), joten tämä on positiivinen9-laatan näyttö, EI täydellinen verkkoloki; manifestivastaus oli jo poistunut puskurista. Network ja Debugger poistettiin käytöstä. Kolmen z4-laatan erillinen origin-GET varmisti HTTP200, RIFF/WEBP-alkutavut ja SHA:t; ei tiedosto-/laatta-ajoja rootilta.

03:19:11 julkinen manifesti: SHA256 6781b69de904bed22ed2b8194a047f6ffb12c380009eba99178eb760e86ddddb, Last-Modified03:18:10GMT. Siirtyneet FRA,AUT,CHE,BIH,BGR =5/27. Kaikki27 kirjaukset säilyvät. Actions-listassa viimeiset kolme varitasoajoa success ja seuraava34802162958 in_progress; maiden tarkkaa run-ID-vastaavuutta ei ole itsenäisesti luettu. Ei väitettä koko erän valmistumisesta.

OSUMAKORJAUS JULKAISTU: PR2401 merged02:57:36, head f9dcda4a623985914904e3b52a2f9a1946059762 / main8cf994fffadba33687cabbbf90a39f28b39de4a3. PR2402 merged03:06:16, head3c14cf769821df15a5476c773012bada9d8d63ee / main74f9bb1b05987411c3c15d9e398cf463f42d3d00 (v1860 tilannekortti). Molemmat exacthead-CI:t ja stepit vihreitä: run34800786750/job103842882410 sekä run34801275077/job103844290745. Molemmat julkaisuajot myös success. Main/fokuspiste/lauta/nostot/laattapyramidi: Git = origin = todella suoritetun selainlähteen SHA256; Debugger444tapahtumaa, ei truncationia.

PARIISIN NORMAALIT OSUMAKONTROLLIT PASS: DOM:n näkyvästä keskipisteestä tavallinen napautus [859.7,283] avasi Pariisi:tietoruutu -pinnan. Suljin Sulje-painikkeella; uusi keskitys muutti karttakoordinaatit. Lukitun Quai-pisteen tuore keskus [1303.20,686.09] avasi Pulu-kuplan ”Ratkaise kaksi kysymystä kartalta.” eikä kaupunkipopupia. Aiempi rauhoittumattoman panoroinnin aikainen osumattomuus ei ole vahvistettu regressio. Ei porttien avaamista/testitilan injektiota.

Root luki runtime-diffit ja raportin. Rajattu Sol-katselmoija varmisti piirretyn pisteen/osuman yhteiset asteet ja etupuolirajat; eristetyn commitin Node-testit22/22 (agentin ajo, ei rootin UI-testi). 44px itsenäinen kosketusalue ei ole uusi vaatimus: sovitut kapeat osuma-alueet säilyvät. Fyysinen sivuun osuva sormi, Budapestin avattu Rudas-vihje ja takapuolen tämän version livevastakoe jäävät erillisiksi — tekijän18/18savuke ei yksin sulje niitä. En pyydä rinnakkaista osumafixiä.

Seuraava: olemassa olevan27maa-ajon valmistuminen ja puuttuvien normaalipelin porttien jatko. Ääni-/kuva-HOLD ja tekstisession erillisyys säilyvät. Ei kirjoittajan/animaatiovetäjän herätystä. QA-välilehti säilyy samassa Pariisissa, ei avointa kaupunkimodaalia.
