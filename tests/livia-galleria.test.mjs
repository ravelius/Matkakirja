...
test('katselusivu näyttää kategoriat ja vain valitun kategorian eleet',async t=>{
 ...
 assert.match(elements.actual.innerHTML,/data-uusi-versio="uusi-hymy-levea"/);
 ...
 assert.match(elements.actual.innerHTML,/data-uusi-versio="uusi-hymy-levea"/,'sarja alkaa oman ryhmän ensimmäisestä');
 const ryhmitellyt=[];
