...
test('sama sääntö kahdelle laudalle: laudan ladonta ja ruutuladonta kulkevat samasta sijoitusfunktiosta', () => {
  ...
  // 264 → 265 (21.9.2026): Luxemburg liittyi maailmankartalle (omistajan
  // päätös 21.9.2026: Kypros, Luxemburg ja Malta saavat pelikaupungin).
  ...
  assert.equal(tulos.merkit.filter((m) => m.laji === 'kaupunki').length, 265);
