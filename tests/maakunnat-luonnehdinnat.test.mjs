 ...
 * GRC:n kuvat saapuvat kuvaputkelta ja se lasketaan mukaan. NLD ja BEL
 * lisättiin samana päivänä samalla tavalla (erä 1, vain `lyhyt`).
 */
const ERASSA_1 = new Set(['GRC', 'NLD', 'BEL']);
