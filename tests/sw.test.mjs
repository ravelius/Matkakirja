...
const NIPUTTAMATTOMAT = new Set([
  ...
  // Maakuntien luonnehdinnat: ensimmäinen tuoja ilmestyi 22.9.2026
  // (js/karttatyokalu-maakunnat.js, Karttatyökalun Maakunnat-runko) —
  // paketti on siis MODULES-listalla (tools/build-standalone.mjs) eikä
  // enää tässä. Rivi jätetty tähän muistiksi listan historiasta.
