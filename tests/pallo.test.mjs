...
test('laatoitettu pallo: Mercator-laatat ämpäristä, z4-tekstuuri varana', async () => {
  ...
  assert.equal(PALLO_LAATTAKANSIO, `${PALLO_LAATTAVERSIO}-nostot-g`, 'kansio g: sama pohja ja viivataso kuin f, nostotaso 2026-09-18-nostot lukituilla ankkureilla (Mac 18.9.2026)');
  assert.equal(PALLO_LAATAT, `https://media.matkakirja.app/${laattojenKansio(PALLO_LAATTAVERSIO, true, 'g')}`);
  ...
  assert.match(pallonLaatta(3, 5, 8), /laatat\/2026-09-07a-nostot-g\/8\/3\/5\.jpg$/, 'taso 8 samasta kansiosta (varakansio pois 5.9.2026 klo 17.30)');
  assert.match(pallonLaatta(3, 5, 7), /laatat\/2026-09-07a-nostot-g\/7\/3\/5\.jpg$/, 'tasot 0-7 nostosarjasta g');
