...
test('laatoitettu pallo: Mercator-laatat ämpäristä, z4-tekstuuri varana', async () => {
  ...
  assert.equal(PALLO_LAATTAKANSIO, `${PALLO_LAATTAVERSIO}-nostot-h`, 'kansio h: sama pohja ja viivataso kuin g, nostotaso 2026-09-19-nostot ilman kaupunkipisteiden mustetta (Mac 18.9.2026)');
  assert.equal(PALLO_LAATAT, `https://media.matkakirja.app/${laattojenKansio(PALLO_LAATTAVERSIO, true, 'h')}`);
  ...
  assert.match(pallonLaatta(3, 5, 8), /laatat\/2026-09-07a-nostot-h\/8\/3\/5\.jpg$/, 'taso 8 samasta kansiosta (varakansio pois 5.9.2026 klo 17.30)');
  assert.match(pallonLaatta(3, 5, 7), /laatat\/2026-09-07a-nostot-h\/7\/3\/5\.jpg$/, 'tasot 0-7 nostosarjasta h');
